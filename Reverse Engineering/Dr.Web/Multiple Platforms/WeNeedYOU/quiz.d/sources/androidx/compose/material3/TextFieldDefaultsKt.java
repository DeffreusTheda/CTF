...
public final class TextFieldDefaultsKt {
    ...
    public static final State<BorderStroke> m1588animateBorderStrokeAsStateNuRrP5Q(boolean z, boolean z2, InteractionSource interactionSource, TextFieldColors textFieldColors, float f, float f2, Composer composer, int i) {
        ...
        if (z) {
            ...
            rememberUpdatedState = AnimateAsStateKt.m113animateDpAsStateAjpBEmI(f3, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1927737286);
            ComposerKt.sourceInformation(composer, "2118@112993L46");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Dp.m5015boximpl(f2), composer, (i >> 15) & 14);
            composer.endReplaceableGroup();
        }
        State<BorderStroke> rememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(new BorderStroke(rememberUpdatedState.getValue().m5031unboximpl(), new SolidColor(indicatorColor$material3_release.getValue().m2721unboximpl(), null), null), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
