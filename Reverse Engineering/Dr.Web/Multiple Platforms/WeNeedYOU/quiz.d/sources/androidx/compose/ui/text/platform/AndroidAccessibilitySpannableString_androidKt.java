...
public final class AndroidAccessibilitySpannableString_androidKt {
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver fontFamilyResolver, URLSpanCache urlSpanCache) {
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            spannableString.setSpan(TtsAnnotationExtensions_androidKt.toSpan(component12), range2.getStart(), range2.getEnd(), 33);
        }
    ...
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i, int i2, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m4783setColorRPmYEkk(spannableString2, spanStyle.m4491getColor0d7_KjU(), i, i2);
        SpannableExtensions_androidKt.m4784setFontSizeKmRG4DE(spannableString2, spanStyle.getFontSize(), density, i, i2);
        if (spanStyle.getFontWeight() != null || spanStyle.getFontStyle() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m4583getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle != null ? fontStyle.m4633unboximpl() : FontStyle.INSTANCE.m4635getNormal_LCdwA())), i, i2, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = FontFamily.Resolver.CC.m4605resolveDPcqOEQ$default(resolver, fontFamily, null, 0, fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4645getAllGVVA2EU(), 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m4781setBackgroundRPmYEkk(spannableString2, spanStyle.getBackground(), i, i2);
    }
}
