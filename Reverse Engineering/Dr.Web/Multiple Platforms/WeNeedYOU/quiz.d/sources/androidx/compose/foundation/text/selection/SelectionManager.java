...
public final class SelectionManager {
    ...
    public SelectionManager(SelectionRegistrarImpl selectionRegistrar) {
        ...
        this.dragBeginPosition = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2435boximpl(Offset.INSTANCE.m2462getZeroF1C5BW0()), null, 2, null);
        this.dragTotalDistance = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2435boximpl(Offset.INSTANCE.m2462getZeroF1C5BW0()), null, 2, null);
        ...
        selectionRegistrar.setOnSelectionUpdateStartCallback$foundation_release(new Function3<LayoutCoordinates, Offset, SelectionAdjustment, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.2
            ...
            public /* bridge */ /* synthetic */ Unit invoke(LayoutCoordinates layoutCoordinates, Offset offset, SelectionAdjustment selectionAdjustment) {
                m970invoked4ec7I(layoutCoordinates, offset.getPackedValue(), selectionAdjustment);
                return Unit.INSTANCE;
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final void m970invoked4ec7I(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                Offset m955convertToContainerCoordinatesQ7Q5hAU = SelectionManager.this.m955convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j);
                if (m955convertToContainerCoordinatesQ7Q5hAU != null) {
                    SelectionManager.this.m961startSelection9KIMszo(m955convertToContainerCoordinatesQ7Q5hAU.getPackedValue(), false, selectionMode);
        ...
        selectionRegistrar.setOnSelectionUpdateCallback$foundation_release(new Function5<LayoutCoordinates, Offset, Offset, Boolean, SelectionAdjustment, Boolean>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.4
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(LayoutCoordinates layoutCoordinates, Offset offset, Offset offset2, Boolean bool, SelectionAdjustment selectionAdjustment) {
                return m971invoke5iVPX68(layoutCoordinates, offset.getPackedValue(), offset2.getPackedValue(), bool.booleanValue(), selectionAdjustment);
            }

            /* renamed from: invoke-5iVPX68, reason: not valid java name */
            public final Boolean m971invoke5iVPX68(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionMode) {
                Intrinsics.checkNotNullParameter(layoutCoordinates, "layoutCoordinates");
                Intrinsics.checkNotNullParameter(selectionMode, "selectionMode");
                return Boolean.valueOf(SelectionManager.this.m969updateSelectionRHHTvR4$foundation_release(SelectionManager.this.m955convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j), SelectionManager.this.m955convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, j2), z, selectionMode));
            }
        });
        selectionRegistrar.setOnSelectionUpdateEndCallback$foundation_release(new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.5
            ...
            public final void invoke2() {
                ...
                SelectionManager.this.m956setCurrentDragPosition_kEHs6E(null);
            }
        });
        ...
        selectionRegistrar.setAfterSelectableUnsubscribe$foundation_release(new Function1<Long, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager.7
            ...
            public final void invoke(long j) {
                ...
                SelectionManager.this.m960setStartHandlePosition_kEHs6E(null);
                SelectionManager.this.m959setEndHandlePosition_kEHs6E(null);
            }
        });
    }
    ...
    public final Modifier getModifier() {
        return KeyInputModifierKt.onKeyEvent(FocusableKt.focusable$default(FocusChangedModifierKt.onFocusChanged(FocusRequesterModifierKt.focusRequester(OnGloballyPositionedModifierKt.onGloballyPositioned(onClearSelectionRequested(Modifier.INSTANCE, new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager$modifier$1
            ...
            public /* bridge */ /* synthetic */ Boolean invoke(KeyEvent keyEvent) {
                return m972invokeZmokQxo(keyEvent.m3699unboximpl());
            }

            /* renamed from: invoke-ZmokQxo, reason: not valid java name */
            public final Boolean m972invokeZmokQxo(android.view.KeyEvent it) {
                boolean z;
                Intrinsics.checkNotNullParameter(it, "it");
                if (SelectionManager_androidKt.m976isCopyKeyEventZmokQxo(it)) {
    ...
    public final void setContainerLayoutCoordinates(LayoutCoordinates layoutCoordinates) {
        ...
        Offset m2435boximpl = layoutCoordinates != null ? Offset.m2435boximpl(LayoutCoordinatesKt.positionInWindow(layoutCoordinates)) : null;
        if (Intrinsics.areEqual(this.previousPosition, m2435boximpl)) {
            return;
        }
        this.previousPosition = m2435boximpl;
        updateHandleOffsets();
    ...
    public final void m957setDragBeginPositionk4lQ0M(long j) {
        this.dragBeginPosition.setValue(Offset.m2435boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragBeginPosition-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m964getDragBeginPositionF1C5BW0$foundation_release() {
    ...
    public final void m958setDragTotalDistancek4lQ0M(long j) {
        this.dragTotalDistance.setValue(Offset.m2435boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getDragTotalDistance-F1C5BW0$foundation_release, reason: not valid java name */
    public final long m965getDragTotalDistanceF1C5BW0$foundation_release() {
        return ((Offset) this.dragTotalDistance.getValue()).getPackedValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setStartHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m960setStartHandlePosition_kEHs6E(Offset offset) {
        this.startHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getStartHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m967getStartHandlePosition_m7T9E() {
        return (Offset) this.startHandlePosition.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setEndHandlePosition-_kEHs6E, reason: not valid java name */
    public final void m959setEndHandlePosition_kEHs6E(Offset offset) {
        this.endHandlePosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getEndHandlePosition-_m7T9-E, reason: not valid java name */
    public final Offset m966getEndHandlePosition_m7T9E() {
    ...
    public final void m956setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m963getCurrentDragPosition_m7T9E() {
    ...
    public final void updateHandleOffsets() {
        ...
        if (selection == null || layoutCoordinates == null || !layoutCoordinates.isAttached() || layoutCoordinates2 == null || layoutCoordinates3 == null) {
            m960setStartHandlePosition_kEHs6E(null);
            m959setEndHandlePosition_kEHs6E(null);
            return;
        }
        long mo3975localPositionOfR5De75A = layoutCoordinates.mo3975localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release.mo923getHandlePositiondBAh8RU(selection, true));
        long mo3975localPositionOfR5De75A2 = layoutCoordinates.mo3975localPositionOfR5De75A(layoutCoordinates3, anchorSelectable$foundation_release2.mo923getHandlePositiondBAh8RU(selection, false));
        Rect visibleBounds = SelectionManagerKt.visibleBounds(layoutCoordinates);
        Offset m2435boximpl = Offset.m2435boximpl(mo3975localPositionOfR5De75A);
        m2435boximpl.getPackedValue();
        if (!SelectionManagerKt.m975containsInclusiveUv8p0NA(visibleBounds, mo3975localPositionOfR5De75A) && getDraggingHandle() != Handle.SelectionStart) {
            m2435boximpl = null;
        }
        m960setStartHandlePosition_kEHs6E(m2435boximpl);
        Offset m2435boximpl2 = Offset.m2435boximpl(mo3975localPositionOfR5De75A2);
        m2435boximpl2.getPackedValue();
        m959setEndHandlePosition_kEHs6E((SelectionManagerKt.m975containsInclusiveUv8p0NA(visibleBounds, mo3975localPositionOfR5De75A2) || getDraggingHandle() == Handle.SelectionEnd) ? m2435boximpl2 : null);
    }
    ...
    private final Rect getContentRect() {
        ...
        if (layoutCoordinates3 != null && layoutCoordinates3.isAttached()) {
            long mo3975localPositionOfR5De75A = layoutCoordinates3.mo3975localPositionOfR5De75A(layoutCoordinates, anchorSelectable$foundation_release.mo923getHandlePositiondBAh8RU(selection, true));
            long mo3975localPositionOfR5De75A2 = layoutCoordinates3.mo3975localPositionOfR5De75A(layoutCoordinates2, anchorSelectable$foundation_release2.mo923getHandlePositiondBAh8RU(selection, false));
            long mo3976localToRootMKHz9U = layoutCoordinates3.mo3976localToRootMKHz9U(mo3975localPositionOfR5De75A);
            long mo3976localToRootMKHz9U2 = layoutCoordinates3.mo3976localToRootMKHz9U(mo3975localPositionOfR5De75A2);
            return new Rect(Math.min(Offset.m2446getXimpl(mo3976localToRootMKHz9U), Offset.m2446getXimpl(mo3976localToRootMKHz9U2)), Math.min(Offset.m2447getYimpl(layoutCoordinates3.mo3976localToRootMKHz9U(layoutCoordinates3.mo3975localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release.getBoundingBox(selection.getStart().getOffset()).getTop())))), Offset.m2447getYimpl(layoutCoordinates3.mo3976localToRootMKHz9U(layoutCoordinates3.mo3975localPositionOfR5De75A(layoutCoordinates2, OffsetKt.Offset(0.0f, anchorSelectable$foundation_release2.getBoundingBox(selection.getEnd().getOffset()).getTop()))))), Math.max(Offset.m2446getXimpl(mo3976localToRootMKHz9U), Offset.m2446getXimpl(mo3976localToRootMKHz9U2)), Math.max(Offset.m2447getYimpl(mo3976localToRootMKHz9U), Offset.m2447getYimpl(mo3976localToRootMKHz9U2)) + ((float) (SelectionHandlesKt.getHandleHeight() * 4.0d)));
        }
        return Rect.INSTANCE.getZero();
    }
    ...
    public final TextDragObserver handleDragObserver(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.SelectionManager$handleDragObserver$1
            ...
            public void mo849onDownk4lQ0M(long point) {
                ...
                long m942getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(anchorSelectable$foundation_release.mo923getHandlePositiondBAh8RU(selection, isStartHandle));
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m956setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(selectionManager.requireContainerCoordinates$foundation_release().mo3975localPositionOfR5De75A(layoutCoordinates, m942getAdjustedCoordinatesk4lQ0M)));
            ...
            public void mo851onStartk4lQ0M(long startPoint) {
                LayoutCoordinates layoutCoordinates;
                long mo923getHandlePositiondBAh8RU;
                SelectionManager.this.hideSelectionToolbar$foundation_release();
                Selection selection = SelectionManager.this.getSelection();
                ...
                if (isStartHandle) {
                    ...
                    mo923getHandlePositiondBAh8RU = selectable.mo923getHandlePositiondBAh8RU(selection, true);
                } else {
                    Intrinsics.checkNotNull(selectable2);
                    mo923getHandlePositiondBAh8RU = selectable2.mo923getHandlePositiondBAh8RU(selection, false);
                }
                long m942getAdjustedCoordinatesk4lQ0M = SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(mo923getHandlePositiondBAh8RU);
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m957setDragBeginPositionk4lQ0M(selectionManager.requireContainerCoordinates$foundation_release().mo3975localPositionOfR5De75A(layoutCoordinates, m942getAdjustedCoordinatesk4lQ0M));
                SelectionManager.this.m958setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2462getZeroF1C5BW0());
            }
            ...
            public void mo850onDragk4lQ0M(long delta) {
                SelectionManager selectionManager = SelectionManager.this;
                selectionManager.m958setDragTotalDistancek4lQ0M(Offset.m2451plusMKHz9U(selectionManager.m965getDragTotalDistanceF1C5BW0$foundation_release(), delta));
                long m2451plusMKHz9U = Offset.m2451plusMKHz9U(SelectionManager.this.m964getDragBeginPositionF1C5BW0$foundation_release(), SelectionManager.this.m965getDragTotalDistanceF1C5BW0$foundation_release());
                if (SelectionManager.this.m969updateSelectionRHHTvR4$foundation_release(Offset.m2435boximpl(m2451plusMKHz9U), Offset.m2435boximpl(SelectionManager.this.m964getDragBeginPositionF1C5BW0$foundation_release()), isStartHandle, SelectionAdjustment.INSTANCE.getCharacterWithWordAccelerate())) {
                    SelectionManager.this.m957setDragBeginPositionk4lQ0M(m2451plusMKHz9U);
                    SelectionManager.this.m958setDragTotalDistancek4lQ0M(Offset.INSTANCE.m2462getZeroF1C5BW0());
                }
            }
    ...
    public final Offset m955convertToContainerCoordinatesQ7Q5hAU(LayoutCoordinates layoutCoordinates, long offset) {
        LayoutCoordinates layoutCoordinates2 = this.containerLayoutCoordinates;
        if (layoutCoordinates2 == null || !layoutCoordinates2.isAttached()) {
            return null;
        }
        return Offset.m2435boximpl(requireContainerCoordinates$foundation_release().mo3975localPositionOfR5De75A(layoutCoordinates, offset));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: startSelection-9KIMszo, reason: not valid java name */
    public final void m961startSelection9KIMszo(long position, boolean isStartHandle, SelectionAdjustment adjustment) {
        m968updateSelection3R_tFg$foundation_release(position, position, null, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-RHHTvR4$foundation_release, reason: not valid java name */
    public final boolean m969updateSelectionRHHTvR4$foundation_release(Offset newPosition, Offset previousPosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Selection selection;
        long selectableId;
        Offset m955convertToContainerCoordinatesQ7Q5hAU;
        ...
        if (selectable == null) {
            m955convertToContainerCoordinatesQ7Q5hAU = null;
        } else {
            LayoutCoordinates layoutCoordinates = selectable.getLayoutCoordinates();
            Intrinsics.checkNotNull(layoutCoordinates);
            m955convertToContainerCoordinatesQ7Q5hAU = m955convertToContainerCoordinatesQ7Q5hAU(layoutCoordinates, SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(selectable.mo923getHandlePositiondBAh8RU(selection, !isStartHandle)));
        }
        if (m955convertToContainerCoordinatesQ7Q5hAU == null) {
            return false;
        }
        long packedValue = m955convertToContainerCoordinatesQ7Q5hAU.getPackedValue();
        long packedValue2 = isStartHandle ? newPosition.getPackedValue() : packedValue;
        if (!isStartHandle) {
            packedValue = newPosition.getPackedValue();
        }
        return m968updateSelection3R_tFg$foundation_release(packedValue2, packedValue, previousPosition, isStartHandle, adjustment);
    }

    /* renamed from: updateSelection-3R_-tFg$foundation_release, reason: not valid java name */
    public final boolean m968updateSelection3R_tFg$foundation_release(long startHandlePosition, long endHandlePosition, Offset previousHandlePosition, boolean isStartHandle, SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
        m956setCurrentDragPosition_kEHs6E(isStartHandle ? Offset.m2435boximpl(startHandlePosition) : Offset.m2435boximpl(endHandlePosition));
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        List<Selectable> sort = this.selectionRegistrar.sort(requireContainerCoordinates$foundation_release());
        int size = sort.size();
        Selection selection = null;
        ...
        while (i < size) {
            ...
            Pair<Selection, Boolean> mo925updateSelectionqCDeeow = selectable.mo925updateSelectionqCDeeow(startHandlePosition, endHandlePosition, previousHandlePosition, isStartHandle, requireContainerCoordinates$foundation_release(), adjustment, this.selectionRegistrar.getSubselections().get(Long.valueOf(selectable.getSelectableId())));
            Selection component1 = mo925updateSelectionqCDeeow.component1();
            z = z || mo925updateSelectionqCDeeow.component2().booleanValue();
            if (component1 != null) {
    ...
    public final void m962contextMenuOpenAdjustmentk4lQ0M(long position) {
        Selection selection = getSelection();
        if (selection == null || TextRange.m4526getCollapsedimpl(selection.m932toTextRanged9O1mEE())) {
            m961startSelection9KIMszo(position, true, SelectionAdjustment.INSTANCE.getWord());
        }
    }
}
