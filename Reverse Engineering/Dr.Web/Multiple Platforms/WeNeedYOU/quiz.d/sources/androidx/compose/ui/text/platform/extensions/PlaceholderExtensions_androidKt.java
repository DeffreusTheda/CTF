...
public final class PlaceholderExtensions_androidKt {
    ...
    private static /* synthetic */ void m4776getSpanUnitR2X_6o$annotations(long j) {
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg$annotations, reason: not valid java name */
    private static /* synthetic */ void m4778getSpanVerticalAligndo9XGg$annotations(int i) {
    }
    ...
    private static final void setPlaceholder(Spannable spannable, Placeholder placeholder, int i, int i2, Density density) {
        ...
        SpannableExtensions_androidKt.setSpan(spannable, new PlaceholderSpan(TextUnit.m5198getValueimpl(placeholder.getWidth()), m4775getSpanUnitR2X_6o(placeholder.getWidth()), TextUnit.m5198getValueimpl(placeholder.getHeight()), m4775getSpanUnitR2X_6o(placeholder.getHeight()), density.getFontScale() * density.getDensity(), m4777getSpanVerticalAligndo9XGg(placeholder.getPlaceholderVerticalAlign())), i, i2);
    }

    /* renamed from: getSpanUnit--R2X_6o, reason: not valid java name */
    private static final int m4775getSpanUnitR2X_6o(long j) {
        ...
        return TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5230getEmUIouoOA()) ? 1 : 2;
    }

    /* renamed from: getSpanVerticalAlign-do9X-Gg, reason: not valid java name */
    private static final int m4777getSpanVerticalAligndo9XGg(int i) {
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4463getAboveBaselineJ6kI3mc())) {
            return 0;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4469getTopJ6kI3mc())) {
            return 1;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4464getBottomJ6kI3mc())) {
            return 2;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4465getCenterJ6kI3mc())) {
            return 3;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4468getTextTopJ6kI3mc())) {
            return 4;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4466getTextBottomJ6kI3mc())) {
            return 5;
        }
        if (PlaceholderVerticalAlign.m4459equalsimpl0(i, PlaceholderVerticalAlign.INSTANCE.m4467getTextCenterJ6kI3mc())) {
            return 6;
        }
