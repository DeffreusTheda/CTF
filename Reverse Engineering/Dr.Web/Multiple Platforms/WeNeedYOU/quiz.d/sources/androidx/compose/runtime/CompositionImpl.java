...
public final class CompositionImpl implements ControlledComposition, RecomposeScopeOwner {
    ...
    public CompositionImpl(CompositionContext parent, Applier<?> applier, CoroutineContext coroutineContext) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2285getLambda1$runtime_release();
    }
    ...
    public void dispose() {
        synchronized (this.lock) {
            if (!this.disposed) {
                this.disposed = true;
                this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2286getLambda2$runtime_release();
    ...
    public void recordModificationsOf(Set<? extends Object> values) {
        ...
        do {
            ...
            set = values;
        } while (!ComplexDouble$$ExternalSyntheticBackport0.m(this.pendingModifications, obj, set));
        if (obj == null) {
            synchronized (this.lock) {
    ...
    private final void addPendingInvalidationsLocked(Set<? extends Object> values, boolean forgetConditionalScopes) {
        ...
        if (!forgetConditionalScopes || !(!this.conditionallyInvalidatedScopes.isEmpty())) {
            if (hashSet != null) {
                ...
                while (i5 < size4) {
                    ...
                    ((IdentityArraySet) identityArraySet2).size = i9;
                    if (identityArraySet2.size() > 0) {
                        if (i6 != i5) {
                            int i11 = valueOrder[i6];
                            valueOrder[i6] = i7;
                            valueOrder[i5] = i11;
                        }
                        i6++;
                ...
                for (int i12 = i6; i12 < size6; i12++) {
                    values5[valueOrder[i12]] = null;
                }
        ...
        int i14 = 0;
        while (i13 < size7) {
            int i15 = valueOrder2[i13];
            IdentityArraySet<RecomposeScopeImpl> identityArraySet3 = scopeSets2[i15];
        ...
        for (int i24 = i14; i24 < size9; i24++) {
            values7[valueOrder2[i24]] = null;
        }
        identityScopeMap4.setSize(i14);
