...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, final MarqueeSpacing spacing, float f) {
        ...
        this.animationMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m256boximpl(i2), null, 2, null);
    ...
    public final int m271getAnimationModeZbEOnfQ() {
    ...
    public final void m273setAnimationMode97h66l8(int i) {
        this.animationMode.setValue(MarqueeAnimationMode.m256boximpl(i));
    }
    ...
    public final void m274updatelWfNwf4(int iterations, int animationMode, int delayMillis, int initialDelayMillis, MarqueeSpacing spacing, float velocity) {
        Intrinsics.checkNotNullParameter(spacing, "spacing");
        setSpacing(spacing);
        m273setAnimationMode97h66l8(animationMode);
        if (this.iterations == iterations && this.delayMillis == delayMillis && this.initialDelayMillis == initialDelayMillis && Dp.m5022equalsimpl0(this.velocity, velocity)) {
            return;
        }
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.m4952copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        setContainerWidth(ConstraintsKt.m4975constrainWidthK40F9xA(j, mo3967measureBRTryo0.getWidth()));
        setContentWidth(mo3967measureBRTryo0.getWidth());
        return MeasureScope.CC.layout$default(measure, getContainerWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.MarqueeModifierNode$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float m2512getHeightimpl = Size.m2512getHeightimpl(contentDrawScope2.mo3184getSizeNHjbRc());
        ...
        drawContext.getTransform().mo3193clipRectN_I0leg(floatValue, 0.0f, floatValue + getContainerWidth(), m2512getHeightimpl, m2700getIntersectrtfAjoo);
        if (z2) {
