...
final class BlockGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped = DelegatableNodeKt.m4082requireCoordinator64DMado(this, NodeKind.m4184constructorimpl(2)).getWrapped();
        if (wrapped != null) {
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.graphics.BlockGraphicsLayerModifier$measure$1
