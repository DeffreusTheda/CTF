...
public final class LazyGridMeasuredItem implements LazyGridItemInfo {
    ...
    private LazyGridMeasuredItem(int i, Object key, boolean z, int i2, int i3, boolean z2, LayoutDirection layoutDirection, int i4, int i5, List<? extends Placeable> placeables, long j, Object obj) {
        ...
        this.size = IntSize;
        this.offset = IntOffset.INSTANCE.m5145getZeronOccac();
        this.row = -1;
        this.column = -1;
    }
    ...
    public final int getCrossAxisOffset() {
        return this.isVertical ? IntOffset.m5135getXimpl(getOffset()) : IntOffset.m5136getYimpl(getOffset());
    }
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                ...
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(offset) + IntOffset.m5135getXimpl(m665getPlacementDeltanOccac), IntOffset.m5136getYimpl(offset) + IntOffset.m5136getYimpl(m665getPlacementDeltanOccac));
                if ((m657getMainAxisgyyYBs(offset) <= mainAxisSize && m657getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m657getMainAxisgyyYBs(offset) >= i2 && m657getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                offset = IntOffset;
            }
            if (this.reverseLayout) {
                int m5135getXimpl = this.isVertical ? IntOffset.m5135getXimpl(offset) : (this.mainAxisLayoutSize - IntOffset.m5135getXimpl(offset)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m5136getYimpl = (this.mainAxisLayoutSize - IntOffset.m5136getYimpl(offset)) - getMainAxisSize(placeable);
                } else {
                    m5136getYimpl = IntOffset.m5136getYimpl(offset);
                }
                offset = IntOffsetKt.IntOffset(m5135getXimpl, m5136getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(offset) + IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(offset) + IntOffset.m5136getYimpl(j));
            if (this.isVertical) {
    ...
    private final int m657getMainAxisgyyYBs(long j) {
    ...
    private final long m656copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
