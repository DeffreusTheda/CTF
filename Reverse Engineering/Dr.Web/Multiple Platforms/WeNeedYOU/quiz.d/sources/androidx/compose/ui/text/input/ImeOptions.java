...
public final class ImeOptions {
    ...
    public /* synthetic */ ImeOptions(boolean z, int i, boolean z2, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this((i4 & 1) != 0 ? false : z, (i4 & 2) != 0 ? KeyboardCapitalization.INSTANCE.m4720getNoneIUNYP9k() : i, (i4 & 4) != 0 ? true : z2, (i4 & 8) != 0 ? KeyboardType.INSTANCE.m4746getTextPjHm6EE() : i2, (i4 & 16) != 0 ? ImeAction.INSTANCE.m4693getDefaulteUduSuo() : i3, null);
    }
    ...
    public static /* synthetic */ ImeOptions m4701copyuxg59PA$default(ImeOptions imeOptions, boolean z, int i, boolean z2, int i2, int i3, int i4, Object obj) {
        if ((i4 & 1) != 0) {
        ...
        return imeOptions.m4702copyuxg59PA(z, i5, z3, i6, i3);
    }

    /* renamed from: copy-uxg59PA, reason: not valid java name */
    public final ImeOptions m4702copyuxg59PA(boolean singleLine, int capitalization, boolean autoCorrect, int keyboardType, int imeAction) {
    ...
    public boolean equals(Object other) {
        ...
        return this.singleLine == imeOptions.singleLine && KeyboardCapitalization.m4711equalsimpl0(this.capitalization, imeOptions.capitalization) && this.autoCorrect == imeOptions.autoCorrect && KeyboardType.m4726equalsimpl0(this.keyboardType, imeOptions.keyboardType) && ImeAction.m4681equalsimpl0(this.imeAction, imeOptions.imeAction);
    }

    public int hashCode() {
        return (((((((UByte$$ExternalSyntheticBackport0.m(this.singleLine) * 31) + KeyboardCapitalization.m4712hashCodeimpl(this.capitalization)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.autoCorrect)) * 31) + KeyboardType.m4727hashCodeimpl(this.keyboardType)) * 31) + ImeAction.m4682hashCodeimpl(this.imeAction);
    }

    public String toString() {
        return "ImeOptions(singleLine=" + this.singleLine + ", capitalization=" + ((Object) KeyboardCapitalization.m4713toStringimpl(this.capitalization)) + ", autoCorrect=" + this.autoCorrect + ", keyboardType=" + ((Object) KeyboardType.m4728toStringimpl(this.keyboardType)) + ", imeAction=" + ((Object) ImeAction.m4683toStringimpl(this.imeAction)) + ')';
    }
}
