...
public final /* data */ class PointerInputEventData {
    ...
    public final PointerInputEventData m3860copygYeeOSc(long id, long uptime, long positionOnScreen, long position, boolean down, float pressure, int type, boolean issuesEnterExit, List<HistoricalChange> historical, long scrollDelta) {
    ...
    public boolean equals(Object other) {
        ...
        return PointerId.m3831equalsimpl0(this.id, pointerInputEventData.id) && this.uptime == pointerInputEventData.uptime && Offset.m2443equalsimpl0(this.positionOnScreen, pointerInputEventData.positionOnScreen) && Offset.m2443equalsimpl0(this.position, pointerInputEventData.position) && this.down == pointerInputEventData.down && Float.compare(this.pressure, pointerInputEventData.pressure) == 0 && PointerType.m3920equalsimpl0(this.type, pointerInputEventData.type) && this.issuesEnterExit == pointerInputEventData.issuesEnterExit && Intrinsics.areEqual(this.historical, pointerInputEventData.historical) && Offset.m2443equalsimpl0(this.scrollDelta, pointerInputEventData.scrollDelta);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public int hashCode() {
        int m3832hashCodeimpl = ((((((PointerId.m3832hashCodeimpl(this.id) * 31) + UByte$$ExternalSyntheticBackport0.m(this.uptime)) * 31) + Offset.m2448hashCodeimpl(this.positionOnScreen)) * 31) + Offset.m2448hashCodeimpl(this.position)) * 31;
        boolean z = this.down;
        int i = z;
        if (z != 0) {
            i = 1;
        }
        int floatToIntBits = (((((m3832hashCodeimpl + i) * 31) + Float.floatToIntBits(this.pressure)) * 31) + PointerType.m3921hashCodeimpl(this.type)) * 31;
        boolean z2 = this.issuesEnterExit;
        return ((((floatToIntBits + (z2 ? 1 : z2 ? 1 : 0)) * 31) + this.historical.hashCode()) * 31) + Offset.m2448hashCodeimpl(this.scrollDelta);
    }

    public String toString() {
        return "PointerInputEventData(id=" + ((Object) PointerId.m3833toStringimpl(this.id)) + ", uptime=" + this.uptime + ", positionOnScreen=" + ((Object) Offset.m2454toStringimpl(this.positionOnScreen)) + ", position=" + ((Object) Offset.m2454toStringimpl(this.position)) + ", down=" + this.down + ", pressure=" + this.pressure + ", type=" + ((Object) PointerType.m3922toStringimpl(this.type)) + ", issuesEnterExit=" + this.issuesEnterExit + ", historical=" + this.historical + ", scrollDelta=" + ((Object) Offset.m2454toStringimpl(this.scrollDelta)) + ')';
    }
    ...
    public final long m3861getIdJ3iCeTQ() {
        return this.id;
    }
    ...
    public final long m3863getPositionOnScreenF1C5BW0() {
        return this.positionOnScreen;
    }

    /* renamed from: getPosition-F1C5BW0, reason: not valid java name */
    public final long m3862getPositionF1C5BW0() {
        return this.position;
    }
    ...
    public final int m3865getTypeT8wyACA() {
        return this.type;
    }
    ...
    public /* synthetic */ PointerInputEventData(long j, long j2, long j3, long j4, boolean z, float f, int i, boolean z2, List list, long j5, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(j, j2, j3, j4, z, f, i, (i2 & 128) != 0 ? false : z2, (i2 & 256) != 0 ? new ArrayList() : list, (i2 & 512) != 0 ? Offset.INSTANCE.m2462getZeroF1C5BW0() : j5, null);
    }
    ...
    public final long m3864getScrollDeltaF1C5BW0() {
        return this.scrollDelta;
    }
}
