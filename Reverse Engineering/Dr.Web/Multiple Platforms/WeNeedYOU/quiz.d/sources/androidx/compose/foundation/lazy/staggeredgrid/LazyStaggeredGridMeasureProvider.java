...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m715childConstraintsJhjzzOo(int requestedSlot, int requestedSpan) {
        int i;
        ...
        if (this.isVertical) {
            return Constraints.INSTANCE.m4971fixedWidthOenEA2s(i);
        }
        return Constraints.INSTANCE.m4970fixedHeightOenEA2s(i);
    }

    /* renamed from: getAndMeasure-jy6DScQ, reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m716getAndMeasurejy6DScQ(int index, long span) {
        int i = (int) (span >> 32);
        int i2 = ((int) (span & 4294967295L)) - i;
        return createItem(index, i, i2, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo678measure0kLqBqw(index, m715childConstraintsJhjzzOo(i, i2)));
    }
