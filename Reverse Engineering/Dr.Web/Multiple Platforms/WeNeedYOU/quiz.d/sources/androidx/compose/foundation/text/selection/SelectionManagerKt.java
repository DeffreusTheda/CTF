...
public final class SelectionManagerKt {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j, Selection.AnchorInfo anchorInfo, boolean z) {
        ...
        if (anchorSelectable$foundation_release != null && (containerLayoutCoordinates = selectionManager.getContainerLayoutCoordinates()) != null && (layoutCoordinates = anchorSelectable$foundation_release.getLayoutCoordinates()) != null) {
            ...
            if (offset > anchorSelectable$foundation_release.getLastVisibleOffset()) {
                return Offset.INSTANCE.m2461getUnspecifiedF1C5BW0();
            }
            Offset m963getCurrentDragPosition_m7T9E = selectionManager.m963getCurrentDragPosition_m7T9E();
            Intrinsics.checkNotNull(m963getCurrentDragPosition_m7T9E);
            float m2446getXimpl = Offset.m2446getXimpl(layoutCoordinates.mo3975localPositionOfR5De75A(containerLayoutCoordinates, m963getCurrentDragPosition_m7T9E.getPackedValue()));
            long mo924getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo924getRangeOfLineContainingjx7JFs(offset);
            Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m4530getMinimpl(mo924getRangeOfLineContainingjx7JFs));
            Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(RangesKt.coerceAtLeast(TextRange.m4529getMaximpl(mo924getRangeOfLineContainingjx7JFs) - 1, TextRange.m4530getMinimpl(mo924getRangeOfLineContainingjx7JFs)));
            float coerceIn = RangesKt.coerceIn(m2446getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
            if (Math.abs(m2446getXimpl - coerceIn) > IntSize.m5177getWidthimpl(j) / 2) {
                return Offset.INSTANCE.m2461getUnspecifiedF1C5BW0();
            }
            return containerLayoutCoordinates.mo3975localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(coerceIn, Offset.m2447getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m2476getCenterF1C5BW0())));
        }
        return Offset.INSTANCE.m2461getUnspecifiedF1C5BW0();
    }

    /* renamed from: calculateSelectionMagnifierCenterAndroid-O0kMr_c, reason: not valid java name */
    public static final long m974calculateSelectionMagnifierCenterAndroidO0kMr_c(SelectionManager manager, long j) {
    ...
    public static final Rect visibleBounds(LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m2484Rect0a9Yr6o(layoutCoordinates.mo3979windowToLocalMKHz9U(boundsInWindow.m2481getTopLeftF1C5BW0()), layoutCoordinates.mo3979windowToLocalMKHz9U(boundsInWindow.m2475getBottomRightF1C5BW0()));
    }

    /* renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m975containsInclusiveUv8p0NA(Rect containsInclusive, long j) {
