...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    public SnapFlingBehavior(LazyListState lazyListState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> snapAnimationSpec, Density density) {
        ...
        this.velocityThreshold = density.mo360toPx0680j_4(this.MinFlingVelocityDp);
        ...
        this.MinFlingVelocityDp = Dp.m5017constructorimpl(400);
    }
    ...
    */
    ...
    private final int getSingleAxisViewportSize(LazyListLayoutInfo lazyListLayoutInfo) {
        return lazyListLayoutInfo.getOrientation() == Orientation.Vertical ? IntSize.m5176getHeightimpl(lazyListLayoutInfo.mo622getViewportSizeYbymL2g()) : IntSize.m5177getWidthimpl(lazyListLayoutInfo.mo622getViewportSizeYbymL2g());
    }
}
