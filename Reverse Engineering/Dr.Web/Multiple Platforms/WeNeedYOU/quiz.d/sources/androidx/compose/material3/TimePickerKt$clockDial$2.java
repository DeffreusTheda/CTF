...
final class TimePickerKt$clockDial$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5126boximpl(IntOffset.INSTANCE.m5145getZeronOccac()), null, 2, null);
        ...
        float mo360toPx0680j_4 = ((Density) consume).mo360toPx0680j_4(f);
        ...
        if (changed || rememberedValue5 == Composer.INSTANCE.getEmpty()) {
            rememberedValue5 = (Function1) new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.TimePickerKt$clockDial$2$1$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                    m1625invokeozmzZPI(intSize.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                public final void m1625invokeozmzZPI(long j) {
                    TimePickerState.this.m1641setCentergyyYBs$material3_release(IntSizeKt.m5183getCenterozmzZPI(j));
                }
            };
            composer.updateRememberedValue(rememberedValue5);
        }
        composer.endReplaceableGroup();
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SuspendingPointerInputFilterKt.pointerInput(OnRemeasuredModifierKt.onSizeChanged(companion, (Function1) rememberedValue5), new Object[]{this.$state, IntOffset.m5126boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo360toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass2(mutableState, mutableState2, coroutineScope, this.$state, mo360toPx0680j_4, this.$autoSwitchToMinute, null)), new Object[]{this.$state, IntOffset.m5126boximpl(invoke$lambda$7(mutableState3)), Float.valueOf(mo360toPx0680j_4)}, (Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object>) new AnonymousClass3(coroutineScope, this.$state, this.$autoSwitchToMinute, mo360toPx0680j_4, mutableState, mutableState2, null));
        if (ComposerKt.isTraceInProgress()) {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
        ...
        static final class AnonymousClass1 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
            ...
            public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                return m1626invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final Object m1626invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (this.label == 0) {
                    ...
                    long j = this.J$0;
                    TimePickerKt$clockDial$2.invoke$lambda$2(this.$offsetX$delegate, Offset.m2446getXimpl(j));
                    TimePickerKt$clockDial$2.invoke$lambda$5(this.$offsetY$delegate, Offset.m2447getYimpl(j));
                    return Unit.INSTANCE;
                }
                    ...
                    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                this.label = 1;
                                if (this.$state.onTap$material3_release(Offset.m2446getXimpl(this.$it), Offset.m2447getYimpl(this.$it), this.$maxDist, this.$autoSwitchToMinute, this) == coroutine_suspended) {
            ...
            if (i == 0) {
                ...
                Function0<Unit> function0 = new Function0<Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.3.1
                    ...
                    static final class C00411 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ResultKt.throwOnFailure(obj);
                                if (Selection.m1422equalsimpl0(this.$state.m1639getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1426getHourJiIwxys()) && this.$autoSwitchToMinute) {
                                    this.$state.m1642setSelectioniHAOin8$material3_release(Selection.INSTANCE.m1427getMinuteJiIwxys());
                                    this.label = 1;
                                    if (this.$state.animateToCurrent$material3_release(this) == coroutine_suspended) {
                                        return coroutine_suspended;
                                    }
                                } else if (Selection.m1422equalsimpl0(this.$state.m1639getSelectionJiIwxys$material3_release(), Selection.INSTANCE.m1427getMinuteJiIwxys())) {
                                    this.label = 2;
                ...
                if (DragGestureDetectorKt.detectDragGestures$default(pointerInputScope, null, function0, null, new Function2<PointerInputChange, Offset, Unit>() { // from class: androidx.compose.material3.TimePickerKt.clockDial.2.3.2
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(PointerInputChange pointerInputChange, Offset offset) {
                        m1628invokeUv8p0NA(pointerInputChange, offset.getPackedValue());
                        return Unit.INSTANCE;
                    }

                    /* renamed from: invoke-Uv8p0NA, reason: not valid java name */
                    public final void m1628invokeUv8p0NA(PointerInputChange pointerInputChange, long j) {
                    ...
                    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        public final Object invokeSuspend(Object obj) {
                            ...
                            if (i == 0) {
                                ...
                                TimePickerKt$clockDial$2.invoke$lambda$2(mutableState, TimePickerKt$clockDial$2.invoke$lambda$1(mutableState) + Offset.m2446getXimpl(this.$dragAmount));
                                MutableState<Float> mutableState2 = this.$offsetY$delegate;
                                TimePickerKt$clockDial$2.invoke$lambda$5(mutableState2, TimePickerKt$clockDial$2.invoke$lambda$4(mutableState2) + Offset.m2447getYimpl(this.$dragAmount));
                                TimePickerState timePickerState = this.$state;
                                atan = TimePickerKt.atan(TimePickerKt$clockDial$2.invoke$lambda$4(this.$offsetY$delegate) - IntOffset.m5136getYimpl(this.$state.m1638getCenternOccac$material3_release()), TimePickerKt$clockDial$2.invoke$lambda$1(this.$offsetX$delegate) - IntOffset.m5135getXimpl(this.$state.m1638getCenternOccac$material3_release()));
                                this.label = 1;
