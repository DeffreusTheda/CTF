...
public final class DelegatableNodeKt {
    ...
    public static /* synthetic */ void m4084visitAncestorsYYKmho$default(DelegatableNode visitAncestors, int i, boolean z, Function1 block, int i2, Object obj) {
        NodeChain nodes;
        if ((i2 & 2) != 0) {
            z = false;
        }
    ...
    public static final /* synthetic */ <T> void m4088visitSelfAndAncestors5BbP62I(DelegatableNode visitSelfAndAncestors, int i, int i2, Function1<? super T, Unit> block) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> void m4089visitSelfAndChildren6rFNWt0(DelegatableNode visitSelfAndChildren, int i, Function1<? super T, Unit> block) {
    ...
    public static final boolean m4080has64DMado(DelegatableNode has, int i) {
    ...
    public static final NodeCoordinator m4082requireCoordinator64DMado(DelegatableNode requireCoordinator, int i) {
        Intrinsics.checkNotNullParameter(requireCoordinator, "$this$requireCoordinator");
        NodeCoordinator coordinator = requireCoordinator.getNode().getCoordinator();
        Intrinsics.checkNotNull(coordinator);
        if (coordinator.getTail() != requireCoordinator || !NodeKindKt.m4193getIncludeSelfInTraversalH91voCI(i)) {
            return coordinator;
        }
    ...
    public static final /* synthetic */ <T> void m4079dispatchForKind6rFNWt0(Modifier.Node dispatchForKind, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4087visitLocalDescendants6rFNWt0(DelegatableNode visitLocalDescendants, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4086visitLocalAncestors6rFNWt0(DelegatableNode visitLocalAncestors, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4083visitAncestorsYYKmho(DelegatableNode visitAncestors, int i, boolean z, Function1<? super T, Unit> block) {
        NodeChain nodes;
        Intrinsics.checkNotNullParameter(visitAncestors, "$this$visitAncestors");
        Intrinsics.checkNotNullParameter(block, "block");
        if (!visitAncestors.getNode().getIsAttached()) {
    ...
    public static final /* synthetic */ <T> List<T> m4078ancestors64DMado(DelegatableNode ancestors, int i) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> T m4081nearestAncestor64DMado(DelegatableNode nearestAncestor, int i) {
        NodeChain nodes;
    ...
    public static final /* synthetic */ <T> void m4090visitSubtree6rFNWt0(DelegatableNode visitSubtree, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4085visitChildren6rFNWt0(DelegatableNode visitChildren, int i, Function1<? super T, Unit> block) {
    ...
    public static final /* synthetic */ <T> void m4091visitSubtreeIf6rFNWt0(DelegatableNode visitSubtreeIf, int i, Function1<? super T, Boolean> block) {
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node node) {
        ...
        if ((NodeKind.m4184constructorimpl(2) & node.getKindSet()) != 0) {
            ...
            if (node instanceof DelegatingNode) {
                ...
                while (delegate != 0) {
                    ...
                    if ((delegate instanceof DelegatingNode) && (NodeKind.m4184constructorimpl(2) & delegate.getKindSet()) != 0) {
