...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m3866processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z, int i, Object obj) {
        if ((i & 4) != 0) {
            z = true;
        }
        return pointerInputEventProcessor.m3867processBIzXfog(pointerInputEvent, positionCalculator, z);
    }

    /* renamed from: process-BIzXfog, reason: not valid java name */
    public final int m3867processBIzXfog(PointerInputEvent pointerEvent, PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z;
        ...
        try {
            ...
            for (PointerInputChange pointerInputChange2 : produce.getChanges().values()) {
                if (z || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2)) {
                    this.root.m4109hitTestM_7yMNQ$ui_release(pointerInputChange2.getPosition(), this.hitResult, (r12 & 4) != 0 ? false : PointerType.m3920equalsimpl0(pointerInputChange2.getType(), PointerType.INSTANCE.m3927getTouchT8wyACA()), (r12 & 8) != 0);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m3777addHitPathKNwqfcY(pointerInputChange2.getId(), this.hitResult);
