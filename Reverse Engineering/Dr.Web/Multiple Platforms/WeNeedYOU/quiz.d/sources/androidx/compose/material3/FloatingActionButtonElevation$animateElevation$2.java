    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Dp.m5022equalsimpl0(m5031unboximpl, f)) {
                focus = new PressInteraction.Press(Offset.INSTANCE.m2462getZeroF1C5BW0(), null);
            } else {
            ...
            this.label = 1;
            if (ElevationKt.m1236animateElevationrAjV9yQ(this.$animatable, this.$target, focus, this.$interaction, this) == coroutine_suspended) {
