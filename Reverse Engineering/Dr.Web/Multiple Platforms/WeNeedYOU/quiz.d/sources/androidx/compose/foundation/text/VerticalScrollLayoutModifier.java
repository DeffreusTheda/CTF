...
final /* data */ class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo70measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.m4952copyZbe2FdA$default(j, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        final int min = Math.min(mo3967measureBRTryo0.getHeight(), Constraints.m4960getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), min, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.VerticalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Vertical, TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, false, mo3967measureBRTryo0.getWidth()), min, mo3967measureBRTryo0.getHeight());
                Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo0, 0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
