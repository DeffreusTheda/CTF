    ...
    */
    public PopupLayout(kotlin.jvm.functions.Function0<kotlin.Unit> r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            r12 = 8
            float r12 = (float) r12
            float r12 = androidx.compose.ui.unit.Dp.m5017constructorimpl(r12)
            ...
            androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1 r0 = new kotlin.jvm.functions.Function2<androidx.compose.ui.geometry.Offset, androidx.compose.ui.unit.IntRect, java.lang.Boolean>() { // from class: androidx.compose.material3.internal.PopupLayout$dismissOnOutsideClick$1
                ...
                public final java.lang.Boolean invoke(androidx.compose.ui.geometry.Offset r4, androidx.compose.ui.unit.IntRect r5) {
                    ...
                    L9:
                        ...
                        float r1 = androidx.compose.ui.geometry.Offset.m2446getXimpl(r1)
                        int r2 = r5.getLeft()
                        float r2 = (float) r2
                        ...
                        if (r1 > 0) goto L4d
                        long r1 = r4.getPackedValue()
                        float r1 = androidx.compose.ui.geometry.Offset.m2447getYimpl(r1)
                        int r2 = r5.getTop()
                        float r2 = (float) r2
                        int r1 = (r1 > r2 ? 1 : (r1 == r2 ? 0 : -1))
                        if (r1 < 0) goto L4d
                        long r1 = r4.getPackedValue()
                        float r4 = androidx.compose.ui.geometry.Offset.m2447getYimpl(r1)
                        int r5 = r5.getBottom()
                        float r5 = (float) r5
            ...
            float r10 = r11.mo360toPx0680j_4(r12)
            r7.setElevation(r10)
            ...
            kotlin.jvm.functions.Function2 r10 = r10.m1724getLambda1$material3_release()
    ...
    public final IntSize m1726getPopupContentSizebOM6tXw() {
        return (IntSize) this.popupContentSize.getValue();
    }

    /* renamed from: setPopupContentSize-fhxjrPA, reason: not valid java name */
    public final void m1727setPopupContentSizefhxjrPA(IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize m1726getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (m1726getPopupContentSizebOM6tXw = m1726getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long packedValue = m1726getPopupContentSizebOM6tXw.getPackedValue();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long mo922calculatePositionllwVHH4 = this.positionProvider.mo922calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, packedValue);
        this.params.x = IntOffset.m5135getXimpl(mo922calculatePositionllwVHH4);
        this.params.y = IntOffset.m5136getYimpl(mo922calculatePositionllwVHH4);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x007f, code lost:
        ...
        if (r5.dismissOnOutsideClick.invoke((r6.getX() == 0.0f && r6.getY() == 0.0f) ? null : androidx.compose.ui.geometry.Offset.m2435boximpl(androidx.compose.ui.geometry.OffsetKt.Offset(r5.params.x + r6.getX(), r5.params.y + r6.getY())), r0).booleanValue() != false) goto L27;
     */
    @Override // android.view.View
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L59:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m2435boximpl(r3)
        L75:
