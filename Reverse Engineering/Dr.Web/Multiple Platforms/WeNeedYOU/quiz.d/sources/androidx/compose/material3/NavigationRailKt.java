...
public final class NavigationRailKt {
    ...
    private static final float NavigationRailHeaderPadding = Dp.m5017constructorimpl(8);
    private static final float NavigationRailItemWidth = NavigationRailTokens.INSTANCE.m2024getContainerWidthD9Ej5fM();
    private static final float NavigationRailItemHeight = NavigationRailTokens.INSTANCE.m2027getNoLabelActiveIndicatorHeightD9Ej5fM();
    ...
    */
    public static final void m1357NavigationRailqi6gXK8(androidx.compose.ui.Modifier r25, long r26, long r28, kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r30, androidx.compose.foundation.layout.WindowInsets r31, final kotlin.jvm.functions.Function3<? super androidx.compose.foundation.layout.ColumnScope, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        /*
            Method dump skipped, instructions count: 415
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.NavigationRailKt.m1357NavigationRailqi6gXK8(androidx.compose.ui.Modifier, long, long, kotlin.jvm.functions.Function3, androidx.compose.foundation.layout.WindowInsets, kotlin.jvm.functions.Function3, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final void NavigationRailItemBaselineLayout(final Function2<? super Composer, ? super Integer, Unit> function2, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final boolean z, final float f, Composer composer, final int i) {
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationRailKt$NavigationRailItemBaselineLayout$2
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    float f2;
                    Object obj;
                    Placeable placeable;
                    MeasureResult m1361placeLabelAndIconzUg2_y0;
                    MeasureResult m1360placeIconX9ElhV4;
                    Intrinsics.checkNotNullParameter(Layout, "$this$Layout");
                    Intrinsics.checkNotNullParameter(measurables, "measurables");
                    List<? extends Measurable> list = measurables;
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                            Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(j);
                            int width = mo3967measureBRTryo0.getWidth();
                            f2 = NavigationRailKt.IndicatorHorizontalPadding;
                            float f3 = 2;
                            int i3 = width + Layout.mo354roundToPx0680j_4(Dp.m5017constructorimpl(f2 * f3));
                            int roundToInt = MathKt.roundToInt(i3 * f);
                            int height = mo3967measureBRTryo0.getHeight() + Layout.mo354roundToPx0680j_4(Dp.m5017constructorimpl((function24 == null ? NavigationRailKt.IndicatorVerticalPaddingNoLabel : NavigationRailKt.IndicatorVerticalPaddingWithLabel) * f3));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                                    Placeable mo3967measureBRTryo02 = measurable2.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(i3, height));
                                    ...
                                    Placeable mo3967measureBRTryo03 = measurable3 != null ? measurable3.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(roundToInt, height)) : null;
                                    if (function24 != null) {
                                        for (Measurable measurable4 : list) {
                                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), "label")) {
                                                placeable = measurable4.mo3967measureBRTryo0(Constraints.m4952copyZbe2FdA$default(j, 0, 0, 0, 0, 11, null));
                                            }
                                        }
                                    ...
                                    placeable = null;
                                    if (function24 == null) {
                                        m1360placeIconX9ElhV4 = NavigationRailKt.m1360placeIconX9ElhV4(Layout, mo3967measureBRTryo0, mo3967measureBRTryo02, mo3967measureBRTryo03, j);
                                        return m1360placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(placeable);
                                    m1361placeLabelAndIconzUg2_y0 = NavigationRailKt.m1361placeLabelAndIconzUg2_y0(Layout, placeable, mo3967measureBRTryo0, mo3967measureBRTryo02, mo3967measureBRTryo03, j, z, f);
                                    return m1361placeLabelAndIconzUg2_y0;
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
    ...
    public static final MeasureResult m1360placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m4975constrainWidthK40F9xA = ConstraintsKt.m4975constrainWidthK40F9xA(j, Math.max(placeable.getWidth(), Math.max(placeable2.getWidth(), placeable3 != null ? placeable3.getWidth() : 0)));
        final int m4960getMaxHeightimpl = Constraints.m4960getMaxHeightimpl(j);
        final int width = (m4975constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int height = (m4960getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (m4975constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int height2 = (m4960getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.CC.layout$default(measureScope, m4975constrainWidthK40F9xA, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (m4975constrainWidthK40F9xA - placeable4.getWidth()) / 2, (m4960getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1361placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        int m4960getMaxHeightimpl = Constraints.m4960getMaxHeightimpl(j);
        int height = m4960getMaxHeightimpl - placeable.getHeight();
        float f2 = NavigationRailItemVerticalPadding;
        final int i = height - measureScope.mo354roundToPx0680j_4(f2);
        final int i2 = measureScope.mo354roundToPx0680j_4(f2);
        final int roundToInt = MathKt.roundToInt(((z ? i2 : (m4960getMaxHeightimpl - placeable2.getHeight()) / 2) - i2) * (1 - f));
        final int m4975constrainWidthK40F9xA = ConstraintsKt.m4975constrainWidthK40F9xA(j, Math.max(placeable2.getWidth(), Math.max(placeable.getWidth(), placeable4 != null ? placeable4.getWidth() : 0)));
        final int width = (m4975constrainWidthK40F9xA - placeable.getWidth()) / 2;
        final int width2 = (m4975constrainWidthK40F9xA - placeable2.getWidth()) / 2;
        final int width3 = (m4975constrainWidthK40F9xA - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo354roundToPx0680j_4(IndicatorVerticalPaddingWithLabel);
        return MeasureScope.CC.layout$default(measureScope, m4975constrainWidthK40F9xA, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationRailKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable5 != null) {
                    int i4 = m4975constrainWidthK40F9xA;
                    int i5 = i2;
                    MeasureScope measureScope2 = measureScope;
                    int i6 = roundToInt;
                    int width4 = (i4 - placeable5.getWidth()) / 2;
                    f3 = NavigationRailKt.IndicatorVerticalPaddingWithLabel;
                    Placeable.PlacementScope.placeRelative$default(layout, placeable5, width4, i6 + (i5 - measureScope2.mo354roundToPx0680j_4(f3)), 0.0f, 4, null);
                }
                if (z || f != 0.0f) {
    ...
    static {
        float f = 4;
        NavigationRailVerticalPadding = Dp.m5017constructorimpl(f);
        NavigationRailItemVerticalPadding = Dp.m5017constructorimpl(f);
        float f2 = 2;
        IndicatorHorizontalPadding = Dp.m5017constructorimpl(Dp.m5017constructorimpl(NavigationRailTokens.INSTANCE.m2022getActiveIndicatorWidthD9Ej5fM() - NavigationRailTokens.INSTANCE.m2025getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingWithLabel = Dp.m5017constructorimpl(Dp.m5017constructorimpl(NavigationRailTokens.INSTANCE.m2021getActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m2025getIconSizeD9Ej5fM()) / f2);
        IndicatorVerticalPaddingNoLabel = Dp.m5017constructorimpl(Dp.m5017constructorimpl(NavigationRailTokens.INSTANCE.m2027getNoLabelActiveIndicatorHeightD9Ej5fM() - NavigationRailTokens.INSTANCE.m2025getIconSizeD9Ej5fM()) / f2);
    }
}
