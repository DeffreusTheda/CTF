...
public final class SuggestionChipDefaults {
    ...
    private static final float Height = SuggestionChipTokens.INSTANCE.m2174getContainerHeightD9Ej5fM();
    private static final float IconSize = SuggestionChipTokens.INSTANCE.m2183getLeadingIconSizeD9Ej5fM();

    private SuggestionChipDefaults() {
    }

    /* renamed from: getHeight-D9Ej5fM, reason: not valid java name */
    public final float m1516getHeightD9Ej5fM() {
        return Height;
    }

    /* renamed from: getIconSize-D9Ej5fM, reason: not valid java name */
    public final float m1517getIconSizeD9Ej5fM() {
        return IconSize;
    }

    /* renamed from: suggestionChipColors-5tl4gsc, reason: not valid java name */
    public final ChipColors m1519suggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m2710copywmQWz5c$default = (i2 & 16) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2710copywmQWz5c$default2 = (i2 & 32) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        ...
        ChipColors chipColors = new ChipColors(m2746getTransparent0d7_KjU, color, color2, Color.INSTANCE.m2747getUnspecified0d7_KjU(), m2746getTransparent0d7_KjU2, m2710copywmQWz5c$default, m2710copywmQWz5c$default2, Color.INSTANCE.m2747getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final ChipElevation m1520suggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2181getFlatContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2181getFlatContainerElevationD9Ej5fM() : f;
        float f7 = (i2 & 2) != 0 ? m2181getFlatContainerElevationD9Ej5fM : f2;
        float f8 = (i2 & 4) != 0 ? m2181getFlatContainerElevationD9Ej5fM : f3;
        float f9 = (i2 & 8) != 0 ? m2181getFlatContainerElevationD9Ej5fM : f4;
        float m2175getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2175getDraggedContainerElevationD9Ej5fM() : f5;
        float f10 = (i2 & 32) != 0 ? m2181getFlatContainerElevationD9Ej5fM : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m2181getFlatContainerElevationD9Ej5fM, f7, f8, f9, m2175getDraggedContainerElevationD9Ej5fM, f10, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipBorder m1518suggestionChipBorderd_3_b6Q(long j, long j2, float f, Composer composer, int i, int i2) {
        ...
        long m2710copywmQWz5c$default = (i2 & 2) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getFlatDisabledOutlineColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j2;
        float m2182getFlatOutlineWidthD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2182getFlatOutlineWidthD9Ej5fM() : f;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipBorder chipBorder = new ChipBorder(color, m2710copywmQWz5c$default, m2182getFlatOutlineWidthD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipColors m1514elevatedSuggestionChipColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m1095getOnSurfaceVariant0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1095getOnSurfaceVariant0d7_KjU() : j3;
        long m2710copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getElevatedDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2710copywmQWz5c$default2 = (i2 & 16) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(SuggestionChipTokens.INSTANCE.getDisabledLabelTextColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j5;
        long m2710copywmQWz5c$default3 = (i2 & 32) != 0 ? Color.m2710copywmQWz5c$default(MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1094getOnSurface0d7_KjU(), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipColors chipColors = new ChipColors(color, color2, m1095getOnSurfaceVariant0d7_KjU, Color.INSTANCE.m2747getUnspecified0d7_KjU(), m2710copywmQWz5c$default, m2710copywmQWz5c$default2, m2710copywmQWz5c$default3, Color.INSTANCE.m2747getUnspecified0d7_KjU(), null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final ChipElevation m1515elevatedSuggestionChipElevationaqJV_2Y(float f, float f2, float f3, float f4, float f5, float f6, Composer composer, int i, int i2) {
        ...
        float m2176getElevatedContainerElevationD9Ej5fM = (i2 & 1) != 0 ? SuggestionChipTokens.INSTANCE.m2176getElevatedContainerElevationD9Ej5fM() : f;
        float m2180getElevatedPressedContainerElevationD9Ej5fM = (i2 & 2) != 0 ? SuggestionChipTokens.INSTANCE.m2180getElevatedPressedContainerElevationD9Ej5fM() : f2;
        float m2178getElevatedFocusContainerElevationD9Ej5fM = (i2 & 4) != 0 ? SuggestionChipTokens.INSTANCE.m2178getElevatedFocusContainerElevationD9Ej5fM() : f3;
        float m2179getElevatedHoverContainerElevationD9Ej5fM = (i2 & 8) != 0 ? SuggestionChipTokens.INSTANCE.m2179getElevatedHoverContainerElevationD9Ej5fM() : f4;
        float m2175getDraggedContainerElevationD9Ej5fM = (i2 & 16) != 0 ? SuggestionChipTokens.INSTANCE.m2175getDraggedContainerElevationD9Ej5fM() : f5;
        float m2177getElevatedDisabledContainerElevationD9Ej5fM = (i2 & 32) != 0 ? SuggestionChipTokens.INSTANCE.m2177getElevatedDisabledContainerElevationD9Ej5fM() : f6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        ChipElevation chipElevation = new ChipElevation(m2176getElevatedContainerElevationD9Ej5fM, m2180getElevatedPressedContainerElevationD9Ej5fM, m2178getElevatedFocusContainerElevationD9Ej5fM, m2179getElevatedHoverContainerElevationD9Ej5fM, m2175getDraggedContainerElevationD9Ej5fM, m2177getElevatedDisabledContainerElevationD9Ej5fM, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
