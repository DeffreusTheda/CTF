...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2398customFocusSearchOMvw8(FocusTargetNode customFocusSearch, int i, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2378getNextdhqQ8s())) {
        ...
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2374getEnterdhqQ8s())) {
                return fetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m2362boximpl(i));
            }
            if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2375getExitdhqQ8s())) {
                return fetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m2362boximpl(i));
            }
    ...
    public static final boolean m2399focusSearchsMXa3k8(FocusTargetNode focusSearch, int i, LayoutDirection layoutDirection, Function1<? super FocusTargetNode, Boolean> onFound) {
        int m2381getRightdhqQ8s;
        Boolean m2411twoDimensionalFocusSearchOMvw8;
        Intrinsics.checkNotNullParameter(focusSearch, "$this$focusSearch");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2378getNextdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2380getPreviousdhqQ8s())) {
            return OneDimensionalFocusSearchKt.m2402oneDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
        }
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2381getRightdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2382getUpdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2373getDowndhqQ8s())) {
            Boolean m2411twoDimensionalFocusSearchOMvw82 = TwoDimensionalFocusSearchKt.m2411twoDimensionalFocusSearchOMvw8(focusSearch, i, onFound);
            if (m2411twoDimensionalFocusSearchOMvw82 != null) {
                return m2411twoDimensionalFocusSearchOMvw82.booleanValue();
            }
        } else if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2374getEnterdhqQ8s())) {
            int i2 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i2 == 1) {
                m2381getRightdhqQ8s = FocusDirection.INSTANCE.m2381getRightdhqQ8s();
            } else {
                if (i2 != 2) {
                    throw new NoWhenBranchMatchedException();
                }
                m2381getRightdhqQ8s = FocusDirection.INSTANCE.m2377getLeftdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusSearch);
            if (findActiveFocusNode != null && (m2411twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m2411twoDimensionalFocusSearchOMvw8(findActiveFocusNode, m2381getRightdhqQ8s, onFound)) != null) {
                return m2411twoDimensionalFocusSearchOMvw8.booleanValue();
            }
        } else if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2375getExitdhqQ8s())) {
            ...
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2367toStringimpl(i))).toString());
        }
        return false;
    }
