...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f, float f2, Function1<? super InspectorInfo, Unit> inspectorInfo) {
        ...
        if ((f < 0.0f && !Dp.m5022equalsimpl0(f, Dp.INSTANCE.m5037getUnspecifiedD9Ej5fM())) || (f2 < 0.0f && !Dp.m5022equalsimpl0(f2, Dp.INSTANCE.m5037getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m410setBefore0680j_4(this.before);
        node.m409setAfter0680j_4(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return alignmentLineOffsetDpElement != null && Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m5022equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m5022equalsimpl0(this.after, alignmentLineOffsetDpElement.after);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m5023hashCodeimpl(this.before)) * 31) + Dp.m5023hashCodeimpl(this.after);
    }
}
