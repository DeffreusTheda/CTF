...
public final class AndroidTextPaint extends TextPaint {
    ...
    public final void setShadow(Shadow shadow) {
        ...
        if (Intrinsics.areEqual(shadow, Shadow.INSTANCE.getNone())) {
            ...
            setShadowLayer(TextPaintExtensions_androidKt.correctBlurRadius(this.shadow.getBlurRadius()), Offset.m2446getXimpl(this.shadow.getOffset()), Offset.m2447getYimpl(this.shadow.getOffset()), ColorKt.m2765toArgb8_81llA(this.shadow.getColor()));
        }
    }

    /* renamed from: setBrush-12SF9DM$default, reason: not valid java name */
    public static /* synthetic */ void m4769setBrush12SF9DM$default(AndroidTextPaint androidTextPaint, Brush brush, long j, float f, int i, Object obj) {
        if ((i & 4) != 0) {
            f = Float.NaN;
        }
        androidTextPaint.m4772setBrush12SF9DM(brush, j, f);
    }

    /* renamed from: setBrush-12SF9DM, reason: not valid java name */
    public final void m4772setBrush12SF9DM(Brush brush, long size, float alpha) {
        if (((brush instanceof SolidColor) && ((SolidColor) brush).getValue() != Color.INSTANCE.m2747getUnspecified0d7_KjU()) || ((brush instanceof ShaderBrush) && size != Size.INSTANCE.m2523getUnspecifiedNHjbRc())) {
            brush.mo2658applyToPq9zytI(size, this.composePaint, Float.isNaN(alpha) ? this.composePaint.getAlpha() : RangesKt.coerceIn(alpha, 0.0f, 1.0f));
        } else if (brush == null) {
    ...
    public final void setDrawStyle(DrawStyle drawStyle) {
        ...
        if (Intrinsics.areEqual(drawStyle, Fill.INSTANCE)) {
            this.composePaint.mo2571setStylek9PVt8s(PaintingStyle.INSTANCE.m2980getFillTiuSbCo());
            return;
        }
        if (drawStyle instanceof Stroke) {
            this.composePaint.mo2571setStylek9PVt8s(PaintingStyle.INSTANCE.m2981getStrokeTiuSbCo());
            Stroke stroke = (Stroke) drawStyle;
            this.composePaint.setStrokeWidth(stroke.getWidth());
            this.composePaint.setStrokeMiterLimit(stroke.getMiter());
            this.composePaint.mo2570setStrokeJoinWw9F2mQ(stroke.getJoin());
            this.composePaint.mo2569setStrokeCapBeK7IIE(stroke.getCap());
            this.composePaint.setPathEffect(stroke.getPathEffect());
        }
    }

    /* renamed from: getBlendMode-0nO6VwU, reason: not valid java name */
    public final int m4770getBlendMode0nO6VwU() {
        return this.composePaint.get_blendMode();
    }

    /* renamed from: setBlendMode-s9anfk8, reason: not valid java name */
    public final void m4771setBlendModes9anfk8(int i) {
        this.composePaint.mo2566setBlendModes9anfk8(i);
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m4773setColor8_81llA(long color) {
        if (color != Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
            this.composePaint.mo2567setColor8_81llA(color);
            this.composePaint.setShader(null);
        }
    }
}
