...
public final class TextMeasurer {
    ...
    public static /* synthetic */ TextLayoutResult m4508measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i, boolean z, int i2, List list, long j, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z2, int i3, Object obj) {
        return textMeasurer.m4510measurexDpz5zY(annotatedString, (i3 & 2) != 0 ? TextStyle.INSTANCE.getDefault() : textStyle, (i3 & 4) != 0 ? TextOverflow.INSTANCE.m4946getClipgIe3tQ8() : i, (i3 & 8) != 0 ? true : z, (i3 & 16) != 0 ? Integer.MAX_VALUE : i2, (i3 & 32) != 0 ? CollectionsKt.emptyList() : list, (i3 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j, (i3 & 128) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i3 & 256) != 0 ? textMeasurer.fallbackDensity : density, (i3 & 512) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i3 & 1024) != 0 ? false : z2);
    }

    /* renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m4510measurexDpz5zY(AnnotatedString text, TextStyle style, int overflow, boolean softWrap, int maxLines, List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m4503copyO0kMr_c(textLayoutInput, ConstraintsKt.m4972constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
    ...
    public final TextLayoutResult m4509measurewNUYSr0(String text, TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, LayoutDirection layoutDirection, Density density, FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m4508measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int m4963getMinWidthimpl = Constraints.m4963getMinWidthimpl(textLayoutInput.getConstraints());
            int m4961getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m4939equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m4947getEllipsisgIe3tQ8())) && Constraints.m4957getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m4961getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m4939equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m4947getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (m4963getMinWidthimpl != m4961getMaxWidthimpl) {
                m4961getMaxWidthimpl = RangesKt.coerceIn(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), m4963getMinWidthimpl, m4961getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, m4961getMaxWidthimpl, 0, Constraints.m4960getMaxHeightimpl(textLayoutInput.getConstraints()), 5, null), maxLines, TextOverflow.m4939equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m4947getEllipsisgIe3tQ8()), null), ConstraintsKt.m4972constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r2.getWidth()), (int) Math.ceil(r2.getHeight()))), null);
        }
    }
}
