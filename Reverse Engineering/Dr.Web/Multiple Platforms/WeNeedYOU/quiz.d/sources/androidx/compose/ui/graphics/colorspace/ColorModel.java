...
public final class ColorModel {
    ...
    public boolean equals(Object obj) {
        return m3119equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3122hashCodeimpl(this.packedValue);
    }
    ...
    static {
        long j = 3;
        long j2 = j << 32;
        Rgb = m3118constructorimpl((0 & 4294967295L) | j2);
        Xyz = m3118constructorimpl((1 & 4294967295L) | j2);
        Lab = m3118constructorimpl(j2 | (2 & 4294967295L));
        Cmyk = m3118constructorimpl((j & 4294967295L) | (4 << 32));
    }

    public String toString() {
        return m3123toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3123toStringimpl(long j) {
        return m3120equalsimpl0(j, Rgb) ? "Rgb" : m3120equalsimpl0(j, Xyz) ? "Xyz" : m3120equalsimpl0(j, Lab) ? "Lab" : m3120equalsimpl0(j, Cmyk) ? "Cmyk" : "Unknown";
    }
}
