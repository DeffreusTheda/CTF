...
public final class ClickableTextKt {
    ...
    */
    public static final void m793ClickableText4YKlhWE(final androidx.compose.ui.text.AnnotatedString r25, androidx.compose.ui.Modifier r26, androidx.compose.ui.text.TextStyle r27, boolean r28, int r29, int r30, kotlin.jvm.functions.Function1<? super androidx.compose.ui.text.TextLayoutResult, kotlin.Unit> r31, final kotlin.jvm.functions.Function1<? super java.lang.Integer, kotlin.Unit> r32, androidx.compose.runtime.Composer r33, final int r34, final int r35) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.ClickableTextKt.m793ClickableText4YKlhWE(androidx.compose.ui.text.AnnotatedString, androidx.compose.ui.Modifier, androidx.compose.ui.text.TextStyle, boolean, int, int, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    */
    ...
    public static final Integer ClickableText_03UYbkw$getOffset(MutableState<TextLayoutResult> mutableState, long j) {
        ...
        if (multiParagraph != null) {
            return Integer.valueOf(multiParagraph.m4420getOffsetForPositionk4lQ0M(j));
        }
        return null;
    }
    ...
    private static final boolean m794containsWithinBoundsUv8p0NA(MultiParagraph multiParagraph, long j) {
        float m2436component1impl = Offset.m2436component1impl(j);
        float m2437component2impl = Offset.m2437component2impl(j);
        return m2436component1impl > 0.0f && m2437component2impl >= 0.0f && m2436component1impl <= multiParagraph.getWidth() && m2437component2impl <= multiParagraph.getHeight();
    }
}
