...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo272measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m4963getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m4961getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m4962getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m4960getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int coerceIn = RangesKt.coerceIn(mo3967measureBRTryo0.getWidth(), Constraints.m4963getMinWidthimpl(j), Constraints.m4961getMaxWidthimpl(j));
        final int coerceIn2 = RangesKt.coerceIn(mo3967measureBRTryo0.getHeight(), Constraints.m4962getMinHeightimpl(j), Constraints.m4960getMaxHeightimpl(j));
        return MeasureScope.CC.layout$default(measure, coerceIn, coerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4026place70tqf50$default(layout, mo3967measureBRTryo0, WrapContentNode.this.getAlignmentCallback().invoke(IntSize.m5169boximpl(IntSizeKt.IntSize(coerceIn - mo3967measureBRTryo0.getWidth(), coerceIn2 - mo3967measureBRTryo0.getHeight())), measure.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
