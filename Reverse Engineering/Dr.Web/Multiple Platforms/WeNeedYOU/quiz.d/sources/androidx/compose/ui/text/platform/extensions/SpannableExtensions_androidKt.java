...
public final class SpannableExtensions_androidKt {
    ...
    public static final void setTextIndent(Spannable spannable, TextIndent textIndent, float f, Density density) {
        float m5198getValueimpl;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        Intrinsics.checkNotNullParameter(density, "density");
        if (textIndent != null) {
            if ((TextUnit.m5195equalsimpl0(textIndent.getFirstLine(), TextUnitKt.getSp(0)) && TextUnit.m5195equalsimpl0(textIndent.getRestLine(), TextUnitKt.getSp(0))) || TextUnitKt.m5216isUnspecifiedR2X_6o(textIndent.getFirstLine()) || TextUnitKt.m5216isUnspecifiedR2X_6o(textIndent.getRestLine())) {
                return;
            }
            long m5197getTypeUIouoOA = TextUnit.m5197getTypeUIouoOA(textIndent.getFirstLine());
            float f2 = 0.0f;
            if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5231getSpUIouoOA())) {
                m5198getValueimpl = density.mo359toPxR2X_6o(textIndent.getFirstLine());
            } else {
                m5198getValueimpl = TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5230getEmUIouoOA()) ? TextUnit.m5198getValueimpl(textIndent.getFirstLine()) * f : 0.0f;
            }
            long m5197getTypeUIouoOA2 = TextUnit.m5197getTypeUIouoOA(textIndent.getRestLine());
            if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA2, TextUnitType.INSTANCE.m5231getSpUIouoOA())) {
                f2 = density.mo359toPxR2X_6o(textIndent.getRestLine());
            } else if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA2, TextUnitType.INSTANCE.m5230getEmUIouoOA())) {
                f2 = TextUnit.m5198getValueimpl(textIndent.getRestLine()) * f;
            }
            setSpan(spannable, new LeadingMarginSpan.Standard((int) Math.ceil(m5198getValueimpl), (int) Math.ceil(f2)), 0, spannable.length());
        }
    }

    /* renamed from: setLineHeight-KmRG4DE, reason: not valid java name */
    public static final void m4785setLineHeightKmRG4DE(Spannable setLineHeight, long j, float f, Density density, LineHeightStyle lineHeightStyle) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(lineHeightStyle, "lineHeightStyle");
        float m4780resolveLineHeightInPxo2QH7mI = m4780resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4780resolveLineHeightInPxo2QH7mI)) {
            return;
        }
        Spannable spannable = setLineHeight;
        setSpan(setLineHeight, new LineHeightStyleSpan(m4780resolveLineHeightInPxo2QH7mI, 0, (spannable.length() == 0 || StringsKt.last(spannable) == '\n') ? setLineHeight.length() + 1 : setLineHeight.length(), LineHeightStyle.Trim.m4884isTrimFirstLineTopimpl$ui_text_release(lineHeightStyle.getTrim()), LineHeightStyle.Trim.m4885isTrimLastLineBottomimpl$ui_text_release(lineHeightStyle.getTrim()), lineHeightStyle.getAlignment()), 0, setLineHeight.length());
    }

    /* renamed from: setLineHeight-r9BaKPg, reason: not valid java name */
    public static final void m4786setLineHeightr9BaKPg(Spannable setLineHeight, long j, float f, Density density) {
        Intrinsics.checkNotNullParameter(setLineHeight, "$this$setLineHeight");
        Intrinsics.checkNotNullParameter(density, "density");
        float m4780resolveLineHeightInPxo2QH7mI = m4780resolveLineHeightInPxo2QH7mI(j, f, density);
        if (Float.isNaN(m4780resolveLineHeightInPxo2QH7mI)) {
        ...
        setSpan(setLineHeight, new LineHeightSpan(m4780resolveLineHeightInPxo2QH7mI), 0, setLineHeight.length());
    }

    /* renamed from: resolveLineHeightInPx-o2QH7mI, reason: not valid java name */
    private static final float m4780resolveLineHeightInPxo2QH7mI(long j, float f, Density density) {
        long m5197getTypeUIouoOA = TextUnit.m5197getTypeUIouoOA(j);
        if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5231getSpUIouoOA())) {
            return density.mo359toPxR2X_6o(j);
        }
        if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5230getEmUIouoOA())) {
            return TextUnit.m5198getValueimpl(j) * f;
        }
        return Float.NaN;
    }
    ...
    public static final void setSpanStyles(Spannable spannable, TextStyle contextTextStyle, List<AnnotatedString.Range<SpanStyle>> spanStyles, Density density, Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> resolveTypeface) {
        MetricAffectingSpan m4779createLetterSpacingSpaneAf_CNQ;
        Intrinsics.checkNotNullParameter(spannable, "<this>");
        ...
        if (z) {
            ...
            for (int i2 = 0; i2 < size2; i2++) {
                ...
                if (start2 >= 0 && start2 < spannable.length() && end2 > start2 && end2 <= spannable.length() && (m4779createLetterSpacingSpaneAf_CNQ = m4779createLetterSpacingSpaneAf_CNQ(item.getLetterSpacing(), density)) != null) {
                    setSpan(spannable, m4779createLetterSpacingSpaneAf_CNQ, start2, end2);
                }
            }
        }
    }
    ...
    private static final void setSpanStyle(Spannable spannable, AnnotatedString.Range<SpanStyle> range, Density density) {
        ...
        m4782setBaselineShift0ocSgnM(spannable, item.getBaselineShift(), start, end);
        m4783setColorRPmYEkk(spannable, item.m4491getColor0d7_KjU(), start, end);
        setBrush(spannable, item.getBrush(), item.getAlpha(), start, end);
        setTextDecoration(spannable, item.getTextDecoration(), start, end);
        m4784setFontSizeKmRG4DE(spannable, item.getFontSize(), density, start, end);
        ...
        m4781setBackgroundRPmYEkk(spannable, item.getBackground(), start, end);
    ...
    private static final MetricAffectingSpan m4779createLetterSpacingSpaneAf_CNQ(long j, Density density) {
        long m5197getTypeUIouoOA = TextUnit.m5197getTypeUIouoOA(j);
        if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5231getSpUIouoOA())) {
            return new LetterSpacingSpanPx(density.mo359toPxR2X_6o(j));
        }
        if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5230getEmUIouoOA())) {
            return new LetterSpacingSpanEm(TextUnit.m5198getValueimpl(j));
        }
        return null;
    }

    private static final boolean getNeedsLetterSpacingSpan(SpanStyle spanStyle) {
        return TextUnitType.m5226equalsimpl0(TextUnit.m5197getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m5231getSpUIouoOA()) || TextUnitType.m5226equalsimpl0(TextUnit.m5197getTypeUIouoOA(spanStyle.getLetterSpacing()), TextUnitType.INSTANCE.m5230getEmUIouoOA());
    }

    private static final void setShadow(Spannable spannable, Shadow shadow, int i, int i2) {
        if (shadow != null) {
            setSpan(spannable, new ShadowSpan(ColorKt.m2765toArgb8_81llA(shadow.getColor()), Offset.m2446getXimpl(shadow.getOffset()), Offset.m2447getYimpl(shadow.getOffset()), TextPaintExtensions_androidKt.correctBlurRadius(shadow.getBlurRadius())), i, i2);
        }
    }
    ...
    public static final void m4784setFontSizeKmRG4DE(Spannable setFontSize, long j, Density density, int i, int i2) {
        Intrinsics.checkNotNullParameter(setFontSize, "$this$setFontSize");
        Intrinsics.checkNotNullParameter(density, "density");
        long m5197getTypeUIouoOA = TextUnit.m5197getTypeUIouoOA(j);
        if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5231getSpUIouoOA())) {
            setSpan(setFontSize, new AbsoluteSizeSpan(MathKt.roundToInt(density.mo359toPxR2X_6o(j)), false), i, i2);
        } else if (TextUnitType.m5226equalsimpl0(m5197getTypeUIouoOA, TextUnitType.INSTANCE.m5230getEmUIouoOA())) {
            setSpan(setFontSize, new RelativeSizeSpan(TextUnit.m5198getValueimpl(j)), i, i2);
        }
    }
    ...
    private static final void m4782setBaselineShift0ocSgnM(Spannable spannable, BaselineShift baselineShift, int i, int i2) {
        if (baselineShift != null) {
            setSpan(spannable, new BaselineShiftSpan(baselineShift.m4798unboximpl()), i, i2);
        }
    }
    ...
    private static final void setBrush(Spannable spannable, Brush brush, float f, int i, int i2) {
        if (brush != null) {
            if (brush instanceof SolidColor) {
                m4783setColorRPmYEkk(spannable, ((SolidColor) brush).getValue(), i, i2);
    ...
    private static final boolean hasFontAttributes(TextStyle textStyle) {
        return TextPaintExtensions_androidKt.hasFontAttributes(textStyle.toSpanStyle()) || textStyle.m4556getFontSynthesisZQGJjVo() != null;
    }
    ...
    private static final void setFontAttributes(final Spannable spannable, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, final Function4<? super FontFamily, ? super FontWeight, ? super FontStyle, ? super FontSynthesis, ? extends Typeface> function4) {
        ...
        flattenFontStylesAndApply(hasFontAttributes(textStyle) ? new SpanStyle(0L, 0L, textStyle.getFontWeight(), textStyle.m4555getFontStyle4Lr2A7w(), textStyle.m4556getFontSynthesisZQGJjVo(), textStyle.getFontFamily(), (String) null, 0L, (BaselineShift) null, (TextGeometricTransform) null, (LocaleList) null, 0L, (TextDecoration) null, (Shadow) null, (PlatformSpanStyle) null, (DrawStyle) null, 65475, (DefaultConstructorMarker) null) : null, arrayList2, new Function3<SpanStyle, Integer, Integer, Unit>() { // from class: androidx.compose.ui.text.platform.extensions.SpannableExtensions_androidKt$setFontAttributes$1
            ...
            public final void invoke(SpanStyle spanStyle, int i2, int i3) {
                ...
                spannable2.setSpan(new TypefaceSpan(function42.invoke(fontFamily, fontWeight, m4627boximpl, FontSynthesis.m4636boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4645getAllGVVA2EU()))), i2, i3, 33);
            }
        });
    }

    /* renamed from: setBackground-RPmYEkk, reason: not valid java name */
    public static final void m4781setBackgroundRPmYEkk(Spannable setBackground, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setBackground, "$this$setBackground");
        if (j != Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
            setSpan(setBackground, new BackgroundColorSpan(ColorKt.m2765toArgb8_81llA(j)), i, i2);
        }
    }

    /* renamed from: setColor-RPmYEkk, reason: not valid java name */
    public static final void m4783setColorRPmYEkk(Spannable setColor, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(setColor, "$this$setColor");
        if (j != Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
            setSpan(setColor, new ForegroundColorSpan(ColorKt.m2765toArgb8_81llA(j)), i, i2);
        }
    }
}
