    ...
    */
    ...
    public static final void m1044StandardBottomSheet8oydGBM(final SheetState sheetState, final float f, final boolean z, final float f2, final Shape shape, final long j, final long j2, final float f3, final float f4, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            final float mo360toPx0680j_4 = ((Density) consume).mo360toPx0680j_4(f);
            ...
            Modifier m558requiredHeightInVpY3zN4$default = SizeKt.m558requiredHeightInVpY3zN4$default(SizeKt.fillMaxWidth$default(SizeKt.m574widthInVpY3zN4$default(Modifier.INSTANCE, 0.0f, SheetDefaultsKt.getBottomSheetMaxWidth(), 1, null), 0.0f, 1, null), f, 0.0f, 2, null);
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier swipeableV2$default = SwipeableV2Kt.swipeableV2$default(NestedScrollModifierKt.nestedScroll$default(m558requiredHeightInVpY3zN4$default, (NestedScrollConnection) rememberedValue3, null, 2, null), sheetState.getSwipeableState$material3_release(), orientation, z, false, null, 24, null);
            ...
            Float valueOf2 = Float.valueOf(mo360toPx0680j_4);
            ...
            if (changed3 || rememberedValue4 == Composer.INSTANCE.getEmpty()) {
                rememberedValue4 = (Function2) new Function2<SheetValue, IntSize, Float>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$2$1
                    ...
                    public /* bridge */ /* synthetic */ Float invoke(SheetValue sheetValue, IntSize intSize) {
                        return m1048invokeO0kMr_c(sheetValue, intSize.getPackedValue());
                    }

                    /* renamed from: invoke-O0kMr_c, reason: not valid java name */
                    public final Float m1048invokeO0kMr_c(SheetValue value, long j3) {
                        ...
                        if (i7 == 1) {
                            ...
                            return Float.valueOf(f2 - mo360toPx0680j_4);
                        }
                        if (i7 == 2) {
                            if (IntSize.m5176getHeightimpl(j3) == MathKt.roundToInt(mo360toPx0680j_4)) {
                                return null;
                            }
                            return Float.valueOf(Math.max(0.0f, f2 - IntSize.m5176getHeightimpl(j3)));
                        }
                        if (i7 != 3) {
            ...
            SurfaceKt.m1521SurfaceT9BRK9s(SwipeableV2Kt.swipeAnchors(swipeableV2$default, swipeableState$material3_release2, of, anchorChangeHandler, (Function2) rememberedValue4), shape, j, j2, f3, f4, null, ComposableLambdaKt.composableLambda(startRestartGroup, -1381492089, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$3
                ...
                public final void invoke(Composer composer2, int i8) {
                    ...
                    if ((i8 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function22 != null) {
                            final String m1512getStringNWtq28 = Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1453getBottomSheetPartialExpandDescriptionadMyvUU(), composer2, 6);
                            final String m1512getStringNWtq282 = Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1449getBottomSheetDismissDescriptionadMyvUU(), composer2, 6);
                            final String m1512getStringNWtq283 = Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1451getBottomSheetExpandDescriptionadMyvUU(), composer2, 6);
                            ...
                            Modifier semantics = SemanticsModifierKt.semantics(columnScopeInstance2.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenterHorizontally()), true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$3$1$1
                                ...
                                public final void invoke2(SemanticsPropertyReceiver semantics2) {
                                    ...
                                    boolean z3 = z2;
                                    String str = m1512getStringNWtq283;
                                    String str2 = m1512getStringNWtq28;
                                    String str3 = m1512getStringNWtq282;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$StandardBottomSheet$4
            ...
            public final void invoke(Composer composer2, int i8) {
                BottomSheetScaffoldKt.m1044StandardBottomSheet8oydGBM(SheetState.this, f, z, f2, shape, j, j2, f3, f4, function2, function3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }
    ...
    public static final void m1043BottomSheetScaffoldLayoutPxNyym8(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function3<? super Integer, ? super Composer, ? super Integer, Unit> function32, final Function2<? super Composer, ? super Integer, Unit> function22, final float f, final Function0<Float> function0, final SheetState sheetState, final long j, final long j2, Composer composer, final int i) {
        ...
        if ((i3 & 1533916891) != 306783378 || !startRestartGroup.getSkipping()) {
            ...
            final int i4 = i3;
            Object[] objArr = {function32, function0, function2, modifier, Color.m2701boximpl(j), Color.m2701boximpl(j2), function3, Dp.m5015boximpl(f), function22, sheetState};
            ...
            if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1047invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m1047invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long j3) {
                        Placeable placeable;
                        int height;
                        Intrinsics.checkNotNullParameter(SubcomposeLayout, "$this$SubcomposeLayout");
                        int m4961getMaxWidthimpl = Constraints.m4961getMaxWidthimpl(j3);
                        final int m4960getMaxHeightimpl = Constraints.m4960getMaxHeightimpl(j3);
                        long m4952copyZbe2FdA$default = Constraints.m4952copyZbe2FdA$default(j3, 0, 0, 0, 0, 10, null);
                        ...
                        final int i6 = i4;
                        final Placeable mo3967measureBRTryo0 = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot, ComposableLambdaKt.composableLambdaInstance(-1192048628, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$sheetPlaceable$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                            ...
                            public final void invoke(Composer composer3, int i7) {
                                ...
                                function33.invoke(Integer.valueOf(m4960getMaxHeightimpl), composer3, Integer.valueOf((i6 >> 6) & 112));
                                if (ComposerKt.isTraceInProgress()) {
                                    ComposerKt.traceEventEnd();
                                }
                            }
                        })).get(0).mo3967measureBRTryo0(m4952copyZbe2FdA$default);
                        final int roundToInt = MathKt.roundToInt(function0.invoke().floatValue());
                        final int max = Math.max(0, (m4961getMaxWidthimpl - mo3967measureBRTryo0.getWidth()) / 2);
                        ...
                        long m4952copyZbe2FdA$default2 = Constraints.m4952copyZbe2FdA$default(m4952copyZbe2FdA$default, 0, 0, 0, m4960getMaxHeightimpl - height2, 7, null);
                        ...
                        final float f2 = f;
                        final Placeable mo3967measureBRTryo02 = SubcomposeLayout.subcompose(bottomSheetScaffoldLayoutSlot2, ComposableLambdaKt.composableLambdaInstance(-1459220575, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(2);
                                ...
                                if ((i10 & 11) != 2 || !composer3.getSkipping()) {
                                    ...
                                    ComposableLambda composableLambda = ComposableLambdaKt.composableLambda(composer3, 1725620860, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1$bodyPlaceable$1.1
                                        ...
                                        public final void invoke(Composer composer4, int i12) {
                                            ...
                                            function35.invoke(PaddingKt.m517PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, f3, 7, null), composer4, Integer.valueOf((i11 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                            }
                                        }
                                    ...
                                    int i12 = i9;
                                    SurfaceKt.m1521SurfaceT9BRK9s(modifier3, null, j6, j7, 0.0f, 0.0f, null, composableLambda, composer3, (i12 & 14) | 12582912 | ((i12 >> 18) & 896) | ((i12 >> 18) & 7168), 114);
                                    if (ComposerKt.isTraceInProgress()) {
                                        ComposerKt.traceEventEnd();
                                        return;
                                    }
                        ...
                        })).get(0).mo3967measureBRTryo0(m4952copyZbe2FdA$default2);
                        final Placeable mo3967measureBRTryo03 = SubcomposeLayout.subcompose(BottomSheetScaffoldLayoutSlot.Snackbar, function22).get(0).mo3967measureBRTryo0(m4952copyZbe2FdA$default);
                        final int width = (m4961getMaxWidthimpl - mo3967measureBRTryo03.getWidth()) / 2;
                        ...
                        if (i10 == 1) {
                            ...
                            height = m4960getMaxHeightimpl - mo3967measureBRTryo03.getHeight();
                        }
                        final int i11 = height;
                        return MeasureScope.CC.layout$default(SubcomposeLayout, m4961getMaxWidthimpl, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo0, max, roundToInt, 0.0f, 4, null);
                                Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo03, width, i11, 0.0f, 4, null);
                            }
                        }, 4, null);
                    }
                };
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.BottomSheetScaffoldKt$BottomSheetScaffoldLayout$2
            ...
            public final void invoke(Composer composer3, int i6) {
                BottomSheetScaffoldKt.m1043BottomSheetScaffoldLayoutPxNyym8(Modifier.this, function2, function3, function32, function22, f, function0, sheetState, j, j2, composer3, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
