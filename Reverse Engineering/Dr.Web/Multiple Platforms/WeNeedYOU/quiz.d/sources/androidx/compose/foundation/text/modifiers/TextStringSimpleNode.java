...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m4946getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, (i4 & 128) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m916updateLayoutRelatedArgsHuAbxIM(TextStyle style, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged) {
        ...
        if (textChanged || layoutChanged) {
            getLayoutCache().m903updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean m901layoutWithConstraintsK40F9xA = layoutCache.m901layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (m901layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(IntSize.m5177getWidthimpl(layoutSize), IntSize.m5176getHeightimpl(layoutSize)));
        int m5177getWidthimpl = IntSize.m5177getWidthimpl(layoutSize);
        int m5176getHeightimpl = IntSize.m5176getHeightimpl(layoutSize);
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5177getWidthimpl, m5176getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextStringSimpleNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (didOverflow) {
            Rect m2486Recttz77jQw = RectKt.m2486Recttz77jQw(Offset.INSTANCE.m2462getZeroF1C5BW0(), SizeKt.Size(IntSize.m5177getWidthimpl(getLayoutCache().getLayoutSize()), IntSize.m5176getHeightimpl(getLayoutCache().getLayoutSize())));
            canvas.save();
        ...
        try {
            ...
            if (brush != null) {
                Paragraph.CC.m4427painthn5TExg$default(paragraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ...
                Paragraph.CC.m4425paintLG529CI$default(paragraph, canvas, m2788invoke0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
        } finally {
            if (didOverflow) {
                canvas.restore();
