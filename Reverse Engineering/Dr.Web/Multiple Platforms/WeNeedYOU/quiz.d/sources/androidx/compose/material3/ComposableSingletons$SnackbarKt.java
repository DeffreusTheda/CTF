...
public final class ComposableSingletons$SnackbarKt {
    ...
    public static Function2<Composer, Integer, Unit> f31lambda1 = ComposableLambdaKt.composableLambdaInstance(-505750804, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$SnackbarKt$lambda-1$1
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if ((i & 11) != 2 || !composer.getSkipping()) {
                ...
                IconKt.m1283Iconww6aTOc(CloseKt.getClose(Icons.Filled.INSTANCE), Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1496getSnackbarDismissadMyvUU(), composer, 6), (Modifier) null, 0L, composer, 0, 12);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function2<Composer, Integer, Unit> m1173getLambda1$material3_release() {
        return f31lambda1;
    }
}
