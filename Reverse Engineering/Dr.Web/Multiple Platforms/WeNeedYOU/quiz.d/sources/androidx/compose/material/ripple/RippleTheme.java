...
public interface RippleTheme {
    ...
    long mo1005defaultColorWaAFU9c(Composer composer, int i);
    ...
    public static final class Companion {
        ...
        public final long m1015defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m2763luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m2748getWhite0d7_KjU();
        }

        /* renamed from: defaultRippleAlpha-DxMtmZc, reason: not valid java name */
        public final RippleAlpha m1014defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            ...
            if (ColorKt.m2763luminance8_81llA(contentColor) > 0.5d) {
