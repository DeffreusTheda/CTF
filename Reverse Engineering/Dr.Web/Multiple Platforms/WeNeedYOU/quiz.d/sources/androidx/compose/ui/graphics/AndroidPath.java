...
public final class AndroidPath implements Path {
    ...
    public int mo2579getFillTypeRgk1Os() {
        if (this.internalPath.getFillType() == Path.FillType.EVEN_ODD) {
            return PathFillType.INSTANCE.m2996getEvenOddRgk1Os();
        }
        return PathFillType.INSTANCE.m2997getNonZeroRgk1Os();
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: setFillType-oQ8Xj4U, reason: not valid java name */
    public void mo2581setFillTypeoQ8Xj4U(int i) {
        Path.FillType fillType;
        android.graphics.Path path = this.internalPath;
        if (PathFillType.m2992equalsimpl0(i, PathFillType.INSTANCE.m2996getEvenOddRgk1Os())) {
    ...
    public void addRoundRect(RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m2421getXimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m2422getYimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m2421getXimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m2422getYimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m2421getXimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m2422getYimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m2421getXimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m2422getYimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs());
        this.internalPath.addRoundRect(this.rectF, this.radii, Path.Direction.CCW);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: addPath-Uv8p0NA, reason: not valid java name */
    public void mo2578addPathUv8p0NA(Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (path instanceof AndroidPath) {
            path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m2446getXimpl(offset), Offset.m2447getYimpl(offset));
            return;
        }
    ...
    public void mo2583translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m2446getXimpl(offset), Offset.m2447getYimpl(offset));
        this.internalPath.transform(this.mMatrix);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* renamed from: transform-58bKbWc, reason: not valid java name */
    public void mo2582transform58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        AndroidMatrixConversions_androidKt.m2558setFromEL8BTi8(this.mMatrix, matrix);
        this.internalPath.transform(this.mMatrix);
    }
    ...
    public boolean mo2580opN5in7k0(Path path1, Path path2, int operation) {
        Path.Op op;
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        if (PathOperation.m3001equalsimpl0(operation, PathOperation.INSTANCE.m3005getDifferenceb3I0S0c())) {
            op = Path.Op.DIFFERENCE;
        } else if (PathOperation.m3001equalsimpl0(operation, PathOperation.INSTANCE.m3006getIntersectb3I0S0c())) {
            op = Path.Op.INTERSECT;
        } else if (PathOperation.m3001equalsimpl0(operation, PathOperation.INSTANCE.m3007getReverseDifferenceb3I0S0c())) {
            op = Path.Op.REVERSE_DIFFERENCE;
        } else {
            op = PathOperation.m3001equalsimpl0(operation, PathOperation.INSTANCE.m3008getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
        }
        android.graphics.Path path = this.internalPath;
