    ...
    */
    public static final kotlin.Pair<androidx.compose.foundation.text.selection.Selection, java.lang.Boolean> m929getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult r15, long r16, long r18, androidx.compose.ui.geometry.Offset r20, long r21, androidx.compose.foundation.text.selection.SelectionAdjustment r23, androidx.compose.foundation.text.selection.Selection r24, boolean r25) {
        /*
            ...
            long r2 = r15.getSize()
            int r2 = androidx.compose.ui.unit.IntSize.m5177getWidthimpl(r2)
            float r2 = (float) r2
            long r3 = r15.getSize()
            int r3 = androidx.compose.ui.unit.IntSize.m5176getHeightimpl(r3)
            float r3 = (float) r3
            r4 = 0
            r0.<init>(r4, r4, r2, r3)
            ...
            r11 = r16
            r13 = r18
            boolean r2 = r9.m981isSelected2x9bVx0$foundation_release(r10, r11, r13)
            r9 = 0
            r3 = 0
            if (r2 != 0) goto L41
        ...
        L41:
            r4 = r16
            int r10 = m928getOffsetForPosition0AR0LA0(r15, r0, r4)
            r4 = r18
            int r11 = m928getOffsetForPosition0AR0LA0(r15, r0, r4)
            if (r20 == 0) goto L59
            long r4 = r20.getPackedValue()
            int r0 = m928getOffsetForPosition0AR0LA0(r15, r0, r4)
            r12 = r0
            goto L5b
        L59:
            r0 = -1
        ...
        L5b:
            ...
            if (r8 == 0) goto L6b
            long r2 = r24.m932toTextRanged9O1mEE()
            androidx.compose.ui.text.TextRange r0 = androidx.compose.ui.text.TextRange.m4520boximpl(r2)
            r6 = r0
            goto L6c
        L6b:
            r6 = r3
        L6c:
            ...
            r4 = r12
            r5 = r25
            long r0 = r0.mo933adjustZXO7KMw(r1, r2, r4, r5, r6)
            boolean r2 = androidx.compose.ui.text.TextRange.m4531getReversedimpl(r0)
            r3 = r21
            r5 = r15
            androidx.compose.foundation.text.selection.Selection r0 = m927getAssembledSelectionInfovJH6DeI(r0, r2, r3, r5)
        ...
        L93:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.selection.MultiWidgetSelectionDelegateKt.m929getTextSelectionInfoyM0VcXU(androidx.compose.ui.text.TextLayoutResult, long, long, androidx.compose.ui.geometry.Offset, long, androidx.compose.foundation.text.selection.SelectionAdjustment, androidx.compose.foundation.text.selection.Selection, boolean):kotlin.Pair");
    }

    /* renamed from: getOffsetForPosition-0AR0LA0, reason: not valid java name */
    public static final int m928getOffsetForPosition0AR0LA0(TextLayoutResult textLayoutResult, Rect bounds, long j) {
        Intrinsics.checkNotNullParameter(textLayoutResult, "textLayoutResult");
        Intrinsics.checkNotNullParameter(bounds, "bounds");
        int length = textLayoutResult.getLayoutInput().getText().length();
        if (bounds.m2472containsk4lQ0M(j)) {
            return RangesKt.coerceIn(textLayoutResult.m4504getOffsetForPositionk4lQ0M(j), 0, length);
        }
        if (SelectionMode.Vertical.mo980compare3MmeM6k$foundation_release(j, bounds) < 0) {
            return 0;
        }
        return length;
    }
    ...
    public static final Selection m927getAssembledSelectionInfovJH6DeI(long j, boolean z, long j2, TextLayoutResult textLayoutResult) {
        return new Selection(new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(TextRange.m4532getStartimpl(j)), TextRange.m4532getStartimpl(j), j2), new Selection.AnchorInfo(textLayoutResult.getBidiRunDirection(Math.max(TextRange.m4527getEndimpl(j) - 1, 0)), TextRange.m4527getEndimpl(j), j2), z);
    }
}
