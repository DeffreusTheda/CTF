...
public abstract class AlignmentLines {
    ...
    protected abstract long mo4067calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            Offset = mo4067calculatePositionInParentR5De75A(initialCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            roundToInt = MathKt.roundToInt(Offset.m2447getYimpl(Offset));
        } else {
            roundToInt = MathKt.roundToInt(Offset.m2446getXimpl(Offset));
        }
