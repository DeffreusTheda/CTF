    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                emptyList.add(Offset.m2435boximpl(OffsetKt.Offset(Math.abs(Offset.m2446getXimpl(semanticsNode4.getBoundsInRoot().m2476getCenterF1C5BW0()) - Offset.m2446getXimpl(semanticsNode3.getBoundsInRoot().m2476getCenterF1C5BW0())), Math.abs(Offset.m2447getYimpl(semanticsNode4.getBoundsInRoot().m2476getCenterF1C5BW0()) - Offset.m2447getYimpl(semanticsNode3.getBoundsInRoot().m2476getCenterF1C5BW0())))));
        ...
        if (emptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    first = Offset.m2435boximpl(Offset.m2451plusMKHz9U(((Offset) first).getPackedValue(), ((Offset) emptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m2437component2impl(packedValue) < Offset.m2436component1impl(packedValue);
    }
