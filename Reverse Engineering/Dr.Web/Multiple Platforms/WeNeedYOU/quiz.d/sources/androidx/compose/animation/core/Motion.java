...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m129boximpl(long j) {
        return new Motion(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m130constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m133equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m139unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m133equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m137hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m138toStringimpl(this.packedValue);
    }
    ...
    public static final long m131copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default, reason: not valid java name */
    public static /* synthetic */ long m132copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m135getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m136getVelocityimpl(j);
        }
        return m131copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl, reason: not valid java name */
    public static final float m135getValueimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl, reason: not valid java name */
    public static final float m136getVelocityimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
