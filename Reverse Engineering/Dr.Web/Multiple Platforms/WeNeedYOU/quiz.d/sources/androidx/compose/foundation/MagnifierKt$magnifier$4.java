...
final class MagnifierKt$magnifier$4 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i) {
        ...
        if (rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2435boximpl(Offset.INSTANCE.m2461getUnspecifiedF1C5BW0()), null, 2, null);
        ...
        if (rememberedValue2 == Composer.INSTANCE.getEmpty()) {
            rememberedValue2 = SnapshotStateKt.derivedStateOf(new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$sourceCenterInRoot$2$1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2435boximpl(m252invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m252invokeF1C5BW0() {
                    ...
                    if (OffsetKt.m2465isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState)) && OffsetKt.m2465isSpecifiedk4lQ0M(packedValue)) {
                        return Offset.m2451plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState), packedValue);
                    }
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$isMagnifierShown$2$1
                ...
                public final Boolean invoke() {
                    return Boolean.valueOf(OffsetKt.m2465isSpecifiedk4lQ0M(MagnifierKt$magnifier$4.invoke$lambda$8(state)));
                }
            });
            ...
            rememberedValue6 = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1
                ...
                public final void invoke2(SemanticsPropertyReceiver semantics) {
                    ...
                    semantics.set(magnifierPositionInRoot, new Function0<Offset>() { // from class: androidx.compose.foundation.MagnifierKt$magnifier$4$4$1.1
                        ...
                        @Override // kotlin.jvm.functions.Function0
                        public /* bridge */ /* synthetic */ Offset invoke() {
                            return Offset.m2435boximpl(m251invokeF1C5BW0());
                        }

                        /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                        public final long m251invokeF1C5BW0() {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                long mo276getSizeYbymL2g = create.mo276getSizeYbymL2g();
                ...
                if (invoke$lambda$6 != null) {
                    invoke$lambda$6.invoke(DpSize.m5103boximpl(density.mo358toDpSizekrfVVM(IntSizeKt.m5187toSizeozmzZPI(mo276getSizeYbymL2g))));
                }
                longRef.element = mo276getSizeYbymL2g;
                ...
                try {
                    ...
                    if (FlowKt.collect(SnapshotStateKt.snapshotFlow(new Function0<Unit>() { // from class: androidx.compose.foundation.MagnifierKt.magnifier.4.1.2
                        ...
                        public final void invoke2() {
                            long m2461getUnspecifiedF1C5BW0;
                            if (MagnifierKt$magnifier$4.invoke$lambda$10(state)) {
                                ...
                                if (OffsetKt.m2465isSpecifiedk4lQ0M(packedValue)) {
                                    m2461getUnspecifiedF1C5BW0 = Offset.m2451plusMKHz9U(MagnifierKt$magnifier$4.invoke$lambda$1(mutableState2), packedValue);
                                } else {
                                    m2461getUnspecifiedF1C5BW0 = Offset.INSTANCE.m2461getUnspecifiedF1C5BW0();
                                }
                                platformMagnifier2.mo277updateWko1d7g(invoke$lambda$8, m2461getUnspecifiedF1C5BW0, MagnifierKt$magnifier$4.invoke$lambda$5(state4));
                                long mo276getSizeYbymL2g2 = PlatformMagnifier.this.mo276getSizeYbymL2g();
                                Ref.LongRef longRef2 = longRef;
                                Density density3 = density2;
                                State<Function1<DpSize, Unit>> state6 = state5;
                                if (IntSize.m5175equalsimpl0(mo276getSizeYbymL2g2, longRef2.element)) {
                                    return;
                                }
                                longRef2.element = mo276getSizeYbymL2g2;
                                Function1 invoke$lambda$62 = MagnifierKt$magnifier$4.invoke$lambda$6(state6);
                                if (invoke$lambda$62 != null) {
                                    invoke$lambda$62.invoke(DpSize.m5103boximpl(density3.mo358toDpSizekrfVVM(IntSizeKt.m5187toSizeozmzZPI(mo276getSizeYbymL2g2))));
                                    return;
                                }
                                return;
                            }
