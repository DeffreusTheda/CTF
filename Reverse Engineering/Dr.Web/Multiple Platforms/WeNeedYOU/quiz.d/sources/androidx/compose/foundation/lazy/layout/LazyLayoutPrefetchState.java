...
public final class LazyLayoutPrefetchState {
    ...
    public interface Prefetcher {
        ...
        PrefetchHandle mo688schedulePrefetch0kLqBqw(int index, long constraints);
    }
    ...
    /* renamed from: schedulePrefetch-0kLqBqw, reason: not valid java name */
    public final PrefetchHandle m687schedulePrefetch0kLqBqw(int index, long constraints) {
        PrefetchHandle mo688schedulePrefetch0kLqBqw;
        Prefetcher prefetcher = this.prefetcher;
        return (prefetcher == null || (mo688schedulePrefetch0kLqBqw = prefetcher.mo688schedulePrefetch0kLqBqw(index, constraints)) == null) ? DummyHandle.INSTANCE : mo688schedulePrefetch0kLqBqw;
    }
}
