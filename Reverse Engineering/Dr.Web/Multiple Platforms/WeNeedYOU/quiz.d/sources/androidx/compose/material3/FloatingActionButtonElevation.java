...
public class FloatingActionButtonElevation {
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5015boximpl(f2), new FloatingActionButtonElevation$animateElevation$2(animatable, this, f2, interaction, null), composer, 64);
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5022equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5022equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5022equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m5022equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation);
    }

    public int hashCode() {
        return (((((Dp.m5023hashCodeimpl(this.defaultElevation) * 31) + Dp.m5023hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5023hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5023hashCodeimpl(this.hoveredElevation);
    }
}
