    ...
    public static final void InlineChildren(final AnnotatedString text, final List<AnnotatedString.Range<Function3<String, Composer, Integer, Unit>>> inlineContents, Composer composer, final int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            AnnotatedStringResolveInlineContentKt$InlineChildren$1$2 annotatedStringResolveInlineContentKt$InlineChildren$1$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> children, long j) {
                    Intrinsics.checkNotNullParameter(Layout, "$this$Layout");
                    Intrinsics.checkNotNullParameter(children, "children");
                    ArrayList arrayList = new ArrayList(children.size());
                    int size2 = children.size();
                    for (int i3 = 0; i3 < size2; i3++) {
                        arrayList.add(children.get(i3).mo3967measureBRTryo0(j));
                    }
                    final ArrayList arrayList2 = arrayList;
                    return MeasureScope.CC.layout$default(Layout, Constraints.m4961getMaxWidthimpl(j), Constraints.m4960getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.AnnotatedStringResolveInlineContentKt$InlineChildren$1$2$measure$1
            ...
            Updater.m2325setimpl(m2318constructorimpl, annotatedStringResolveInlineContentKt$InlineChildren$1$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
