...
public final class IconButtonDefaults {
    ...
    public final IconButtonColors m1277iconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
        ...
        if ((i2 & 2) != 0) {
            ...
            j5 = ((Color) consume).m2721unboximpl();
        } else {
            j5 = j2;
        }
        long m2746getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2746getTransparent0d7_KjU() : j3;
        long m2710copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2710copywmQWz5c$default(j5, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(m2746getTransparent0d7_KjU, j5, m2746getTransparent0d7_KjU2, m2710copywmQWz5c$default, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1278iconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        if ((i2 & 2) != 0) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            j7 = ((Color) consume).m2721unboximpl();
        } else {
            j7 = j2;
        }
        long m2746getTransparent0d7_KjU2 = (i2 & 4) != 0 ? Color.INSTANCE.m2746getTransparent0d7_KjU() : j3;
        long m2710copywmQWz5c$default = (i2 & 8) != 0 ? Color.m2710copywmQWz5c$default(j7, 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        long m2746getTransparent0d7_KjU3 = (i2 & 16) != 0 ? Color.INSTANCE.m2746getTransparent0d7_KjU() : j5;
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2746getTransparent0d7_KjU, j7, m2746getTransparent0d7_KjU2, m2710copywmQWz5c$default, m2746getTransparent0d7_KjU3, color, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1273filledIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m2710copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2710copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(FilledIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconButtonColors iconButtonColors = new IconButtonColors(color, m1141contentColorForek8zF_U, m2710copywmQWz5c$default, m2710copywmQWz5c$default2, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconToggleButtonColors m1274filledIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        long m1141contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(color3, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, color2, m2710copywmQWz5c$default, m2710copywmQWz5c$default2, color3, m1141contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1275filledTonalIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        ...
        long m1141contentColorForek8zF_U = (i2 & 2) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(color, composer, i & 14) : j2;
        long m2710copywmQWz5c$default = (i2 & 4) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledContainerColor(), composer, 6), 0.12f, 0.0f, 0.0f, 0.0f, 14, null) : j3;
        long m2710copywmQWz5c$default2 = (i2 & 8) != 0 ? Color.m2710copywmQWz5c$default(ColorSchemeKt.toColor(FilledTonalIconButtonTokens.INSTANCE.getDisabledColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null) : j4;
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final IconToggleButtonColors m1276filledTonalIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(color, m1141contentColorForek8zF_U, m2710copywmQWz5c$default, m2710copywmQWz5c$default2, color2, color3, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final IconButtonColors m1279outlinedIconButtonColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        long j5;
    ...
    public final IconToggleButtonColors m1280outlinedIconToggleButtonColors5tl4gsc(long j, long j2, long j3, long j4, long j5, long j6, Composer composer, int i, int i2) {
        long j7;
        ...
        long m1141contentColorForek8zF_U = (i2 & 32) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(color, composer, (i >> 12) & 14) : j6;
        if (ComposerKt.isTraceInProgress()) {
        ...
        IconToggleButtonColors iconToggleButtonColors = new IconToggleButtonColors(m2746getTransparent0d7_KjU, j7, m2746getTransparent0d7_KjU2, m2710copywmQWz5c$default, color, m1141contentColorForek8zF_U, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final BorderStroke outlinedIconButtonBorder(boolean z, Composer composer, int i) {
        ...
        if (z) {
            ...
            Object consume = composer.consume(localContentColor);
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2710copywmQWz5c$default = ((Color) consume).m2721unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            ComposerKt.sourceInformationMarkerEnd(composer);
            m2710copywmQWz5c$default = Color.m2710copywmQWz5c$default(((Color) consume2).m2721unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
            composer.endReplaceableGroup();
        }
        Color m2701boximpl = Color.m2701boximpl(m2710copywmQWz5c$default);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2701boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BorderStrokeKt.m220BorderStrokecXLIe8U(OutlinedIconButtonTokens.INSTANCE.m2051getUnselectedOutlineWidthD9Ej5fM(), m2710copywmQWz5c$default);
