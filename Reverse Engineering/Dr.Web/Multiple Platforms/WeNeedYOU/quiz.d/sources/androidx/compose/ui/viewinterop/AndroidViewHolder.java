...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback {
    ...
    public AndroidViewHolder(Context context, CompositionContext compositionContext, int i, NestedScrollDispatcher dispatcher, View view) {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo44measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
                int obtainMeasureSpec;
                int obtainMeasureSpec2;
                Intrinsics.checkNotNullParameter(measure, "$this$measure");
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.CC.layout$default(measure, Constraints.m4963getMinWidthimpl(j), Constraints.m4962getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5$measure$1
                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                ...
                if (Constraints.m4963getMinWidthimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m4963getMinWidthimpl(j));
                }
                if (Constraints.m4962getMinHeightimpl(j) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m4962getMinHeightimpl(j));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                ...
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m4963getMinWidthimpl, m4961getMaxWidthimpl, layoutParams.width);
                ...
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m4962getMinHeightimpl, m4960getMaxHeightimpl, layoutParams2.height);
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type, int[] consumed) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long m3733dispatchPostScrollDzOQY0M = nestedScrollDispatcher.m3733dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2446getXimpl(m3733dispatchPostScrollDzOQY0M));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2447getYimpl(m3733dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset2 = OffsetKt.Offset(composeOffset3, composeOffset4);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            nestedScrollDispatcher.m3733dispatchPostScrollDzOQY0M(Offset, Offset2, nestedScrollSource);
        }
    }
    ...
    public void onNestedPreScroll(View target, int dx, int dy, int[] consumed, int type) {
        ...
        if (isNestedScrollingEnabled()) {
            ...
            long Offset = OffsetKt.Offset(composeOffset, composeOffset2);
            nestedScrollSource = AndroidViewHolder_androidKt.toNestedScrollSource(type);
            long m3735dispatchPreScrollOzD1aCk = nestedScrollDispatcher.m3735dispatchPreScrollOzD1aCk(Offset, nestedScrollSource);
            consumed[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2446getXimpl(m3735dispatchPreScrollOzD1aCk));
            consumed[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2447getYimpl(m3735dispatchPreScrollOzD1aCk));
        }
    }
