...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m5017constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m1864getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m5017constructorimpl((float) 80.0d);
    ...
    public final float m2010getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2011getActiveIndicatorWidthD9Ej5fM() {
