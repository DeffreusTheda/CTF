...
final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m243updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        int m4371hashCodeimpl = (((hashCode2 + (role != null ? Role.m4371hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode()) * 31;
        String str2 = this.onLongClickLabel;
        int hashCode3 = (m4371hashCodeimpl + (str2 != null ? str2.hashCode() : 0)) * 31;
