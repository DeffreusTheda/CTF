...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public void update(OffsetNode node) {
        ...
        node.m484setX0680j_4(this.x);
        node.m485setY0680j_4(this.y);
    ...
    public boolean equals(Object other) {
        ...
        return offsetElement != null && Dp.m5022equalsimpl0(this.x, offsetElement.x) && Dp.m5022equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5023hashCodeimpl(this.x) * 31) + Dp.m5023hashCodeimpl(this.y)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + ((Object) Dp.m5028toStringimpl(this.x)) + ", y=" + ((Object) Dp.m5028toStringimpl(this.y)) + ", rtlAware=" + this.rtlAware + ')';
    }
