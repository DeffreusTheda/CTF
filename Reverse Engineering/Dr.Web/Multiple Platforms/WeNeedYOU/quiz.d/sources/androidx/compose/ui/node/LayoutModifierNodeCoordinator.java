...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo3967measureBRTryo0(long constraints) {
            ...
            lookaheadDelegateForLayoutModifierNode.m4025setMeasurementConstraintsBRTryo0(constraints);
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m4949boximpl(constraints);
            LookaheadDelegate lookaheadDelegate = layoutModifierNodeCoordinator.getWrappedNonNull().getLookaheadDelegate();
            Intrinsics.checkNotNull(lookaheadDelegate);
            lookaheadDelegateForLayoutModifierNode.set_measureResult(layoutModifierNodeCoordinator.getLayoutModifierNode().mo272measure3p2s80s(this, lookaheadDelegate, constraints));
    ...
    /* renamed from: measure-BRTryo0 */
    public Placeable mo3967measureBRTryo0(long constraints) {
        MeasureResult mo272measure3p2s80s;
        ...
        if (layoutModifierNode instanceof IntermediateLayoutModifierNode) {
            ...
            mo272measure3p2s80s = ((IntermediateLayoutModifierNode) layoutModifierNode).m3969intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, IntSize, constraints2.getValue());
        } else {
            mo272measure3p2s80s = layoutModifierNode.mo272measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(mo272measure3p2s80s);
    ...
    protected void mo3968placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        ...
        int m5177getWidthimpl = IntSize.m5177getWidthimpl(getMeasuredSize());
        ...
        Placeable.PlacementScope.parentWidth = m5177getWidthimpl;
    ...
    static {
        ...
        Paint.mo2567setColor8_81llA(Color.INSTANCE.m2738getBlue0d7_KjU());
