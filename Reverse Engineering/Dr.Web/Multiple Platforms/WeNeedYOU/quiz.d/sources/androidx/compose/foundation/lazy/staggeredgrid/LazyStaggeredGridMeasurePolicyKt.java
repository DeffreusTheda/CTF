...
public final class LazyStaggeredGridMeasurePolicyKt {
    ...
    public static final Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m713rememberStaggeredGridMeasurePolicynbWgWpA(final LazyStaggeredGridState state, final Function0<? extends LazyStaggeredGridItemProvider> itemProviderLambda, final PaddingValues contentPadding, final boolean z, final Orientation orientation, final float f, float f2, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Composer composer, int i) {
        ...
        Object[] objArr = {state, itemProviderLambda, contentPadding, Boolean.valueOf(z), orientation, Dp.m5015boximpl(f), Dp.m5015boximpl(f2), slots};
        ...
        if (z2 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridMeasurePolicyKt$rememberStaggeredGridMeasurePolicy$1$1
                ...
                public final LazyStaggeredGridMeasureResult m714invoke0kLqBqw(LazyLayoutMeasureScope lazyLayoutMeasureScope, long j) {
                    float beforePadding;
                    float afterPadding;
                    float startPadding;
                    long IntOffset;
                    Intrinsics.checkNotNullParameter(lazyLayoutMeasureScope, "$this$null");
                    CheckScrollableContainerConstraintsKt.m221checkScrollableContainerConstraintsK40F9xA(j, Orientation.this);
                    LazyStaggeredGridSlots invoke = slots.invoke(lazyLayoutMeasureScope, Constraints.m4949boximpl(j));
                    ...
                    int i3 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(beforePadding);
                    ...
                    int i4 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(afterPadding);
                    ...
                    int i5 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(startPadding);
                    int m4960getMaxHeightimpl = ((z3 ? Constraints.m4960getMaxHeightimpl(j) : Constraints.m4961getMaxWidthimpl(j)) - i3) - i4;
                    if (z3) {
                    ...
                    int i6 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(Dp.m5017constructorimpl(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()) + PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection())));
                    PaddingValues paddingValues2 = contentPadding;
                    boolean z4 = z3;
                    LazyStaggeredGridMeasureResult m712measureStaggeredGriddSVRQoE = LazyStaggeredGridMeasureKt.m712measureStaggeredGriddSVRQoE(lazyLayoutMeasureScope, state, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke2, state.getPinnedItems(), state.getBeyondBoundsInfo()), invoke2, invoke, Constraints.m4952copyZbe2FdA$default(j, ConstraintsKt.m4975constrainWidthK40F9xA(j, i6), 0, ConstraintsKt.m4974constrainHeightK40F9xA(j, lazyLayoutMeasureScope.mo354roundToPx0680j_4(Dp.m5017constructorimpl(paddingValues2.getTop() + paddingValues2.getBottom()))), 0, 10, null), z4, z, j2, m4960getMaxHeightimpl, lazyLayoutMeasureScope.mo354roundToPx0680j_4(f), i3, i4);
                    state.applyMeasureResult$foundation_release(m712measureStaggeredGriddSVRQoE);
                    return m712measureStaggeredGriddSVRQoE;
                }
            };
