...
public final class DecodeHelper {
        ...
        while (this.parcel.dataAvail() > 1) {
            ...
            if (decodeByte != 1) {
                ...
                if (decodeByte == 2) {
                    ...
                    mutableSpanStyle.m4315setFontSizeR2X_6o(m4287decodeTextUnitXSAIIZE());
                    ...
                    mutableSpanStyle.m4316setFontStylemLjRB2g(FontStyle.m4627boximpl(m4285decodeFontStyle_LCdwA()));
                    mutableSpanStyle2 = mutableSpanStyle;
                            ...
                            if (decodeByte != 8) {
                                if (decodeByte != 9) {
                                    if (decodeByte != 10) {
                                        ...
                                        mutableSpanStyle.m4312setBackground8_81llA(m4284decodeColor0d7_KjU());
                                    }
                                } else {
                                    if (dataAvailable() < 8) {
                                        break;
                                ...
                                mutableSpanStyle.m4313setBaselineShift_isdbwI(BaselineShift.m4792boximpl(m4282decodeBaselineShifty9eOQZs()));
                            }
                        } else {
                            if (dataAvailable() < 5) {
                                break;
                            }
                            mutableSpanStyle.m4318setLetterSpacingR2X_6o(m4287decodeTextUnitXSAIIZE());
                        }
                    } else {
                    ...
                    mutableSpanStyle.m4317setFontSynthesistDdu0R4(FontSynthesis.m4636boximpl(m4286decodeFontSynthesisGVVA2EU()));
                    mutableSpanStyle2 = mutableSpanStyle;
                }
            } else {
                if (dataAvailable() < 8) {
                ...
                mutableSpanStyle2.m4314setColor8_81llA(m4284decodeColor0d7_KjU());
            }
        }
        mutableSpanStyle = mutableSpanStyle2;
    ...
    public final long m4284decodeColor0d7_KjU() {
        return Color.m2707constructorimpl(m4283decodeULongsVKNKU());
    }

    /* renamed from: decodeTextUnit-XSAIIZE, reason: not valid java name */
    public final long m4287decodeTextUnitXSAIIZE() {
        long m5232getUnspecifiedUIouoOA;
        byte decodeByte = decodeByte();
        if (decodeByte == 1) {
            m5232getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5231getSpUIouoOA();
        } else if (decodeByte == 2) {
            m5232getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5230getEmUIouoOA();
        } else {
            m5232getUnspecifiedUIouoOA = TextUnitType.INSTANCE.m5232getUnspecifiedUIouoOA();
        }
        if (TextUnitType.m5226equalsimpl0(m5232getUnspecifiedUIouoOA, TextUnitType.INSTANCE.m5232getUnspecifiedUIouoOA())) {
            return TextUnit.INSTANCE.m5209getUnspecifiedXSAIIZE();
        }
        return TextUnitKt.m5210TextUnitanM5pPY(decodeFloat(), m5232getUnspecifiedUIouoOA);
    }
    ...
    public final int m4285decodeFontStyle_LCdwA() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontStyle.INSTANCE.m4635getNormal_LCdwA();
        }
        if (decodeByte == 1) {
            return FontStyle.INSTANCE.m4634getItalic_LCdwA();
        }
        return FontStyle.INSTANCE.m4635getNormal_LCdwA();
    }

    /* renamed from: decodeFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m4286decodeFontSynthesisGVVA2EU() {
        byte decodeByte = decodeByte();
        if (decodeByte == 0) {
            return FontSynthesis.INSTANCE.m4646getNoneGVVA2EU();
        }
        if (decodeByte == 1) {
            return FontSynthesis.INSTANCE.m4645getAllGVVA2EU();
        }
        if (decodeByte == 3) {
            return FontSynthesis.INSTANCE.m4647getStyleGVVA2EU();
        }
        if (decodeByte == 2) {
            return FontSynthesis.INSTANCE.m4648getWeightGVVA2EU();
        }
        return FontSynthesis.INSTANCE.m4646getNoneGVVA2EU();
    }

    /* renamed from: decodeBaselineShift-y9eOQZs, reason: not valid java name */
    private final float m4282decodeBaselineShifty9eOQZs() {
        return BaselineShift.m4793constructorimpl(decodeFloat());
    }
    ...
    private final Shadow decodeShadow() {
        return new Shadow(m4284decodeColor0d7_KjU(), OffsetKt.Offset(decodeFloat(), decodeFloat()), decodeFloat(), null);
    }
    ...
    private final long m4283decodeULongsVKNKU() {
        return ULong.m5703constructorimpl(this.parcel.readLong());
    }
