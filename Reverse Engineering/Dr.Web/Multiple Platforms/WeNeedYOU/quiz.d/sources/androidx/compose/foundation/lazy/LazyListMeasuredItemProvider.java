...
public abstract class LazyListMeasuredItemProvider {
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider itemProvider, LazyLayoutMeasureScope measureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m4961getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, !z ? Constraints.m4960getMaxHeightimpl(j) : Integer.MAX_VALUE, 5, null);
    }
    ...
    public final LazyListMeasuredItem getAndMeasure(int index) {
        return createItem(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo678measure0kLqBqw(index, this.childConstraints));
    }
