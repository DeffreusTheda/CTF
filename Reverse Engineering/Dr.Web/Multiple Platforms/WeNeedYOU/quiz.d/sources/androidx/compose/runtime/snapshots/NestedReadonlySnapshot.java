...
public final class NestedReadonlySnapshot extends Snapshot {
    ...
    public NestedReadonlySnapshot(int i, SnapshotIdSet invalid, final Function1<Object, Unit> function1, Snapshot parent) {
        ...
        this.parent = parent;
        parent.mo2333nestedActivated$runtime_release(this);
        if (function1 != null) {
    ...
    public void dispose() {
        ...
        this.parent.mo2334nestedDeactivated$runtime_release(this);
        super.dispose();
    }

    @Override // androidx.compose.runtime.snapshots.Snapshot
    /* renamed from: recordModified$runtime_release, reason: merged with bridge method [inline-methods] */
    public Void mo2335recordModified$runtime_release(StateObject state) {
        Intrinsics.checkNotNullParameter(state, "state");
    ...
    public Void mo2334nestedDeactivated$runtime_release(Snapshot snapshot) {
    ...
    public Void mo2333nestedActivated$runtime_release(Snapshot snapshot) {
        Intrinsics.checkNotNullParameter(snapshot, "snapshot");
        SnapshotStateMapKt.unsupported();
        throw new KotlinNothingValueException();
    }
