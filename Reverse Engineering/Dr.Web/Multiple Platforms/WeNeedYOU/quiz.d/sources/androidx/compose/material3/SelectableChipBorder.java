...
public final class SelectableChipBorder {
    ...
    public final State<BorderStroke> borderStroke$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<BorderStroke> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(BorderStrokeKt.m220BorderStrokecXLIe8U(z2 ? this.selectedBorderWidth : this.borderWidth, j), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.borderColor, selectableChipBorder.borderColor) && Color.m2712equalsimpl0(this.selectedBorderColor, selectableChipBorder.selectedBorderColor) && Color.m2712equalsimpl0(this.disabledBorderColor, selectableChipBorder.disabledBorderColor) && Color.m2712equalsimpl0(this.disabledSelectedBorderColor, selectableChipBorder.disabledSelectedBorderColor) && Dp.m5022equalsimpl0(this.borderWidth, selectableChipBorder.borderWidth) && Dp.m5022equalsimpl0(this.selectedBorderWidth, selectableChipBorder.selectedBorderWidth);
    }

    public int hashCode() {
        return (((((((((Color.m2718hashCodeimpl(this.borderColor) * 31) + Color.m2718hashCodeimpl(this.selectedBorderColor)) * 31) + Color.m2718hashCodeimpl(this.disabledBorderColor)) * 31) + Color.m2718hashCodeimpl(this.disabledSelectedBorderColor)) * 31) + Dp.m5023hashCodeimpl(this.borderWidth)) * 31) + Dp.m5023hashCodeimpl(this.selectedBorderWidth);
    }
}
