...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public boolean mo177onPreKeyEventZmokQxo(KeyEvent event) {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.INSTANCE.m2462getZeroF1C5BW0();
        ...
        public final void m180setCentreOffsetk4lQ0M(long j) {
            this.centreOffset = j;
        }
    }
    ...
    public static /* synthetic */ void m174updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z, String str, Role role, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        abstractClickableNode.m178updateCommonXHw0xAI(mutableInteractionSource, z, str, role, function0);
    }

    /* renamed from: updateCommon-XHw0xAI, reason: not valid java name */
    protected final void m178updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
    ...
    public void mo176onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        getClickablePointerInputNode().mo176onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public boolean mo175onKeyEventZmokQxo(KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        if (this.enabled && Clickable_androidKt.m241isPressZmokQxo(event)) {
            if (!this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3399boximpl(KeyEvent_androidKt.m3710getKeyZmokQxo(event)))) {
                PressInteraction.Press press = new PressInteraction.Press(this.interactionData.getCentreOffset(), null);
                this.interactionData.getCurrentKeyPressInteractions().put(Key.m3399boximpl(KeyEvent_androidKt.m3710getKeyZmokQxo(event)), press);
        ...
        } else if (this.enabled && Clickable_androidKt.m239isClickZmokQxo(event)) {
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3399boximpl(KeyEvent_androidKt.m3710getKeyZmokQxo(event)));
            if (remove != null) {
