...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i, boolean z, int i2, int i3, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, resolver, (i4 & 8) != 0 ? null : function1, (i4 & 16) != 0 ? TextOverflow.INSTANCE.m4946getClipgIe3tQ8() : i, (i4 & 32) != 0 ? true : z, (i4 & 64) != 0 ? Integer.MAX_VALUE : i2, (i4 & 128) != 0 ? 1 : i3, (i4 & 256) != 0 ? null : list, (i4 & 512) != 0 ? null : function12, (i4 & 1024) != 0 ? null : selectionController, (i4 & 2048) != 0 ? null : colorProducer, null);
    }
    ...
    public final boolean m915updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> placeholders, int minLines, int maxLines, boolean softWrap, FontFamily.Resolver fontFamilyResolver, int overflow) {
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        ...
        if (TextOverflow.m4939equalsimpl0(this.overflow, overflow)) {
            return z;
        }
    ...
    public final void doInvalidations(boolean drawChanged, boolean textChanged, boolean layoutChanged, boolean callbacksChanged) {
        ...
        if (textChanged || layoutChanged || callbacksChanged) {
            getLayoutCache().m897updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
    ...
    public final MeasureResult m914measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long constraints) {
        Intrinsics.checkNotNullParameter(measureScope, "measureScope");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return mo272measure3p2s80s(measureScope, measurable, constraints);
    }
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        boolean m896layoutWithConstraintsK40F9xA = layoutCache.m896layoutWithConstraintsK40F9xA(j, measure.getLayoutDirection());
        ...
        if (m896layoutWithConstraintsK40F9xA) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(IntSize.m5177getWidthimpl(textLayoutResult.getSize()), IntSize.m5176getHeightimpl(textLayoutResult.getSize())));
        int m5177getWidthimpl = IntSize.m5177getWidthimpl(textLayoutResult.getSize());
        int m5176getHeightimpl = IntSize.m5176getHeightimpl(textLayoutResult.getSize());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        Intrinsics.checkNotNull(map);
        return measure.layout(m5177getWidthimpl, m5176getHeightimpl, map, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.modifiers.TextAnnotatedStringNode$measure$1
            {
                super(1);
            }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        boolean z = textLayoutResult.getHasVisualOverflow() && !TextOverflow.m4939equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4948getVisiblegIe3tQ8());
        if (z) {
            Rect m2486Recttz77jQw = RectKt.m2486Recttz77jQw(Offset.INSTANCE.m2462getZeroF1C5BW0(), SizeKt.Size(IntSize.m5177getWidthimpl(textLayoutResult.getSize()), IntSize.m5176getHeightimpl(textLayoutResult.getSize())));
            canvas.save();
            Canvas.CC.m2685clipRectmtrdDE$default(canvas, m2486Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush == null) {
                ...
                long m2788invoke0d7_KjU = colorProducer != null ? colorProducer.m2788invoke0d7_KjU() : Color.INSTANCE.m2747getUnspecified0d7_KjU();
                if (m2788invoke0d7_KjU == Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
                    if (this.style.m4553getColor0d7_KjU() != Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
                        m2788invoke0d7_KjU = this.style.m4553getColor0d7_KjU();
                    } else {
                        m2788invoke0d7_KjU = Color.INSTANCE.m2737getBlack0d7_KjU();
                    }
                }
                multiParagraph.m4422paintLG529CI(canvas, (r14 & 2) != 0 ? Color.INSTANCE.m2747getUnspecified0d7_KjU() : m2788invoke0d7_KjU, (r14 & 4) != 0 ? null : shadow2, (r14 & 8) != 0 ? null : textDecoration2, (r14 & 16) == 0 ? drawStyle2 : null, (r14 & 32) != 0 ? DrawScope.INSTANCE.m3267getDefaultBlendMode0nO6VwU() : 0);
            } else {
                multiParagraph.m4424painthn5TExg(canvas, brush, (r17 & 4) != 0 ? Float.NaN : this.style.getAlpha(), (r17 & 8) != 0 ? null : shadow2, (r17 & 16) != 0 ? null : textDecoration2, (r17 & 32) != 0 ? null : drawStyle2, (r17 & 64) != 0 ? DrawScope.INSTANCE.m3267getDefaultBlendMode0nO6VwU() : 0);
            }
