...
final class DeviceFontFamilyNameFont extends AndroidFont {
    ...
    private DeviceFontFamilyNameFont(String familyName, FontWeight weight, int i, FontVariation.Settings variationSettings) {
        super(FontLoadingStrategy.INSTANCE.m4623getOptionalLocalPKNRLFQ(), NamedFontLoader.INSTANCE, variationSettings, null);
    ...
    public final android.graphics.Typeface loadCached(Context context) {
        ...
        return PlatformTypefacesKt.PlatformTypefaces().mo4657optionalOnDeviceFontFamilyByName78DK7lM(this.familyName, getWeight(), getStyle(), getVariationSettings(), context);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DeviceFontFamilyName.m4597equalsimpl0(this.familyName, deviceFontFamilyNameFont.familyName) && Intrinsics.areEqual(getWeight(), deviceFontFamilyNameFont.getWeight()) && FontStyle.m4630equalsimpl0(getStyle(), deviceFontFamilyNameFont.getStyle()) && Intrinsics.areEqual(getVariationSettings(), deviceFontFamilyNameFont.getVariationSettings());
    }

    public int hashCode() {
        return (((((DeviceFontFamilyName.m4598hashCodeimpl(this.familyName) * 31) + getWeight().hashCode()) * 31) + FontStyle.m4631hashCodeimpl(getStyle())) * 31) + getVariationSettings().hashCode();
    }

    public String toString() {
        return "Font(familyName=\"" + ((Object) DeviceFontFamilyName.m4599toStringimpl(this.familyName)) + "\", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4632toStringimpl(getStyle())) + ')';
    }
}
