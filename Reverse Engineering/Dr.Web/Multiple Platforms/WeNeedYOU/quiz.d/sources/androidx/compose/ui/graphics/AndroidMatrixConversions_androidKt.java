...
public final class AndroidMatrixConversions_androidKt {
    ...
    public static final void m2559setFromtUYjHk(float[] setFrom, android.graphics.Matrix matrix) {
    ...
    public static final void m2558setFromEL8BTi8(android.graphics.Matrix setFrom, float[] matrix) {
        Intrinsics.checkNotNullParameter(setFrom, "$this$setFrom");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float f = matrix[2];
        if (f == 0.0f) {
