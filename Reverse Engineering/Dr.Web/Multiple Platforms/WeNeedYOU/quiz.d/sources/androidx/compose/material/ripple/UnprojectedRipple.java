...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1018setColorDxMtmZc(long color, float alpha) {
        long m1017calculateRippleColor5vOe2sY = m1017calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 != null && Color.m2712equalsimpl0(color2.m2721unboximpl(), m1017calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m2701boximpl(m1017calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m2765toArgb8_81llA(m1017calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m1017calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m2710copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
