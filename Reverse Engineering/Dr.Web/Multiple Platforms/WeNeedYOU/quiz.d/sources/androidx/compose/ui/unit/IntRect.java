...
public final /* data */ class IntRect {
    ...
    public final IntRect m5165translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m5135getXimpl(offset), this.top + IntOffset.m5136getYimpl(offset), this.right + IntOffset.m5135getXimpl(offset), this.bottom + IntOffset.m5136getYimpl(offset));
    }
    ...
    public final boolean m5154containsgyyYBs(long offset) {
        return IntOffset.m5135getXimpl(offset) >= this.left && IntOffset.m5135getXimpl(offset) < this.right && IntOffset.m5136getYimpl(offset) >= this.top && IntOffset.m5136getYimpl(offset) < this.bottom;
    }
