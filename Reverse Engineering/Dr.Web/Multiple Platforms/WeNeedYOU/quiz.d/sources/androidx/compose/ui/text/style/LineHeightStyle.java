...
public final class LineHeightStyle {
    ...
    static {
        ...
        Default = new LineHeightStyle(Alignment.INSTANCE.m4877getProportionalPIaL0Z0(), Trim.INSTANCE.m4888getBothEVpEnUU(), defaultConstructorMarker);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Alignment.m4871equalsimpl0(this.alignment, lineHeightStyle.alignment) && Trim.m4882equalsimpl0(this.trim, lineHeightStyle.trim);
    }

    public int hashCode() {
        return (Alignment.m4872hashCodeimpl(this.alignment) * 31) + Trim.m4883hashCodeimpl(this.trim);
    }

    public String toString() {
        return "LineHeightStyle(alignment=" + ((Object) Alignment.m4873toStringimpl(this.alignment)) + ", trim=" + ((Object) Trim.m4886toStringimpl(this.trim)) + ')';
    }
    ...
    public static final class Trim {
        ...
        private static final int FirstLineTop = m4880constructorimpl(1);
        private static final int LastLineBottom = m4880constructorimpl(16);
        private static final int Both = m4880constructorimpl(17);
        private static final int None = m4880constructorimpl(0);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Trim m4879boximpl(int i) {
            return new Trim(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        private static int m4880constructorimpl(int i) {
            return i;
        }
        ...
        public static final boolean m4882equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        public static final boolean m4884isTrimFirstLineTopimpl$ui_text_release(int i) {
            return (i & 1) > 0;
        }

        /* renamed from: isTrimLastLineBottom-impl$ui_text_release, reason: not valid java name */
        public static final boolean m4885isTrimLastLineBottomimpl$ui_text_release(int i) {
            return (i & 16) > 0;
        }

        public boolean equals(Object obj) {
            return m4881equalsimpl(this.value, obj);
        }

        public int hashCode() {
            return m4883hashCodeimpl(this.value);
        }
        ...
        public static final class Companion {
            ...
            public final int m4889getFirstLineTopEVpEnUU() {
                return Trim.FirstLineTop;
            }

            /* renamed from: getLastLineBottom-EVpEnUU, reason: not valid java name */
            public final int m4890getLastLineBottomEVpEnUU() {
                return Trim.LastLineBottom;
            }

            /* renamed from: getBoth-EVpEnUU, reason: not valid java name */
            public final int m4888getBothEVpEnUU() {
                return Trim.Both;
            }

            /* renamed from: getNone-EVpEnUU, reason: not valid java name */
            public final int m4891getNoneEVpEnUU() {
                return Trim.None;
            }
        }
    }
    ...
    public static final class Alignment {
        ...
        /* renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final float Top = m4869constructorimpl(0.0f);
        private static final float Center = m4869constructorimpl(0.5f);
        private static final float Proportional = m4869constructorimpl(-1.0f);
        private static final float Bottom = m4869constructorimpl(1.0f);

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ Alignment m4868boximpl(float f) {
        ...
        public boolean equals(Object obj) {
            return m4870equalsimpl(this.topRatio, obj);
        }

        public int hashCode() {
            return m4872hashCodeimpl(this.topRatio);
        }
        ...
        /* renamed from: constructor-impl, reason: not valid java name */
        public static float m4869constructorimpl(float f) {
        ...
        public String toString() {
            return m4873toStringimpl(this.topRatio);
        }
        ...
        public static final class Companion {
            ...
            public final float m4878getTopPIaL0Z0() {
                return Alignment.Top;
            }

            /* renamed from: getCenter-PIaL0Z0, reason: not valid java name */
            public final float m4876getCenterPIaL0Z0() {
                return Alignment.Center;
            }

            /* renamed from: getProportional-PIaL0Z0, reason: not valid java name */
            public final float m4877getProportionalPIaL0Z0() {
                return Alignment.Proportional;
            }

            /* renamed from: getBottom-PIaL0Z0, reason: not valid java name */
            public final float m4875getBottomPIaL0Z0() {
