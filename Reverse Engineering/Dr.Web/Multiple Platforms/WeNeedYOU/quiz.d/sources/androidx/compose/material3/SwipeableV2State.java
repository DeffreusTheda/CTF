...
public final class SwipeableV2State<T> {
    ...
    public /* synthetic */ SwipeableV2State(Object obj, SpringSpec<Float> springSpec, AnonymousClass1 anonymousClass1, Function2 function2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        } : anonymousClass1, (i & 8) != 0 ? SwipeableV2Defaults.INSTANCE.getPositionalThreshold() : function2, (i & 16) != 0 ? SwipeableV2Defaults.INSTANCE.m1536getVelocityThresholdD9Ej5fM() : f, null);
    }
    ...
    */
    ...
    public final T computeTarget(float offset, T currentValue, float velocity) {
        ...
        float mo360toPx0680j_4 = requireDensity.mo360toPx0680j_4(this.velocityThreshold);
        if (Intrinsics.areEqual(f, offset) || f == null) {
            return currentValue;
        }
        if (f.floatValue() < offset) {
            if (velocity >= mo360toPx0680j_4) {
    ...
    public static final class Companion {
        ...
        public final <T> Saver<SwipeableV2State<T>, T> m1540SavereqLRuRQ(final AnimationSpec<Float> animationSpec, final Function1<? super T, Boolean> confirmValueChange, final Function2<? super Density, ? super Float, Float> positionalThreshold, final float velocityThreshold) {
            Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
            Intrinsics.checkNotNullParameter(confirmValueChange, "confirmValueChange");
            Intrinsics.checkNotNullParameter(positionalThreshold, "positionalThreshold");
