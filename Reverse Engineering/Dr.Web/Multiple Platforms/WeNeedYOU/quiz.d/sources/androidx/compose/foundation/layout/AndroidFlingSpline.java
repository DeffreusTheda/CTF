...
final class AndroidFlingSpline {
    ...
    public final long m417flingPositionLfoxSSI(float time) {
        float f;
        float f2;
        float f3 = 100;
        int i = (int) (f3 * time);
        ...
        return FlingResult.m419constructorimpl((Float.floatToIntBits(f2) & 4294967295L) | (Float.floatToIntBits(f) << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m418boximpl(long j) {
        ...
        public static int m424hashCodeimpl(long j) {
        ...
        public boolean equals(Object obj) {
            return m420equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m424hashCodeimpl(this.packedValue);
        }
        ...
        public static final float m422getDistanceCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m423getVelocityCoefficientimpl(long j) {
            FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
