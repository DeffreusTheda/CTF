...
public final class OffsetKt {
    ...
    public static final Modifier m480offsetVpY3zN4(Modifier offset, final float f, final float f2) {
        ...
        return offset.then(new OffsetElement(f, f2, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$1
            ...
            public final void invoke2(InspectorInfo $receiver) {
                ...
                $receiver.getProperties().set("x", Dp.m5015boximpl(f));
                $receiver.getProperties().set("y", Dp.m5015boximpl(f2));
            }
        }, null));
    }

    /* renamed from: absoluteOffset-VpY3zN4, reason: not valid java name */
    public static final Modifier m478absoluteOffsetVpY3zN4(Modifier absoluteOffset, final float f, final float f2) {
    ...
    public static final Modifier offset(Modifier modifier, final Function1<? super Density, IntOffset> offset) {
        ...
        return modifier.then(new OffsetPxElement(offset, true, new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.OffsetKt$offset$2
            ...
            public final void invoke2(InspectorInfo $receiver) {
                Intrinsics.checkNotNullParameter($receiver, "$this$$receiver");
                $receiver.setName(TypedValues.CycleType.S_WAVE_OFFSET);
                $receiver.getProperties().set(TypedValues.CycleType.S_WAVE_OFFSET, offset);
            }
        }));
    }
    ...
    public static /* synthetic */ Modifier m481offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m480offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4$default, reason: not valid java name */
    public static /* synthetic */ Modifier m479absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m5017constructorimpl(0);
        }
        if ((i & 2) != 0) {
        ...
        return m478absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
