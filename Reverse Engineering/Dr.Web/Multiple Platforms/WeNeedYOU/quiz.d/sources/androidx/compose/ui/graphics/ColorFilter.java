...
public final class ColorFilter {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ColorFilter m2752tintxETnrds$default(Companion companion, long j, int i, int i2, Object obj) {
            if ((i2 & 2) != 0) {
                i = BlendMode.INSTANCE.m2653getSrcIn0nO6VwU();
            }
            return companion.m2755tintxETnrds(j, i);
        }

        /* renamed from: tint-xETnrds, reason: not valid java name */
        public final ColorFilter m2755tintxETnrds(long color, int blendMode) {
            return AndroidColorFilter_androidKt.m2554actualTintColorFilterxETnrds(color, blendMode);
        }

        /* renamed from: colorMatrix-jHG-Opc, reason: not valid java name */
        public final ColorFilter m2753colorMatrixjHGOpc(float[] colorMatrix) {
            Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
            return AndroidColorFilter_androidKt.m2552actualColorMatrixColorFilterjHGOpc(colorMatrix);
        }

        /* renamed from: lighting--OWjLjI, reason: not valid java name */
        public final ColorFilter m2754lightingOWjLjI(long multiply, long add) {
            return AndroidColorFilter_androidKt.m2553actualLightingColorFilterOWjLjI(multiply, add);
        }
    }
