...
public final class TextFieldCursorKt {
    private static final AnimationSpec<Float> cursorAnimationSpec = AnimationSpecKt.m124infiniteRepeatable9IiC70o$default(AnimationSpecKt.keyframes(new Function1<KeyframesSpec.KeyframesSpecConfig<Float>, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursorAnimationSpec$1
    ...
    private static final float DefaultCursorThickness = Dp.m5017constructorimpl(2);
    ...
    public static final Modifier cursor(Modifier modifier, final TextFieldState state, final TextFieldValue value, final OffsetMapping offsetMapping, final Brush cursorBrush, boolean z) {
        ...
        return z ? ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                boolean z2 = ((brush instanceof SolidColor) && ((SolidColor) brush).getValue() == Color.INSTANCE.m2747getUnspecified0d7_KjU()) ? false : true;
                if (state.getHasFocus() && TextRange.m4526getCollapsedimpl(value.getSelection()) && z2) {
                    EffectsKt.LaunchedEffect(value.getAnnotatedString(), TextRange.m4520boximpl(value.getSelection()), new AnonymousClass1(animatable, null), composer, 512);
                    ...
                    companion = DrawModifierKt.drawWithContent(composed, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.TextFieldCursorKt$cursor$1.2
                        ...
                        public final void invoke2(ContentDrawScope drawWithContent) {
                            ...
                            int originalToTransformed = offsetMapping2.originalToTransformed(TextRange.m4532getStartimpl(textFieldValue.getSelection()));
                            ...
                            float f = drawWithContent.mo360toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness());
                            float f2 = f / 2;
                            float coerceAtMost = RangesKt.coerceAtMost(rect.getLeft() + f2, Size.m2515getWidthimpl(drawWithContent.mo3184getSizeNHjbRc()) - f2);
                            DrawScope.CC.m3255drawLine1RTmtNc$default(drawWithContent, brush2, OffsetKt.Offset(coerceAtMost, rect.getTop()), OffsetKt.Offset(coerceAtMost, rect.getBottom()), f, 0, null, coerceIn, null, 0, 432, null);
                        }
                    });
                } else {
