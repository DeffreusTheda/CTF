...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m5017constructorimpl(10);
    ...
    public static final float m1008getRippleStartRadiusuvyYCjk(long j) {
        return Math.max(Size.m2515getWidthimpl(j), Size.m2512getHeightimpl(j)) * 0.3f;
    }

    /* renamed from: getRippleEndRadius-cSwnlzA, reason: not valid java name */
    public static final float m1007getRippleEndRadiuscSwnlzA(Density getRippleEndRadius, boolean z, long j) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float m2444getDistanceimpl = Offset.m2444getDistanceimpl(OffsetKt.Offset(Size.m2515getWidthimpl(j), Size.m2512getHeightimpl(j))) / 2.0f;
        return z ? m2444getDistanceimpl + getRippleEndRadius.mo360toPx0680j_4(BoundedRippleExtraRadius) : m2444getDistanceimpl;
    }
}
