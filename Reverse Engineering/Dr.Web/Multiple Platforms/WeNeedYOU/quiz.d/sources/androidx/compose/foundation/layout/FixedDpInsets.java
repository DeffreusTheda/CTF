...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        ...
        return density.mo354roundToPx0680j_4(this.leftDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo354roundToPx0680j_4(this.topDp);
    }
    ...
    public int getRight(Density density, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo354roundToPx0680j_4(this.rightDp);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo354roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + ((Object) Dp.m5028toStringimpl(this.leftDp)) + ", top=" + ((Object) Dp.m5028toStringimpl(this.topDp)) + ", right=" + ((Object) Dp.m5028toStringimpl(this.rightDp)) + ", bottom=" + ((Object) Dp.m5028toStringimpl(this.bottomDp)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5022equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m5022equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m5022equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m5022equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m5023hashCodeimpl(this.leftDp) * 31) + Dp.m5023hashCodeimpl(this.topDp)) * 31) + Dp.m5023hashCodeimpl(this.rightDp)) * 31) + Dp.m5023hashCodeimpl(this.bottomDp);
    }
}
