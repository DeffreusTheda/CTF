...
public final class SelectableChipElevation {
    ...
    private final State<Dp> animateElevation(boolean z, InteractionSource interactionSource, Composer composer, int i) {
        ...
        if (rememberedValue3 == Composer.INSTANCE.getEmpty()) {
            rememberedValue3 = new Animatable(Dp.m5015boximpl(f2), VectorConvertersKt.getVectorConverter(Dp.INSTANCE), null, null, 12, null);
        ...
        if (!z) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5015boximpl(f2), new SelectableChipElevation$animateElevation$2(animatable, f2, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-699481799);
            ComposerKt.sourceInformation(composer, "1712@81209L570");
            EffectsKt.LaunchedEffect(Dp.m5015boximpl(f2), new SelectableChipElevation$animateElevation$3(animatable, this, f2, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5022equalsimpl0(this.elevation, selectableChipElevation.elevation) && Dp.m5022equalsimpl0(this.pressedElevation, selectableChipElevation.pressedElevation) && Dp.m5022equalsimpl0(this.focusedElevation, selectableChipElevation.focusedElevation) && Dp.m5022equalsimpl0(this.hoveredElevation, selectableChipElevation.hoveredElevation) && Dp.m5022equalsimpl0(this.disabledElevation, selectableChipElevation.disabledElevation);
    }

    public int hashCode() {
        return (((((((Dp.m5023hashCodeimpl(this.elevation) * 31) + Dp.m5023hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5023hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5023hashCodeimpl(this.hoveredElevation)) * 31) + Dp.m5023hashCodeimpl(this.disabledElevation);
    }
}
