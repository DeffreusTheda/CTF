...
public class Connector {
    ...
    private Connector(ColorSpace source, ColorSpace destination, int i) {
        this(source, destination, ColorModel.m3120equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3127getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(source, Illuminant.INSTANCE.getD50(), null, 2, null) : source, ColorModel.m3120equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3127getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(destination, Illuminant.INSTANCE.getD50(), null, 2, null) : destination, i, INSTANCE.m3136computeTransformYBCOT_4(source, destination, i), null);
        Intrinsics.checkNotNullParameter(source, "source");
        Intrinsics.checkNotNullParameter(destination, "destination");
    }
    ...
    public long mo3134transformToColorwmQWz5c$ui_graphics_release(float r, float g, float b, float a) {
        ...
        return this.transformDestination.mo3130xyzaToColorJlNiLsg$ui_graphics_release(f2, f, z$ui_graphics_release, a, this.destination);
    }
        ...
        */
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r10, androidx.compose.ui.graphics.colorspace.Rgb r11, int r12) {
            /*
                ...
                r9.mSource = r10
                r9.mDestination = r11
                float[] r10 = r9.m3137computeTransformYBCOT_4(r10, r11, r12)
                r9.mTransform = r10
                return
            */
        ...
        private final float[] m3137computeTransformYBCOT_4(Rgb source, Rgb destination, int intent) {
            ...
            if (RenderIntent.m3141equalsimpl0(intent, RenderIntent.INSTANCE.m3145getAbsoluteuksYyKA())) {
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        public final float[] m3136computeTransformYBCOT_4(ColorSpace source, ColorSpace destination, int intent) {
            if (!RenderIntent.m3141equalsimpl0(intent, RenderIntent.INSTANCE.m3145getAbsoluteuksYyKA())) {
                return null;
            }
            boolean m3120equalsimpl0 = ColorModel.m3120equalsimpl0(source.getModel(), ColorModel.INSTANCE.m3127getRgbxdoWZVw());
            boolean m3120equalsimpl02 = ColorModel.m3120equalsimpl0(destination.getModel(), ColorModel.INSTANCE.m3127getRgbxdoWZVw());
            if (m3120equalsimpl0 && m3120equalsimpl02) {
                return null;
            }
            if (!m3120equalsimpl0 && !m3120equalsimpl02) {
                return null;
            ...
            Rgb rgb = (Rgb) source;
            float[] xyz$ui_graphics_release = m3120equalsimpl0 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
            float[] xyz$ui_graphics_release2 = m3120equalsimpl02 ? rgb.getWhitePoint().toXyz$ui_graphics_release() : Illuminant.INSTANCE.getD50Xyz$ui_graphics_release();
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace source) {
            Intrinsics.checkNotNullParameter(source, "source");
            final int m3147getRelativeuksYyKA = RenderIntent.INSTANCE.m3147getRelativeuksYyKA();
            return new Connector(source, m3147getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                @Override // androidx.compose.ui.graphics.colorspace.Connector
                public float[] transform(float[] v) {
                    Intrinsics.checkNotNullParameter(v, "v");
                    return v;
                ...
                {
                    super(source, source, m3147getRelativeuksYyKA, null);
                }
    ...
    static {
        ...
        SrgbToOklabPerceptual = new Connector(ColorSpaces.INSTANCE.getSrgb(), ColorSpaces.INSTANCE.getOklab(), RenderIntent.INSTANCE.m3146getPerceptualuksYyKA(), defaultConstructorMarker);
        OklabToSrgbPerceptual = new Connector(ColorSpaces.INSTANCE.getOklab(), ColorSpaces.INSTANCE.getSrgb(), RenderIntent.INSTANCE.m3146getPerceptualuksYyKA(), defaultConstructorMarker);
    }
}
