...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll(Modifier modifier) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Modifier nestedScroll$default = NestedScrollModifierKt.nestedScroll$default(composed, WindowInsetsConnection_androidKt.m590rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.Companion.current(composer, 8).getIme(), WindowInsetsSides.INSTANCE.m611getBottomJoeWqyM(), composer, 48), null, 2, null);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m590rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator m550chooseCalculatorni1skBw = SideCalculator.INSTANCE.m550chooseCalculatorni1skBw(i, (LayoutDirection) consume);
        ...
        Object[] objArr = {windowInsets, view, m550chooseCalculatorni1skBw, density};
        ...
        if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new WindowInsetsNestedScrollConnection(windowInsets, view, m550chooseCalculatorni1skBw, density);
