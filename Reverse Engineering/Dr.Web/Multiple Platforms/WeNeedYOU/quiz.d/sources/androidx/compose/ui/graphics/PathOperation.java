...
public final class PathOperation {
    ...
    private static final int Difference = m2999constructorimpl(0);
    private static final int Intersect = m2999constructorimpl(1);
    private static final int Union = m2999constructorimpl(2);
    private static final int Xor = m2999constructorimpl(3);
    private static final int ReverseDifference = m2999constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ PathOperation m2998boximpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m3005getDifferenceb3I0S0c() {
            return PathOperation.Difference;
        }

        /* renamed from: getIntersect-b3I0S0c, reason: not valid java name */
        public final int m3006getIntersectb3I0S0c() {
            return PathOperation.Intersect;
        }

        /* renamed from: getUnion-b3I0S0c, reason: not valid java name */
        public final int m3008getUnionb3I0S0c() {
            return PathOperation.Union;
        }

        /* renamed from: getXor-b3I0S0c, reason: not valid java name */
        public final int m3009getXorb3I0S0c() {
            return PathOperation.Xor;
        }

        /* renamed from: getReverseDifference-b3I0S0c, reason: not valid java name */
        public final int m3007getReverseDifferenceb3I0S0c() {
    ...
    public static String m3003toStringimpl(int i) {
        return m3001equalsimpl0(i, Difference) ? "Difference" : m3001equalsimpl0(i, Intersect) ? "Intersect" : m3001equalsimpl0(i, Union) ? "Union" : m3001equalsimpl0(i, Xor) ? "Xor" : m3001equalsimpl0(i, ReverseDifference) ? "ReverseDifference" : "Unknown";
    }
}
