...
public abstract class Placeable implements Measured {
    ...
    public abstract void mo3968placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock);

    public Placeable() {
        long j;
        j = PlaceableKt.DefaultConstraints;
        this.measurementConstraints = j;
        this.apparentToRealOffset = IntOffset.INSTANCE.m5145getZeronOccac();
    }
    ...
    public int getMeasuredWidth() {
        return IntSize.m5177getWidthimpl(this.measuredSize);
    }

    @Override // androidx.compose.ui.layout.Measured
    public int getMeasuredHeight() {
        return IntSize.m5176getHeightimpl(this.measuredSize);
    }
    ...
    protected final void m4024setMeasuredSizeozmzZPI(long j) {
        if (IntSize.m5175equalsimpl0(this.measuredSize, j)) {
            return;
        }
        this.measuredSize = j;
    ...
    private final void onMeasuredSizeChanged() {
        this.width = RangesKt.coerceIn(IntSize.m5177getWidthimpl(this.measuredSize), Constraints.m4963getMinWidthimpl(this.measurementConstraints), Constraints.m4961getMaxWidthimpl(this.measurementConstraints));
        this.height = RangesKt.coerceIn(IntSize.m5176getHeightimpl(this.measuredSize), Constraints.m4962getMinHeightimpl(this.measurementConstraints), Constraints.m4960getMaxHeightimpl(this.measurementConstraints));
        this.apparentToRealOffset = IntOffsetKt.IntOffset((this.width - IntSize.m5177getWidthimpl(this.measuredSize)) / 2, (this.height - IntSize.m5176getHeightimpl(this.measuredSize)) / 2);
    }
    ...
    public final void m4025setMeasurementConstraintsBRTryo0(long j) {
        if (Constraints.m4954equalsimpl0(this.measurementConstraints, j)) {
            return;
        }
        this.measurementConstraints = j;
        onMeasuredSizeChanged();
    ...
    public static abstract class PlacementScope {
        ...
        public static /* synthetic */ void m4027placeRelative70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4033placeRelative70tqf50(placeable, j, f);
        }
        ...
        public final void placeRelative(Placeable placeable, int i, int i2, float f) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                ...
                placeable.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset) + IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(IntOffset) + IntOffset.m5136getYimpl(j)), f, null);
            } else {
                long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5135getXimpl(IntOffset), IntOffset.m5136getYimpl(IntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset2) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(IntOffset2) + IntOffset.m5136getYimpl(j2)), f, null);
            }
        }
        ...
        public static /* synthetic */ void m4026place70tqf50$default(PlacementScope placementScope, Placeable placeable, long j, float f, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4030place70tqf50(placeable, j, f);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM$default, reason: not valid java name */
        public static /* synthetic */ void m4028placeRelativeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4034placeRelativeWithLayeraW9wM(placeable, j, f2, function1);
        }
        ...
        public final void placeRelativeWithLayer(Placeable placeable, int i, int i2, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            ...
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j = placeable.apparentToRealOffset;
                placeable.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset) + IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(IntOffset) + IntOffset.m5136getYimpl(j)), f, layerBlock);
            } else {
                long IntOffset2 = IntOffsetKt.IntOffset((getParentWidth() - placeable.getWidth()) - IntOffset.m5135getXimpl(IntOffset), IntOffset.m5136getYimpl(IntOffset));
                long j2 = placeable.apparentToRealOffset;
                placeable.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset2) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(IntOffset2) + IntOffset.m5136getYimpl(j2)), f, layerBlock);
            }
        }
        ...
        public static /* synthetic */ void m4029placeWithLayeraW9wM$default(PlacementScope placementScope, Placeable placeable, long j, float f, Function1 function1, int i, Object obj) {
            if (obj != null) {
            ...
            placementScope.m4035placeWithLayeraW9wM(placeable, j, f2, function1);
        }

        /* renamed from: placeAutoMirrored-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4032placeAutoMirroredaW9wM$ui_release(Placeable placeAutoMirrored, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            Intrinsics.checkNotNullParameter(placeAutoMirrored, "$this$placeAutoMirrored");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, function1);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeAutoMirrored.getWidth()) - IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(j));
                long j3 = placeAutoMirrored.apparentToRealOffset;
                placeAutoMirrored.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset) + IntOffset.m5135getXimpl(j3), IntOffset.m5136getYimpl(IntOffset) + IntOffset.m5136getYimpl(j3)), f, function1);
            }
        }

        /* renamed from: placeApparentToRealOffset-aW-9-wM$ui_release, reason: not valid java name */
        public final void m4031placeApparentToRealOffsetaW9wM$ui_release(Placeable placeApparentToRealOffset, long j, float f, Function1<? super GraphicsLayerScope, Unit> function1) {
            ...
            placeApparentToRealOffset.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, function1);
        }
        ...
        public final void m4033placeRelative70tqf50(Placeable placeRelative, long j, float f) {
            Intrinsics.checkNotNullParameter(placeRelative, "$this$placeRelative");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelative.apparentToRealOffset;
                placeRelative.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, null);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelative.getWidth()) - IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(j));
                long j3 = placeRelative.apparentToRealOffset;
                placeRelative.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset) + IntOffset.m5135getXimpl(j3), IntOffset.m5136getYimpl(IntOffset) + IntOffset.m5136getYimpl(j3)), f, null);
            }
        }

        /* renamed from: place-70tqf50, reason: not valid java name */
        public final void m4030place70tqf50(Placeable place, long j, float f) {
            Intrinsics.checkNotNullParameter(place, "$this$place");
            long j2 = place.apparentToRealOffset;
            place.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, null);
        }

        /* renamed from: placeRelativeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4034placeRelativeWithLayeraW9wM(Placeable placeRelativeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeRelativeWithLayer, "$this$placeRelativeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            if (getParentLayoutDirection() == LayoutDirection.Ltr || getParentWidth() == 0) {
                long j2 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, layerBlock);
            } else {
                long IntOffset = IntOffsetKt.IntOffset((getParentWidth() - placeRelativeWithLayer.getWidth()) - IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(j));
                long j3 = placeRelativeWithLayer.apparentToRealOffset;
                placeRelativeWithLayer.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset) + IntOffset.m5135getXimpl(j3), IntOffset.m5136getYimpl(IntOffset) + IntOffset.m5136getYimpl(j3)), f, layerBlock);
            }
        }

        /* renamed from: placeWithLayer-aW-9-wM, reason: not valid java name */
        public final void m4035placeWithLayeraW9wM(Placeable placeWithLayer, long j, float f, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            Intrinsics.checkNotNullParameter(placeWithLayer, "$this$placeWithLayer");
            Intrinsics.checkNotNullParameter(layerBlock, "layerBlock");
            long j2 = placeWithLayer.apparentToRealOffset;
            placeWithLayer.mo3968placeAtf8xVGno(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(j) + IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j) + IntOffset.m5136getYimpl(j2)), f, layerBlock);
        }
    }
}
