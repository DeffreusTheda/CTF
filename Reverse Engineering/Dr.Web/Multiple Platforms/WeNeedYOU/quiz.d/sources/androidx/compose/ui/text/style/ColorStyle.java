...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m4807copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m4809copy8_81llA(j);
    }
    ...
    public final ColorStyle m4809copy8_81llA(long value) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m2712equalsimpl0(this.value, ((ColorStyle) other).value);
    }
    ...
    public int hashCode() {
        return Color.m2718hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m2719toStringimpl(this.value)) + ')';
    }
    ...
    public final long m4810getValue0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    /* renamed from: getColor-0d7_KjU */
    public long mo4806getColor0d7_KjU() {
        return this.value;
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m2713getAlphaimpl(mo4806getColor0d7_KjU());
    }
}
