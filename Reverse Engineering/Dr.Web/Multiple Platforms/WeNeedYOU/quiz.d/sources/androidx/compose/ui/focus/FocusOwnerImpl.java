...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    public void clearFocus(boolean force, boolean refreshFocusEvents) {
        ...
        if (!force) {
            int i = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2394performCustomClearFocusMxy_nc0(this.rootFocusNode, FocusDirection.INSTANCE.m2375getExitdhqQ8s()).ordinal()];
            if (i == 1 || i == 2 || i == 3) {
                return;
            }
        }
    ...
    public boolean mo2383moveFocus3ESFkO8(final int focusDirection) {
        final FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode == null) {
            return false;
        }
        FocusRequester m2398customFocusSearchOMvw8 = FocusTraversalKt.m2398customFocusSearchOMvw8(findActiveFocusNode, focusDirection, getLayoutDirection());
        if (m2398customFocusSearchOMvw8 != FocusRequester.INSTANCE.getDefault()) {
            return m2398customFocusSearchOMvw8 != FocusRequester.INSTANCE.getCancel() && m2398customFocusSearchOMvw8.focus$ui_release();
        }
        final Ref.BooleanRef booleanRef = new Ref.BooleanRef();
        boolean m2399focusSearchsMXa3k8 = FocusTraversalKt.m2399focusSearchsMXa3k8(this.rootFocusNode, focusDirection, getLayoutDirection(), new Function1<FocusTargetNode, Boolean>() { // from class: androidx.compose.ui.focus.FocusOwnerImpl$moveFocus$foundNextItem$1
            ...
            public final Boolean invoke(FocusTargetNode destination) {
                        ...
                        while (parent != null) {
                            if ((parent.getKindSet() & m4184constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if ((node2.getKindSet() & m4184constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                        int i = 0;
                ...
                int i2 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2397performCustomRequestFocusMxy_nc0(destination, focusDirection).ordinal()];
                if (i2 != 1) {
                    if (i2 == 2 || i2 == 3) {
        ...
        return m2399focusSearchsMXa3k8 || m2387wrapAroundFocus3ESFkO8(focusDirection);
    }
    ...
    public boolean mo2385dispatchKeyEventZmokQxo(KeyEvent keyEvent) {
        int size;
        NodeChain nodes;
        ...
        if (lastLocalKeyInputNode == null) {
            int m4184constructorimpl = NodeKind.m4184constructorimpl(8192);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
                    ...
                    while (parent != null) {
                        if ((parent.getKindSet() & m4184constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                ...
                                if ((delegatingNode.getKindSet() & m4184constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
        ...
        if (lastLocalKeyInputNode != null) {
            ...
            int m4184constructorimpl2 = NodeKind.m4184constructorimpl(8192);
            ...
            while (requireLayoutNode2 != null) {
                if ((requireLayoutNode2.getNodes().getHead().getAggregateChildKindSet() & m4184constructorimpl2) != 0) {
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & m4184constructorimpl2) != 0) {
                            ...
                            while (node2 != null) {
                                if (node2 instanceof KeyInputModifierNode) {
                                    ...
                                    arrayList.add(node2);
                                } else if ((node2.getKindSet() & m4184constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                                    int i2 = 0;
                                    for (Modifier.Node delegate2 = ((DelegatingNode) node2).getDelegate(); delegate2 != null; delegate2 = delegate2.getChild()) {
                                        if ((delegate2.getKindSet() & m4184constructorimpl2) != 0) {
                                            i2++;
                                            if (i2 == 1) {
                                                node2 = delegate2;
                                            } else {
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i3 = size - 1;
                    if (((KeyInputModifierNode) arrayList.get(size)).mo177onPreKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i3 < 0) {
                        break;
            ...
            while (node3 != 0) {
                if (node3 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node3).mo177onPreKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & m4184constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                    Modifier.Node delegate3 = node3.getDelegate();
                    int i4 = 0;
                    node3 = node3;
                    while (delegate3 != null) {
                        if ((delegate3.getKindSet() & m4184constructorimpl2) != 0) {
                            i4++;
                            if (i4 == 1) {
                                node3 = delegate3;
                            } else {
            ...
            while (node4 != 0) {
                if (node4 instanceof KeyInputModifierNode) {
                    if (((KeyInputModifierNode) node4).mo175onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node4.getKindSet() & m4184constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                    Modifier.Node delegate4 = node4.getDelegate();
                    int i5 = 0;
                    node4 = node4;
                    while (delegate4 != null) {
                        if ((delegate4.getKindSet() & m4184constructorimpl2) != 0) {
                            i5++;
                            if (i5 == 1) {
                                node4 = delegate4;
                            } else {
            ...
            if (arrayList != null) {
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    if (((KeyInputModifierNode) arrayList.get(i6)).mo175onKeyEventZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean mo2384dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m4184constructorimpl = NodeKind.m4184constructorimpl(131072);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            ...
            int m4184constructorimpl2 = NodeKind.m4184constructorimpl(131072);
                        ...
                        if ((parent2.getKindSet() & m4184constructorimpl2) != 0) {
                            ...
                            while (node != null) {
                                if (node instanceof SoftKeyboardInterceptionModifierNode) {
                                    ...
                                    arrayList.add(node);
                                } else if ((node.getKindSet() & m4184constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
                                    int i2 = 0;
            ...
            if (arrayList != null && arrayList.size() - 1 >= 0) {
                while (true) {
                    int i3 = size - 1;
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(size)).mo3398onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                    if (i3 < 0) {
                        break;
            ...
            while (node2 != 0) {
                if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node2).mo3398onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node2.getKindSet() & m4184constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
            ...
            while (node3 != 0) {
                if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                    if (((SoftKeyboardInterceptionModifierNode) node3).mo3397onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                } else if ((node3.getKindSet() & m4184constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
            ...
            if (arrayList != null) {
                int size2 = arrayList.size();
                for (int i6 = 0; i6 < size2; i6++) {
                    if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i6)).mo3397onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                        return true;
                    }
                }
            }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent event) {
        ...
        if (findActiveFocusNode != null) {
            FocusTargetNode focusTargetNode = findActiveFocusNode;
            int m4184constructorimpl = NodeKind.m4184constructorimpl(16384);
            if (!focusTargetNode.getNode().getIsAttached()) {
                throw new IllegalStateException("visitAncestors called on an unattached node".toString());
            }
            Modifier.Node parent = focusTargetNode.getNode().getParent();
        ...
        if (rotaryInputModifierNode != null) {
            ...
            int m4184constructorimpl2 = NodeKind.m4184constructorimpl(16384);
    ...
    private final boolean m2387wrapAroundFocus3ESFkO8(int focusDirection) {
        if (!this.rootFocusNode.getFocusState().getHasFocus() || this.rootFocusNode.getFocusState().isFocused() || (!FocusDirection.m2365equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2378getNextdhqQ8s()) && !FocusDirection.m2365equalsimpl0(focusDirection, FocusDirection.INSTANCE.m2380getPreviousdhqQ8s()))) {
            return false;
        }
        clearFocus(false);
        if (this.rootFocusNode.getFocusState().isFocused()) {
            return mo2383moveFocus3ESFkO8(focusDirection);
        }
        return false;
    }

    /* renamed from: traverseAncestors-Y-YKmho, reason: not valid java name */
    private final /* synthetic */ <T extends DelegatableNode> void m2386traverseAncestorsYYKmho(DelegatableNode delegatableNode, int i, Function1<? super T, Unit> function1, Function1<? super T, Unit> function12) {
        int i2;
        int size;
        NodeChain nodes;
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int m4184constructorimpl = NodeKind.m4184constructorimpl(1024) | NodeKind.m4184constructorimpl(8192);
        if (!delegatableNode.getNode().getIsAttached()) {
        ...
        if ((node.getAggregateChildKindSet() & m4184constructorimpl) != 0) {
            for (Modifier.Node child = node.getChild(); child != null; child = child.getChild()) {
                if ((child.getKindSet() & m4184constructorimpl) != 0) {
                    if ((NodeKind.m4184constructorimpl(1024) & child.getKindSet()) != 0) {
                        return node2;
                    }
                    node2 = child;
                }
