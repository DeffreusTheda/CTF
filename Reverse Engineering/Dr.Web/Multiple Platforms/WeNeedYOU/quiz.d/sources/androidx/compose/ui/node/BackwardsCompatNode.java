...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m4184constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m4184constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m4184constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m4184constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m4184constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$2
                        ...
                        public void onLayoutComplete() {
                            ...
                            if (layoutCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m4082requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m4184constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m4184constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier)) {
        ...
        if ((NodeKind.m4184constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m4184constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo2351getSizeNHjbRc() {
        return IntSizeKt.m5187toSizeozmzZPI(DelegatableNodeKt.m4082requireCoordinator64DMado(this, NodeKind.m4184constructorimpl(128)).mo3974getSizeYbymL2g());
    }
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo70measure3p2s80s(measure, measurable, j);
    }
    ...
    public void mo176onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo3869onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo248onRemeasuredozmzZPI(long size) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo285onRemeasuredozmzZPI(size);
        }
    }
