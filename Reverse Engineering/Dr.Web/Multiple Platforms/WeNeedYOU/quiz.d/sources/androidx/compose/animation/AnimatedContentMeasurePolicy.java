    ...
    public MeasureResult mo44measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i] = measurable.mo3967measureBRTryo0(j);
            }
            i++;
        }
        ...
        for (int i2 = 0; i2 < size3; i2++) {
            ...
            if (placeableArr[i2] == null) {
                placeableArr[i2] = measurable2.mo3967measureBRTryo0(j);
            }
        }
        if (size == 0) {
            placeable2 = null;
        ...
        this.rootScope.m69setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(width3, height3));
        return MeasureScope.CC.layout$default(measure, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentMeasurePolicy$measure$3
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                for (Placeable placeable5 : placeableArr2) {
                    if (placeable5 != null) {
                        long mo2336alignKFBX0sM = animatedContentMeasurePolicy.getRootScope().getContentAlignment().mo2336alignKFBX0sM(IntSizeKt.IntSize(placeable5.getWidth(), placeable5.getHeight()), IntSizeKt.IntSize(i3, i4), LayoutDirection.Ltr);
                        Placeable.PlacementScope.place$default(layout, placeable5, IntOffset.m5135getXimpl(mo2336alignKFBX0sM), IntOffset.m5136getYimpl(mo2336alignKFBX0sM), 0.0f, 4, null);
                    }
                }
            }
        }, 4, null);
