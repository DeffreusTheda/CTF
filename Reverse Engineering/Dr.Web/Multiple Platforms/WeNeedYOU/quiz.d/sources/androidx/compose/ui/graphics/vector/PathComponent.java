...
public final class PathComponent extends VNode {
    ...
    public final void m3355setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo2581setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m3356setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m3357setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int mo2579getFillTypeRgk1Os = this.renderPath.mo2579getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo2581setFillTypeoQ8Xj4U(mo2579getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.CC.m3259drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.CC.m3259drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
