...
final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        CheckScrollableContainerConstraintsKt.m221checkScrollableContainerConstraintsK40F9xA(j, this.isVertical ? Orientation.Vertical : Orientation.Horizontal);
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.m4952copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m4961getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m4960getMaxHeightimpl(j), 5, null));
        int coerceAtMost = RangesKt.coerceAtMost(mo3967measureBRTryo0.getWidth(), Constraints.m4961getMaxWidthimpl(j));
        int coerceAtMost2 = RangesKt.coerceAtMost(mo3967measureBRTryo0.getHeight(), Constraints.m4960getMaxHeightimpl(j));
        final int height = mo3967measureBRTryo0.getHeight() - coerceAtMost2;
        int width = mo3967measureBRTryo0.getWidth() - coerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
        ...
        return MeasureScope.CC.layout$default(measure, coerceAtMost, coerceAtMost2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ScrollingLayoutNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.placeRelativeWithLayer$default(layout, mo3967measureBRTryo0, ScrollingLayoutNode.this.getIsVertical() ? 0 : i, ScrollingLayoutNode.this.getIsVertical() ? i : 0, 0.0f, null, 12, null);
            }
        }, 4, null);
    }
