...
final class DebugRippleTheme implements RippleTheme {
    ...
    public long mo1005defaultColorWaAFU9c(Composer composer, int i) {
        ...
        long m1015defaultRippleColor5vOe2sY = RippleTheme.INSTANCE.m1015defaultRippleColor5vOe2sY(Color.INSTANCE.m2737getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1015defaultRippleColor5vOe2sY;
    }
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i) {
        ...
        RippleAlpha m1014defaultRippleAlphaDxMtmZc = RippleTheme.INSTANCE.m1014defaultRippleAlphaDxMtmZc(Color.INSTANCE.m2737getBlack0d7_KjU(), true);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1014defaultRippleAlphaDxMtmZc;
    }
}
