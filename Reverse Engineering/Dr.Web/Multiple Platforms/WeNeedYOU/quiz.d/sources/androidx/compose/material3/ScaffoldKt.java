...
public final class ScaffoldKt {
    ...
    private static final float FabSpacing = Dp.m5017constructorimpl(16);
    ...
    */
    ...
    public static final void m1404ScaffoldLayoutFMILGgc(final int i, final Function2<? super Composer, ? super Integer, Unit> function2, final Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final WindowInsets windowInsets, final Function2<? super Composer, ? super Integer, Unit> function24, Composer composer, final int i2) {
        ...
        if ((2995931 & i5) != 599186 || !startRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {function2, function22, windowInsets, function23, FabPosition.m1244boximpl(i), function24, function3};
            ...
            if (z || rememberedValue == Composer.INSTANCE.getEmpty()) {
                ...
                rememberedValue = (Function2) new Function2<SubcomposeMeasureScope, Constraints, MeasureResult>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1
                    ...
                    public /* bridge */ /* synthetic */ MeasureResult invoke(SubcomposeMeasureScope subcomposeMeasureScope, Constraints constraints) {
                        return m1406invoke0kLqBqw(subcomposeMeasureScope, constraints.getValue());
                    }

                    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                    public final MeasureResult m1406invoke0kLqBqw(final SubcomposeMeasureScope SubcomposeLayout, long j) {
                        ...
                        final long m4952copyZbe2FdA$default = Constraints.m4952copyZbe2FdA$default(j, 0, 0, 0, 0, 10, null);
                        ...
                        return MeasureScope.CC.layout$default(SubcomposeLayout, m4961getMaxWidthimpl, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1.1
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            /* JADX WARN: Multi-variable type inference failed */
                            {
                                super(1);
                            ...
                            public final void invoke2(Placeable.PlacementScope layout) {
                                ...
                                long j3 = m4952copyZbe2FdA$default;
                                ...
                                while (it3.hasNext()) {
                                    ...
                                    arrayList4.add(((Measurable) it3.next()).mo3967measureBRTryo0(ConstraintsKt.m4977offsetNN6EwU(j3, (-windowInsets3.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection())) - windowInsets3.getRight(subcomposeMeasureScope2, subcomposeMeasureScope.getLayoutDirection()), -windowInsets3.getBottom(subcomposeMeasureScope2))));
                                ...
                                List<Measurable> subcompose4 = subcomposeMeasureScope7.subcompose(scaffoldLayoutContent, ComposableLambdaKt.composableLambdaInstance(-1455477816, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$1$1$1$bottomBarPlaceables$1
                                    ...
                                    public final void invoke(Composer composer3, int i13) {
                                        ...
                                        if ((i13 & 11) != 2 || !composer3.getSkipping()) {
                                            ...
                                            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ScaffoldKt.getLocalFabPlacement().provides(FabPlacement.this)}, function29, composer3, ((i12 >> 15) & 112) | 8);
                                            if (ComposerKt.isTraceInProgress()) {
                                ...
                                long j5 = m4952copyZbe2FdA$default;
                                ...
                                while (it9.hasNext()) {
                                    arrayList9.add(((Measurable) it9.next()).mo3967measureBRTryo0(j5));
                                }
                                ...
                                if (fabPlacement != null) {
                                    ...
                                    if (valueOf == null) {
                                        ...
                                        i9 = height12 + subcomposeMeasureScope8.mo354roundToPx0680j_4(f2) + windowInsets5.getBottom(subcomposeMeasureScope8);
                                    } else {
                                        int intValue = valueOf.intValue() + fabPlacement.getHeight();
                                        f = ScaffoldKt.FabSpacing;
                                        i9 = intValue + subcomposeMeasureScope8.mo354roundToPx0680j_4(f);
                                    }
                                    ...
                                    public final void invoke(Composer composer3, int i14) {
                                        ...
                                        if ((i14 & 11) != 2 || !composer3.getSkipping()) {
                                            ...
                                            if (arrayList2.isEmpty()) {
                                                ...
                                                f5 = subcomposeMeasureScope10.mo357toDpu2uoSUM(height3);
                                            }
                                            if (arrayList10.isEmpty() || (num3 = num2) == null) {
                                                bottom = asPaddingValues.getBottom();
                                            } else {
                                                bottom = subcomposeMeasureScope10.mo357toDpu2uoSUM(num3.intValue());
                                            }
                                            function33.invoke(PaddingKt.m516PaddingValuesa9UjIt4(PaddingKt.calculateStartPadding(asPaddingValues, subcomposeMeasureScope10.getLayoutDirection()), f5, PaddingKt.calculateEndPadding(asPaddingValues, subcomposeMeasureScope10.getLayoutDirection()), bottom), composer3, Integer.valueOf((i13 >> 3) & 112));
                                            if (ComposerKt.isTraceInProgress()) {
                                                ComposerKt.traceEventEnd();
                                                return;
                                            }
                                ...
                                long j6 = m4952copyZbe2FdA$default;
                                ...
                                while (it11.hasNext()) {
                                    arrayList12.add(((Measurable) it11.next()).mo3967measureBRTryo0(j6));
                                }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ScaffoldKt$ScaffoldLayout$2
            ...
            public final void invoke(Composer composer3, int i7) {
                ScaffoldKt.m1404ScaffoldLayoutFMILGgc(i, function2, function3, function22, function23, windowInsets, function24, composer3, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
