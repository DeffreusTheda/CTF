...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m567size3ABfNKs(Modifier.INSTANCE, IconButtonTokens.INSTANCE.m1981getIconSizeD9Ej5fM());
    ...
    */
    public static final void m1283Iconww6aTOc(final androidx.compose.ui.graphics.vector.ImageVector r17, final java.lang.String r18, androidx.compose.ui.Modifier r19, long r20, androidx.compose.runtime.Composer r22, final int r23, final int r24) {
        /*
            Method dump skipped, instructions count: 301
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.IconKt.m1283Iconww6aTOc(androidx.compose.ui.graphics.vector.ImageVector, java.lang.String, androidx.compose.ui.Modifier, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1281Iconww6aTOc(final ImageBitmap bitmap, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        long j2;
        int i3;
        ...
        if ((i2 & 8) != 0) {
            ...
            j2 = ((Color) consume).m2721unboximpl();
            i3 = i & (-7169);
        } else {
            j2 = j;
            i3 = i;
        ...
        m1282Iconww6aTOc((BitmapPainter) rememberedValue, str, modifier2, j2, startRestartGroup, (i3 & 112) | 8 | (i3 & 896) | (i3 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$2
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1281Iconww6aTOc(ImageBitmap.this, str, modifier3, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }

    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1282Iconww6aTOc(final Painter painter, final String str, Modifier modifier, long j, Composer composer, final int i, final int i2) {
        long j2;
        int i3;
        ...
        ColorFilter m2752tintxETnrds$default = Color.m2712equalsimpl0(j2, Color.INSTANCE.m2747getUnspecified0d7_KjU()) ? null : ColorFilter.Companion.m2752tintxETnrds$default(ColorFilter.INSTANCE, j2, 0, 2, null);
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$semantics$1$1
                    ...
                    public final void invoke2(SemanticsPropertyReceiver semantics) {
                        ...
                        SemanticsPropertiesKt.m4388setRolekuIjeqM(semantics, Role.INSTANCE.m4377getImageo7Vup1c());
                    }
                };
        ...
        startRestartGroup.endReplaceableGroup();
        final long j3 = j2;
        BoxKt.Box(PainterModifierKt.paint$default(defaultSizeFor(GraphicsLayerModifierKt.toolingGraphicsLayer(modifier2), painter), painter, false, null, ContentScale.INSTANCE.getFit(), 0.0f, m2752tintxETnrds$default, 22, null).then(companion), startRestartGroup, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.IconKt$Icon$3
            ...
            public final void invoke(Composer composer2, int i4) {
                IconKt.m1282Iconww6aTOc(Painter.this, str, modifier3, j3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), i2);
            }
        });
    }
    ...
    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        Modifier.Companion companion;
        if (Size.m2511equalsimpl0(painter.getIntrinsicSize(), Size.INSTANCE.m2523getUnspecifiedNHjbRc()) || m1284isInfiniteuvyYCjk(painter.getIntrinsicSize())) {
    ...
    private static final boolean m1284isInfiniteuvyYCjk(long j) {
        return Float.isInfinite(Size.m2515getWidthimpl(j)) && Float.isInfinite(Size.m2512getHeightimpl(j));
    }
}
