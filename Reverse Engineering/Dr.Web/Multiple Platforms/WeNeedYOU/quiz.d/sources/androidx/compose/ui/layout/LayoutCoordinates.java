...
public interface LayoutCoordinates {
    ...
    long mo3975localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource);

    /* renamed from: localToRoot-MK-Hz9U, reason: not valid java name */
    long mo3976localToRootMKHz9U(long relativeToLocal);

    /* renamed from: localToWindow-MK-Hz9U, reason: not valid java name */
    long mo3977localToWindowMKHz9U(long relativeToLocal);

    /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
    void mo3978transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix);

    /* renamed from: windowToLocal-MK-Hz9U, reason: not valid java name */
    long mo3979windowToLocalMKHz9U(long relativeToWindow);
    ...
    public final /* synthetic */ class CC {
        ...
        public static void m3980$default$transformFromEL8BTi8(LayoutCoordinates _this, LayoutCoordinates sourceCoordinates, float[] matrix) {
    ...
    public static final class DefaultImpls {
        @Deprecated
        /* renamed from: transformFrom-EL8BTi8, reason: not valid java name */
        public static void m3982transformFromEL8BTi8(LayoutCoordinates layoutCoordinates, LayoutCoordinates sourceCoordinates, float[] matrix) {
            Intrinsics.checkNotNullParameter(sourceCoordinates, "sourceCoordinates");
            Intrinsics.checkNotNullParameter(matrix, "matrix");
            CC.m3980$default$transformFromEL8BTi8(layoutCoordinates, sourceCoordinates, matrix);
        }
    }
}
