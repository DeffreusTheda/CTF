...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m4748copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (TextRange.m4526getCollapsedimpl(getSelection())) {
        ...
        return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m4530getMinimpl(getSelection()), TextRange.m4530getMinimpl(getSelection()))});
    }
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L1b:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m4527getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m2479getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m2512getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m4504getOffsetForPositionk4lQ0M(r0)
