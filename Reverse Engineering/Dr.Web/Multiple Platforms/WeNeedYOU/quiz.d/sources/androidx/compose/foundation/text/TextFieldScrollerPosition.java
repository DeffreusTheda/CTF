...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4537getZerod9O1mEE();
    ...
    public final void m871setPreviousSelection5zctL8(long j) {
    ...
    public final int m869getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4532getStartimpl(selection) != TextRange.m4532getStartimpl(this.previousSelection) ? TextRange.m4532getStartimpl(selection) : TextRange.m4527getEndimpl(selection) != TextRange.m4527getEndimpl(this.previousSelection) ? TextRange.m4527getEndimpl(selection) : TextRange.m4530getMinimpl(selection);
    }
