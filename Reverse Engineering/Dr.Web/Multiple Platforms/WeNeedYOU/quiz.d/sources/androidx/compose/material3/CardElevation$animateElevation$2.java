...
final class CardElevation$animateElevation$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$enabled) {
                float m5031unboximpl = this.$animatable.getTargetValue().m5031unboximpl();
                f = this.this$0.pressedElevation;
                DragInteraction.Start start = null;
                if (Dp.m5022equalsimpl0(m5031unboximpl, f)) {
                    start = new PressInteraction.Press(Offset.INSTANCE.m2462getZeroF1C5BW0(), null);
                } else {
                    ...
                    if (Dp.m5022equalsimpl0(m5031unboximpl, f2)) {
                        ...
                        if (Dp.m5022equalsimpl0(m5031unboximpl, f3)) {
                            ...
                            if (Dp.m5022equalsimpl0(m5031unboximpl, f4)) {
                ...
                this.label = 1;
                if (ElevationKt.m1236animateElevationrAjV9yQ(this.$animatable, this.$target, start, this.$interaction, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                this.label = 2;
                if (this.$animatable.snapTo(Dp.m5015boximpl(this.$target), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else {
