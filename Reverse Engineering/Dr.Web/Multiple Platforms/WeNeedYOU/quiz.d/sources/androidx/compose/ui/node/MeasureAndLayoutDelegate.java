...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m4141updateRootConstraintsBRTryo0(long constraints) {
        Constraints constraints2 = this.rootConstraints;
        if (constraints2 != null && Constraints.m4954equalsimpl0(constraints2.getValue(), constraints)) {
            return;
        }
        if (!(!this.duringMeasureLayout)) {
            throw new IllegalArgumentException("Failed requirement.".toString());
        }
        this.rootConstraints = Constraints.m4949boximpl(constraints);
    ...
    private final boolean m4138doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4107lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            m4107lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4111lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4107lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4107lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4107lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4107lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m4139doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4108remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4108remeasure_Sx5XlM$ui_release$default = layoutNode.m4112remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4108remeasure_Sx5XlM$ui_release$default = LayoutNode.m4108remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4108remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4108remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m4140measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        Intrinsics.checkNotNullParameter(layoutNode, "layoutNode");
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                boolean m4138doLookaheadRemeasuresdFAvZA = m4138doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4949boximpl(constraints));
                m4139doRemeasuresdFAvZA(layoutNode, Constraints.m4949boximpl(constraints));
                if ((m4138doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
    ...
    public final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        boolean m4138doLookaheadRemeasuresdFAvZA;
        boolean m4139doRemeasuresdFAvZA;
        int i = 0;
        ...
        if (layoutNode.getLookaheadMeasurePending$ui_release() || layoutNode.getMeasurePending$ui_release()) {
            ...
            m4138doLookaheadRemeasuresdFAvZA = (layoutNode.getLookaheadMeasurePending$ui_release() && affectsLookahead) ? m4138doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
            m4139doRemeasuresdFAvZA = m4139doRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4139doRemeasuresdFAvZA = false;
            m4138doLookaheadRemeasuresdFAvZA = false;
        }
        if ((m4138doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) && affectsLookahead) {
            layoutNode.lookaheadReplace$ui_release();
        }
        if (layoutNode.getLayoutPending$ui_release() && layoutNode.isPlaced()) {
            if (layoutNode == this.root) {
        ...
        return m4139doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode) {
        ...
        if (layoutNode.getMeasurePending$ui_release() || layoutNode.getLookaheadMeasurePending$ui_release()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                m4138doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            }
            m4139doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
