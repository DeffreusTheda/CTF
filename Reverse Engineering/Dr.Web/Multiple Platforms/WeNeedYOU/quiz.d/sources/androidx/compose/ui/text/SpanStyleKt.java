...
public final class SpanStyleKt {
    ...
    public static final long m4497lerpTextUnitInheritableC3pnCVY(long j, long j2, float f) {
        if (TextUnitKt.m5216isUnspecifiedR2X_6o(j) || TextUnitKt.m5216isUnspecifiedR2X_6o(j2)) {
            return ((TextUnit) lerpDiscrete(TextUnit.m5188boximpl(j), TextUnit.m5188boximpl(j2), f)).getPackedValue();
        }
        return TextUnitKt.m5218lerpC3pnCVY(j, j2, f);
    }
    ...
    public static final SpanStyle lerp(SpanStyle start, SpanStyle stop, float f) {
        ...
        long m4497lerpTextUnitInheritableC3pnCVY = m4497lerpTextUnitInheritableC3pnCVY(start.getFontSize(), stop.getFontSize(), f);
        ...
        long m4497lerpTextUnitInheritableC3pnCVY2 = m4497lerpTextUnitInheritableC3pnCVY(start.getLetterSpacing(), stop.getLetterSpacing(), f);
        BaselineShift baselineShift = start.getBaselineShift();
        float m4798unboximpl = baselineShift != null ? baselineShift.m4798unboximpl() : BaselineShift.m4793constructorimpl(0.0f);
        BaselineShift baselineShift2 = stop.getBaselineShift();
        float m4805lerpjWV1Mfo = BaselineShiftKt.m4805lerpjWV1Mfo(m4798unboximpl, baselineShift2 != null ? baselineShift2.m4798unboximpl() : BaselineShift.m4793constructorimpl(0.0f), f);
        ...
        long m2762lerpjxsXWHM = ColorKt.m2762lerpjxsXWHM(start.getBackground(), stop.getBackground(), f);
        ...
        return new SpanStyle(lerp, m4497lerpTextUnitInheritableC3pnCVY, lerp2, fontStyle, fontSynthesis, fontFamily, str, m4497lerpTextUnitInheritableC3pnCVY2, BaselineShift.m4792boximpl(m4805lerpjWV1Mfo), lerp3, localeList, m2762lerpjxsXWHM, textDecoration, ShadowKt.lerp(shadow, shadow2, f), lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), f), (DrawStyle) lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), f), (DefaultConstructorMarker) null);
    }
    ...
    public static final SpanStyle resolveSpanStyleDefaults(SpanStyle style) {
        ...
        TextForegroundStyle takeOrElse = style.getTextForegroundStyle().takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.SpanStyleKt$resolveSpanStyleDefaults$1
            ...
            public final TextForegroundStyle invoke() {
                ...
                return companion.m4918from8_81llA(j);
            }
        });
        long fontSize = TextUnitKt.m5216isUnspecifiedR2X_6o(style.getFontSize()) ? DefaultFontSize : style.getFontSize();
        ...
        FontSynthesis m4636boximpl = FontSynthesis.m4636boximpl(fontSynthesis != null ? fontSynthesis.getValue() : FontSynthesis.INSTANCE.m4645getAllGVVA2EU());
        ...
        if (TextUnitKt.m5216isUnspecifiedR2X_6o(style.getLetterSpacing())) {
        ...
        BaselineShift m4792boximpl = BaselineShift.m4792boximpl(baselineShift != null ? baselineShift.m4798unboximpl() : BaselineShift.INSTANCE.m4802getNoney9eOQZs());
        ...
        if (background == Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
        ...
        return new SpanStyle(takeOrElse, fontSize, fontWeight2, m4627boximpl, m4636boximpl, fontFamily2, str, j, m4792boximpl, textGeometricTransform2, localeList2, j2, textDecoration2, shadow2, platformStyle, drawStyle, (DefaultConstructorMarker) null);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:4:0x0033, code lost:
        ...
        if (androidx.compose.ui.unit.TextUnit.m5195equalsimpl0(r26, r21.getFontSize()) == false) goto L7;
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x005a, code lost:
    
        if (androidx.compose.ui.graphics.Color.m2712equalsimpl0(r22, r21.getTextForegroundStyle().mo4806getColor0d7_KjU()) == false) goto L7;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:71:0x008e, code lost:
        ...
        if (androidx.compose.ui.unit.TextUnit.m5195equalsimpl0(r33, r21.getLetterSpacing()) == false) goto L7;
     */
    ...
    */
    public static final androidx.compose.ui.text.SpanStyle m4496fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle r21, long r22, androidx.compose.ui.graphics.Brush r24, float r25, long r26, androidx.compose.ui.text.font.FontWeight r28, androidx.compose.ui.text.font.FontStyle r29, androidx.compose.ui.text.font.FontSynthesis r30, androidx.compose.ui.text.font.FontFamily r31, java.lang.String r32, long r33, androidx.compose.ui.text.style.BaselineShift r35, androidx.compose.ui.text.style.TextGeometricTransform r36, androidx.compose.ui.text.intl.LocaleList r37, long r38, androidx.compose.ui.text.style.TextDecoration r40, androidx.compose.ui.graphics.Shadow r41, androidx.compose.ui.text.PlatformSpanStyle r42, androidx.compose.ui.graphics.drawscope.DrawStyle r43) {
        /*
            Method dump skipped, instructions count: 509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.text.SpanStyleKt.m4496fastMergedSHsh3o(androidx.compose.ui.text.SpanStyle, long, androidx.compose.ui.graphics.Brush, float, long, androidx.compose.ui.text.font.FontWeight, androidx.compose.ui.text.font.FontStyle, androidx.compose.ui.text.font.FontSynthesis, androidx.compose.ui.text.font.FontFamily, java.lang.String, long, androidx.compose.ui.text.style.BaselineShift, androidx.compose.ui.text.style.TextGeometricTransform, androidx.compose.ui.text.intl.LocaleList, long, androidx.compose.ui.text.style.TextDecoration, androidx.compose.ui.graphics.Shadow, androidx.compose.ui.text.PlatformSpanStyle, androidx.compose.ui.graphics.drawscope.DrawStyle):androidx.compose.ui.text.SpanStyle");
    }
}
