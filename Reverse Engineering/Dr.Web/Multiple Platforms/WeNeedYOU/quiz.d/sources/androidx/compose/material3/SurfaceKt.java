...
public final class SurfaceKt {
    private static final ProvidableCompositionLocal<Dp> LocalAbsoluteTonalElevation = CompositionLocalKt.compositionLocalOf$default(null, new Function0<Dp>() { // from class: androidx.compose.material3.SurfaceKt$LocalAbsoluteTonalElevation$1
        ...
        public /* bridge */ /* synthetic */ Dp invoke() {
            return Dp.m5015boximpl(m1529invokeD9Ej5fM());
        }

        /* renamed from: invoke-D9Ej5fM, reason: not valid java name */
        public final float m1529invokeD9Ej5fM() {
            return Dp.m5017constructorimpl(0);
        }
    }, 1, null);

    /* renamed from: Surface-T9BRK9s, reason: not valid java name */
    public static final void m1521SurfaceT9BRK9s(Modifier modifier, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, int i2) {
        ...
        final long m1105getSurface0d7_KjU = (i2 & 4) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1105getSurface0d7_KjU() : j;
        long m1141contentColorForek8zF_U = (i2 & 8) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(m1105getSurface0d7_KjU, composer, (i >> 6) & 14) : j2;
        float m5017constructorimpl = (i2 & 16) != 0 ? Dp.m5017constructorimpl(0) : f;
        float m5017constructorimpl2 = (i2 & 32) != 0 ? Dp.m5017constructorimpl(0) : f2;
        ...
        final float m5017constructorimpl3 = Dp.m5017constructorimpl(((Dp) consume).m5031unboximpl() + m5017constructorimpl);
        ProvidedValue[] providedValueArr = {ContentColorKt.getLocalContentColor().provides(Color.m2701boximpl(m1141contentColorForek8zF_U)), providableCompositionLocal.provides(Dp.m5015boximpl(m5017constructorimpl3))};
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = m5017constructorimpl2;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -70914509, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1
            ...
            public final void invoke(Composer composer2, int i3) {
                long m1528surfaceColorAtElevationCLU3JFs;
                Modifier m1527surface8ww4TTg;
                ...
                if ((i3 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    m1528surfaceColorAtElevationCLU3JFs = SurfaceKt.m1528surfaceColorAtElevationCLU3JFs(m1105getSurface0d7_KjU, m5017constructorimpl3, composer2, (i >> 6) & 14);
                    m1527surface8ww4TTg = SurfaceKt.m1527surface8ww4TTg(modifier2, shape2, m1528surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m1527surface8ww4TTg, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$1.1
    ...
    public static final void m1524Surfaceo_FOJdg(final Function0<Unit> onClick, Modifier modifier, boolean z, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        ...
        long m1105getSurface0d7_KjU = (i3 & 16) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1105getSurface0d7_KjU() : j;
        long m1141contentColorForek8zF_U = (i3 & 32) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(m1105getSurface0d7_KjU, composer, (i >> 12) & 14) : j2;
        float m5017constructorimpl = (i3 & 64) != 0 ? Dp.m5017constructorimpl(0) : f;
        float m5017constructorimpl2 = (i3 & 128) != 0 ? Dp.m5017constructorimpl(0) : f2;
        ...
        final long j3 = m1105getSurface0d7_KjU;
        final BorderStroke borderStroke3 = borderStroke2;
        final float f3 = m5017constructorimpl2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 1279702876, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$3
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Shape shape3 = shape2;
                    m1528surfaceColorAtElevationCLU3JFs = SurfaceKt.m1528surfaceColorAtElevationCLU3JFs(j3, m5017constructorimpl3, composer2, (i >> 12) & 14);
                    m1527surface8ww4TTg = SurfaceKt.m1527surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1528surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    m223clickableO2vRcR0 = ClickableKt.m223clickableO2vRcR0(m1527surface8ww4TTg, mutableInteractionSource3, RippleKt.m1013rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), (r14 & 4) != 0 ? true : z2, (r14 & 8) != 0 ? null : null, (r14 & 16) != 0 ? null : null, onClick);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m223clickableO2vRcR0);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final void m1522Surfaced85dljk(final boolean z, final Function0<Unit> onClick, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        long m1105getSurface0d7_KjU = (i3 & 32) != 0 ? MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1105getSurface0d7_KjU() : j;
        long m1141contentColorForek8zF_U = (i3 & 64) != 0 ? ColorSchemeKt.m1141contentColorForek8zF_U(m1105getSurface0d7_KjU, composer, (i >> 15) & 14) : j2;
        float m5017constructorimpl = (i3 & 128) != 0 ? Dp.m5017constructorimpl(0) : f;
        float m5017constructorimpl2 = (i3 & 256) != 0 ? Dp.m5017constructorimpl(0) : f2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, -1164547968, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$5
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    Modifier minimumInteractiveComponentSize = InteractiveComponentSizeKt.minimumInteractiveComponentSize(Modifier.this);
                    Shape shape3 = shape2;
                    m1528surfaceColorAtElevationCLU3JFs = SurfaceKt.m1528surfaceColorAtElevationCLU3JFs(j3, m5017constructorimpl3, composer2, (i >> 15) & 14);
                    m1527surface8ww4TTg = SurfaceKt.m1527surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1528surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier m753selectableO2vRcR0$default = SelectableKt.m753selectableO2vRcR0$default(m1527surface8ww4TTg, z, mutableInteractionSource3, RippleKt.m1013rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onClick, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m753selectableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    /* renamed from: Surface-d85dljk, reason: not valid java name */
    public static final void m1523Surfaced85dljk(final boolean z, final Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean z2, Shape shape, long j, long j2, float f, float f2, BorderStroke borderStroke, MutableInteractionSource mutableInteractionSource, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2, int i3) {
        MutableInteractionSource mutableInteractionSource2;
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, ComposableLambdaKt.composableLambda(composer, 712720927, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SurfaceKt$Surface$7
            ...
            public final void invoke(Composer composer2, int i4) {
                ...
                if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                    ...
                    m1528surfaceColorAtElevationCLU3JFs = SurfaceKt.m1528surfaceColorAtElevationCLU3JFs(j3, m5017constructorimpl3, composer2, (i >> 15) & 14);
                    m1527surface8ww4TTg = SurfaceKt.m1527surface8ww4TTg(minimumInteractiveComponentSize, shape3, m1528surfaceColorAtElevationCLU3JFs, borderStroke3, f3);
                    Modifier m757toggleableO2vRcR0$default = ToggleableKt.m757toggleableO2vRcR0$default(m1527surface8ww4TTg, z, mutableInteractionSource3, RippleKt.m1013rememberRipple9IZ8Weo(false, 0.0f, 0L, composer2, 0, 7), z3, null, onCheckedChange, 16, null);
                    Function2<Composer, Integer, Unit> function2 = content;
                    int i5 = i2;
                    composer2.startReplaceableGroup(733328855);
                    ComposerKt.sourceInformation(composer2, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                    ...
                    ViewConfiguration viewConfiguration = (ViewConfiguration) consume4;
                    Function0<ComposeUiNode> constructor = ComposeUiNode.INSTANCE.getConstructor();
                    Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m757toggleableO2vRcR0$default);
                    if (!(composer2.getApplier() instanceof Applier)) {
                        ComposablesKt.invalidApplier();
                    }
                    composer2.startReusableNode();
    ...
    public static final Modifier m1527surface8ww4TTg(Modifier modifier, Shape shape, long j, BorderStroke borderStroke, float f) {
        return ClipKt.clip(BackgroundKt.m192backgroundbw27NRU(ShadowKt.m2358shadows4CzXII$default(modifier, f, shape, false, 0L, 0L, 24, null).then(borderStroke != null ? BorderKt.border(Modifier.INSTANCE, borderStroke, shape) : Modifier.INSTANCE), j, shape), shape);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surfaceColorAtElevation-CLU3JFs, reason: not valid java name */
    public static final long m1528surfaceColorAtElevationCLU3JFs(long j, float f, Composer composer, int i) {
        ...
        if (Color.m2712equalsimpl0(j, MaterialTheme.INSTANCE.getColorScheme(composer, 6).m1105getSurface0d7_KjU())) {
            j = ColorSchemeKt.m1146surfaceColorAtElevation3ABfNKs(MaterialTheme.INSTANCE.getColorScheme(composer, 6), f);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
