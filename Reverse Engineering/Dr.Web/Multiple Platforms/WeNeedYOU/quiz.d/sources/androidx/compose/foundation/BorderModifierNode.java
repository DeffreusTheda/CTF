...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private BorderModifierNode(float f, Brush brushParameter, Shape shapeParameter) {
        ...
        this.drawWithCacheModifierNode = (CacheDrawModifierNode) delegate(DrawModifierKt.CacheDrawModifierNode(new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.BorderModifierNode$drawWithCacheModifierNode$1
            ...
            public final DrawResult invoke(CacheDrawScope CacheDrawModifierNode) {
                ...
                DrawResult m207drawRectBorderNsqcLGU;
                DrawResult m210drawRoundRectBorderJqoCqck;
                DrawResult drawGenericBorder;
                Intrinsics.checkNotNullParameter(CacheDrawModifierNode, "$this$CacheDrawModifierNode");
                if (CacheDrawModifierNode.mo360toPx0680j_4(BorderModifierNode.this.getWidth()) < 0.0f || Size.m2514getMinDimensionimpl(CacheDrawModifierNode.m2352getSizeNHjbRc()) <= 0.0f) {
                    drawContentWithoutBorder = BorderKt.drawContentWithoutBorder(CacheDrawModifierNode);
                    return drawContentWithoutBorder;
                }
                float f2 = 2;
                float min = Math.min(Dp.m5022equalsimpl0(BorderModifierNode.this.getWidth(), Dp.INSTANCE.m5035getHairlineD9Ej5fM()) ? 1.0f : (float) Math.ceil(CacheDrawModifierNode.mo360toPx0680j_4(BorderModifierNode.this.getWidth())), (float) Math.ceil(Size.m2514getMinDimensionimpl(CacheDrawModifierNode.m2352getSizeNHjbRc()) / f2));
                float f3 = min / f2;
                long Offset = OffsetKt.Offset(f3, f3);
                long Size = SizeKt.Size(Size.m2515getWidthimpl(CacheDrawModifierNode.m2352getSizeNHjbRc()) - min, Size.m2512getHeightimpl(CacheDrawModifierNode.m2352getSizeNHjbRc()) - min);
                boolean z = f2 * min > Size.m2514getMinDimensionimpl(CacheDrawModifierNode.m2352getSizeNHjbRc());
                Outline mo242createOutlinePq9zytI = BorderModifierNode.this.getShape().mo242createOutlinePq9zytI(CacheDrawModifierNode.m2352getSizeNHjbRc(), CacheDrawModifierNode.getLayoutDirection(), CacheDrawModifierNode);
                if (mo242createOutlinePq9zytI instanceof Outline.Generic) {
                    BorderModifierNode borderModifierNode = BorderModifierNode.this;
                    drawGenericBorder = borderModifierNode.drawGenericBorder(CacheDrawModifierNode, borderModifierNode.getBrush(), (Outline.Generic) mo242createOutlinePq9zytI, z, min);
                    return drawGenericBorder;
                }
                if (mo242createOutlinePq9zytI instanceof Outline.Rounded) {
                    BorderModifierNode borderModifierNode2 = BorderModifierNode.this;
                    m210drawRoundRectBorderJqoCqck = borderModifierNode2.m210drawRoundRectBorderJqoCqck(CacheDrawModifierNode, borderModifierNode2.getBrush(), (Outline.Rounded) mo242createOutlinePq9zytI, Offset, Size, z, min);
                    return m210drawRoundRectBorderJqoCqck;
                }
                if (!(mo242createOutlinePq9zytI instanceof Outline.Rectangle)) {
                    throw new NoWhenBranchMatchedException();
                }
                m207drawRectBorderNsqcLGU = BorderKt.m207drawRectBorderNsqcLGU(CacheDrawModifierNode, BorderModifierNode.this.getBrush(), Offset, Size, z, min);
                return m207drawRectBorderNsqcLGU;
            }
        }));
    }
    ...
    public final void m212setWidth0680j_4(float f) {
        if (Dp.m5022equalsimpl0(this.width, f)) {
            return;
        }
        this.width = f;
    ...
    */
    ...
    public final DrawResult m210drawRoundRectBorderJqoCqck(CacheDrawScope cacheDrawScope, final Brush brush, Outline.Rounded rounded, final long j, final long j2, final boolean z, final float f) {
        final Path createRoundRectPath;
        if (RoundRectKt.isSimple(rounded.getRoundRect())) {
            final long m2496getTopLeftCornerRadiuskKHJgLs = rounded.getRoundRect().m2496getTopLeftCornerRadiuskKHJgLs();
            final float f2 = f / 2;
            ...
            return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$1
                ...
                public final void invoke2(ContentDrawScope onDrawWithContent) {
                    long m208shrinkKibmq7A;
                    Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                    onDrawWithContent.drawContent();
                    if (z) {
                        DrawScope.CC.m3265drawRoundRectZuiqVtQ$default(onDrawWithContent, brush, 0L, 0L, m2496getTopLeftCornerRadiuskKHJgLs, 0.0f, null, null, 0, 246, null);
                        return;
                    }
                    float m2421getXimpl = CornerRadius.m2421getXimpl(m2496getTopLeftCornerRadiuskKHJgLs);
                    float f3 = f2;
                    if (m2421getXimpl < f3) {
                        ContentDrawScope contentDrawScope = onDrawWithContent;
                        float f4 = f;
                        float m2515getWidthimpl = Size.m2515getWidthimpl(onDrawWithContent.mo3184getSizeNHjbRc()) - f;
                        float m2512getHeightimpl = Size.m2512getHeightimpl(onDrawWithContent.mo3184getSizeNHjbRc()) - f;
                        int m2699getDifferencertfAjoo = ClipOp.INSTANCE.m2699getDifferencertfAjoo();
                        Brush brush2 = brush;
                        long j3 = m2496getTopLeftCornerRadiuskKHJgLs;
                        DrawContext drawContext = contentDrawScope.getDrawContext();
                        long mo3190getSizeNHjbRc = drawContext.mo3190getSizeNHjbRc();
                        drawContext.getCanvas().save();
                        drawContext.getTransform().mo3193clipRectN_I0leg(f4, f4, m2515getWidthimpl, m2512getHeightimpl, m2699getDifferencertfAjoo);
                        DrawScope.CC.m3265drawRoundRectZuiqVtQ$default(contentDrawScope, brush2, 0L, 0L, j3, 0.0f, null, null, 0, 246, null);
                    ...
                    long j4 = j;
                    long j5 = j2;
                    m208shrinkKibmq7A = BorderKt.m208shrinkKibmq7A(m2496getTopLeftCornerRadiuskKHJgLs, f3);
                    DrawScope.CC.m3265drawRoundRectZuiqVtQ$default(onDrawWithContent, brush3, j4, j5, m208shrinkKibmq7A, 0.0f, stroke, null, 0, 208, null);
                }
            });
        }
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderModifierNode$drawRoundRectBorder$2
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.CC.m3259drawPathGBMwjPU$default(onDrawWithContent, Path.this, brush, 0.0f, null, null, 0, 60, null);
            }
        });
    }
}
