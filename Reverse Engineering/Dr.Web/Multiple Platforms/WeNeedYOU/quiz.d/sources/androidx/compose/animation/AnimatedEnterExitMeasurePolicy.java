...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo44measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
        ...
        while (it.hasNext()) {
            arrayList.add(((Measurable) it.next()).mo3967measureBRTryo0(j));
        }
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5169boximpl(IntSizeKt.IntSize(width3, height3)));
        return MeasureScope.CC.layout$default(measure, width3, height3, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedEnterExitMeasurePolicy$measure$1
