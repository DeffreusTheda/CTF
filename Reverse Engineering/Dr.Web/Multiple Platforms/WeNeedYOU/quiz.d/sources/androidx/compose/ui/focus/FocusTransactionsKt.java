...
public final class FocusTransactionsKt {
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        ...
        int i = WhenMappings.$EnumSwitchMapping$0[m2397performCustomRequestFocusMxy_nc0(focusTargetNode, FocusDirection.INSTANCE.m2374getEnterdhqQ8s()).ordinal()];
        if (i == 1) {
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (i2 == 4) {
            ...
            int m4184constructorimpl2 = NodeKind.m4184constructorimpl(1024);
                    ...
                    while (parent2 != null) {
                        if ((parent2.getKindSet() & m4184constructorimpl2) != 0) {
                            ...
                            while (node3 != null) {
                                ...
                                if ((node3.getKindSet() & m4184constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                                    int i3 = 0;
    ...
    public static final CustomDestinationResult m2397performCustomRequestFocusMxy_nc0(FocusTargetNode performCustomRequestFocus, int i) {
        Modifier.Node node;
        NodeChain nodes;
        ...
        if (i2 == 3) {
            ...
            if (activeChild != null) {
                return m2394performCustomClearFocusMxy_nc0(activeChild, i);
            }
            throw new IllegalStateException("Required value was null.".toString());
        }
        if (i2 == 4) {
            ...
            if (i4 == 1) {
                return m2395performCustomEnterMxy_nc0(focusTargetNode2, i);
            }
            if (i4 == 2) {
                return CustomDestinationResult.Cancelled;
            }
            if (i4 == 3) {
                return m2397performCustomRequestFocusMxy_nc0(focusTargetNode2, i);
            }
            if (i4 != 4) {
                throw new NoWhenBranchMatchedException();
            }
            CustomDestinationResult m2397performCustomRequestFocusMxy_nc0 = m2397performCustomRequestFocusMxy_nc0(focusTargetNode2, i);
            CustomDestinationResult customDestinationResult = m2397performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None ? m2397performCustomRequestFocusMxy_nc0 : null;
            return customDestinationResult == null ? m2395performCustomEnterMxy_nc0(focusTargetNode2, i) : customDestinationResult;
        }
        throw new NoWhenBranchMatchedException();
    }

    /* renamed from: performCustomClearFocus-Mxy_nc0, reason: not valid java name */
    public static final CustomDestinationResult m2394performCustomClearFocusMxy_nc0(FocusTargetNode performCustomClearFocus, int i) {
        ...
        if (i2 != 1) {
            ...
            if (i2 == 3) {
                ...
                CustomDestinationResult m2394performCustomClearFocusMxy_nc0 = m2394performCustomClearFocusMxy_nc0(activeChild, i);
                if (m2394performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                    m2394performCustomClearFocusMxy_nc0 = null;
                }
                return m2394performCustomClearFocusMxy_nc0 == null ? m2396performCustomExitMxy_nc0(performCustomClearFocus, i) : m2394performCustomClearFocusMxy_nc0;
            }
            if (i2 != 4) {
                throw new NoWhenBranchMatchedException();
            }
    ...
    private static final CustomDestinationResult m2395performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2362boximpl(i));
    ...
    private static final CustomDestinationResult m2396performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i) {
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester invoke = focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2362boximpl(i));
                if (invoke != FocusRequester.INSTANCE.getDefault()) {
                    if (invoke == FocusRequester.INSTANCE.getCancel()) {
                        return CustomDestinationResult.Cancelled;
                    }
