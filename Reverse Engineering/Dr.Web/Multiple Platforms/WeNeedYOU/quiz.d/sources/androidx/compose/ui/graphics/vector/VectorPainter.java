...
public final class VectorPainter extends Painter {
    ...
    private final MutableState size = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2503boximpl(Size.INSTANCE.m2524getZeroNHjbRc()), null, 2, null);
    ...
    public final long m3362getSizeNHjbRc$ui_release() {
        return ((Size) this.size.getValue()).getPackedValue();
    }

    /* renamed from: setSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m3363setSizeuvyYCjk$ui_release(long j) {
        this.size.setValue(Size.m2503boximpl(j));
    }
    ...
    public long getIntrinsicSize() {
        return m3362getSizeNHjbRc$ui_release();
    }
