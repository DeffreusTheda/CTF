...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        ...
        node.m589setMinWidth0680j_4(this.minWidth);
        node.m588setMinHeight0680j_4(this.minHeight);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m5015boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m5015boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5022equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && Dp.m5022equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (Dp.m5023hashCodeimpl(this.minWidth) * 31) + Dp.m5023hashCodeimpl(this.minHeight);
    }
}
