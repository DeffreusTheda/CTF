...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i, List<TabPosition> list) {
        int mo354roundToPx0680j_4 = density.mo354roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m1552getRightD9Ej5fM()) + i;
        int maxValue = mo354roundToPx0680j_4 - this.scrollState.getMaxValue();
        return RangesKt.coerceIn(density.mo354roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo354roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, RangesKt.coerceAtLeast(mo354roundToPx0680j_4 - maxValue, 0));
    }
}
