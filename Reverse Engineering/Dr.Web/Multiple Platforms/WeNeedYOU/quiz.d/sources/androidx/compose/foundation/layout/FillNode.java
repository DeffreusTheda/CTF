...
final class FillNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        if (Constraints.m4957getHasBoundedWidthimpl(j) && this.direction != Direction.Vertical) {
            m4963getMinWidthimpl = RangesKt.coerceIn(MathKt.roundToInt(Constraints.m4961getMaxWidthimpl(j) * this.fraction), Constraints.m4963getMinWidthimpl(j), Constraints.m4961getMaxWidthimpl(j));
            m4961getMaxWidthimpl = m4963getMinWidthimpl;
        } else {
            m4963getMinWidthimpl = Constraints.m4963getMinWidthimpl(j);
            m4961getMaxWidthimpl = Constraints.m4961getMaxWidthimpl(j);
        }
        if (Constraints.m4956getHasBoundedHeightimpl(j) && this.direction != Direction.Horizontal) {
            i = RangesKt.coerceIn(MathKt.roundToInt(Constraints.m4960getMaxHeightimpl(j) * this.fraction), Constraints.m4962getMinHeightimpl(j), Constraints.m4960getMaxHeightimpl(j));
            m4960getMaxHeightimpl = i;
        } else {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(ConstraintsKt.Constraints(m4963getMinWidthimpl, m4961getMaxWidthimpl, i, m4960getMaxHeightimpl));
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FillNode$measure$1
            {
                super(1);
            }
