...
final class CombinedClickableNode extends AbstractClickableNode {
    ...
    public final void m243updatecJG_KMw(MutableInteractionSource interactionSource, boolean enabled, String onClickLabel, Role role, Function0<Unit> onClick, String onLongClickLabel, Function0<Unit> onLongClick, Function0<Unit> onDoubleClick) {
        Intrinsics.checkNotNullParameter(interactionSource, "interactionSource");
        Intrinsics.checkNotNullParameter(onClick, "onClick");
        ...
        m178updateCommonXHw0xAI(interactionSource, enabled, onClickLabel, role, onClick);
        getClickableSemanticsNode().m238updateUMe6uN4(enabled, onClickLabel, role, onClick, onLongClickLabel, onLongClick);
