...
public final class HitTestResult implements List<Modifier.Node>, KMappedMarker {
    ...
    public final boolean hasHit() {
        long m4102findBestHitDistanceptXAw2c = m4102findBestHitDistanceptXAw2c();
        return DistanceAndInLayer.m4097getDistanceimpl(m4102findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m4099isInLayerimpl(m4102findBestHitDistanceptXAw2c);
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float distanceFromEdge, boolean isInLayer) {
        ...
        return DistanceAndInLayer.m4093compareToS_HNhKs(m4102findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0;
    }

    /* renamed from: findBestHitDistance-ptXAw2c, reason: not valid java name */
    private final long m4102findBestHitDistanceptXAw2c() {
        long DistanceAndInLayer;
        ...
        if (i <= lastIndex) {
            while (true) {
                long m4094constructorimpl = DistanceAndInLayer.m4094constructorimpl(this.distanceFromEdgeAndInLayer[i]);
                if (DistanceAndInLayer.m4093compareToS_HNhKs(m4094constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m4094constructorimpl;
                }
                if (DistanceAndInLayer.m4097getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m4099isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final void speculativeHit(Modifier.Node node, float distanceFromEdge, boolean isInLayer, Function0<Unit> childHitTest) {
        ...
        hitInMinimumTouchTarget(node, distanceFromEdge, isInLayer, childHitTest);
        if (this.hitDepth + 1 < CollectionsKt.getLastIndex(hitTestResult) && DistanceAndInLayer.m4093compareToS_HNhKs(m4102findBestHitDistanceptXAw2c, m4102findBestHitDistanceptXAw2c()) > 0) {
