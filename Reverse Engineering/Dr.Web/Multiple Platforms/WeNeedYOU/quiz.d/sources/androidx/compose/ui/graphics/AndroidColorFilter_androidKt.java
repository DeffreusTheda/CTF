...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m2554actualTintColorFilterxETnrds(long j, int i) {
        PorterDuffColorFilter porterDuffColorFilter;
        if (Build.VERSION.SDK_INT >= 29) {
            porterDuffColorFilter = BlendModeColorFilterHelper.INSTANCE.m2657BlendModeColorFilterxETnrds(j, i);
        } else {
            porterDuffColorFilter = new PorterDuffColorFilter(ColorKt.m2765toArgb8_81llA(j), AndroidBlendMode_androidKt.m2539toPorterDuffModes9anfk8(i));
        }
        return new ColorFilter(porterDuffColorFilter);
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc, reason: not valid java name */
    public static final ColorFilter m2552actualColorMatrixColorFilterjHGOpc(float[] colorMatrix) {
        Intrinsics.checkNotNullParameter(colorMatrix, "colorMatrix");
        return new ColorFilter(new ColorMatrixColorFilter(colorMatrix));
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final ColorFilter m2553actualLightingColorFilterOWjLjI(long j, long j2) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m2765toArgb8_81llA(j), ColorKt.m2765toArgb8_81llA(j2)));
    }
}
