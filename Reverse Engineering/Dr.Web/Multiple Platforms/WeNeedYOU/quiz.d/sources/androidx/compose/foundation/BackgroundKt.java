...
public final class BackgroundKt {
    ...
    public static /* synthetic */ Modifier m193backgroundbw27NRU$default(Modifier modifier, long j, Shape shape, int i, Object obj) {
        if ((i & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m192backgroundbw27NRU(modifier, j, shape);
    }
    ...
    public static final Modifier m192backgroundbw27NRU(Modifier background, final long j, final Shape shape) {
        ...
        return background.then(new BackgroundElement(j, null, 1.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo inspectorInfo) {
                Intrinsics.checkNotNullParameter(inspectorInfo, "$this$null");
                inspectorInfo.setName("background");
                inspectorInfo.setValue(Color.m2701boximpl(j));
                inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m2701boximpl(j));
                inspectorInfo.getProperties().set("shape", shape);
            }
