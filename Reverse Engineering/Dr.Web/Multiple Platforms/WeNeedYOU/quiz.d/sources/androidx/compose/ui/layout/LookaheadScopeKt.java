...
public final class LookaheadScopeKt {
            ...
            LookaheadScope(ComposableLambdaKt.composableLambda(startRestartGroup, 1705879204, true, new Function3<LookaheadScope, Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadLayout$1
                ...
                public final void invoke(LookaheadScope LookaheadScope, Composer composer2, int i5) {
                    ...
                    if ((i5 & 91) != 18 || !composer2.getSkipping()) {
                        ...
                        modifierMaterializerOf.invoke(SkippableUpdater.m2309boximpl(SkippableUpdater.m2310constructorimpl(composer2)), composer2, 0);
    ...
    public static final void LookaheadScope(final Function3<? super LookaheadScope, ? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        ...
        if ((i2 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            Updater.m2322initimpl(m2318constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$1
            ...
            Updater.m2325setimpl(m2318constructorimpl, lookaheadScopeImpl, new Function2<LayoutNode, LookaheadScopeImpl, Unit>() { // from class: androidx.compose.ui.layout.LookaheadScopeKt$LookaheadScope$2$2
                @Override // kotlin.jvm.functions.Function2
