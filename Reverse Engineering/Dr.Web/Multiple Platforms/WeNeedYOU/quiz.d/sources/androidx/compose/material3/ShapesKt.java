...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        ...
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        Intrinsics.checkNotNullParameter(cornerBasedShape, "<this>");
        float f = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), null, null, CornerSizeKt.m773CornerSize0680j_4(Dp.m5017constructorimpl(f)), 6, null);
    }
}
