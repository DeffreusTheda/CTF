...
public final class VertexMode {
    ...
    private static final int Triangles = m3106constructorimpl(0);
    private static final int TriangleStrip = m3106constructorimpl(1);
    private static final int TriangleFan = m3106constructorimpl(2);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ VertexMode m3105boximpl(int i) {
    ...
    public static String m3110toStringimpl(int i) {
        return m3108equalsimpl0(i, Triangles) ? "Triangles" : m3108equalsimpl0(i, TriangleStrip) ? "TriangleStrip" : m3108equalsimpl0(i, TriangleFan) ? "TriangleFan" : "Unknown";
    }
}
