...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke border, Shape shape) {
        ...
        return m206borderziNgDLE(modifier, border.getWidth(), border.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m205borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m204borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m204borderxT4_qwU(Modifier border, float f, long j, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return m206borderziNgDLE(border, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m206borderziNgDLE(Modifier border, float f, Brush brush, Shape shape) {
        Intrinsics.checkNotNullParameter(border, "$this$border");
    ...
    public static final DrawResult m207drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long m2462getZeroF1C5BW0 = z ? Offset.INSTANCE.m2462getZeroF1C5BW0() : j;
        final long m2352getSizeNHjbRc = z ? cacheDrawScope.m2352getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope onDrawWithContent) {
                Intrinsics.checkNotNullParameter(onDrawWithContent, "$this$onDrawWithContent");
                onDrawWithContent.drawContent();
                DrawScope.CC.m3263drawRectAsUm42w$default(onDrawWithContent, Brush.this, m2462getZeroF1C5BW0, m2352getSizeNHjbRc, 0.0f, stroke, null, 0, LocationRequestCompat.QUALITY_LOW_POWER, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo2580opN5in7k0(path, Path, PathOperation.INSTANCE.m3005getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m208shrinkKibmq7A(roundRect.m2496getTopLeftCornerRadiuskKHJgLs(), f), m208shrinkKibmq7A(roundRect.m2497getTopRightCornerRadiuskKHJgLs(), f), m208shrinkKibmq7A(roundRect.m2495getBottomRightCornerRadiuskKHJgLs(), f), m208shrinkKibmq7A(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m208shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m2421getXimpl(j) - f), Math.max(0.0f, CornerRadius.m2422getYimpl(j) - f));
    }
}
