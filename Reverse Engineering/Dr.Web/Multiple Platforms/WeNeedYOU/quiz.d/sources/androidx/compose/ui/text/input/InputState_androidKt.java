...
public final class InputState_androidKt {
    public static final ExtractedText toExtractedText(TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m4530getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m4529getMaximpl(textFieldValue.getSelection());
