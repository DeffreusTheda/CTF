...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m4617equalsimpl0(font.getLoadingStrategy(), FontLoadingStrategy.INSTANCE.m4621getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList3.add(TuplesKt.to(font2.getWeight(), FontStyle.m4627boximpl(font2.getStyle())));
        }
        ...
        for (int i4 = 0; i4 < size4; i4++) {
            ...
            int m4633unboximpl = ((FontStyle) pair.component2()).m4633unboximpl();
            firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m4626matchFontRetOiIg(fonts, fontWeight, m4633unboximpl), new TypefaceRequest(fontFamily, fontWeight, m4633unboximpl, FontSynthesis.INSTANCE.m4645getAllGVVA2EU(), platformFontLoader.getCacheKey(), null), this.asyncTypefaceCache, platformFontLoader, new Function1<TypefaceRequest, Unit>() { // from class: androidx.compose.ui.text.font.FontListFontFamilyTypefaceAdapter$preload$2$1
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        ...
        firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m4626matchFontRetOiIg(((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m4673getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, createDefaultTypeface);
        List list = (List) firstImmediatelyAvailable.component1();
