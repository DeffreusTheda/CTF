...
public final class DatePickerColors {
    ...
    public final State<Color> dayContentColor$material3_release(boolean z, boolean z2, boolean z3, boolean z4, Composer composer, int i) {
        long j;
        State<Color> m101animateColorAsStateeuL9pac;
        ...
        if (z3) {
            ...
            m101animateColorAsStateeuL9pac = SnapshotStateKt.rememberUpdatedState(Color.m2701boximpl(j2), composer, 0);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(379006329);
            ComposerKt.sourceInformation(composer, "596@26492L134");
            m101animateColorAsStateeuL9pac = SingleValueAnimationKt.m101animateColorAsStateeuL9pac(j2, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> dayContainerColor$material3_release(boolean z, boolean z2, boolean z3, Composer composer, int i) {
        long m2746getTransparent0d7_KjU;
        ...
        if (z) {
            m2746getTransparent0d7_KjU = z2 ? this.selectedDayContainerColor : this.disabledSelectedDayContainerColor;
        } else {
            m2746getTransparent0d7_KjU = Color.INSTANCE.m2746getTransparent0d7_KjU();
        }
        long j = m2746getTransparent0d7_KjU;
        if (z3) {
            composer.startReplaceableGroup(1577406023);
            ComposerKt.sourceInformation(composer, "622@27316L134");
            rememberUpdatedState = SingleValueAnimationKt.m101animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(1577406187);
            ComposerKt.sourceInformation(composer, "627@27480L28");
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2701boximpl(j), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> yearContentColor$material3_release(boolean z, boolean z2, Composer composer, int i) {
        ...
        State<Color> m101animateColorAsStateeuL9pac = SingleValueAnimationKt.m101animateColorAsStateeuL9pac(j, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> yearContainerColor$material3_release(boolean z, Composer composer, int i) {
        ...
        State<Color> m101animateColorAsStateeuL9pac = SingleValueAnimationKt.m101animateColorAsStateeuL9pac(z ? this.selectedYearContainerColor : Color.INSTANCE.m2746getTransparent0d7_KjU(), AnimationSpecKt.tween$default(100, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.containerColor, datePickerColors.containerColor) && Color.m2712equalsimpl0(this.titleContentColor, datePickerColors.titleContentColor) && Color.m2712equalsimpl0(this.headlineContentColor, datePickerColors.headlineContentColor) && Color.m2712equalsimpl0(this.weekdayContentColor, datePickerColors.weekdayContentColor) && Color.m2712equalsimpl0(this.subheadContentColor, datePickerColors.subheadContentColor) && Color.m2712equalsimpl0(this.yearContentColor, datePickerColors.yearContentColor) && Color.m2712equalsimpl0(this.currentYearContentColor, datePickerColors.currentYearContentColor) && Color.m2712equalsimpl0(this.selectedYearContentColor, datePickerColors.selectedYearContentColor) && Color.m2712equalsimpl0(this.selectedYearContainerColor, datePickerColors.selectedYearContainerColor) && Color.m2712equalsimpl0(this.dayContentColor, datePickerColors.dayContentColor) && Color.m2712equalsimpl0(this.disabledDayContentColor, datePickerColors.disabledDayContentColor) && Color.m2712equalsimpl0(this.selectedDayContentColor, datePickerColors.selectedDayContentColor) && Color.m2712equalsimpl0(this.disabledSelectedDayContentColor, datePickerColors.disabledSelectedDayContentColor) && Color.m2712equalsimpl0(this.selectedDayContainerColor, datePickerColors.selectedDayContainerColor) && Color.m2712equalsimpl0(this.disabledSelectedDayContainerColor, datePickerColors.disabledSelectedDayContainerColor) && Color.m2712equalsimpl0(this.todayContentColor, datePickerColors.todayContentColor) && Color.m2712equalsimpl0(this.todayDateBorderColor, datePickerColors.todayDateBorderColor) && Color.m2712equalsimpl0(this.dayInSelectionRangeContainerColor, datePickerColors.dayInSelectionRangeContainerColor) && Color.m2712equalsimpl0(this.dayInSelectionRangeContentColor, datePickerColors.dayInSelectionRangeContentColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((Color.m2718hashCodeimpl(this.containerColor) * 31) + Color.m2718hashCodeimpl(this.titleContentColor)) * 31) + Color.m2718hashCodeimpl(this.headlineContentColor)) * 31) + Color.m2718hashCodeimpl(this.weekdayContentColor)) * 31) + Color.m2718hashCodeimpl(this.subheadContentColor)) * 31) + Color.m2718hashCodeimpl(this.yearContentColor)) * 31) + Color.m2718hashCodeimpl(this.currentYearContentColor)) * 31) + Color.m2718hashCodeimpl(this.selectedYearContentColor)) * 31) + Color.m2718hashCodeimpl(this.selectedYearContainerColor)) * 31) + Color.m2718hashCodeimpl(this.dayContentColor)) * 31) + Color.m2718hashCodeimpl(this.disabledDayContentColor)) * 31) + Color.m2718hashCodeimpl(this.selectedDayContentColor)) * 31) + Color.m2718hashCodeimpl(this.disabledSelectedDayContentColor)) * 31) + Color.m2718hashCodeimpl(this.selectedDayContainerColor)) * 31) + Color.m2718hashCodeimpl(this.disabledSelectedDayContainerColor)) * 31) + Color.m2718hashCodeimpl(this.todayContentColor)) * 31) + Color.m2718hashCodeimpl(this.todayDateBorderColor)) * 31) + Color.m2718hashCodeimpl(this.dayInSelectionRangeContainerColor)) * 31) + Color.m2718hashCodeimpl(this.dayInSelectionRangeContentColor);
    }
}
