...
public final class XmlVectorParser_androidKt {
    ...
    static /* synthetic */ int m3370getStrokeLineCapCSYIeUk$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeCap.INSTANCE.m3066getButtKaPHkGw();
        }
        return m3369getStrokeLineCapCSYIeUk(i, i2);
    }

    /* renamed from: getStrokeLineCap-CSYIeUk, reason: not valid java name */
    private static final int m3369getStrokeLineCapCSYIeUk(int i, int i2) {
        if (i == 0) {
            return StrokeCap.INSTANCE.m3066getButtKaPHkGw();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeCap.INSTANCE.m3068getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m3067getRoundKaPHkGw();
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA$default, reason: not valid java name */
    static /* synthetic */ int m3372getStrokeLineJoinkLtJ_vA$default(int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i2 = StrokeJoin.INSTANCE.m3077getMiterLxFBmk8();
        }
        return m3371getStrokeLineJoinkLtJ_vA(i, i2);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3371getStrokeLineJoinkLtJ_vA(int i, int i2) {
        if (i == 0) {
            return StrokeJoin.INSTANCE.m3077getMiterLxFBmk8();
        }
        if (i != 1) {
            return i != 2 ? i2 : StrokeJoin.INSTANCE.m3076getBevelLxFBmk8();
        }
        return StrokeJoin.INSTANCE.m3078getRoundLxFBmk8();
    }
    ...
    public static final ImageVector.Builder createVectorImageBuilder(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs) {
        long m2747getUnspecified0d7_KjU;
        int m2653getSrcIn0nO6VwU;
        Intrinsics.checkNotNullParameter(androidVectorParser, "<this>");
        Intrinsics.checkNotNullParameter(res, "res");
        Intrinsics.checkNotNullParameter(attrs, "attrs");
        ...
        if (obtainAttributes.hasValue(AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
            ...
            if (typedValue.type == 2) {
                m2747getUnspecified0d7_KjU = Color.INSTANCE.m2747getUnspecified0d7_KjU();
            } else {
                ...
                if (namedColorStateList != null) {
                    m2747getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                } else {
                    m2747getUnspecified0d7_KjU = Color.INSTANCE.m2747getUnspecified0d7_KjU();
                }
            }
        ...
        long j = m2747getUnspecified0d7_KjU;
        ...
        if (i == -1) {
            m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2653getSrcIn0nO6VwU();
        } else if (i == 3) {
            m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2655getSrcOver0nO6VwU();
        } else if (i == 5) {
            m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2653getSrcIn0nO6VwU();
        } else if (i == 9) {
            m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2652getSrcAtop0nO6VwU();
        } else {
            switch (i) {
                case 14:
                    m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2644getModulate0nO6VwU();
                    break;
                case 15:
                    m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2649getScreen0nO6VwU();
                    break;
                case 16:
                    m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2647getPlus0nO6VwU();
                    break;
                default:
                    m2653getSrcIn0nO6VwU = BlendMode.INSTANCE.m2653getSrcIn0nO6VwU();
                    break;
        ...
        int i2 = m2653getSrcIn0nO6VwU;
        float m5017constructorimpl = Dp.m5017constructorimpl(dimension / res.getDisplayMetrics().density);
        float m5017constructorimpl2 = Dp.m5017constructorimpl(dimension2 / res.getDisplayMetrics().density);
        obtainAttributes.recycle();
        return new ImageVector.Builder(null, m5017constructorimpl, m5017constructorimpl2, namedFloat, namedFloat2, j, i2, namedBoolean, 1, null);
    }
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources res, Resources.Theme theme, AttributeSet attrs, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        int m3369getStrokeLineCapCSYIeUk = m3369getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.INSTANCE.m3066getButtKaPHkGw());
        int m3371getStrokeLineJoinkLtJ_vA = m3371getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", AndroidVectorResources.INSTANCE.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.INSTANCE.m3076getBevelLxFBmk8());
        ...
        builder.m3349addPathoIyEayM(addPathNodes, namedInt == 0 ? companion.m2997getNonZeroRgk1Os() : companion.m2996getEvenOddRgk1Os(), str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3369getStrokeLineCapCSYIeUk, m3371getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
    }
