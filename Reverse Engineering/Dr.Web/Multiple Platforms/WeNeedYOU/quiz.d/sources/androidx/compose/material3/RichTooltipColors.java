...
public final class RichTooltipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.containerColor, richTooltipColors.containerColor) && Color.m2712equalsimpl0(this.contentColor, richTooltipColors.contentColor) && Color.m2712equalsimpl0(this.titleContentColor, richTooltipColors.titleContentColor) && Color.m2712equalsimpl0(this.actionContentColor, richTooltipColors.actionContentColor);
    }

    public int hashCode() {
        return (((((Color.m2718hashCodeimpl(this.containerColor) * 31) + Color.m2718hashCodeimpl(this.contentColor)) * 31) + Color.m2718hashCodeimpl(this.titleContentColor)) * 31) + Color.m2718hashCodeimpl(this.actionContentColor);
    }
}
