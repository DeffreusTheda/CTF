...
public final class AndroidPopup_androidKt$SimpleStack$1 implements MeasurePolicy {
    ...
    public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
        ...
        if (size == 1) {
            ...
            return MeasureScope.CC.layout$default(Layout, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$2
                {
                    super(1);
                }
        ...
        for (int i4 = 0; i4 < size2; i4++) {
            arrayList.add(measurables.get(i4).mo3967measureBRTryo0(j));
        }
        ...
        return MeasureScope.CC.layout$default(Layout, i, i2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidPopup_androidKt$SimpleStack$1$measure$3
