...
public final class FocusTargetNode extends Modifier.Node implements FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int m4184constructorimpl = NodeKind.m4184constructorimpl(2048);
        int m4184constructorimpl2 = NodeKind.m4184constructorimpl(1024);
        Modifier.Node node = focusTargetNode.getNode();
        int i = m4184constructorimpl | m4184constructorimpl2;
            ...
            if ((requireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & i) != 0) {
                while (node2 != null) {
                    if ((node2.getKindSet() & i) != 0) {
                        if (node2 != node && (node2.getKindSet() & m4184constructorimpl2) != 0) {
                            break loop0;
                        }
                        if ((node2.getKindSet() & m4184constructorimpl) != 0) {
    ...
    public final void m2392fetchCustomEnteraToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2362boximpl(focusDirection));
    ...
    public final void m2393fetchCustomExitaToIllA$ui_release(int focusDirection, Function1<? super FocusRequester, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ...
        try {
            FocusRequester invoke = fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2362boximpl(focusDirection));
            if (invoke != FocusRequester.INSTANCE.getDefault()) {
                block.invoke(invoke);
            }
        } finally {
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int m4184constructorimpl = NodeKind.m4184constructorimpl(4096);
        MutableVector mutableVector = null;
        while (node != 0) {
        ...
        FocusTargetNode focusTargetNode = this;
        int m4184constructorimpl2 = NodeKind.m4184constructorimpl(4096) | NodeKind.m4184constructorimpl(1024);
        if (!focusTargetNode.getNode().getIsAttached()) {
            throw new IllegalStateException("visitAncestors called on an unattached node".toString());
        }
        ...
        while (requireLayoutNode != null) {
            if ((requireLayoutNode.getNodes().getHead().getAggregateChildKindSet() & m4184constructorimpl2) != 0) {
                while (parent != null) {
                    if ((parent.getKindSet() & m4184constructorimpl2) != 0 && (NodeKind.m4184constructorimpl(1024) & parent.getKindSet()) == 0 && parent.getIsAttached()) {
                        int m4184constructorimpl3 = NodeKind.m4184constructorimpl(4096);
                        ...
                        while (delegatingNode != 0) {
                            ...
                            } else if ((delegatingNode.getKindSet() & m4184constructorimpl3) != 0 && (delegatingNode instanceof DelegatingNode)) {
                                Modifier.Node delegate2 = delegatingNode.getDelegate();
                                int i2 = 0;
                                delegatingNode = delegatingNode;
                                while (delegate2 != null) {
                                    if ((delegate2.getKindSet() & m4184constructorimpl3) != 0) {
                                        i2++;
                                        if (i2 == 1) {
