...
public final class AlertDialogKt {
    ...
    private static final float DialogMinWidth = Dp.m5017constructorimpl(280);
    private static final float DialogMaxWidth = Dp.m5017constructorimpl(560);
    ...
    */
    public static final void m1020AlertDialogContent4hvqGtA(final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r23, androidx.compose.ui.Modifier r24, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r25, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r26, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, final androidx.compose.ui.graphics.Shape r28, final long r29, final float r31, final long r32, final long r34, final long r36, final long r38, androidx.compose.runtime.Composer r40, final int r41, final int r42, final int r43) {
        /*
            Method dump skipped, instructions count: 587
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AlertDialogKt.m1020AlertDialogContent4hvqGtA(kotlin.jvm.functions.Function2, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, kotlin.jvm.functions.Function2, androidx.compose.ui.graphics.Shape, long, float, long, long, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* renamed from: AlertDialogFlowRow-ixp7dh8, reason: not valid java name */
    public static final void m1021AlertDialogFlowRowixp7dh8(final float f, final float f2, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                public final MeasureResult mo44measure3p2s80s(final MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    while (it.hasNext()) {
                        Placeable mo3967measureBRTryo0 = it.next().mo3967measureBRTryo0(j);
                        Ref.IntRef intRef7 = intRef6;
                        if (measure_3p2s80s$canAddToCurrentSequence(arrayList6, intRef5, Layout, f, j, mo3967measureBRTryo0)) {
                            intRef = intRef5;
                            intRef2 = intRef4;
                        ...
                        if (!arrayList2.isEmpty()) {
                            intRef8.element += Layout.mo354roundToPx0680j_4(f);
                        }
                        arrayList2.add(mo3967measureBRTryo0);
                        intRef8.element += mo3967measureBRTryo0.getWidth();
                        intRef6 = intRef7;
                        intRef6.element = Math.max(intRef6.element, mo3967measureBRTryo0.getHeight());
                        intRef5 = intRef8;
                    ...
                    final int max = Math.max(intRef3.element, Constraints.m4963getMinWidthimpl(j));
                    int max2 = Math.max(intRef9.element, Constraints.m4962getMinHeightimpl(j));
                    final float f3 = f;
                    return MeasureScope.CC.layout$default(Layout, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1$measure$1
                        ...
                        public final void invoke2(Placeable.PlacementScope layout) {
                            ...
                            for (Object obj : list) {
                                ...
                                int i6 = 0;
                                while (i6 < size) {
                                    iArr[i6] = ((Placeable) list3.get(i6)).getWidth() + (i6 < CollectionsKt.getLastIndex(list3) ? measureScope.mo354roundToPx0680j_4(f4) : 0);
                                    i6++;
                                }
                ...
                private static final boolean measure_3p2s80s$canAddToCurrentSequence(List<Placeable> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, long j, Placeable placeable) {
                    return list.isEmpty() || (intRef.element + measureScope.mo354roundToPx0680j_4(f3)) + placeable.getWidth() <= Constraints.m4961getMaxWidthimpl(j);
                }
                ...
                private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Ref.IntRef intRef, MeasureScope measureScope, float f3, List<Placeable> list2, List<Integer> list3, Ref.IntRef intRef2, List<Integer> list4, Ref.IntRef intRef3, Ref.IntRef intRef4) {
                    ...
                    if (!list5.isEmpty()) {
                        intRef.element += measureScope.mo354roundToPx0680j_4(f3);
                    }
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$2
            ...
            public final void invoke(Composer composer2, int i4) {
                AlertDialogKt.m1021AlertDialogFlowRowixp7dh8(f, f2, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    static {
        float f = 24;
        DialogPadding = PaddingKt.m513PaddingValues0680j_4(Dp.m5017constructorimpl(f));
        float f2 = 16;
        IconPadding = PaddingKt.m517PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5017constructorimpl(f2), 7, null);
        TitlePadding = PaddingKt.m517PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5017constructorimpl(f2), 7, null);
        TextPadding = PaddingKt.m517PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5017constructorimpl(f), 7, null);
    }
}
