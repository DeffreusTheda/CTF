...
public final class MenuTokens {
    ...
    private static final float ListItemContainerHeight = Dp.m5017constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 24.0d;
        ListItemLeadingIconSize = Dp.m5017constructorimpl(f);
        ListItemTrailingIconSize = Dp.m5017constructorimpl(f);
    }
    ...
    public final float m2007getListItemContainerHeightD9Ej5fM() {
    ...
    public final float m2008getListItemLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2009getListItemTrailingIconSizeD9Ej5fM() {
