...
public final class AndroidParagraph implements Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int i, boolean z, long j) {
        ...
        int m4402toLayoutAlignAMY3VfE;
        int m4404toLayoutHyphenationFrequency0_XeFpE;
        int m4403toLayoutBreakStrategyu6PBz3U;
        int m4405toLayoutLineBreakStyle4a2g8L8;
        int m4406toLayoutLineBreakWordStylegvcdTPQ;
        ArrayList arrayList;
        Rect rect;
        ...
        this.ellipsis = z;
        this.constraints = j;
        if (Constraints.m4962getMinHeightimpl(j) != 0 || Constraints.m4963getMinWidthimpl(j) != 0) {
        ...
        m4402toLayoutAlignAMY3VfE = AndroidParagraph_androidKt.m4402toLayoutAlignAMY3VfE(style.m4561getTextAlignbuA522U());
        TextAlign m4561getTextAlignbuA522U = style.m4561getTextAlignbuA522U();
        int i2 = m4561getTextAlignbuA522U == null ? 0 : TextAlign.m4895equalsimpl0(m4561getTextAlignbuA522U.getValue(), TextAlign.INSTANCE.m4901getJustifye0LSkKk()) ? 1 : 0;
        m4404toLayoutHyphenationFrequency0_XeFpE = AndroidParagraph_androidKt.m4404toLayoutHyphenationFrequency0_XeFpE(style.getParagraphStyle().getHyphens());
        LineBreak m4559getLineBreakLgCVezo = style.m4559getLineBreakLgCVezo();
        m4403toLayoutBreakStrategyu6PBz3U = AndroidParagraph_androidKt.m4403toLayoutBreakStrategyu6PBz3U(m4559getLineBreakLgCVezo != null ? LineBreak.Strategy.m4836boximpl(LineBreak.m4827getStrategyfcGXIks(m4559getLineBreakLgCVezo.getMask())) : null);
        LineBreak m4559getLineBreakLgCVezo2 = style.m4559getLineBreakLgCVezo();
        m4405toLayoutLineBreakStyle4a2g8L8 = AndroidParagraph_androidKt.m4405toLayoutLineBreakStyle4a2g8L8(m4559getLineBreakLgCVezo2 != null ? LineBreak.Strictness.m4846boximpl(LineBreak.m4828getStrictnessusljTpc(m4559getLineBreakLgCVezo2.getMask())) : null);
        LineBreak m4559getLineBreakLgCVezo3 = style.m4559getLineBreakLgCVezo();
        m4406toLayoutLineBreakWordStylegvcdTPQ = AndroidParagraph_androidKt.m4406toLayoutLineBreakWordStylegvcdTPQ(m4559getLineBreakLgCVezo3 != null ? LineBreak.WordBreak.m4857boximpl(LineBreak.m4829getWordBreakjp8hJ3c(m4559getLineBreakLgCVezo3.getMask())) : null);
        TextUtils.TruncateAt truncateAt = z ? TextUtils.TruncateAt.END : null;
        TextLayout constructTextLayout = constructTextLayout(m4402toLayoutAlignAMY3VfE, i2, truncateAt, i, m4404toLayoutHyphenationFrequency0_XeFpE, m4403toLayoutBreakStrategyu6PBz3U, m4405toLayoutLineBreakStyle4a2g8L8, m4406toLayoutLineBreakWordStylegvcdTPQ);
        if (z && constructTextLayout.getHeight() > Constraints.m4960getMaxHeightimpl(j) && i > 1) {
            numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m4960getMaxHeightimpl(j));
            if (numberOfLinesThatFitMaxHeight >= 0 && numberOfLinesThatFitMaxHeight != i) {
                constructTextLayout = constructTextLayout(m4402toLayoutAlignAMY3VfE, i2, truncateAt, RangesKt.coerceAtLeast(numberOfLinesThatFitMaxHeight, 1), m4404toLayoutHyphenationFrequency0_XeFpE, m4403toLayoutBreakStrategyu6PBz3U, m4405toLayoutLineBreakStyle4a2g8L8, m4406toLayoutLineBreakWordStylegvcdTPQ);
            }
            this.layout = constructTextLayout;
        } else {
            this.layout = constructTextLayout;
        }
        getTextPaint$ui_text_release().m4772setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
        for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
            shaderBrushSpan.m4791setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
        }
    ...
    public float getWidth() {
        return Constraints.m4961getMaxWidthimpl(this.constraints);
    }
    ...
    public int mo4392getOffsetForPositionk4lQ0M(long position) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2447getYimpl(position)), Offset.m2446getXimpl(position));
    }
    ...
    public final void m4390fillBoundingBoxes8ffj60Q(long range, float[] array, int arrayStart) {
        Intrinsics.checkNotNullParameter(array, "array");
        this.layout.fillBoundingBoxes(TextRange.m4530getMinimpl(range), TextRange.m4529getMaximpl(range), array, arrayStart);
    }
    ...
    public long mo4393getWordBoundaryjx7JFs(int offset) {
    ...
    public void mo4395paintRPmYEkk(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4773setColor8_81llA(color);
    ...
    public void mo4394paintLG529CI(Canvas canvas, long color, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        int m4770getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4770getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4773setColor8_81llA(color);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4771setBlendModes9anfk8(blendMode);
        paint(canvas);
        getTextPaint$ui_text_release().m4771setBlendModes9anfk8(m4770getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-hn5TExg, reason: not valid java name */
    public void mo4396painthn5TExg(Canvas canvas, Brush brush, float alpha, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int blendMode) {
        Intrinsics.checkNotNullParameter(canvas, "canvas");
        Intrinsics.checkNotNullParameter(brush, "brush");
        int m4770getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4770getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4772setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), alpha);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4771setBlendModes9anfk8(blendMode);
