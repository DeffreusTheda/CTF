        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyListMeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyListMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m623invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }

                /* renamed from: invoke-0kLqBqw, reason: not valid java name */
                public final LazyListMeasureResult m623invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i5;
                    int i6;
                    int i7;
                    float spacing;
                    ...
                    CheckScrollableContainerConstraintsKt.m221checkScrollableContainerConstraintsK40F9xA(j, z2 ? Orientation.Vertical : Orientation.Horizontal);
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.mo470calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i6 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.mo471calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i6 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    int i8 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.getTop());
                    int i9 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.getBottom());
                    final int i10 = i8 + i9;
                    final int i11 = i5 + i6;
                    boolean z4 = z2;
                    int i12 = z4 ? i10 : i11;
                    ...
                    final long m4977offsetNN6EwU = ConstraintsKt.m4977offsetNN6EwU(j, -i11, -i10);
                    ...
                    invoke.getItemScope().setMaxSize(Constraints.m4961getMaxWidthimpl(m4977offsetNN6EwU), Constraints.m4960getMaxHeightimpl(m4977offsetNN6EwU));
                    if (z2) {
                    ...
                    final int i14 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(spacing);
                    ...
                    final boolean z7 = z;
                    final int i16 = i7;
                    LazyListMeasuredItemProvider lazyListMeasuredItemProvider = new LazyListMeasuredItemProvider(m4977offsetNN6EwU, z6, invoke, lazyLayoutMeasureScope, itemCount, i14, horizontal6, vertical6, z7, i16, i13, j2) { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1$measuredItemProvider$1
                    ...
                    lazyListState.m633setPremeasureConstraintsBRTryo0$foundation_release(lazyListMeasuredItemProvider.getChildConstraints());
                    ...
                    try {
                        ...
                        try {
                            ...
                            LazyListMeasureResult m627measureLazyListCD5nmq0 = LazyListMeasureKt.m627measureLazyListCD5nmq0(itemCount, lazyListMeasuredItemProvider, i15, i7, i13, i14, updateScrollPositionIfTheFirstItemWasMoved$foundation_release, firstVisibleItemScrollOffset, lazyListState.getScrollToBeConsumed(), m4977offsetNN6EwU, z2, invoke.getHeaderIndexes(), vertical4, horizontal4, z, lazyLayoutMeasureScope2, lazyListState.getPlacementAnimator(), i, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyListState.getPinnedItems(), lazyListState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.LazyListKt$rememberLazyListMeasurePolicy$1$1.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                                ...
                                public final MeasureResult invoke(int i17, int i18, Function1<? super Placeable.PlacementScope, Unit> placement) {
                                    ...
                                    return LazyLayoutMeasureScope.this.layout(ConstraintsKt.m4975constrainWidthK40F9xA(j, i17 + i11), ConstraintsKt.m4974constrainHeightK40F9xA(j, i18 + i10), MapsKt.emptyMap(), placement);
                                }
                            });
                            lazyListState.applyMeasureResult$foundation_release(m627measureLazyListCD5nmq0);
                            return m627measureLazyListCD5nmq0;
                        } finally {
