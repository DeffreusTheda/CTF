...
public final class SheetDefaultsKt {
    private static final float DragHandleVerticalPadding = Dp.m5017constructorimpl(22);
    private static final float BottomSheetMaxWidth = Dp.m5017constructorimpl(640);
    ...
    public static final NestedScrollConnection ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(final SheetState sheetState, final Orientation orientation, final Function1<? super Float, Unit> onFling) {
        ...
        return new NestedScrollConnection() { // from class: androidx.compose.material3.SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1
            ...
            public long mo370onPreScrollOzD1aCk(long available, int source) {
                ...
                if (offsetToFloat < 0.0f && NestedScrollSource.m3739equalsimpl0(source, NestedScrollSource.INSTANCE.m3744getDragWNlRxjI())) {
            ...
            private final float velocityToFloat(long j) {
                return orientation == Orientation.Horizontal ? Velocity.m5242getXimpl(j) : Velocity.m5243getYimpl(j);
            }

            private final float offsetToFloat(long j) {
                return orientation == Orientation.Horizontal ? Offset.m2446getXimpl(j) : Offset.m2447getYimpl(j);
            }
        };
    }
    ...
    public static final SheetState rememberSheetState(boolean z, Function1<? super SheetValue, Boolean> function1, SheetValue sheetValue, boolean z2, Composer composer, int i, int i2) {
        ...
        SheetState sheetState = (SheetState) RememberSaveableKt.m2332rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
