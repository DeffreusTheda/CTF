...
public final class CheckboxKt {
    ...
    private static final float CheckboxSize = Dp.m5017constructorimpl(20);
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:101:0x02bd A[LOOP:0: B:100:0x02bb->B:101:0x02bd, LOOP_END] */
    ...
    */
    ...
    public static final void m1070drawBox1wkBAMs(DrawScope drawScope, long j, long j2, float f, float f2) {
        float f3 = f2 / 2.0f;
        ...
        if (Color.m2712equalsimpl0(j, j2)) {
            DrawScope.CC.m3266drawRoundRectuAw5IA$default(drawScope, j, 0L, SizeKt.Size(m2515getWidthimpl, m2515getWidthimpl), CornerRadiusKt.CornerRadius$default(f, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f4 = m2515getWidthimpl - (2 * f2);
        DrawScope.CC.m3266drawRoundRectuAw5IA$default(drawScope, j, OffsetKt.Offset(f2, f2), SizeKt.Size(f4, f4), CornerRadiusKt.CornerRadius$default(Math.max(0.0f, f - f2), 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 224, null);
        float f5 = m2515getWidthimpl - f2;
        DrawScope.CC.m3266drawRoundRectuAw5IA$default(drawScope, j2, OffsetKt.Offset(f3, f3), SizeKt.Size(f5, f5), CornerRadiusKt.CornerRadius$default(f - f3, 0.0f, 2, null), stroke, 0.0f, null, 0, 224, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: drawCheck-3IgeMak, reason: not valid java name */
    public static final void m1071drawCheck3IgeMak(DrawScope drawScope, long j, float f, float f2, float f3, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f3, 0.0f, StrokeCap.INSTANCE.m3068getSquareKaPHkGw(), 0, null, 26, null);
        float m2515getWidthimpl = Size.m2515getWidthimpl(drawScope.mo3184getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * m2515getWidthimpl, lerp3 * m2515getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(lerp * m2515getWidthimpl, lerp2 * m2515getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * m2515getWidthimpl, m2515getWidthimpl * lerp4);
        ...
        DrawScope.CC.m3260drawPathLG529CI$default(drawScope, checkDrawingCache.getPathToDraw(), j, 0.0f, stroke, null, 0, 52, null);
    }

    static {
        float f = 2;
        CheckboxDefaultPadding = Dp.m5017constructorimpl(f);
        StrokeWidth = Dp.m5017constructorimpl(f);
        RadiusSize = Dp.m5017constructorimpl(f);
    }
}
