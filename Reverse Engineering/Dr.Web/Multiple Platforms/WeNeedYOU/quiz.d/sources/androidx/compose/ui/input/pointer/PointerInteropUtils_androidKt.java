...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m3908toMotionEventScoped4ec7I(PointerEvent toMotionEventScope, long j, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toMotionEventScope, "$this$toMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m3909toMotionEventScopeubNVwUQ(toMotionEventScope, j, block, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I, reason: not valid java name */
    public static final void m3907toCancelMotionEventScoped4ec7I(PointerEvent toCancelMotionEventScope, long j, Function1<? super MotionEvent, Unit> block) {
        Intrinsics.checkNotNullParameter(toCancelMotionEventScope, "$this$toCancelMotionEventScope");
        Intrinsics.checkNotNullParameter(block, "block");
        m3909toMotionEventScopeubNVwUQ(toCancelMotionEventScope, j, block, true);
    }
    ...
    private static final void m3909toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        motionEvent$ui_release.offsetLocation(-Offset.m2446getXimpl(j), -Offset.m2447getYimpl(j));
