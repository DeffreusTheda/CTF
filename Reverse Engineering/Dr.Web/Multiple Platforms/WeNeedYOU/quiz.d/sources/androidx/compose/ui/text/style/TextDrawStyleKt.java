...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle start, TextForegroundStyle stop, float f) {
        ...
        if (!z && !(stop instanceof BrushStyle)) {
            return TextForegroundStyle.INSTANCE.m4918from8_81llA(ColorKt.m2762lerpjxsXWHM(start.mo4806getColor0d7_KjU(), stop.mo4806getColor0d7_KjU(), f));
        }
        if (z && (stop instanceof BrushStyle)) {
    ...
    public static final long m4917modulateDxMtmZc(long j, float f) {
        return (Float.isNaN(f) || f >= 1.0f) ? j : Color.m2710copywmQWz5c$default(j, Color.m2713getAlphaimpl(j) * f, 0.0f, 0.0f, 0.0f, 14, null);
    }
