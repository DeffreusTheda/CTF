...
final class ParentSizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo272measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        int m4963getMinWidthimpl = roundToInt != Integer.MAX_VALUE ? roundToInt : Constraints.m4963getMinWidthimpl(j);
        int m4962getMinHeightimpl = roundToInt2 != Integer.MAX_VALUE ? roundToInt2 : Constraints.m4962getMinHeightimpl(j);
        if (roundToInt == Integer.MAX_VALUE) {
            roundToInt = Constraints.m4961getMaxWidthimpl(j);
        }
        if (roundToInt2 == Integer.MAX_VALUE) {
            roundToInt2 = Constraints.m4960getMaxHeightimpl(j);
        }
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(ConstraintsKt.Constraints(m4963getMinWidthimpl, roundToInt, m4962getMinHeightimpl, roundToInt2));
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.ParentSizeNode$measure$1
            {
                super(1);
            }
