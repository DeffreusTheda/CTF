...
public final /* data */ class BiasAlignment implements Alignment {
    ...
    public long mo2336alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        ...
        float m5177getWidthimpl = (IntSize.m5177getWidthimpl(space) - IntSize.m5177getWidthimpl(size)) / 2.0f;
        float m5176getHeightimpl = (IntSize.m5176getHeightimpl(space) - IntSize.m5176getHeightimpl(size)) / 2.0f;
        ...
        float f2 = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt(m5177getWidthimpl * (f + f2)), MathKt.roundToInt(m5176getHeightimpl * (f2 + this.verticalBias)));
    }
