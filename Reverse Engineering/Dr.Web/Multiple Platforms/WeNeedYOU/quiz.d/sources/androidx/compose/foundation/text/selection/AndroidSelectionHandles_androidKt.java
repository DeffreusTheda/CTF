...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void m918SelectionHandle8fL75g(final long j, final boolean z, final ResolvedTextDirection direction, final boolean z2, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        int i2;
        ...
        if ((374491 & i3) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            m917HandlePopupULxng0E(j, handleReferencePoint, ComposableLambdaKt.composableLambda(startRestartGroup, 732099485, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        if (function2 == null) {
                            ...
                            Offset m2435boximpl = Offset.m2435boximpl(j);
                            final boolean z3 = z;
                            final long j2 = j;
                            composer2.startReplaceableGroup(511388516);
                            ComposerKt.sourceInformation(composer2, "CC(remember)P(1,2):Composables.kt#9igjgp");
                            boolean changed = composer2.changed(valueOf) | composer2.changed(m2435boximpl);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$SelectionHandle$2
            ...
            public final void invoke(Composer composer2, int i4) {
                AndroidSelectionHandles_androidKt.m918SelectionHandle8fL75g(j, z, direction, z2, modifier, function2, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
    ...
    public static final void DefaultSelectionHandle(final Modifier modifier, final boolean z, final ResolvedTextDirection direction, final boolean z2, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m569sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z, direction, z2), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
    ...
    public static final Modifier drawSelectionHandle(Modifier modifier, final boolean z, final ResolvedTextDirection direction, final boolean z2) {
        ...
        return ComposedModifierKt.composed$default(modifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1
            ...
            public final Modifier invoke(Modifier composed, Composer composer, int i) {
                ...
                Object[] objArr = {Color.m2701boximpl(handleColor), Boolean.valueOf(z), direction, Boolean.valueOf(z2)};
                final boolean z3 = z;
                ...
                if (z5 || rememberedValue == Composer.INSTANCE.getEmpty()) {
                    rememberedValue = (Function1) new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope drawWithCache) {
                            ...
                            final ImageBitmap createHandleImage = AndroidSelectionHandles_androidKt.createHandleImage(drawWithCache, Size.m2515getWidthimpl(drawWithCache.m2352getSizeNHjbRc()) / 2.0f);
                            final ColorFilter m2752tintxETnrds$default = ColorFilter.Companion.m2752tintxETnrds$default(ColorFilter.INSTANCE, handleColor, 0, 2, null);
                            final boolean z6 = z3;
                            ...
                            return drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope onDrawWithContent) {
                                    ...
                                    if (isLeft) {
                                        ...
                                        ColorFilter colorFilter = m2752tintxETnrds$default;
                                        long mo3183getCenterF1C5BW0 = contentDrawScope.mo3183getCenterF1C5BW0();
                                        DrawContext drawContext = contentDrawScope.getDrawContext();
                                        long mo3190getSizeNHjbRc = drawContext.mo3190getSizeNHjbRc();
                                        drawContext.getCanvas().save();
                                        drawContext.getTransform().mo3197scale0AR0LA0(-1.0f, 1.0f, mo3183getCenterF1C5BW0);
                                        DrawScope.CC.m3254drawImagegbVJVH8$default(contentDrawScope, imageBitmap, 0L, 0.0f, null, colorFilter, 0, 46, null);
                                        drawContext.getCanvas().restore();
                                        drawContext.mo3191setSizeuvyYCjk(mo3190getSizeNHjbRc);
                                        return;
                                    }
                                    DrawScope.CC.m3254drawImagegbVJVH8$default(onDrawWithContent, createHandleImage, 0L, 0.0f, null, m2752tintxETnrds$default, 0, 46, null);
                                }
                            });
                        }
                    };
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f) {
        ...
        if (imageBitmap == null || canvas == null || ceil > imageBitmap.getWidth() || ceil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2941ImageBitmapx__hDU$default(ceil, ceil, ImageBitmapConfig.INSTANCE.m2935getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        DrawScope.CC.m3264drawRectnJ9OG0$default(canvasDrawScope3, Color.INSTANCE.m2737getBlack0d7_KjU(), 0L, canvasDrawScope3.mo3184getSizeNHjbRc(), 0.0f, null, null, BlendMode.INSTANCE.m2628getClear0nO6VwU(), 58, null);
        DrawScope.CC.m3264drawRectnJ9OG0$default(canvasDrawScope3, ColorKt.Color(4278190080L), Offset.INSTANCE.m2462getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        DrawScope.CC.m3251drawCircleVaOC9Bg$default(canvasDrawScope3, ColorKt.Color(4278190080L), f, OffsetKt.Offset(f, f), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        canvas2.restore();
        CanvasDrawScope.DrawParams drawParams3 = canvasDrawScope2.getDrawParams();
        drawParams3.setDensity(density);
        drawParams3.setLayoutDirection(layoutDirection2);
        drawParams3.setCanvas(canvas3);
        drawParams3.m3189setSizeuvyYCjk(size);
        return imageBitmap2;
    }

    /* renamed from: HandlePopup-ULxng0E, reason: not valid java name */
    public static final void m917HandlePopupULxng0E(final long j, final HandleReferencePoint handleReferencePoint, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i) {
        int i2;
        ...
        if ((i2 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            long IntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2446getXimpl(j)), MathKt.roundToInt(Offset.m2447getYimpl(j)));
            IntOffset m5126boximpl = IntOffset.m5126boximpl(IntOffset);
            startRestartGroup.startReplaceableGroup(511388516);
            ComposerKt.sourceInformation(startRestartGroup, "CC(remember)P(1,2):Composables.kt#9igjgp");
            boolean changed = startRestartGroup.changed(m5126boximpl) | startRestartGroup.changed(handleReferencePoint);
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.selection.AndroidSelectionHandles_androidKt$HandlePopup$1
            ...
            public final void invoke(Composer composer2, int i3) {
                AndroidSelectionHandles_androidKt.m917HandlePopupULxng0E(j, handleReferencePoint, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1));
            }
        });
    }
