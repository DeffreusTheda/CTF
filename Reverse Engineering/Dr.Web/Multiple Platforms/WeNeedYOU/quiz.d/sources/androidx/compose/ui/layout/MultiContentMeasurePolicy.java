...
public interface MultiContentMeasurePolicy {
    ...
    MeasureResult m4018measure3p2s80s(MeasureScope measureScope, List<? extends List<? extends Measurable>> list, long j);
    ...
    public final /* synthetic */ class CC {
        public static int $default$minIntrinsicWidth(MultiContentMeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
            ...
            return _this.m4018measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getWidth();
        }
        ...
        public static int $default$minIntrinsicHeight(MultiContentMeasurePolicy _this, IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i) {
            ...
            return _this.m4018measure3p2s80s(new IntrinsicsMeasureScope(intrinsicMeasureScope, intrinsicMeasureScope.getLayoutDirection()), arrayList, Constraints$default).getHeight();
        }
