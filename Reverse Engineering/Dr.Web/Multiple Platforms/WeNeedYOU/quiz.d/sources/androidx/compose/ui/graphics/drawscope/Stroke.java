...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m3066getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m3077getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m3332getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m3333getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m3062equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m3072equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int floatToIntBits = ((((((Float.floatToIntBits(this.width) * 31) + Float.floatToIntBits(this.miter)) * 31) + StrokeCap.m3063hashCodeimpl(this.cap)) * 31) + StrokeJoin.m3073hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return floatToIntBits + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m3064toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m3074toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
