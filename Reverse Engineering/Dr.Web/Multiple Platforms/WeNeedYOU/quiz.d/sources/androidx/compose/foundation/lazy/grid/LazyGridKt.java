        ...
        if (z3 || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = (Function2) new Function2<LazyLayoutMeasureScope, Constraints, LazyGridMeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1
                ...
                public /* bridge */ /* synthetic */ LazyGridMeasureResult invoke(LazyLayoutMeasureScope lazyLayoutMeasureScope, Constraints constraints) {
                    return m654invoke0kLqBqw(lazyLayoutMeasureScope, constraints.getValue());
                }
                ...
                public final LazyGridMeasureResult m654invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, final long j) {
                    int i4;
                    int i5;
                    int i6;
                    float spacing;
                    ...
                    if (z2) {
                        i4 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.mo470calculateLeftPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i4 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(PaddingKt.calculateStartPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    if (z2) {
                        i5 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(paddingValues.mo471calculateRightPaddingu2uoSUM(lazyLayoutMeasureScope.getLayoutDirection()));
                    } else {
                        i5 = lazyLayoutMeasureScope.mo354roundToPx0680j_4(PaddingKt.calculateEndPadding(paddingValues, lazyLayoutMeasureScope.getLayoutDirection()));
                    }
                    ...
                    final LazyGridSlots invoke2 = function2.invoke(lazyLayoutMeasureScope, Constraints.m4949boximpl(j));
                    ...
                    lazyGridState.setPrefetchInfoRetriever$foundation_release(new Function1<Integer, ArrayList<Pair<? extends Integer, ? extends Constraints>>>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.1
                        ...
                        public final ArrayList<Pair<Integer, Constraints>> invoke(int i17) {
                            ...
                            for (int i19 = 0; i19 < size; i19++) {
                                int m639getCurrentLineSpanimpl = GridItemSpan.m639getCurrentLineSpanimpl(spans.get(i19).getPackedValue());
                                arrayList.add(TuplesKt.to(Integer.valueOf(firstItemIndex), Constraints.m4949boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m660childConstraintsJhjzzOo$foundation_release(i18, m639getCurrentLineSpanimpl))));
                                firstItemIndex++;
                                i18 += m639getCurrentLineSpanimpl;
                            }
                            return arrayList;
                        }
                    });
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release >= itemCount && itemCount > 0) {
                                ...
                                lazyGridState.applyMeasureResult$foundation_release(m655measureLazyGridZRKPzZ8);
                                return m655measureLazyGridZRKPzZ8;
                            }
                            ...
                            createNonObservableSnapshot.dispose();
                            LazyGridMeasureResult m655measureLazyGridZRKPzZ82 = LazyGridMeasureKt.m655measureLazyGridZRKPzZ8(itemCount, (LazyGridMeasuredLineProvider) r2, (LazyGridMeasuredItemProvider) r18, i15, i6, i13, i14, i7, firstVisibleItemScrollOffset, lazyGridState.getScrollToBeConsumed(), m4977offsetNN6EwU, z2, vertical2, horizontal2, z, lazyLayoutMeasureScope2, lazyGridState.getPlacementAnimator(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(invoke, lazyGridState.getPinnedItems(), lazyGridState.getBeyondBoundsInfo()), new Function3<Integer, Integer, Function1<? super Placeable.PlacementScope, ? extends Unit>, MeasureResult>() { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1.3
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(3);
                                }
                            ...
                            lazyGridState.applyMeasureResult$foundation_release(m655measureLazyGridZRKPzZ82);
                            return m655measureLazyGridZRKPzZ82;
                        } finally {
