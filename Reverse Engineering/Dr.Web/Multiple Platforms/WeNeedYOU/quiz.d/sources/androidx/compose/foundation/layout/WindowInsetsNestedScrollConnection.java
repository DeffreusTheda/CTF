...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    public long mo370onPreScrollOzD1aCk(long available, int source) {
        return m596scroll8S9VItk(available, this.sideCalculator.hideMotion(Offset.m2446getXimpl(available), Offset.m2447getYimpl(available)));
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostScroll-DzOQY0M */
    public long mo368onPostScrollDzOQY0M(long consumed, long available, int source) {
        return m596scroll8S9VItk(available, this.sideCalculator.showMotion(Offset.m2446getXimpl(available), Offset.m2447getYimpl(available)));
    }

    /* renamed from: scroll-8S9VItk, reason: not valid java name */
    private final long m596scroll8S9VItk(long available, float scrollAmount) {
        ...
        if (scrollAmount != 0.0f) {
            if (this.windowInsets.isVisible() != (scrollAmount > 0.0f) || windowInsetsAnimationController != null) {
                if (windowInsetsAnimationController == null) {
                    ...
                    requestAnimationController();
                    return this.sideCalculator.mo548consumedOffsetsMKHz9U(available);
                }
    ...
    public Object mo369onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
        return m595flinghuYlsQE(j, this.sideCalculator.hideMotion(Velocity.m5242getXimpl(j), Velocity.m5243getYimpl(j)), false, continuation);
    }

    @Override // androidx.compose.ui.input.nestedscroll.NestedScrollConnection
    /* renamed from: onPostFling-RZ2iAVY */
    public Object mo367onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
        return m595flinghuYlsQE(j2, this.sideCalculator.showMotion(Velocity.m5242getXimpl(j2), Velocity.m5243getYimpl(j2)), true, continuation);
    }
    ...
    */
    public final java.lang.Object m595flinghuYlsQE(long r26, float r28, boolean r29, kotlin.coroutines.Continuation<? super androidx.compose.ui.unit.Velocity> r30) {
        /*
            Method dump skipped, instructions count: 425
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.WindowInsetsNestedScrollConnection.m595flinghuYlsQE(long, float, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
