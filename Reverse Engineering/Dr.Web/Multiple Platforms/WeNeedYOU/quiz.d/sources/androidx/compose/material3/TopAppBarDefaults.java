...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1723topAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        long m1139applyTonalElevationHht5A8o = (i2 & 2) != 0 ? ColorSchemeKt.m1139applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), color, TopAppBarSmallTokens.INSTANCE.m2237getOnScrollContainerElevationD9Ej5fM()) : j2;
        ...
        TopAppBarColors topAppBarColors = new TopAppBarColors(color, m1139applyTonalElevationHht5A8o, color2, color3, color4, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TopAppBarColors m1722smallTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
        ...
        TopAppBarColors m1723topAppBarColorszjMxDiM = m1723topAppBarColorszjMxDiM(color, m1139applyTonalElevationHht5A8o, color2, color3, color4, composer, (i & 14) | (i & 112) | (i & 896) | (i & 7168) | (57344 & i) | (i & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m1723topAppBarColorszjMxDiM;
    }
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m593onlybOOhFvg = WindowInsetsKt.m593onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m603plusgK_yJZ4(WindowInsetsSides.INSTANCE.m613getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m617getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m593onlybOOhFvg;
    }

    /* renamed from: centerAlignedTopAppBarColors-zjMxDiM, reason: not valid java name */
    public final TopAppBarColors m1719centerAlignedTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m1721mediumTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
    ...
    public final TopAppBarColors m1720largeTopAppBarColorszjMxDiM(long j, long j2, long j3, long j4, long j5, Composer composer, int i, int i2) {
