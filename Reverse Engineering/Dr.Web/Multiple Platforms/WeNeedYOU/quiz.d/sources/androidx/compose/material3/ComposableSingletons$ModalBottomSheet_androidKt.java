...
public final class ComposableSingletons$ModalBottomSheet_androidKt {
    ...
    public static Function2<Composer, Integer, Unit> f22lambda1 = ComposableLambdaKt.composableLambdaInstance(2103486466, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$ModalBottomSheet_androidKt$lambda-1$1
        ...
        public final void invoke(Composer composer, int i) {
            ...
            BottomSheetDefaults.INSTANCE.m1039DragHandlelgZ2HuY(null, 0.0f, 0.0f, null, 0L, composer, ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 31);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final Function2<Composer, Integer, Unit> m1164getLambda1$material3_release() {
        return f22lambda1;
    }

    /* renamed from: getLambda-2$material3_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1165getLambda2$material3_release() {
        return f23lambda2;
    }

    /* renamed from: getLambda-3$material3_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1166getLambda3$material3_release() {
        return f24lambda3;
    }
}
