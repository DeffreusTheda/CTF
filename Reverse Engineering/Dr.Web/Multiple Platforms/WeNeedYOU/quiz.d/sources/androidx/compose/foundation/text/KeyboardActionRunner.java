...
public final class KeyboardActionRunner implements KeyboardActionScope {
    ...
    public final void m809runActionKlQnJC8(int imeAction) {
        Function1<KeyboardActionScope, Unit> function1;
        Unit unit = null;
        if (ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4694getDoneeUduSuo())) {
            ...
            if (!ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4693getDefaulteUduSuo()) && !ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4697getNoneeUduSuo())) {
        ...
        if (unit == null) {
            mo808defaultKeyboardActionKlQnJC8(imeAction);
        }
    }

    @Override // androidx.compose.foundation.text.KeyboardActionScope
    /* renamed from: defaultKeyboardAction-KlQnJC8, reason: not valid java name */
    public void mo808defaultKeyboardActionKlQnJC8(int imeAction) {
        if (ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4696getNexteUduSuo())) {
            getFocusManager().mo2383moveFocus3ESFkO8(FocusDirection.INSTANCE.m2378getNextdhqQ8s());
            return;
        }
        if (ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4698getPreviouseUduSuo())) {
            getFocusManager().mo2383moveFocus3ESFkO8(FocusDirection.INSTANCE.m2380getPreviousdhqQ8s());
            return;
        }
        if (ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4694getDoneeUduSuo())) {
        ...
        if (ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4695getGoeUduSuo()) || ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4699getSearcheUduSuo()) || ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4700getSendeUduSuo()) || ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4693getDefaulteUduSuo())) {
            return;
        }
        ImeAction.m4681equalsimpl0(imeAction, ImeAction.INSTANCE.m4697getNoneeUduSuo());
    }
}
