...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2655getSrcOver0nO6VwU();
    }
    ...
    public long mo2561getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2567setColor8_81llA(long j) {
        AndroidPaint_androidKt.m2573setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo2566setBlendModes9anfk8(int i) {
        if (BlendMode.m2624equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m2572setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2565getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2571setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m2577setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo2563getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2569setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m2575setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2564getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2570setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m2576setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo2562getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo2568setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m2574setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
