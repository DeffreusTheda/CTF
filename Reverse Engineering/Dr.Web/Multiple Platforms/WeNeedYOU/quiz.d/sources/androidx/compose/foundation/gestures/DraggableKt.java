...
public final class DraggableKt {
    ...
    */
    ...
    public static final Object m322awaitDragSu4bsnU(AwaitPointerEventScope awaitPointerEventScope, PointerInputChange pointerInputChange, long j, final VelocityTracker velocityTracker, final SendChannel<? super DragEvent> sendChannel, final boolean z, Orientation orientation, Continuation<? super Boolean> continuation) {
        sendChannel.mo7090trySendJP2dKIU(new DragEvent.DragStarted(Offset.m2450minusMKHz9U(pointerInputChange.getPosition(), OffsetKt.Offset(Offset.m2446getXimpl(j) * Math.signum(Offset.m2446getXimpl(pointerInputChange.getPosition())), Offset.m2447getYimpl(j) * Math.signum(Offset.m2447getYimpl(pointerInputChange.getPosition())))), null));
        sendChannel.mo7090trySendJP2dKIU(new DragEvent.DragDelta(z ? Offset.m2453timestuRUvjQ(j, -1.0f) : j, null));
        return m323onDragOrUpAxegvzg(awaitPointerEventScope, orientation, pointerInputChange.getId(), new Function1<PointerInputChange, Unit>() { // from class: androidx.compose.foundation.gestures.DraggableKt$awaitDrag$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final void invoke2(PointerInputChange event) {
                ...
                if (z) {
                    positionChange = Offset.m2453timestuRUvjQ(positionChange, -1.0f);
                }
                sendChannel2.mo7090trySendJP2dKIU(new DragEvent.DragDelta(positionChange, null));
            }
        }, continuation);
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final java.lang.Object m323onDragOrUpAxegvzg(androidx.compose.ui.input.pointer.AwaitPointerEventScope r18, androidx.compose.foundation.gestures.Orientation r19, long r20, kotlin.jvm.functions.Function1<? super androidx.compose.ui.input.pointer.PointerInputChange, kotlin.Unit> r22, kotlin.coroutines.Continuation<? super java.lang.Boolean> r23) {
        /*
            Method dump skipped, instructions count: 341
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.DraggableKt.m323onDragOrUpAxegvzg(androidx.compose.ui.input.pointer.AwaitPointerEventScope, androidx.compose.foundation.gestures.Orientation, long, kotlin.jvm.functions.Function1, kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-3MmeM6k, reason: not valid java name */
    public static final float m324toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m2447getYimpl(j) : Offset.m2446getXimpl(j);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU, reason: not valid java name */
    public static final float m325toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m5243getYimpl(j) : Velocity.m5242getXimpl(j);
    }
}
