...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo2680createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m2467isUnspecifiedk4lQ0M(this.center)) {
            Offset = SizeKt.m2525getCenteruvyYCjk(size);
        } else {
            Offset = OffsetKt.Offset(Offset.m2446getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2515getWidthimpl(size) : Offset.m2446getXimpl(this.center), Offset.m2447getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m2512getHeightimpl(size) : Offset.m2447getYimpl(this.center));
        }
        return ShaderKt.m3032SweepGradientShader9KIMszo(Offset, this.colors, this.stops);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Offset.m2443equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int m2448hashCodeimpl = ((Offset.m2448hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return m2448hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
