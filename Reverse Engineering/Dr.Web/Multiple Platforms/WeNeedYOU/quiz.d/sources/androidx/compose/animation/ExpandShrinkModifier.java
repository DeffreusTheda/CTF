...
final class ExpandShrinkModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m91sizeByStateUzc_VyU(EnterExitState targetState, long fullSize) {
        ...
        long packedValue = value != null ? value.getSize().invoke(IntSize.m5169boximpl(fullSize)).getPackedValue() : fullSize;
        ChangeSize value2 = this.shrink.getValue();
        long packedValue2 = value2 != null ? value2.getSize().invoke(IntSize.m5169boximpl(fullSize)).getPackedValue() : fullSize;
    ...
    public final long m92targetOffsetByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        Intrinsics.checkNotNullParameter(targetState, "targetState");
        if (this.currentAlignment != null && this.alignment.getValue() != null && !Intrinsics.areEqual(this.currentAlignment, this.alignment.getValue())) {
            int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
            if (i == 1) {
                return IntOffset.INSTANCE.m5145getZeronOccac();
            }
            if (i == 2) {
                return IntOffset.INSTANCE.m5145getZeronOccac();
            }
            ...
            if (value != null) {
                long packedValue = value.getSize().invoke(IntSize.m5169boximpl(fullSize)).getPackedValue();
                Alignment value2 = this.alignment.getValue();
                Intrinsics.checkNotNull(value2);
                long mo2336alignKFBX0sM = value2.mo2336alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                Alignment alignment = this.currentAlignment;
                Intrinsics.checkNotNull(alignment);
                long mo2336alignKFBX0sM2 = alignment.mo2336alignKFBX0sM(fullSize, packedValue, LayoutDirection.Ltr);
                return IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(mo2336alignKFBX0sM) - IntOffset.m5135getXimpl(mo2336alignKFBX0sM2), IntOffset.m5136getYimpl(mo2336alignKFBX0sM) - IntOffset.m5136getYimpl(mo2336alignKFBX0sM2));
            }
            return IntOffset.INSTANCE.m5145getZeronOccac();
        }
        return IntOffset.INSTANCE.m5145getZeronOccac();
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final long IntSize = IntSizeKt.IntSize(mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight());
        long packedValue = this.sizeAnimation.animate(this.sizeTransitionSpec, new Function1<EnterExitState, IntSize>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$currentSize$1
            ...
            public /* bridge */ /* synthetic */ IntSize invoke(EnterExitState enterExitState) {
                return IntSize.m5169boximpl(m93invokeYEO4UFw(enterExitState));
            }

            /* renamed from: invoke-YEO4UFw, reason: not valid java name */
            public final long m93invokeYEO4UFw(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m91sizeByStateUzc_VyU(it, IntSize);
            }
        ...
        final long packedValue2 = this.offsetAnimation.animate(new Function1<Transition.Segment<EnterExitState>, FiniteAnimationSpec<IntOffset>>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$offsetDelta$1
            ...
            public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                return IntOffset.m5126boximpl(m94invokeBjo55l4(enterExitState));
            }

            /* renamed from: invoke-Bjo55l4, reason: not valid java name */
            public final long m94invokeBjo55l4(EnterExitState it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return ExpandShrinkModifier.this.m92targetOffsetByStateoFUgxo0(it, IntSize);
            }
        }).getValue().getPackedValue();
        Alignment alignment = this.currentAlignment;
        final long mo2336alignKFBX0sM = alignment != null ? alignment.mo2336alignKFBX0sM(IntSize, packedValue, LayoutDirection.Ltr) : IntOffset.INSTANCE.m5145getZeronOccac();
        return MeasureScope.CC.layout$default(measure, IntSize.m5177getWidthimpl(packedValue), IntSize.m5176getHeightimpl(packedValue), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.ExpandShrinkModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, Placeable.this, IntOffset.m5135getXimpl(mo2336alignKFBX0sM) + IntOffset.m5135getXimpl(packedValue2), IntOffset.m5136getYimpl(mo2336alignKFBX0sM) + IntOffset.m5136getYimpl(packedValue2), 0.0f, 4, null);
            }
        }, 4, null);
    }
}
