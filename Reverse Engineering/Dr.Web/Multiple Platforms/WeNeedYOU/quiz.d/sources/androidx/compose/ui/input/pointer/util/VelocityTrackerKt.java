...
public final class VelocityTrackerKt {
    ...
    public static final void addPointerInputChange(VelocityTracker velocityTracker, PointerInputChange event) {
        ...
        if (PointerEventKt.changedToDownIgnoreConsumed(event)) {
            velocityTracker.m3943setCurrentPointerPositionAccumulatork4lQ0M$ui_release(event.getPosition());
        ...
        while (i < size) {
            ...
            long m2450minusMKHz9U = Offset.m2450minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m3943setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2451plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), m2450minusMKHz9U));
            velocityTracker.m3940addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m3943setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2451plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m2450minusMKHz9U(event.getPosition(), previousPosition)));
        velocityTracker.m3940addPositionUv8p0NA(event.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
