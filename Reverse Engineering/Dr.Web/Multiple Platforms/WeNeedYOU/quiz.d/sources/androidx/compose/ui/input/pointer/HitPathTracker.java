...
public final class HitPathTracker {
    ...
    public final void m3777addHitPathKNwqfcY(long pointerId, List<? extends Modifier.Node> pointerInputNodes) {
        Node node;
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (z) {
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    if (!node3.getPointerIds().contains(PointerId.m3828boximpl(pointerId))) {
                        node3.getPointerIds().add(PointerId.m3828boximpl(pointerId));
                    }
                    nodeParent = node3;
                } else {
                    z = false;
            ...
            node4.getPointerIds().add(PointerId.m3828boximpl(pointerId));
