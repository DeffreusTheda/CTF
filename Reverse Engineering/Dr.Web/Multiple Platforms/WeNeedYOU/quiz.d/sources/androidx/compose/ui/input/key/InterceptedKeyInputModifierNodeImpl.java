...
final class InterceptedKeyInputModifierNodeImpl extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean mo3397onInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m3693boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo3398onPreInterceptKeyBeforeSoftKeyboardZmokQxo(android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
