...
final class ScrollDraggableState implements DraggableState, DragScope {
    ...
    public void dragBy(float pixels) {
        ...
        value.m371dispatchScroll3eAAhYA(this.latestScrollScope, value.m380toOffsettuRUvjQ(pixels), NestedScrollSource.INSTANCE.m3744getDragWNlRxjI());
    }
    ...
    public void dispatchRawDelta(float delta) {
        ScrollingLogic value = this.scrollLogic.getValue();
        value.m374performRawScrollMKHz9U(value.m380toOffsettuRUvjQ(delta));
    }
}
