...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public int mo353roundToPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo353roundToPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: roundToPx-0680j_4 */
    public int mo354roundToPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo354roundToPx0680j_4(f);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx--R2X_6o */
    public float mo359toPxR2X_6o(long j) {
        return this.subcomposeMeasureScope.mo359toPxR2X_6o(j);
    }

    @Override // androidx.compose.ui.unit.Density
    /* renamed from: toPx-0680j_4 */
    public float mo360toPx0680j_4(float f) {
        return this.subcomposeMeasureScope.mo360toPx0680j_4(f);
    }
    ...
    public List<Placeable> mo678measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(subcompose.get(i).mo3967measureBRTryo0(constraints));
        }
    ...
    public float mo355toDpGaN1DYA(long j) {
        return this.subcomposeMeasureScope.mo355toDpGaN1DYA(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo357toDpu2uoSUM(int i) {
        return this.subcomposeMeasureScope.mo357toDpu2uoSUM(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDp-u2uoSUM */
    public float mo356toDpu2uoSUM(float f) {
        return this.subcomposeMeasureScope.mo356toDpu2uoSUM(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo363toSpkPz2Gy4(float f) {
        return this.subcomposeMeasureScope.mo363toSpkPz2Gy4(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-kPz2Gy4 */
    public long mo364toSpkPz2Gy4(int i) {
        return this.subcomposeMeasureScope.mo364toSpkPz2Gy4(i);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSp-0xMU5do */
    public long mo362toSp0xMU5do(float f) {
        return this.subcomposeMeasureScope.mo362toSp0xMU5do(f);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toSize-XkaWNTQ */
    public long mo361toSizeXkaWNTQ(long j) {
        return this.subcomposeMeasureScope.mo361toSizeXkaWNTQ(j);
    }

    @Override // androidx.compose.foundation.lazy.layout.LazyLayoutMeasureScope, androidx.compose.ui.unit.Density
    /* renamed from: toDpSize-k-rfVVM */
    public long mo358toDpSizekrfVVM(long j) {
        return this.subcomposeMeasureScope.mo358toDpSizekrfVVM(j);
    }
}
