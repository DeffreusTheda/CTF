...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        ...
        if (this.isActive) {
            ...
            int m4530getMinimpl = composition != null ? TextRange.m4530getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m4530getMinimpl(state.getSelection()), TextRange.m4529getMaximpl(state.getSelection()), m4530getMinimpl, composition2 != null ? TextRange.m4529getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4526getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4530getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int m4693getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4693getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4695getGoeUduSuo();
                    break;
                case 3:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4699getSearcheUduSuo();
                    break;
                case 4:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4700getSendeUduSuo();
                    break;
                case 5:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4696getNexteUduSuo();
                    break;
                case 6:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4694getDoneeUduSuo();
                    break;
                case 7:
                    m4693getDefaulteUduSuo = ImeAction.INSTANCE.m4698getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo4707onImeActionKlQnJC8(m4693getDefaulteUduSuo);
        return true;
    }
