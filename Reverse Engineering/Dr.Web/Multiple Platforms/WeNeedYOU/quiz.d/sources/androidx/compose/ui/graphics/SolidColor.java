...
public final class SolidColor extends Brush {
    ...
    public void mo2658applyToPq9zytI(long size, Paint p, float alpha) {
        long m2710copywmQWz5c$default;
        Intrinsics.checkNotNullParameter(p, "p");
        p.setAlpha(1.0f);
        if (alpha != 1.0f) {
            long j = this.value;
            m2710copywmQWz5c$default = Color.m2710copywmQWz5c$default(j, Color.m2713getAlphaimpl(j) * alpha, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            m2710copywmQWz5c$default = this.value;
        }
        p.mo2567setColor8_81llA(m2710copywmQWz5c$default);
        if (p.getShader() != null) {
            p.setShader(null);
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SolidColor) && Color.m2712equalsimpl0(this.value, ((SolidColor) other).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + ((Object) Color.m2719toStringimpl(this.value)) + ')';
    }
}
