...
public final class SwitchKt {
    ...
    */
    ...
    public static final void m1543SwitchImpl0DmnUew(final BoxScope boxScope, final boolean z, final boolean z2, final SwitchColors switchColors, final State<Float> state, final Function2<? super Composer, ? super Integer, Unit> function2, final InteractionSource interactionSource, final Shape shape, final float f, final float f2, final float f3, Composer composer, final int i, final int i2) {
        int i3;
        int i4;
        float m5017constructorimpl;
        final float floatValue;
        float m2193getTrackOutlineWidthD9Ej5fM;
        ...
        if ((i3 & 1533916891) != 306783378 || (i4 & 11) != 2 || !startRestartGroup.getSkipping()) {
            ...
            float mo356toDpu2uoSUM = ((Density) consume).mo356toDpu2uoSUM(state.getValue().floatValue());
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                m5017constructorimpl = SwitchTokens.INSTANCE.m2187getPressedHandleWidthD9Ej5fM();
            } else {
                m5017constructorimpl = Dp.m5017constructorimpl(Dp.m5017constructorimpl(Dp.m5017constructorimpl(ThumbDiameter - f) * (Dp.m5017constructorimpl(mo356toDpu2uoSUM - f2) / Dp.m5017constructorimpl(f3 - f2))) + f);
            }
            ...
            if (SwitchImpl_0DmnUew$lambda$7(collectIsPressedAsState)) {
                ...
                if (!z) {
                    m2193getTrackOutlineWidthD9Ej5fM = SwitchTokens.INSTANCE.m2193getTrackOutlineWidthD9Ej5fM();
                } else {
                    m2193getTrackOutlineWidthD9Ej5fM = Dp.m5017constructorimpl(ThumbPathLength - SwitchTokens.INSTANCE.m2193getTrackOutlineWidthD9Ej5fM());
                }
                floatValue = density.mo360toPx0680j_4(m2193getTrackOutlineWidthD9Ej5fM);
            } else {
            ...
            Modifier m192backgroundbw27NRU = BackgroundKt.m192backgroundbw27NRU(BorderKt.m204borderxT4_qwU(SizeKt.m553height3ABfNKs(SizeKt.m572width3ABfNKs(boxScope.align(Modifier.INSTANCE, Alignment.INSTANCE.getCenter()), SwitchWidth), SwitchHeight), SwitchTokens.INSTANCE.m2193getTrackOutlineWidthD9Ej5fM(), switchColors.borderColor$material3_release(z2, z, startRestartGroup, i5).getValue().m2721unboximpl(), shape2), SwitchImpl_0DmnUew$lambda$6(trackColor$material3_release), shape2);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf = LayoutKt.materializerOf(m192backgroundbw27NRU);
            ...
            Updater.m2325setimpl(m2318constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
            ...
            if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
                rememberedValue = (Function1) new Function1<Density, IntOffset>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(Density density3) {
                        return IntOffset.m5126boximpl(m1545invokeBjo55l4(density3));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m1545invokeBjo55l4(Density offset) {
            ...
            startRestartGroup.endReplaceableGroup();
            Modifier m192backgroundbw27NRU2 = BackgroundKt.m192backgroundbw27NRU(SizeKt.m559requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(align, (Function1) rememberedValue), interactionSource, RippleKt.m1013rememberRipple9IZ8Weo(false, Dp.m5017constructorimpl(SwitchTokens.INSTANCE.m2191getStateLayerSizeD9Ej5fM() / 2), 0L, startRestartGroup, 54, 4)), m5017constructorimpl), SwitchImpl_0DmnUew$lambda$13$lambda$10, shape);
            ...
            Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf2 = LayoutKt.materializerOf(m192backgroundbw27NRU2);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2325setimpl(m2318constructorimpl2, rememberBoxMeasurePolicy2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m2325setimpl(m2318constructorimpl2, density3, ComposeUiNode.INSTANCE.getSetDensity());
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.SwitchKt$SwitchImpl$2
            ...
            public final void invoke(Composer composer2, int i7) {
                SwitchKt.m1543SwitchImpl0DmnUew(BoxScope.this, z, z2, switchColors, state, function2, interactionSource, shape, f, f2, f3, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2));
            }
        });
    }

    static {
        float m2189getSelectedHandleWidthD9Ej5fM = SwitchTokens.INSTANCE.m2189getSelectedHandleWidthD9Ej5fM();
        ThumbDiameter = m2189getSelectedHandleWidthD9Ej5fM;
        UncheckedThumbDiameter = SwitchTokens.INSTANCE.m2196getUnselectedHandleWidthD9Ej5fM();
        float m2194getTrackWidthD9Ej5fM = SwitchTokens.INSTANCE.m2194getTrackWidthD9Ej5fM();
        SwitchWidth = m2194getTrackWidthD9Ej5fM;
        float m2192getTrackHeightD9Ej5fM = SwitchTokens.INSTANCE.m2192getTrackHeightD9Ej5fM();
        SwitchHeight = m2192getTrackHeightD9Ej5fM;
        float m5017constructorimpl = Dp.m5017constructorimpl(Dp.m5017constructorimpl(m2192getTrackHeightD9Ej5fM - m2189getSelectedHandleWidthD9Ej5fM) / 2);
        ThumbPadding = m5017constructorimpl;
        ThumbPathLength = Dp.m5017constructorimpl(Dp.m5017constructorimpl(m2194getTrackWidthD9Ej5fM - m2189getSelectedHandleWidthD9Ej5fM) - m5017constructorimpl);
