...
public final class NodeKind<T> {
    ...
    public static final /* synthetic */ NodeKind m4183boximpl(int i) {
        return new NodeKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> int m4184constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m4185equalsimpl(int i, Object obj) {
        return (obj instanceof NodeKind) && i == ((NodeKind) obj).m4191unboximpl();
    }
    ...
    public static final int m4188orH91voCI(int i, int i2) {
        return i | i2;
    }

    /* renamed from: or-impl, reason: not valid java name */
    public static final int m4189orimpl(int i, int i2) {
        return i | i2;
    }
    ...
    public boolean equals(Object obj) {
        return m4185equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m4187hashCodeimpl(this.mask);
    }
