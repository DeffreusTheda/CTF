...
public final class Float16Kt {
    ...
    public static final short m2855minAoSsdG0(short s, short s2) {
        if (Float16.m2827isNaNimpl(s) || Float16.m2827isNaNimpl(s2)) {
            return Float16.INSTANCE.m2849getNaNslo4al4();
        }
        return Float16.m2814compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m2854maxAoSsdG0(short s, short s2) {
        if (Float16.m2827isNaNimpl(s) || Float16.m2827isNaNimpl(s2)) {
            return Float16.INSTANCE.m2849getNaNslo4al4();
        }
        return Float16.m2814compareTo41bOqos(s, s2) >= 0 ? s : s2;
