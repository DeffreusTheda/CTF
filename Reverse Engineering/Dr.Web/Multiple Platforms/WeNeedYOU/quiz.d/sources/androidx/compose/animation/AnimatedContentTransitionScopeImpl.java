...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        this.measuredSize = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5169boximpl(IntSize.INSTANCE.m5182getZeroYbymL2g()), null, 2, null);
    ...
    public EnterTransition mo45slideIntoContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> initialOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(initialOffset, "initialOffset");
        return m66isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                m65getCurrentSizeYbymL2g = this.m65getCurrentSizeYbymL2g();
                int m5177getWidthimpl = IntSize.m5177getWidthimpl(m65getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m65getCurrentSizeYbymL2g2 = this.m65getCurrentSizeYbymL2g();
                m64calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m64calculateOffsetemnUabE(IntSize, m65getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5177getWidthimpl - IntOffset.m5135getXimpl(m64calculateOffsetemnUabE)));
            }
        }) : m67isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideInHorizontally(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                return function1.invoke(Integer.valueOf((-IntOffset.m5135getXimpl(m64calculateOffsetemnUabE)) - i));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m61getUpDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = initialOffset;
                m65getCurrentSizeYbymL2g = this.m65getCurrentSizeYbymL2g();
                int m5176getHeightimpl = IntSize.m5176getHeightimpl(m65getCurrentSizeYbymL2g);
                AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl = this;
                long IntSize = IntSizeKt.IntSize(i, i);
                m65getCurrentSizeYbymL2g2 = this.m65getCurrentSizeYbymL2g();
                m64calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m64calculateOffsetemnUabE(IntSize, m65getCurrentSizeYbymL2g2);
                return function1.invoke(Integer.valueOf(m5176getHeightimpl - IntOffset.m5136getYimpl(m64calculateOffsetemnUabE)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m56getDownDKzdypw()) ? EnterExitTransitionKt.slideInVertically(animationSpec, new Function1<Integer, Integer>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideIntoContainer$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(1);
            ...
            public final Integer invoke(int i) {
                ...
                m65getCurrentSizeYbymL2g = this.m65getCurrentSizeYbymL2g();
                m64calculateOffsetemnUabE = animatedContentTransitionScopeImpl.m64calculateOffsetemnUabE(IntSize, m65getCurrentSizeYbymL2g);
                return function1.invoke(Integer.valueOf((-IntOffset.m5136getYimpl(m64calculateOffsetemnUabE)) - i));
            }
    ...
    private final boolean m66isLeftgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m58getLeftDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m60getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr) || (AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m57getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl);
    }

    /* renamed from: isRight-gWo6LJ4, reason: not valid java name */
    private final boolean m67isRightgWo6LJ4(int i) {
        return AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m59getRightDKzdypw()) || (AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m60getStartDKzdypw()) && this.layoutDirection == LayoutDirection.Rtl) || (AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(i, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m57getEndDKzdypw()) && this.layoutDirection == LayoutDirection.Ltr);
    }
    ...
    public final long m64calculateOffsetemnUabE(long fullSize, long currentSize) {
        return this.contentAlignment.mo2336alignKFBX0sM(fullSize, currentSize, LayoutDirection.Ltr);
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideOutOfContainer-mOhB8PU */
    public ExitTransition mo46slideOutOfContainermOhB8PU(int towards, FiniteAnimationSpec<IntOffset> animationSpec, final Function1<? super Integer, Integer> targetOffset) {
        Intrinsics.checkNotNullParameter(animationSpec, "animationSpec");
        Intrinsics.checkNotNullParameter(targetOffset, "targetOffset");
        return m66isLeftgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$1
            ...
            public final Integer invoke(int i) {
                ...
                long packedValue = state != null ? ((IntSize) state.getValue()).getPackedValue() : IntSize.INSTANCE.m5182getZeroYbymL2g();
                Function1<Integer, Integer> function1 = targetOffset;
                m64calculateOffsetemnUabE = this.this$0.m64calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m5135getXimpl(m64calculateOffsetemnUabE)) - i));
            }
        }) : m67isRightgWo6LJ4(towards) ? EnterExitTransitionKt.slideOutHorizontally(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$2
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m64calculateOffsetemnUabE = this.this$0.m64calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m5135getXimpl(m64calculateOffsetemnUabE)) + IntSize.m5177getWidthimpl(packedValue)));
            }
        }) : AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m61getUpDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$3
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
        ...
        }) : AnimatedContentTransitionScope.SlideDirection.m52equalsimpl0(towards, AnimatedContentTransitionScope.SlideDirection.INSTANCE.m56getDownDKzdypw()) ? EnterExitTransitionKt.slideOutVertically(animationSpec, new Function1<Integer, Integer>(this) { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$slideOutOfContainer$4
            final /* synthetic */ AnimatedContentTransitionScopeImpl<S> this$0;
            ...
            public final Integer invoke(int i) {
                ...
                Function1<Integer, Integer> function1 = targetOffset;
                m64calculateOffsetemnUabE = this.this$0.m64calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), packedValue);
                return function1.invoke(Integer.valueOf((-IntOffset.m5136getYimpl(m64calculateOffsetemnUabE)) + IntSize.m5176getHeightimpl(packedValue)));
            }
    ...
    public final long m68getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize.getValue()).getPackedValue();
    }

    /* renamed from: setMeasuredSize-ozmzZPI$animation_release, reason: not valid java name */
    public final void m69setMeasuredSizeozmzZPI$animation_release(long j) {
        this.measuredSize.setValue(IntSize.m5169boximpl(j));
    }
    ...
    public final long m65getCurrentSizeYbymL2g() {
        ...
        return state != null ? state.getValue().getPackedValue() : m68getMeasuredSizeYbymL2g$animation_release();
    }
    ...
    final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
            ...
            Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>> function1 = new Function1<Transition.Segment<S>, FiniteAnimationSpec<IntSize>>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$1
                ...
                public final FiniteAnimationSpec<IntSize> invoke(Transition.Segment<S> animate) {
                    FiniteAnimationSpec<IntSize> mo108createAnimationSpecTemP2vQ;
                    ...
                    long packedValue = state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5182getZeroYbymL2g();
                    State<IntSize> state2 = animatedContentTransitionScopeImpl.getTargetSizeMap$animation_release().get(animate.getTargetState());
                    long packedValue2 = state2 != null ? state2.getValue().getPackedValue() : IntSize.INSTANCE.m5182getZeroYbymL2g();
                    SizeTransform value = this.getSizeTransform().getValue();
                    return (value == null || (mo108createAnimationSpecTemP2vQ = value.mo108createAnimationSpecTemP2vQ(packedValue, packedValue2)) == null) ? AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null) : mo108createAnimationSpecTemP2vQ;
                }
            };
            ...
            State<IntSize> animate = deferredAnimation.animate(function1, new Function1<S, IntSize>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$size$2
                ...
                public /* bridge */ /* synthetic */ IntSize invoke(Object obj) {
                    return IntSize.m5169boximpl(m71invokeYEO4UFw(obj));
                }
                ...
                public final long m71invokeYEO4UFw(S s) {
                    ...
                    return state != null ? state.getValue().getPackedValue() : IntSize.INSTANCE.m5182getZeroYbymL2g();
                }
            });
            this.this$0.setAnimatedSize$animation_release(animate);
            final long mo2336alignKFBX0sM = this.this$0.getContentAlignment().mo2336alignKFBX0sM(IntSizeKt.IntSize(mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight()), animate.getValue().getPackedValue(), LayoutDirection.Ltr);
            return MeasureScope.CC.layout$default(measure, IntSize.m5177getWidthimpl(animate.getValue().getPackedValue()), IntSize.m5176getHeightimpl(animate.getValue().getPackedValue()), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.AnimatedContentTransitionScopeImpl$SizeModifier$measure$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Placeable.PlacementScope layout) {
                    ...
                    Placeable.PlacementScope.m4026place70tqf50$default(layout, Placeable.this, mo2336alignKFBX0sM, 0.0f, 2, null);
                }
            }, 4, null);
        }
    }
