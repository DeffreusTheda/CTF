...
public final class TextSelectionColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m2712equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m2718hashCodeimpl(this.handleColor) * 31) + Color.m2718hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + ((Object) Color.m2719toStringimpl(this.handleColor)) + ", selectionBackgroundColor=" + ((Object) Color.m2719toStringimpl(this.backgroundColor)) + ')';
    }
}
