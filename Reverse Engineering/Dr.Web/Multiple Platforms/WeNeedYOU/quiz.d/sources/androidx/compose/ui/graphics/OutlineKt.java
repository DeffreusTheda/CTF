...
public final class OutlineKt {
    public static final void addOutline(Path path, Outline outline) {
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            Path.CC.m2984addPathUv8p0NA$default(path, ((Outline.Generic) outline).getPath(), 0L, 2, null);
        }
    }

    /* renamed from: drawOutline-hn5TExg$default, reason: not valid java name */
    public static /* synthetic */ void m2970drawOutlinehn5TExg$default(DrawScope drawScope, Outline outline, Brush brush, float f, DrawStyle drawStyle, ColorFilter colorFilter, int i, int i2, Object obj) {
        ...
        m2969drawOutlinehn5TExg(drawScope, outline, brush, f2, drawStyle2, colorFilter2, i);
    }
    ...
    public static final void drawOutline(Canvas canvas, Outline outline, Paint paint) {
        ...
        if (outline instanceof Outline.Rounded) {
            ...
            if (roundRectPath != null) {
                ...
                canvas.drawRoundRect(rounded.getRoundRect().getLeft(), rounded.getRoundRect().getTop(), rounded.getRoundRect().getRight(), rounded.getRoundRect().getBottom(), CornerRadius.m2421getXimpl(rounded.getRoundRect().m2494getBottomLeftCornerRadiuskKHJgLs()), CornerRadius.m2422getYimpl(rounded.getRoundRect().m2494getBottomLeftCornerRadiuskKHJgLs()), paint);
                return;
            }
        }
        if (!(outline instanceof Outline.Generic)) {
    ...
    public static final boolean hasSameCornerRadius(RoundRect roundRect) {
        return ((CornerRadius.m2421getXimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2421getXimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2421getXimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2421getXimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2421getXimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2421getXimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2421getXimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2421getXimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2421getXimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2421getXimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2421getXimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2421getXimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0) && ((CornerRadius.m2422getYimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()) > CornerRadius.m2422getYimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2422getYimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()) == CornerRadius.m2422getYimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2422getYimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) > CornerRadius.m2422getYimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2422getYimpl(roundRect.m2495getBottomRightCornerRadiuskKHJgLs()) == CornerRadius.m2422getYimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) ? 0 : -1)) == 0 && (CornerRadius.m2422getYimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) > CornerRadius.m2422getYimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs()) ? 1 : (CornerRadius.m2422getYimpl(roundRect.m2497getTopRightCornerRadiuskKHJgLs()) == CornerRadius.m2422getYimpl(roundRect.m2496getTopLeftCornerRadiuskKHJgLs()) ? 0 : -1)) == 0);
    }

    /* renamed from: drawOutline-wDX37Ww, reason: not valid java name */
    public static final void m2971drawOutlinewDX37Ww(DrawScope drawOutline, Outline outline, long j, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        ...
        if (outline instanceof Outline.Rectangle) {
            ...
            drawOutline.mo3180drawRectnJ9OG0(j, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                ...
                drawOutline.mo3182drawRoundRectuAw5IA(j, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2421getXimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), style, f, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo3176drawPathLG529CI(path, j, f, style, colorFilter, i);
    }

    /* renamed from: drawOutline-hn5TExg, reason: not valid java name */
    public static final void m2969drawOutlinehn5TExg(DrawScope drawOutline, Outline outline, Brush brush, float f, DrawStyle style, ColorFilter colorFilter, int i) {
        Path path;
        Intrinsics.checkNotNullParameter(drawOutline, "$this$drawOutline");
        Intrinsics.checkNotNullParameter(outline, "outline");
        ...
        if (outline instanceof Outline.Rectangle) {
            Rect rect = ((Outline.Rectangle) outline).getRect();
            drawOutline.mo3179drawRectAsUm42w(brush, topLeft(rect), size(rect), f, style, colorFilter, i);
            return;
        }
        if (outline instanceof Outline.Rounded) {
            Outline.Rounded rounded = (Outline.Rounded) outline;
            ...
            if (path == null) {
                RoundRect roundRect = rounded.getRoundRect();
                drawOutline.mo3181drawRoundRectZuiqVtQ(brush, topLeft(roundRect), size(roundRect), CornerRadiusKt.CornerRadius$default(CornerRadius.m2421getXimpl(roundRect.m2494getBottomLeftCornerRadiuskKHJgLs()), 0.0f, 2, null), f, style, colorFilter, i);
                return;
            }
        } else {
            if (!(outline instanceof Outline.Generic)) {
        ...
        drawOutline.mo3175drawPathGBMwjPU(path, brush, f, style, colorFilter, i);
    }
}
