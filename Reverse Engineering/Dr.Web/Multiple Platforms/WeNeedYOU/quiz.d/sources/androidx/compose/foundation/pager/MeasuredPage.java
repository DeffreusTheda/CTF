...
public final class MeasuredPage implements PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            long m735getOffsetBjo55l4 = m735getOffsetBjo55l4(i);
            if (this.reverseLayout) {
                int m5135getXimpl = this.isVertical ? IntOffset.m5135getXimpl(m735getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5135getXimpl(m735getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m5136getYimpl = (this.mainAxisLayoutSize - IntOffset.m5136getYimpl(m735getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m5136getYimpl = IntOffset.m5136getYimpl(m735getOffsetBjo55l4);
                }
                m735getOffsetBjo55l4 = IntOffsetKt.IntOffset(m5135getXimpl, m5136getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m735getOffsetBjo55l4) + IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(m735getOffsetBjo55l4) + IntOffset.m5136getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m4029placeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4028placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getOffset-Bjo55l4, reason: not valid java name */
    private final long m735getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
    ...
    private final long m734copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
