...
public final class FlowLayoutKt {
    ...
    public static final void FlowRow(Modifier modifier, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, int i, Function3<? super FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Updater.m2325setimpl(m2318constructorimpl, rowMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
    ...
    public static final void FlowColumn(Modifier modifier, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i, Function3<? super FlowColumnScope, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        Composer m2318constructorimpl = Updater.m2318constructorimpl(composer);
        Updater.m2325setimpl(m2318constructorimpl, columnMeasurementHelper, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        Updater.m2325setimpl(m2318constructorimpl, currentCompositionLocalMap, ComposeUiNode.INSTANCE.getSetResolvedCompositionLocals());
        Function2<ComposeUiNode, Integer, Unit> setCompositeKeyHash = ComposeUiNode.INSTANCE.getSetCompositeKeyHash();
        if (m2318constructorimpl.getInserting() || !Intrinsics.areEqual(m2318constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
            m2318constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
    ...
    public static final MeasurePolicy rowMeasurementHelper(Arrangement.Horizontal horizontalArrangement, Arrangement.Vertical verticalArrangement, int i, Composer composer, int i2) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m467flowMeasurePolicybs7tms(LayoutOrientation.Horizontal, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_TOP, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), i);
    ...
    public static final MeasurePolicy columnMeasurementHelper(Arrangement.Vertical verticalArrangement, Arrangement.Horizontal horizontalArrangement, int i, Composer composer, int i2) {
        ...
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = m467flowMeasurePolicybs7tms(LayoutOrientation.Vertical, getVerticalArrangement(verticalArrangement), verticalArrangement.getSpacing(), SizeMode.Wrap, CROSS_AXIS_ALIGNMENT_START, getHorizontalArrangement(horizontalArrangement), horizontalArrangement.getSpacing(), i);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        MeasurePolicy measurePolicy = (MeasurePolicy) rememberedValue;
    ...
    public static final MeasurePolicy m467flowMeasurePolicybs7tms(final LayoutOrientation layoutOrientation, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function5, final float f, final SizeMode sizeMode, final CrossAxisAlignment crossAxisAlignment, final Function5<? super Integer, ? super int[], ? super LayoutDirection, ? super Density, ? super int[], Unit> function52, final float f2, final int i) {
        return new MeasurePolicy(function5, f, sizeMode, crossAxisAlignment, i, f2, function52) { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1
            ...
            public MeasureResult mo44measure3p2s80s(final MeasureScope measure, List<? extends Measurable> measurables, long j) {
                ...
                final FlowResult m466breakDownItemsw1Onq5I = FlowLayoutKt.m466breakDownItemsw1Onq5I(measure, rowColumnMeasurementHelper, LayoutOrientation.this, OrientationIndependentConstraints.m489constructorimpl(j, LayoutOrientation.this), this.$maxItemsInMainAxis);
                MutableVector<RowColumnMeasureHelperResult> items = m466breakDownItemsw1Onq5I.getItems();
                ...
                int crossAxisTotalSize = m466breakDownItemsw1Onq5I.getCrossAxisTotalSize() + (measure.mo354roundToPx0680j_4(this.$crossAxisArrangementSpacing) * (items.getSize() - 1));
                ...
                return MeasureScope.CC.layout$default(measure, ConstraintsKt.m4975constrainWidthK40F9xA(j, crossAxisTotalSize), ConstraintsKt.m4974constrainHeightK40F9xA(j, mainAxisTotalSize), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$flowMeasurePolicy$1$measure$2
            ...
            public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                Intrinsics.checkNotNullParameter(measurables, "measurables");
                if (LayoutOrientation.this == LayoutOrientation.Horizontal) {
                    return minIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo354roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo354roundToPx0680j_4(this.$crossAxisArrangementSpacing));
                }
                return intrinsicCrossAxisSize(measurables, i2, intrinsicMeasureScope.mo354roundToPx0680j_4(this.$mainAxisArrangementSpacing), intrinsicMeasureScope.mo354roundToPx0680j_4(this.$crossAxisArrangementSpacing));
            }
            ...
            public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i2) {
                ...
                return maxIntrinsicMainAxisSize(measurables, i2, intrinsicMeasureScope.mo354roundToPx0680j_4(this.$mainAxisArrangementSpacing));
            }
    ...
    private static final int m468measureAndCache6m2dt9o(Measurable measurable, long j, LayoutOrientation layoutOrientation, Function1<? super Placeable, Unit> function1) {
        if (RowColumnImplKt.getWeight(RowColumnImplKt.getRowColumnParentData(measurable)) == 0.0f) {
            Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(OrientationIndependentConstraints.m502toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m491copyyUG9Ft0$default(j, 0, 0, 0, 0, 14, null), layoutOrientation));
            function1.invoke(mo3967measureBRTryo0);
            return mainAxisSize(mo3967measureBRTryo0, layoutOrientation);
        }
    ...
    public static final FlowResult m466breakDownItemsw1Onq5I(MeasureScope breakDownItems, RowColumnMeasurementHelper measureHelper, LayoutOrientation orientation, long j, int i) {
        ...
        int ceil = (int) Math.ceil(breakDownItems.mo360toPx0680j_4(measureHelper.getArrangementSpacing()));
        long m487constructorimpl = OrientationIndependentConstraints.m487constructorimpl(m4963getMinWidthimpl, m4961getMaxWidthimpl, 0, m4960getMaxHeightimpl);
        Measurable measurable = (Measurable) CollectionsKt.getOrNull(measurables, 0);
        Integer valueOf = measurable != null ? Integer.valueOf(m468measureAndCache6m2dt9o(measurable, m487constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$nextSize$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        while (i3 < size) {
            ...
            Integer valueOf2 = measurable2 != null ? Integer.valueOf(m468measureAndCache6m2dt9o(measurable2, m487constructorimpl, orientation, new Function1<Placeable, Unit>() { // from class: androidx.compose.foundation.layout.FlowLayoutKt$breakDownItems$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
            ...
            int min = Math.min(Math.max(m4963getMinWidthimpl, i7), m4961getMaxWidthimpl);
            numArr[i6] = Integer.valueOf(i8);
            i6++;
            i2 = m4961getMaxWidthimpl;
            valueOf2 = valueOf2 != null ? Integer.valueOf(valueOf2.intValue() - ceil) : null;
            i5 = i8;
            i4 = 0;
            m4963getMinWidthimpl = min;
            i3 = i8;
            valueOf = valueOf2;
        }
        int i9 = m4963getMinWidthimpl;
        long m502toBoxConstraintsOenEA2s = OrientationIndependentConstraints.m502toBoxConstraintsOenEA2s(OrientationIndependentConstraints.m491copyyUG9Ft0$default(m487constructorimpl, i9, 0, 0, 0, 14, null), orientation);
        Integer num = (Integer) ArraysKt.getOrNull(numArr, 0);
        int i10 = 0;
        int i11 = 0;
        int i12 = 0;
        while (num != null) {
            RowColumnMeasureHelperResult m547measureWithoutPlacing_EkL_Y = measureHelper.m547measureWithoutPlacing_EkL_Y(breakDownItems, m502toBoxConstraintsOenEA2s, i10, num.intValue());
            i11 += m547measureWithoutPlacing_EkL_Y.getCrossAxisSize();
            i9 = Math.max(i9, m547measureWithoutPlacing_EkL_Y.getMainAxisSize());
            mutableVector.add(m547measureWithoutPlacing_EkL_Y);
            i10 = num.intValue();
            i12++;
            num = (Integer) ArraysKt.getOrNull(numArr, i12);
        }
        return new FlowResult(Math.max(i9, Constraints.m4963getMinWidthimpl(j)), Math.max(i11, Constraints.m4962getMinHeightimpl(j)), mutableVector);
    }
}
