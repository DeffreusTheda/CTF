...
public final class TopAppBarColors {
    ...
    public final long m1715containerColorXeAY9LY$material3_release(float f, Composer composer, int i) {
        ...
        long m2762lerpjxsXWHM = ColorKt.m2762lerpjxsXWHM(this.containerColor, this.scrolledContainerColor, EasingKt.getFastOutLinearInEasing().transform(f));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m2762lerpjxsXWHM;
    }
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.containerColor, topAppBarColors.containerColor) && Color.m2712equalsimpl0(this.scrolledContainerColor, topAppBarColors.scrolledContainerColor) && Color.m2712equalsimpl0(this.navigationIconContentColor, topAppBarColors.navigationIconContentColor) && Color.m2712equalsimpl0(this.titleContentColor, topAppBarColors.titleContentColor) && Color.m2712equalsimpl0(this.actionIconContentColor, topAppBarColors.actionIconContentColor);
    }

    public int hashCode() {
        return (((((((Color.m2718hashCodeimpl(this.containerColor) * 31) + Color.m2718hashCodeimpl(this.scrolledContainerColor)) * 31) + Color.m2718hashCodeimpl(this.navigationIconContentColor)) * 31) + Color.m2718hashCodeimpl(this.titleContentColor)) * 31) + Color.m2718hashCodeimpl(this.actionIconContentColor);
    }
}
