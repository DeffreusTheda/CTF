...
public final /* data */ class SelectionHandleInfo {
    ...
    public static /* synthetic */ SelectionHandleInfo m938copyUv8p0NA$default(SelectionHandleInfo selectionHandleInfo, Handle handle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return selectionHandleInfo.m940copyUv8p0NA(handle, j);
    }
    ...
    public final SelectionHandleInfo m940copyUv8p0NA(Handle handle, long position) {
    ...
    public boolean equals(Object other) {
        ...
        return this.handle == selectionHandleInfo.handle && Offset.m2443equalsimpl0(this.position, selectionHandleInfo.position);
    }

    public int hashCode() {
        return (this.handle.hashCode() * 31) + Offset.m2448hashCodeimpl(this.position);
    }

    public String toString() {
        return "SelectionHandleInfo(handle=" + this.handle + ", position=" + ((Object) Offset.m2454toStringimpl(this.position)) + ')';
    }
    ...
    public final long m941getPositionF1C5BW0() {
        return this.position;
    }
}
