...
public final class ImageBitmapConfig {
    ...
    private static final int Argb8888 = m2929constructorimpl(0);
    private static final int Alpha8 = m2929constructorimpl(1);
    private static final int Rgb565 = m2929constructorimpl(2);
    private static final int F16 = m2929constructorimpl(3);
    private static final int Gpu = m2929constructorimpl(4);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m2928boximpl(int i) {
    ...
    public static boolean m2930equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m2934unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m2936getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ, reason: not valid java name */
        public final int m2935getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ, reason: not valid java name */
        public final int m2939getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ, reason: not valid java name */
        public final int m2937getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ, reason: not valid java name */
        public final int m2938getGpu_sVssgQ() {
    ...
    public static String m2933toStringimpl(int i) {
        return m2931equalsimpl0(i, Argb8888) ? "Argb8888" : m2931equalsimpl0(i, Alpha8) ? "Alpha8" : m2931equalsimpl0(i, Rgb565) ? "Rgb565" : m2931equalsimpl0(i, F16) ? "F16" : m2931equalsimpl0(i, Gpu) ? "Gpu" : "Unknown";
    }
}
