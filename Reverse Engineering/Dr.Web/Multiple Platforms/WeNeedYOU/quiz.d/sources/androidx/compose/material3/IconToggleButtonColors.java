...
public final class IconToggleButtonColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m2712equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m2712equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m2712equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m2712equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m2712equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor);
    }

    public int hashCode() {
        return (((((((((Color.m2718hashCodeimpl(this.containerColor) * 31) + Color.m2718hashCodeimpl(this.contentColor)) * 31) + Color.m2718hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2718hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2718hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2718hashCodeimpl(this.checkedContentColor);
    }
}
