...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, int i, int i2) {
        ...
        m249Image5hnEew(bitmap, str, companion, center, fit, f2, colorFilter2, FilterQuality.INSTANCE.m2808getLowfv9h1I(), composer, (i & 112) | 8 | (i & 896) | (i & 7168) | (57344 & i) | (458752 & i) | (i & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m249Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(bitmap, "bitmap");
        ...
        int m3268getDefaultFilterQualityfv9h1I = (i3 & 128) != 0 ? DrawScope.INSTANCE.m3268getDefaultFilterQualityfv9h1I() : i;
        if (ComposerKt.isTraceInProgress()) {
        ...
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = BitmapPainterKt.m3339BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, m3268getDefaultFilterQualityfv9h1I, 6, null);
    ...
    public static final void Image(final Painter painter, final String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, Composer composer, final int i, final int i2) {
        ...
        ImageKt$Image$2 imageKt$Image$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.ImageKt$Image$2
            ...
            public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j) {
                ...
                return MeasureScope.CC.layout$default(Layout, Constraints.m4963getMinWidthimpl(j), Constraints.m4962getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.ImageKt$Image$2$measure$1
                    /* renamed from: invoke, reason: avoid collision after fix types in other method */
        ...
        Updater.m2325setimpl(m2318constructorimpl, imageKt$Image$2, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
