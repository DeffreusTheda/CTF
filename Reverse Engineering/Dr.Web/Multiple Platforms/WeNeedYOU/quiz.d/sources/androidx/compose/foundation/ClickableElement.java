...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public void update(ClickableNode node) {
        ...
        node.m235updateXHw0xAI(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((hashCode2 + (role != null ? Role.m4371hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
