...
public final class TimePicker_androidKt {
    ...
    public static final int getDefaultTimePickerLayoutType(Composer composer, int i) {
        ...
        if (configuration.screenHeightDp < configuration.screenWidthDp) {
            m1637getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1636getHorizontalQJTpgSE();
        } else {
            m1637getVerticalQJTpgSE = TimePickerLayoutType.INSTANCE.m1637getVerticalQJTpgSE();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return m1637getVerticalQJTpgSE;
    }
}
