...
public abstract class Ripple implements Indication {
    ...
    public abstract RippleIndicationInstance mo1003rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i);
    ...
    public final IndicationInstance rememberUpdatedInstance(InteractionSource interactionSource, Composer composer, int i) {
        long mo1005defaultColorWaAFU9c;
        ...
        if (this.color.getValue().m2721unboximpl() != Color.INSTANCE.m2747getUnspecified0d7_KjU()) {
            mo1005defaultColorWaAFU9c = this.color.getValue().m2721unboximpl();
        } else {
            mo1005defaultColorWaAFU9c = rippleTheme.mo1005defaultColorWaAFU9c(composer, 0);
        }
        composer.endReplaceableGroup();
        RippleIndicationInstance mo1003rememberUpdatedRippleInstance942rkJo = mo1003rememberUpdatedRippleInstance942rkJo(interactionSource, this.bounded, this.radius, SnapshotStateKt.rememberUpdatedState(Color.m2701boximpl(mo1005defaultColorWaAFU9c), composer, 0), SnapshotStateKt.rememberUpdatedState(rippleTheme.rippleAlpha(composer, 0), composer, 0), composer, (i & 14) | ((i << 12) & 458752));
        EffectsKt.LaunchedEffect(mo1003rememberUpdatedRippleInstance942rkJo, interactionSource, new Ripple$rememberUpdatedInstance$1(interactionSource, mo1003rememberUpdatedRippleInstance942rkJo, null), composer, ((i << 3) & 112) | 520);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return mo1003rememberUpdatedRippleInstance942rkJo;
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.bounded == ripple.bounded && Dp.m5022equalsimpl0(this.radius, ripple.radius) && Intrinsics.areEqual(this.color, ripple.color);
    }

    public int hashCode() {
        return (((UByte$$ExternalSyntheticBackport0.m(this.bounded) * 31) + Dp.m5023hashCodeimpl(this.radius)) * 31) + this.color.hashCode();
    }
}
