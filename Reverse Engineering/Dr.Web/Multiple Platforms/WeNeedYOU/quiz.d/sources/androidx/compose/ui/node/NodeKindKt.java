...
public final class NodeKindKt {
    ...
    public static final boolean m4192contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m4194or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4184constructorimpl = NodeKind.m4184constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4184constructorimpl |= NodeKind.m4184constructorimpl(32768);
        }
        return node instanceof SoftKeyboardInterceptionModifierNode ? m4184constructorimpl | NodeKind.m4184constructorimpl(131072) : m4184constructorimpl;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m4184constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m4082requireCoordinator64DMado(node, NodeKind.m4184constructorimpl(2)).onRelease();
                }
            }
            if ((NodeKind.m4184constructorimpl(256) & i) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if ((NodeKind.m4184constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m4184constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m4184constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if ((NodeKind.m4184constructorimpl(1024) & i) != 0 && (node instanceof FocusTargetNode)) {
                if (i2 == 2) {
                    node.onReset();
                } else {
            ...
            if ((NodeKind.m4184constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m4184constructorimpl(4096)) == 0 || !(node instanceof FocusEventModifierNode)) {
                return;
            }
    ...
    public static final boolean m4193getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m4184constructorimpl(128)) != 0;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4184constructorimpl | NodeKind.m4184constructorimpl(128) : m4184constructorimpl;
    }
}
