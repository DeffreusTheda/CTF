...
public final class LookaheadLayoutCoordinatesImpl implements LookaheadLayoutCoordinates {
    ...
    public long mo3974getSizeYbymL2g() {
    ...
    private final long m3991getLookaheadOffsetF1C5BW0() {
        LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m2450minusMKHz9U(mo3975localPositionOfR5De75A(rootLookaheadDelegate.getCoordinates(), Offset.INSTANCE.m2462getZeroF1C5BW0()), getCoordinator().mo3975localPositionOfR5De75A(rootLookaheadDelegate.getCoordinator(), Offset.INSTANCE.m2462getZeroF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: windowToLocal-MK-Hz9U */
    public long mo3979windowToLocalMKHz9U(long relativeToWindow) {
        return Offset.m2451plusMKHz9U(getCoordinator().mo3979windowToLocalMKHz9U(relativeToWindow), m3991getLookaheadOffsetF1C5BW0());
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToWindow-MK-Hz9U */
    public long mo3977localToWindowMKHz9U(long relativeToLocal) {
        return getCoordinator().mo3977localToWindowMKHz9U(Offset.m2451plusMKHz9U(relativeToLocal, m3991getLookaheadOffsetF1C5BW0()));
    }

    @Override // androidx.compose.ui.layout.LayoutCoordinates
    /* renamed from: localToRoot-MK-Hz9U */
    public long mo3976localToRootMKHz9U(long relativeToLocal) {
        return getCoordinator().mo3976localToRootMKHz9U(Offset.m2451plusMKHz9U(relativeToLocal, m3991getLookaheadOffsetF1C5BW0()));
    }
    ...
    public long mo3975localPositionOfR5De75A(LayoutCoordinates sourceCoordinates, long relativeToSource) {
        ...
        if (sourceCoordinates instanceof LookaheadLayoutCoordinatesImpl) {
            ...
            if (lookaheadDelegate2 != null) {
                long m4136positionInBjo55l4$ui_release = lookaheadDelegate.m4136positionInBjo55l4$ui_release(lookaheadDelegate2);
                long IntOffset = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2446getXimpl(relativeToSource)), MathKt.roundToInt(Offset.m2447getYimpl(relativeToSource)));
                long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m4136positionInBjo55l4$ui_release) + IntOffset.m5135getXimpl(IntOffset), IntOffset.m5136getYimpl(m4136positionInBjo55l4$ui_release) + IntOffset.m5136getYimpl(IntOffset));
                long m4136positionInBjo55l4$ui_release2 = this.lookaheadDelegate.m4136positionInBjo55l4$ui_release(lookaheadDelegate2);
                long IntOffset3 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset2) - IntOffset.m5135getXimpl(m4136positionInBjo55l4$ui_release2), IntOffset.m5136getYimpl(IntOffset2) - IntOffset.m5136getYimpl(m4136positionInBjo55l4$ui_release2));
                return OffsetKt.Offset(IntOffset.m5135getXimpl(IntOffset3), IntOffset.m5136getYimpl(IntOffset3));
            }
            LookaheadDelegate rootLookaheadDelegate = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate);
            long m4136positionInBjo55l4$ui_release3 = lookaheadDelegate.m4136positionInBjo55l4$ui_release(rootLookaheadDelegate);
            long position = rootLookaheadDelegate.getPosition();
            long IntOffset4 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m4136positionInBjo55l4$ui_release3) + IntOffset.m5135getXimpl(position), IntOffset.m5136getYimpl(m4136positionInBjo55l4$ui_release3) + IntOffset.m5136getYimpl(position));
            long IntOffset5 = IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2446getXimpl(relativeToSource)), MathKt.roundToInt(Offset.m2447getYimpl(relativeToSource)));
            long IntOffset6 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset4) + IntOffset.m5135getXimpl(IntOffset5), IntOffset.m5136getYimpl(IntOffset4) + IntOffset.m5136getYimpl(IntOffset5));
            LookaheadDelegate lookaheadDelegate3 = this.lookaheadDelegate;
            long m4136positionInBjo55l4$ui_release4 = lookaheadDelegate3.m4136positionInBjo55l4$ui_release(LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate3));
            long position2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(lookaheadDelegate3).getPosition();
            long IntOffset7 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m4136positionInBjo55l4$ui_release4) + IntOffset.m5135getXimpl(position2), IntOffset.m5136getYimpl(m4136positionInBjo55l4$ui_release4) + IntOffset.m5136getYimpl(position2));
            long IntOffset8 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(IntOffset6) - IntOffset.m5135getXimpl(IntOffset7), IntOffset.m5136getYimpl(IntOffset6) - IntOffset.m5136getYimpl(IntOffset7));
            ...
            return wrappedBy.mo3975localPositionOfR5De75A(wrappedBy2, OffsetKt.Offset(IntOffset.m5135getXimpl(IntOffset8), IntOffset.m5136getYimpl(IntOffset8)));
        }
        LookaheadDelegate rootLookaheadDelegate2 = LookaheadLayoutCoordinatesKt.getRootLookaheadDelegate(this.lookaheadDelegate);
        return Offset.m2451plusMKHz9U(mo3975localPositionOfR5De75A(rootLookaheadDelegate2.getLookaheadLayoutCoordinates(), relativeToSource), rootLookaheadDelegate2.getCoordinator().getCoordinates().mo3975localPositionOfR5De75A(sourceCoordinates, Offset.INSTANCE.m2462getZeroF1C5BW0()));
    }
    ...
    public void mo3978transformFromEL8BTi8(LayoutCoordinates sourceCoordinates, float[] matrix) {
        ...
        getCoordinator().mo3978transformFromEL8BTi8(sourceCoordinates, matrix);
    }
