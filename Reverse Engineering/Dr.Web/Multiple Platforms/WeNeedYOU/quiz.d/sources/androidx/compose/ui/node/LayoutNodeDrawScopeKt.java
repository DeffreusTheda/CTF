...
public final class LayoutNodeDrawScopeKt {
    ...
    public static final Modifier.Node nextDrawNode(DelegatableNode delegatableNode) {
        ...
        int m4184constructorimpl2 = NodeKind.m4184constructorimpl(2);
        Modifier.Node child = delegatableNode.getNode().getChild();
        if (child == null || (child.getAggregateChildKindSet() & m4184constructorimpl) == 0) {
            return null;
        }
        while (child != null && (child.getKindSet() & m4184constructorimpl2) == 0) {
