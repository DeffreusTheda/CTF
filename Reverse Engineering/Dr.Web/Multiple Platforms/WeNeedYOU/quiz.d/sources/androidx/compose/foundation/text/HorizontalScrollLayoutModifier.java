...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo70measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4960getMaxHeightimpl(j)) < Constraints.m4961getMaxWidthimpl(j) ? j : Constraints.m4952copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int min = Math.min(mo3967measureBRTryo0.getWidth(), Constraints.m4961getMaxWidthimpl(j));
        return MeasureScope.CC.layout$default(measure, min, mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, invoke != null ? invoke.getValue() : null, MeasureScope.this.getLayoutDirection() == LayoutDirection.Rtl, mo3967measureBRTryo0.getWidth()), min, mo3967measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo0, MathKt.roundToInt(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
