...
public final class CursorAnchorInfoBuilderKt {
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, TextLayoutResult textLayoutResult, Matrix matrix) {
        ...
        int m4530getMinimpl = TextRange.m4530getMinimpl(textFieldValue.getSelection());
        builder.setSelectionRange(m4530getMinimpl, TextRange.m4529getMaximpl(textFieldValue.getSelection()));
        setInsertionMarker(builder, m4530getMinimpl, textLayoutResult);
        ...
        int m4529getMaximpl = composition2 != null ? TextRange.m4529getMaximpl(composition2.getPackedValue()) : -1;
        if (m4530getMinimpl2 >= 0 && m4530getMinimpl2 < m4529getMaximpl) {
            builder.setComposingText(m4530getMinimpl2, textFieldValue.getText().subSequence(m4530getMinimpl2, m4529getMaximpl));
        }
