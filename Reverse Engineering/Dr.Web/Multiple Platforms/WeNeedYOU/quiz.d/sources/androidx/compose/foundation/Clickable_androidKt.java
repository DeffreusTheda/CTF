...
public final class Clickable_androidKt {
    ...
    public static final boolean m241isPressZmokQxo(KeyEvent isPress) {
        Intrinsics.checkNotNullParameter(isPress, "$this$isPress");
        return KeyEventType.m3703equalsimpl0(KeyEvent_androidKt.m3711getTypeZmokQxo(isPress), KeyEventType.INSTANCE.m3707getKeyDownCS__XNY()) && m240isEnterZmokQxo(isPress);
    }

    /* renamed from: isClick-ZmokQxo, reason: not valid java name */
    public static final boolean m239isClickZmokQxo(KeyEvent isClick) {
        Intrinsics.checkNotNullParameter(isClick, "$this$isClick");
        return KeyEventType.m3703equalsimpl0(KeyEvent_androidKt.m3711getTypeZmokQxo(isClick), KeyEventType.INSTANCE.m3708getKeyUpCS__XNY()) && m240isEnterZmokQxo(isClick);
    }

    /* renamed from: isEnter-ZmokQxo, reason: not valid java name */
    private static final boolean m240isEnterZmokQxo(KeyEvent keyEvent) {
        int m3717getNativeKeyCodeYVgTNJs = Key_androidKt.m3717getNativeKeyCodeYVgTNJs(KeyEvent_androidKt.m3710getKeyZmokQxo(keyEvent));
        return m3717getNativeKeyCodeYVgTNJs == 23 || m3717getNativeKeyCodeYVgTNJs == 66 || m3717getNativeKeyCodeYVgTNJs == 160;
    }
}
