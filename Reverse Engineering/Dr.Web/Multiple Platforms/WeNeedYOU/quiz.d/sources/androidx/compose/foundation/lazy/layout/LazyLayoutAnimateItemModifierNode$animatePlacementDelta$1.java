    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!animatable2.isRunning()) {
                ...
                this.label = 1;
                if (animatable3.snapTo(IntOffset.m5126boximpl(this.$totalDelta), this) == coroutine_suspended) {
        ...
        final long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(packedValue) - IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(packedValue) - IntOffset.m5136getYimpl(j));
        ...
        this.L$0 = null;
        this.label = 2;
        if (Animatable.animateTo$default(animatable5, m5126boximpl, finiteAnimationSpec2, null, new Function1<Animatable<IntOffset, AnimationVector2D>, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode$animatePlacementDelta$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Animatable<IntOffset, AnimationVector2D> animateTo) {
                ...
                long j2 = IntOffset;
                lazyLayoutAnimateItemModifierNode2.m663setPlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(packedValue2) - IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(packedValue2) - IntOffset.m5136getYimpl(j2)));
            }
