...
final class MinimumInteractiveComponentSizeModifier implements LayoutModifier {
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final int max = Math.max(mo3967measureBRTryo0.getWidth(), measure.mo354roundToPx0680j_4(DpSize.m5115getWidthD9Ej5fM(this.size)));
        final int max2 = Math.max(mo3967measureBRTryo0.getHeight(), measure.mo354roundToPx0680j_4(DpSize.m5113getHeightD9Ej5fM(this.size)));
        return MeasureScope.CC.layout$default(measure, max, max2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.MinimumInteractiveComponentSizeModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.place$default(layout, mo3967measureBRTryo0, MathKt.roundToInt((max - mo3967measureBRTryo0.getWidth()) / 2.0f), MathKt.roundToInt((max2 - mo3967measureBRTryo0.getHeight()) / 2.0f), 0.0f, 4, null);
            }
        }, 4, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return DpSize.m5112equalsimpl0(this.size, minimumInteractiveComponentSizeModifier.size);
    }

    public int hashCode() {
        return DpSize.m5117hashCodeimpl(this.size);
    }
}
