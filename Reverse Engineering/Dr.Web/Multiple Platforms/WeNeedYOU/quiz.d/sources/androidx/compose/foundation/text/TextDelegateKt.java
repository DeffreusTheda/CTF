...
public final class TextDelegateKt {
    ...
    public static final TextDelegate m847updateTextDelegaterm0N8CA(TextDelegate current, AnnotatedString text, TextStyle style, Density density, FontFamily.Resolver fontFamilyResolver, boolean z, int i, int i2, int i3, List<AnnotatedString.Range<Placeholder>> placeholders) {
        ...
        if (Intrinsics.areEqual(current.getText(), text) && Intrinsics.areEqual(current.getStyle(), style)) {
            if (current.getSoftWrap() == z) {
                if (TextOverflow.m4939equalsimpl0(current.getOverflow(), i)) {
