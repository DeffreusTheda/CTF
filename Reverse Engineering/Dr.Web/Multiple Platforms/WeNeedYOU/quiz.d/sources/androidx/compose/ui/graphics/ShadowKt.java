...
public final class ShadowKt {
    public static final Shadow lerp(Shadow start, Shadow stop, float f) {
        ...
        return new Shadow(ColorKt.m2762lerpjxsXWHM(start.getColor(), stop.getColor(), f), OffsetKt.m2469lerpWko1d7g(start.getOffset(), stop.getOffset(), f), MathHelpersKt.lerp(start.getBlurRadius(), stop.getBlurRadius(), f), null);
    }
}
