...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m5017constructorimpl(56);
    private static final PagerLayoutInfo EmptyLayoutInfo = new PagerLayoutInfo() { // from class: androidx.compose.foundation.pager.PagerStateKt$EmptyLayoutInfo$1
        ...
        private final long viewportSize = IntSize.INSTANCE.m5182getZeroYbymL2g();
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> pageCount, Composer composer, int i2, int i3) {
        ...
        PagerStateImpl pagerStateImpl = (PagerStateImpl) RememberSaveableKt.m2332rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
