...
public final class DateRangePickerKt {
    ...
    private static final PaddingValues CalendarMonthSubheadPadding = PaddingKt.m517PaddingValuesa9UjIt4$default(Dp.m5017constructorimpl(24), Dp.m5017constructorimpl(20), 0.0f, Dp.m5017constructorimpl(8), 4, null);
    private static final float HeaderHeightOffset = Dp.m5017constructorimpl(60);
    ...
    */
    ...
    public static final DateRangePickerState m1200rememberDateRangePickerStatepMw4iz8(Long l, Long l2, Long l3, IntRange intRange, int i, Composer composer, int i2, int i3) {
        ...
        final int m1221getPickerjFl4v0 = (i3 & 16) != 0 ? DisplayMode.INSTANCE.m1221getPickerjFl4v0() : i;
        ...
        DateRangePickerState dateRangePickerState = (DateRangePickerState) RememberSaveableKt.m2332rememberSaveable(new Object[0], (Saver) DateRangePickerState.INSTANCE.Saver(), (String) null, (Function0) new Function0<DateRangePickerState>() { // from class: androidx.compose.material3.DateRangePickerKt$rememberDateRangePickerState$1
            ...
            public final DateRangePickerState invoke() {
                return new DateRangePickerState(l4, l5, l6, yearRange, m1221getPickerjFl4v0, null);
            }
        }, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void SwitchableDateEntryContent(final DateRangePickerState dateRangePickerState, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i3 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            int m1203getDisplayModejFl4v0 = dateRangePickerState.m1203getDisplayModejFl4v0();
            CrossfadeKt.Crossfade(DisplayMode.m1213boximpl(m1203getDisplayModejFl4v0), SemanticsModifierKt.semantics$default(Modifier.INSTANCE, false, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$SwitchableDateEntryContent$1
                ...
                public /* bridge */ /* synthetic */ Unit invoke(DisplayMode displayMode, Composer composer2, Integer num) {
                    m1202invokeQujVXRc(displayMode.getValue(), composer2, num.intValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-QujVXRc, reason: not valid java name */
                public final void m1202invokeQujVXRc(int i4, Composer composer2, int i5) {
                    int i6;
    ...
    public static final void DateRangePickerContent(final StateData stateData, final DatePickerFormatter datePickerFormatter, final Function1<? super Long, Boolean> function1, final DatePickerColors datePickerColors, Composer composer, final int i) {
        ...
        if ((i2 & 5851) != 1170 || !startRestartGroup.getSkipping()) {
            ...
            Modifier m522paddingVpY3zN4$default = PaddingKt.m522paddingVpY3zN4$default(Modifier.INSTANCE, DatePickerKt.getDatePickerHorizontalPadding(), 0.0f, 2, null);
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), DatePickerModalTokens.INSTANCE.getRangeSelectionMonthSubheadFont()), ComposableLambdaKt.composableLambda(startRestartGroup, 56792252, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1
                ...
                public final void invoke(Composer composer2, int i4) {
                    ...
                    if ((i4 & 11) != 2 || !composer2.getSkipping()) {
                        ...
                        composer2.endReplaceableGroup();
                        final String m1512getStringNWtq28 = Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1484getDateRangePickerScrollToShowPreviousMonthadMyvUU(), composer2, 6);
                        final String m1512getStringNWtq282 = Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1483getDateRangePickerScrollToShowNextMonthadMyvUU(), composer2, 6);
                                ...
                                LazyListScope.CC.items$default(LazyColumn, totalMonthsInRange, null, null, ComposableLambdaKt.composableLambdaInstance(1246706073, true, new Function4<LazyItemScope, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.material3.DateRangePickerKt.VerticalMonthsList.1.2.1
                                    ...
                                    public final void invoke(LazyItemScope items, int i7, Composer composer3, int i8) {
                                        ...
                                        if ((i9 & 731) != 146 || !composer3.getSkipping()) {
                                            ...
                                            TextKt.m1599Text4IGK_g(formatMonthYear$material3_release, SemanticsModifierKt.semantics$default(ClickableKt.m226clickableXHw0xAI$default(PaddingKt.padding(Modifier.INSTANCE, DateRangePickerKt.getCalendarMonthSubheadPadding()), false, null, null, new Function0<Unit>() { // from class: androidx.compose.material3.DateRangePickerKt$VerticalMonthsList$1$2$1$1$1
                                                /* renamed from: invoke, reason: avoid collision after fix types in other method */
    ...
    public static final void m1199drawRangeBackgroundmxwnekA(ContentDrawScope drawRangeBackground, SelectedRangeInfo selectedRangeInfo, long j) {
        ...
        float f = drawRangeBackground.mo360toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f2 = drawRangeBackground.mo360toPx0680j_4(DatePickerKt.getRecommendedSizeForAccessibility());
        float f3 = drawRangeBackground.mo360toPx0680j_4(DatePickerModalTokens.INSTANCE.m1833getDateStateLayerHeightD9Ej5fM());
        float f4 = 2;
        float f5 = (f2 - f3) / f4;
        float f6 = 7;
        float m2515getWidthimpl2 = (Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()) - (f6 * f)) / f6;
        long packedValue = selectedRangeInfo.getGridCoordinates().getFirst().getPackedValue();
        int m5127component1impl = IntOffset.m5127component1impl(packedValue);
        int m5128component2impl = IntOffset.m5128component2impl(packedValue);
        long packedValue2 = selectedRangeInfo.getGridCoordinates().getSecond().getPackedValue();
        int m5127component1impl2 = IntOffset.m5127component1impl(packedValue2);
        int m5128component2impl2 = IntOffset.m5128component2impl(packedValue2);
        float f7 = f + m2515getWidthimpl2;
        float f8 = m2515getWidthimpl2 / f4;
        float f9 = (m5127component1impl * f7) + (selectedRangeInfo.getFirstIsSelectionStart() ? f / f4 : 0.0f) + f8;
        float f10 = (m5128component2impl * f2) + f5;
        float f11 = m5127component1impl2 * f7;
        if (selectedRangeInfo.getLastIsSelectionEnd()) {
            f /= f4;
        }
        float f12 = f11 + f + f8;
        float f13 = (m5128component2impl2 * f2) + f5;
        boolean z = drawRangeBackground.getLayoutDirection() == LayoutDirection.Rtl;
        if (z) {
            f9 = Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()) - f9;
            f12 = Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()) - f12;
        }
        ContentDrawScope contentDrawScope = drawRangeBackground;
        long Offset = OffsetKt.Offset(f9, f10);
        if (m5128component2impl == m5128component2impl2) {
            m2515getWidthimpl = f12 - f9;
        } else {
            m2515getWidthimpl = z ? -f9 : Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()) - f9;
        }
        DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, j, Offset, SizeKt.Size(m2515getWidthimpl, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        if (m5128component2impl != m5128component2impl2) {
            for (int i = (m5128component2impl2 - m5128component2impl) - 1; i > 0; i--) {
                DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, j, OffsetKt.Offset(0.0f, (i * f2) + f10), SizeKt.Size(Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()), f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            }
            long Offset2 = OffsetKt.Offset(drawRangeBackground.getLayoutDirection() != LayoutDirection.Ltr ? Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc()) : 0.0f, f13);
            if (z) {
                f12 -= Size.m2515getWidthimpl(drawRangeBackground.mo3184getSizeNHjbRc());
            }
            DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, j, Offset2, SizeKt.Size(f12, f3), 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
        }
    }
    ...
    static {
        float f = 64;
        float f2 = 12;
        DateRangePickerTitlePadding = PaddingKt.m517PaddingValuesa9UjIt4$default(Dp.m5017constructorimpl(f), 0.0f, Dp.m5017constructorimpl(f2), 0.0f, 10, null);
        DateRangePickerHeadlinePadding = PaddingKt.m517PaddingValuesa9UjIt4$default(Dp.m5017constructorimpl(f), 0.0f, Dp.m5017constructorimpl(f2), Dp.m5017constructorimpl(f2), 2, null);
    }
}
