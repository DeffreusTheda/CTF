...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    private final float[] tmpMatrix = Matrix.m2944constructorimpl$default(null, 1, null);

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo4277calculateMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        Matrix.m2953resetimpl(matrix);
        m4280transformMatrixToWindowEL8BTi8(view, matrix);
    }

    /* renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m4280transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m4280transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m4279preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m4279preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpLocation);
            m4279preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m4279preTranslate3XD1CNM(matrix, r0[0], r0[1]);
        }
        ...
        m4278preConcattUYjHk(matrix, viewMatrix);
    }

    /* renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m4278preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m2559setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m4276preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m4279preTranslate3XD1CNM(float[] fArr, float f, float f2) {
        Matrix.m2953resetimpl(this.tmpMatrix);
        Matrix.m2964translateimpl$default(this.tmpMatrix, f, f2, 0.0f, 4, null);
        AndroidComposeView_androidKt.m4276preTransformJiSxe2E(fArr, this.tmpMatrix);
    }
}
