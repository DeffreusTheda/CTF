...
public final class Updater<T> {
    ...
    public static final /* synthetic */ Updater m2317boximpl(Composer composer) {
        return new Updater(composer);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <T> Composer m2318constructorimpl(Composer composer) {
        Intrinsics.checkNotNullParameter(composer, "composer");
        return composer;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m2319equalsimpl(Composer composer, Object obj) {
        return (obj instanceof Updater) && Intrinsics.areEqual(composer, ((Updater) obj).getComposer());
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m2320equalsimpl0(Composer composer, Composer composer2) {
    ...
    public static int m2321hashCodeimpl(Composer composer) {
        return composer.hashCode();
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m2326toStringimpl(Composer composer) {
        return "Updater(composer=" + composer + ')';
    }

    public boolean equals(Object obj) {
        return m2319equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m2321hashCodeimpl(this.composer);
    }

    public String toString() {
        return m2326toStringimpl(this.composer);
    }
    ...
    public static final void m2324setimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
    ...
    /* renamed from: set-impl, reason: not valid java name */
    public static final <V> void m2325setimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2327updateimpl(Composer composer, int i, Function2<? super T, ? super Integer, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    /* renamed from: update-impl, reason: not valid java name */
    public static final <V> void m2328updateimpl(Composer composer, V v, Function2<? super T, ? super V, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        boolean inserting = composer.getInserting();
    ...
    public static final void m2322initimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
    ...
    public static final void m2323reconcileimpl(Composer composer, final Function1<? super T, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
