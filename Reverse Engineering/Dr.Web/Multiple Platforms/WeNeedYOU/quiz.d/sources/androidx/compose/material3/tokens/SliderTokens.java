...
public final class SliderTokens {
    ...
    private static final float DisabledHandleElevation = ElevationTokens.INSTANCE.m1862getLevel0D9Ej5fM();
    ...
    private static final float HandleElevation = ElevationTokens.INSTANCE.m1863getLevel1D9Ej5fM();
    ...
    private static final float LabelContainerElevation = ElevationTokens.INSTANCE.m1862getLevel0D9Ej5fM();
    private static final float LabelContainerHeight = Dp.m5017constructorimpl((float) 28.0d);
    ...
    private static final float TrackElevation = ElevationTokens.INSTANCE.m1862getLevel0D9Ej5fM();
    private static final ColorSchemeKeyTokens OverlapHandleOutlineColor = ColorSchemeKeyTokens.OnPrimary;
    private static final float OverlapHandleOutlineWidth = Dp.m5017constructorimpl((float) 1.0d);
    ...
    private static final float TickMarksContainerSize = Dp.m5017constructorimpl((float) 2.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveTrackHeight = Dp.m5017constructorimpl(f);
        float f2 = (float) 20.0d;
        HandleHeight = Dp.m5017constructorimpl(f2);
        HandleWidth = Dp.m5017constructorimpl(f2);
        InactiveTrackHeight = Dp.m5017constructorimpl(f);
    }
    ...
    public final float m2158getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2159getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2160getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2161getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2162getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2163getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2164getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2165getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2167getStateLayerSizeD9Ej5fM() {
        return StateLayerSize;
    }

    /* renamed from: getTrackElevation-D9Ej5fM, reason: not valid java name */
    public final float m2169getTrackElevationD9Ej5fM() {
    ...
    public final float m2166getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2168getTickMarksContainerSizeD9Ej5fM() {
