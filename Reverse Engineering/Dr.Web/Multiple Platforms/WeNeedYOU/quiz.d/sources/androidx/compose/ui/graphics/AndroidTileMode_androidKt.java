...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m2592isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m3082equalsimpl0(i, TileMode.INSTANCE.m3087getDecal3opZhB0());
    }

    /* renamed from: toAndroidTileMode-0vamqd0, reason: not valid java name */
    public static final Shader.TileMode m2593toAndroidTileMode0vamqd0(int i) {
        if (TileMode.m3082equalsimpl0(i, TileMode.INSTANCE.m3086getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m3082equalsimpl0(i, TileMode.INSTANCE.m3089getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m3082equalsimpl0(i, TileMode.INSTANCE.m3088getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (TileMode.m3082equalsimpl0(i, TileMode.INSTANCE.m3087getDecal3opZhB0())) {
    ...
    public static final int toComposeTileMode(Shader.TileMode tileMode) {
        ...
        if (i == 1) {
            return TileMode.INSTANCE.m3086getClamp3opZhB0();
        }
        if (i == 2) {
            return TileMode.INSTANCE.m3088getMirror3opZhB0();
        }
        if (i == 3) {
            return TileMode.INSTANCE.m3089getRepeated3opZhB0();
        }
        if (Build.VERSION.SDK_INT >= 31) {
            tileMode2 = Shader.TileMode.DECAL;
            if (tileMode == tileMode2) {
                return TileModeVerificationHelper.INSTANCE.m3090getComposeTileModeDecal3opZhB0();
            }
        }
        return TileMode.INSTANCE.m3086getClamp3opZhB0();
    }
