...
public abstract class Painter {
    ...
    public abstract long mo3336getIntrinsicSizeNHjbRc();
    ...
    public static /* synthetic */ void m3341drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j, float f, ColorFilter colorFilter, int i, Object obj) {
        if (obj != null) {
        ...
        painter.m3342drawx_KDEd0(drawScope, j, f2, colorFilter);
    }

    /* renamed from: draw-x_KDEd0, reason: not valid java name */
    public final void m3342drawx_KDEd0(DrawScope draw, long j, float f, ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float m2515getWidthimpl = Size.m2515getWidthimpl(draw.mo3184getSizeNHjbRc()) - Size.m2515getWidthimpl(j);
        float m2512getHeightimpl = Size.m2512getHeightimpl(draw.mo3184getSizeNHjbRc()) - Size.m2512getHeightimpl(j);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, m2515getWidthimpl, m2512getHeightimpl);
        if (f > 0.0f && Size.m2515getWidthimpl(j) > 0.0f && Size.m2512getHeightimpl(j) > 0.0f) {
            if (this.useLayer) {
                Rect m2486Recttz77jQw = RectKt.m2486Recttz77jQw(Offset.INSTANCE.m2462getZeroF1C5BW0(), SizeKt.Size(Size.m2515getWidthimpl(j), Size.m2512getHeightimpl(j)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(m2486Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
