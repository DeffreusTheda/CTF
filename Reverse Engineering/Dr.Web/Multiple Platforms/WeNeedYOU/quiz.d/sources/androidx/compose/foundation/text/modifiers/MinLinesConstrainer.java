...
public final class MinLinesConstrainer {
    ...
    public final long m890coerceMinLinesOh53vG4$foundation_release(long inConstraints, int minLines) {
        String str;
        Paragraph m4430ParagraphUdtVg6A;
        String str2;
        Paragraph m4430ParagraphUdtVg6A2;
        ...
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            ...
            m4430ParagraphUdtVg6A = ParagraphKt.m4430ParagraphUdtVg6A(str, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 1, (r22 & 256) != 0 ? false : false);
            f = m4430ParagraphUdtVg6A.getHeight();
            str2 = MinLinesConstrainerKt.TwoLineTextReplacement;
            m4430ParagraphUdtVg6A2 = ParagraphKt.m4430ParagraphUdtVg6A(str2, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null), this.density, this.fontFamilyResolver, (r22 & 32) != 0 ? CollectionsKt.emptyList() : null, (r22 & 64) != 0 ? CollectionsKt.emptyList() : null, (r22 & 128) != 0 ? Integer.MAX_VALUE : 2, (r22 & 256) != 0 ? false : false);
            f2 = m4430ParagraphUdtVg6A2.getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (minLines != 1) {
            m4962getMinHeightimpl = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(MathKt.roundToInt(f + (f2 * (minLines - 1))), 0), Constraints.m4960getMaxHeightimpl(inConstraints));
        } else {
            m4962getMinHeightimpl = Constraints.m4962getMinHeightimpl(inConstraints);
        }
        return ConstraintsKt.Constraints(Constraints.m4963getMinWidthimpl(inConstraints), Constraints.m4961getMaxWidthimpl(inConstraints), m4962getMinHeightimpl, Constraints.m4960getMaxHeightimpl(inConstraints));
    }
}
