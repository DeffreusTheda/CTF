...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m4583getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m4630equalsimpl0(i, FontStyle.INSTANCE.m4634getItalic_LCdwA()));
    }
}
