...
public final class TextOverflow {
    ...
    private static final int Clip = m4937constructorimpl(1);
    private static final int Ellipsis = m4937constructorimpl(2);
    private static final int Visible = m4937constructorimpl(3);

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ TextOverflow m4936boximpl(int i) {
    ...
    public static final boolean m4939equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public static String m4941toStringimpl(int i) {
        return m4939equalsimpl0(i, Clip) ? "Clip" : m4939equalsimpl0(i, Ellipsis) ? "Ellipsis" : m4939equalsimpl0(i, Visible) ? "Visible" : "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m4943getClipgIe3tQ8$annotations() {
        }

        /* renamed from: getEllipsis-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m4944getEllipsisgIe3tQ8$annotations() {
        }

        /* renamed from: getVisible-gIe3tQ8$annotations, reason: not valid java name */
        public static /* synthetic */ void m4945getVisiblegIe3tQ8$annotations() {
        }
        ...
        public final int m4946getClipgIe3tQ8() {
            return TextOverflow.Clip;
        }

        /* renamed from: getEllipsis-gIe3tQ8, reason: not valid java name */
        public final int m4947getEllipsisgIe3tQ8() {
            return TextOverflow.Ellipsis;
        }

        /* renamed from: getVisible-gIe3tQ8, reason: not valid java name */
        public final int m4948getVisiblegIe3tQ8() {
