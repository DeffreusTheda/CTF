...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    */
    public void mo3869onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r5, androidx.compose.ui.input.pointer.PointerEventPass r6, long r7) {
        /*
            r4 = this;
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo3869onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        long mo3976localToRootMKHz9U = layoutCoordinates$ui_release.mo3976localToRootMKHz9U(Offset.INSTANCE.m2462getZeroF1C5BW0());
                        final PointerInteropFilter pointerInteropFilter = this.this$0;
                        PointerInteropUtils_androidKt.m3907toCancelMotionEventScoped4ec7I(pointerEvent, mo3976localToRootMKHz9U, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$2
                            {
                                super(1);
                            }
        ...
        if (layoutCoordinates$ui_release2 != null) {
            long mo3976localToRootMKHz9U2 = layoutCoordinates$ui_release2.mo3976localToRootMKHz9U(Offset.INSTANCE.m2462getZeroF1C5BW0());
            final PointerInteropFilter pointerInteropFilter2 = this.this$0;
            PointerInteropUtils_androidKt.m3908toMotionEventScoped4ec7I(pointerEvent, mo3976localToRootMKHz9U2, new Function1<MotionEvent, Unit>() { // from class: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1$dispatchToView$3
