...
public final class LazyListItemPlacementAnimator {
    ...
    private final void initializeNode(LazyListMeasuredItem item, int mainAxisOffset) {
        ...
        long m630getOffsetBjo55l4 = item.m630getOffsetBjo55l4(0);
        if (item.getIsVertical()) {
            m5131copyiSbpLlY$default = IntOffset.m5131copyiSbpLlY$default(m630getOffsetBjo55l4, 0, mainAxisOffset, 1, null);
        } else {
            m5131copyiSbpLlY$default = IntOffset.m5131copyiSbpLlY$default(m630getOffsetBjo55l4, mainAxisOffset, 0, 2, null);
        }
        int placeablesCount = item.getPlaceablesCount();
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long m630getOffsetBjo55l42 = item.m630getOffsetBjo55l4(i);
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m630getOffsetBjo55l42) - IntOffset.m5135getXimpl(m630getOffsetBjo55l4), IntOffset.m5136getYimpl(m630getOffsetBjo55l42) - IntOffset.m5136getYimpl(m630getOffsetBjo55l4));
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00bf, code lost:
        ...
        r15 = r14.m630getOffsetBjo55l4(0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00ca, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m5136getYimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x00cf, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m5135getXimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00fb, code lost:
        ...
        if (androidx.compose.ui.unit.IntOffset.m5134equalsimpl0(r7.getRawOffset(), androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode.INSTANCE.m668getNotInitializednOccac()) != false) goto L111;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00fd, code lost:
    
        r1 = r7.getRawOffset();
        r7.m667setRawOffsetgyyYBs(androidx.compose.ui.unit.IntOffsetKt.IntOffset(androidx.compose.ui.unit.IntOffset.m5135getXimpl(r1) + androidx.compose.ui.unit.IntOffset.m5135getXimpl(r10), androidx.compose.ui.unit.IntOffset.m5136getYimpl(r1) + androidx.compose.ui.unit.IntOffset.m5136getYimpl(r10)));
     */
    ...
    */
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem item) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            LazyLayoutAnimateItemModifierNode node = getNode(item.getParentData(i));
            if (node != null) {
                long m630getOffsetBjo55l4 = item.m630getOffsetBjo55l4(i);
                long rawOffset = node.getRawOffset();
                if (!IntOffset.m5134equalsimpl0(rawOffset, LazyLayoutAnimateItemModifierNode.INSTANCE.m668getNotInitializednOccac()) && !IntOffset.m5134equalsimpl0(rawOffset, m630getOffsetBjo55l4)) {
                    node.m664animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m630getOffsetBjo55l4) - IntOffset.m5135getXimpl(rawOffset), IntOffset.m5136getYimpl(m630getOffsetBjo55l4) - IntOffset.m5136getYimpl(rawOffset)));
                }
                node.m667setRawOffsetgyyYBs(m630getOffsetBjo55l4);
            }
        }
    }
