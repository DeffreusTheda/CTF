...
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public /* synthetic */ float getSpacing() {
            return Arrangement.Horizontal.CC.m434$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final Vertical Top = new Vertical() { // from class: androidx.compose.foundation.layout.Arrangement$Top$1
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public /* synthetic */ float getSpacing() {
            return Arrangement.Vertical.CC.m444$default$getSpacingD9Ej5fM(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5017constructorimpl(0);
    ...
    public interface Horizontal {
        ...
        public final /* synthetic */ class CC {
            ...
            public static float m434$default$getSpacingD9Ej5fM(Horizontal _this) {
        ...
        public static final class DefaultImpls {
            ...
            public static float m436getSpacingD9Ej5fM(Horizontal horizontal) {
                return CC.m434$default$getSpacingD9Ej5fM(horizontal);
            }
        }
    }
    ...
    public interface Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m444$default$getSpacingD9Ej5fM(Vertical _this) {
                return Dp.m5017constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m446getSpacingD9Ej5fM(Vertical vertical) {
                return CC.m444$default$getSpacingD9Ej5fM(vertical);
            }
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public final /* synthetic */ class CC {
            /* renamed from: $default$getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m437$default$getSpacingD9Ej5fM(HorizontalOrVertical _this) {
                return Dp.m5017constructorimpl(0);
            }
        }
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m439getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                return CC.m437$default$getSpacingD9Ej5fM(horizontalOrVertical);
            }
        }
    }
    ...
    public final HorizontalOrVertical m427spacedBy0680j_4(float space) {
    ...
    public final Horizontal m428spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
    ...
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m429spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
    ...
    public final Horizontal aligned(final Alignment.Horizontal alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5017constructorimpl(0), true, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$1
            {
                super(2);
            }
    ...
    public final Vertical aligned(final Alignment.Vertical alignment) {
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        return new SpacedAligned(Dp.m5017constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$aligned$2
            {
                super(2);
            }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4, reason: not valid java name */
        public final HorizontalOrVertical m430spacedBy0680j_4(float space) {
            return new SpacedAligned(space, false, null, 0 == true ? 1 : 0);
        }

        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m431spacedByD5KLDUw(float space, final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m432spacedByD5KLDUw(float space, final Alignment.Vertical alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
        ...
        public final Horizontal aligned(final Alignment.Horizontal alignment) {
            Intrinsics.checkNotNullParameter(alignment, "alignment");
            return new SpacedAligned(Dp.m5017constructorimpl(0), false, new Function2<Integer, LayoutDirection, Integer>() { // from class: androidx.compose.foundation.layout.Arrangement$Absolute$aligned$1
                {
                    super(2);
                }
    ...
    public static final /* data */ class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m440copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2 function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m442copy8Feqmps(f, z, function2);
        }
        ...
        public final SpacedAligned m442copy8Feqmps(float space, boolean rtlMirror, Function2<? super Integer, ? super LayoutDirection, Integer> alignment) {
        ...
        public boolean equals(Object other) {
            ...
            return Dp.m5022equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual(this.alignment, spacedAligned.alignment);
        }

        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m5023hashCodeimpl = Dp.m5023hashCodeimpl(this.space) * 31;
            boolean z = this.rtlMirror;
            int i = z;
            if (z != 0) {
                i = 1;
            }
            int i2 = (m5023hashCodeimpl + i) * 31;
        ...
        public final float m443getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        public void arrange(Density density, int i, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int mo354roundToPx0680j_4 = density.mo354roundToPx0680j_4(this.space);
            ...
            if (!z) {
                ...
                while (i4 < length) {
                    ...
                    outPositions[i5] = min;
                    int min2 = Math.min(mo354roundToPx0680j_4, (i - min) - i6);
                ...
                for (int length2 = sizes.length - 1; -1 < length2; length2--) {
                    ...
                    i3 = Math.min(mo354roundToPx0680j_4, (i - min3) - i8);
        ...
        public String toString() {
            ...
            sb.append((Object) Dp.m5028toStringimpl(this.space));
            sb.append(", ");
