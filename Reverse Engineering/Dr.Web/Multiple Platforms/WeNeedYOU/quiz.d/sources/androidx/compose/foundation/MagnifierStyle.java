...
public final class MagnifierStyle {
    ...
    public /* synthetic */ MagnifierStyle(long j, float f, float f2, boolean z, boolean z2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? DpSize.INSTANCE.m5124getUnspecifiedMYxV2XQ() : j, (i & 2) != 0 ? Dp.INSTANCE.m5037getUnspecifiedD9Ej5fM() : f, (i & 4) != 0 ? Dp.INSTANCE.m5037getUnspecifiedD9Ej5fM() : f2, (i & 8) != 0 ? true : z, (i & 16) != 0 ? false : z2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.useTextDefault == magnifierStyle.useTextDefault && DpSize.m5112equalsimpl0(this.size, magnifierStyle.size) && Dp.m5022equalsimpl0(this.cornerRadius, magnifierStyle.cornerRadius) && Dp.m5022equalsimpl0(this.elevation, magnifierStyle.elevation) && this.clippingEnabled == magnifierStyle.clippingEnabled && this.fishEyeEnabled == magnifierStyle.fishEyeEnabled;
    }

    public int hashCode() {
        return (((((((((UByte$$ExternalSyntheticBackport0.m(this.useTextDefault) * 31) + DpSize.m5117hashCodeimpl(this.size)) * 31) + Dp.m5023hashCodeimpl(this.cornerRadius)) * 31) + Dp.m5023hashCodeimpl(this.elevation)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.clippingEnabled)) * 31) + UByte$$ExternalSyntheticBackport0.m(this.fishEyeEnabled);
    }
    ...
    public String toString() {
        ...
        return "MagnifierStyle(size=" + ((Object) DpSize.m5122toStringimpl(this.size)) + ", cornerRadius=" + ((Object) Dp.m5028toStringimpl(this.cornerRadius)) + ", elevation=" + ((Object) Dp.m5028toStringimpl(this.elevation)) + ", clippingEnabled=" + this.clippingEnabled + ", fishEyeEnabled=" + this.fishEyeEnabled + ')';
    }
