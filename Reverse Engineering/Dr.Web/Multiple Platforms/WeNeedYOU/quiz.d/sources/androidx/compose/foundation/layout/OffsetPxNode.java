...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo272measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (OffsetPxNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, mo3967measureBRTryo0, IntOffset.m5135getXimpl(packedValue), IntOffset.m5136getYimpl(packedValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, mo3967measureBRTryo0, IntOffset.m5135getXimpl(packedValue), IntOffset.m5136getYimpl(packedValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
