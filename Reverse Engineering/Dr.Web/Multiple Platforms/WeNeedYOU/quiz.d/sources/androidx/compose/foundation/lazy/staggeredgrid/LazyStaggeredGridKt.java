...
public final class LazyStaggeredGridKt {
    ...
    public static final void m704LazyStaggeredGridLJWHXA8(final LazyStaggeredGridState state, final Orientation orientation, final Function2<? super Density, ? super Constraints, LazyStaggeredGridSlots> slots, Modifier modifier, PaddingValues paddingValues, boolean z, FlingBehavior flingBehavior, boolean z2, float f, float f2, final Function1<? super LazyStaggeredGridScope, Unit> content, Composer composer, final int i, final int i2, final int i3) {
        ...
        PaddingValues m513PaddingValues0680j_4 = (i3 & 16) != 0 ? PaddingKt.m513PaddingValues0680j_4(Dp.m5017constructorimpl(0)) : paddingValues;
        ...
        float m5017constructorimpl = (i3 & 256) != 0 ? Dp.m5017constructorimpl(0) : f;
        float m5017constructorimpl2 = (i3 & 512) != 0 ? Dp.m5017constructorimpl(0) : f2;
        ...
        Function2<LazyLayoutMeasureScope, Constraints, LazyStaggeredGridMeasureResult> m713rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m713rememberStaggeredGridMeasurePolicynbWgWpA(state, rememberStaggeredGridItemProviderLambda, m513PaddingValues0680j_4, z3, orientation, m5017constructorimpl, m5017constructorimpl2, slots, startRestartGroup, (i5 & 7168) | (i5 & 896) | 8 | ((i4 << 9) & 57344) | (i6 & 458752) | (3670016 & i6) | ((i4 << 15) & 29360128));
        ...
        LazyLayoutKt.LazyLayout(rememberStaggeredGridItemProviderLambda, ScrollableKt.scrollable(overscroll, state, orientation, overscrollEffect, z4, scrollableDefaults.reverseDirection((LayoutDirection) consume, orientation, z5), flingBehavior2, state.getMutableInteractionSource()), state.getPrefetchState(), m713rememberStaggeredGridMeasurePolicynbWgWpA, startRestartGroup, 0, 0);
        if (ComposerKt.isTraceInProgress()) {
        ...
        final PaddingValues paddingValues2 = m513PaddingValues0680j_4;
        final FlingBehavior flingBehavior3 = flingBehavior2;
        final boolean z6 = z4;
        final float f3 = m5017constructorimpl;
        final float f4 = m5017constructorimpl2;
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridKt$LazyStaggeredGrid$1
            ...
            public final void invoke(Composer composer2, int i9) {
                LazyStaggeredGridKt.m704LazyStaggeredGridLJWHXA8(LazyStaggeredGridState.this, orientation, slots, modifier3, paddingValues2, z5, flingBehavior3, z6, f3, f4, content, composer2, RecomposeScopeImplKt.updateChangedFlags(i | 1), RecomposeScopeImplKt.updateChangedFlags(i2), i3);
            }
        });
    }
