...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2572setNativeBlendModeGB0RdKg(android.graphics.Paint setNativeBlendMode, int i) {
        Intrinsics.checkNotNullParameter(setNativeBlendMode, "$this$setNativeBlendMode");
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m3116setBlendModeGB0RdKg(setNativeBlendMode, i);
        } else {
            setNativeBlendMode.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2539toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m2573setNativeColor4WTKRHQ(android.graphics.Paint setNativeColor, long j) {
        Intrinsics.checkNotNullParameter(setNativeColor, "$this$setNativeColor");
        setNativeColor.setColor(ColorKt.m2765toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2577setNativeStyle5YerkU(android.graphics.Paint setNativeStyle, int i) {
        Intrinsics.checkNotNullParameter(setNativeStyle, "$this$setNativeStyle");
        setNativeStyle.setStyle(PaintingStyle.m2976equalsimpl0(i, PaintingStyle.INSTANCE.m2981getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if (style != null && WhenMappings.$EnumSwitchMapping$0[style.ordinal()] == 1) {
            return PaintingStyle.INSTANCE.m2981getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m2980getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m3068getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m3066getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m2575setNativeStrokeCapCSYIeUk(android.graphics.Paint setNativeStrokeCap, int i) {
        Paint.Cap cap;
        Intrinsics.checkNotNullParameter(setNativeStrokeCap, "$this$setNativeStrokeCap");
        if (StrokeCap.m3062equalsimpl0(i, StrokeCap.INSTANCE.m3068getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m3062equalsimpl0(i, StrokeCap.INSTANCE.m3067getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m3062equalsimpl0(i, StrokeCap.INSTANCE.m3066getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m3076getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m2576setNativeStrokeJoinkLtJ_vA(android.graphics.Paint setNativeStrokeJoin, int i) {
        Paint.Join join;
        Intrinsics.checkNotNullParameter(setNativeStrokeJoin, "$this$setNativeStrokeJoin");
        if (StrokeJoin.m3072equalsimpl0(i, StrokeJoin.INSTANCE.m3077getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m3072equalsimpl0(i, StrokeJoin.INSTANCE.m3076getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m3072equalsimpl0(i, StrokeJoin.INSTANCE.m3078getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        ...
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m2810getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m2808getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2574setNativeFilterQuality50PEsBU(android.graphics.Paint setNativeFilterQuality, int i) {
        Intrinsics.checkNotNullParameter(setNativeFilterQuality, "$this$setNativeFilterQuality");
        setNativeFilterQuality.setFilterBitmap(!FilterQuality.m2803equalsimpl0(i, FilterQuality.INSTANCE.m2810getNonefv9h1I()));
    }
