...
public final class PlatformRipple extends Ripple {
    ...
    public RippleIndicationInstance mo1003rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> color, State<RippleAlpha> rippleAlpha, Composer composer, int i) {
        View view;
