...
public final class SelectionHandlesKt {
    ...
    public static final long m942getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m2446getXimpl(j), Offset.m2447getYimpl(j) - 1.0f);
    }

    static {
        float f = 25;
        HandleWidth = Dp.m5017constructorimpl(f);
        HandleHeight = Dp.m5017constructorimpl(f);
    }
}
