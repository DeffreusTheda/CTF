...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m2797getAutoNrFUSI();
    ...
    public void mo4289setCompositingStrategyaDBOjCE(int i) {
        if (CompositingStrategy.m2793equalsimpl0(i, CompositingStrategy.INSTANCE.m2799getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2793equalsimpl0(i, CompositingStrategy.INSTANCE.m2798getModulateAlphaNrFUSI())) {
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m2793equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m2799getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.CC.m2683clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
