...
public final class SuspendingPointerInputModifierNodeImpl extends Modifier.Node implements SuspendingPointerInputModifierNode, PointerInputScope, Density {
    ...
    public SuspendingPointerInputModifierNodeImpl(Function2<? super PointerInputScope, ? super Continuation<? super Unit>, ? extends Object> pointerInputHandler) {
        ...
        this.boundsSize = IntSize.INSTANCE.m5182getZeroYbymL2g();
    }
    ...
    public long mo3870getExtendedTouchPaddingNHjbRc() {
        long mo361toSizeXkaWNTQ = mo361toSizeXkaWNTQ(getViewConfiguration().mo4113getMinimumTouchTargetSizeMYxV2XQ());
        long boundsSize = getBoundsSize();
        return SizeKt.Size(Math.max(0.0f, Size.m2515getWidthimpl(mo361toSizeXkaWNTQ) - IntSize.m5177getWidthimpl(boundsSize)) / 2.0f, Math.max(0.0f, Size.m2512getHeightimpl(mo361toSizeXkaWNTQ) - IntSize.m5176getHeightimpl(boundsSize)) / 2.0f);
    }
    ...
    final class PointerEventHandlerCoroutine<R> implements AwaitPointerEventScope, Density, Continuation<R> {
        ...
        public long mo3748getSizeYbymL2g() {
        ...
        @Override // androidx.compose.ui.input.pointer.AwaitPointerEventScope
        /* renamed from: getExtendedTouchPadding-NH-jbRc */
        public long mo3747getExtendedTouchPaddingNHjbRc() {
            return this.this$0.mo3870getExtendedTouchPaddingNHjbRc();
        }
        ...
        public final void offerPointerEvent(PointerEvent event, PointerEventPass pass) {
            ...
            cancellableContinuation.resumeWith(Result.m5528constructorimpl(event));
        }
    ...
    public <R> Object awaitPointerEventScope(Function2<? super AwaitPointerEventScope, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        ...
        synchronized (this.pointerHandlers) {
            ...
            Result.Companion companion = Result.INSTANCE;
            createCoroutine.resumeWith(Result.m5528constructorimpl(Unit.INSTANCE));
            Unit unit = Unit.INSTANCE;
        }
