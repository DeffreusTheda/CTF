...
public final class MyersDiffKt {
    private static final IntStack calculateDiff(int i, int i2, DiffCallback diffCallback) {
        ...
        int i4 = (i3 * 2) + 1;
        int[] m4069constructorimpl = CenteredArray.m4069constructorimpl(new int[i4]);
        int[] m4069constructorimpl2 = CenteredArray.m4069constructorimpl(new int[i4]);
        int[] m4243constructorimpl = Snake.m4243constructorimpl(new int[5]);
        while (intStack2.isNotEmpty()) {
            int pop = intStack2.pop();
            int pop2 = intStack2.pop();
            int pop3 = intStack2.pop();
            int pop4 = intStack2.pop();
            int[] iArr = m4069constructorimpl;
            int[] iArr2 = m4069constructorimpl2;
            if (m4145midPointq5eDKzI(pop4, pop3, pop2, pop, diffCallback, m4069constructorimpl, m4069constructorimpl2, m4243constructorimpl)) {
                if (Snake.m4246getDiagonalSizeimpl(m4243constructorimpl) > 0) {
                    Snake.m4241addDiagonalToStackimpl(m4243constructorimpl, intStack);
                }
                intStack2.pushRange(pop4, Snake.m4251getStartXimpl(m4243constructorimpl), pop2, Snake.m4252getStartYimpl(m4243constructorimpl));
                intStack2.pushRange(Snake.m4247getEndXimpl(m4243constructorimpl), pop3, Snake.m4248getEndYimpl(m4243constructorimpl), pop);
            }
            m4069constructorimpl = iArr;
            m4069constructorimpl2 = iArr2;
        }
    ...
    private static final boolean m4145midPointq5eDKzI(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int[] iArr3) {
        int i5 = i2 - i;
        int i6 = i4 - i3;
        if (i5 >= 1 && i6 >= 1) {
            int i7 = ((i5 + i6) + 1) / 2;
            CenteredArray.m4075setimpl(iArr, 1, i);
            CenteredArray.m4075setimpl(iArr2, 1, i2);
            int i8 = 0;
            while (i8 < i7) {
                int i9 = i8;
                if (m4144forward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i8, iArr3) || m4143backward4l5_RBY(i, i2, i3, i4, diffCallback, iArr, iArr2, i9, iArr3)) {
                    return true;
                }
                i8 = i9 + 1;
            }
    ...
    private static final boolean m4144forward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m4072getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4072getimpl(iArr, i10 + 1) > CenteredArray.m4072getimpl(iArr, i10 - 1))) {
                m4072getimpl = CenteredArray.m4072getimpl(iArr, i10 + 1);
                i6 = m4072getimpl;
            } else {
                m4072getimpl = CenteredArray.m4072getimpl(iArr, i10 - 1);
                i6 = m4072getimpl + 1;
            ...
            int i11 = (i3 + (i6 - i)) - i10;
            int i12 = (i5 == 0 || i6 != m4072getimpl) ? i11 : i11 - 1;
            while (i6 < i2 && i11 < i4) {
            ...
            CenteredArray.m4075setimpl(iArr, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 + 1 && i7 <= i5 - 1) {
                if (CenteredArray.m4072getimpl(iArr2, i7) <= i6) {
                    fillSnake(m4072getimpl, i12, i6, i11, false, iArr3);
                    return true;
                }
            }
        }
    ...
    private static final boolean m4143backward4l5_RBY(int i, int i2, int i3, int i4, DiffCallback diffCallback, int[] iArr, int[] iArr2, int i5, int[] iArr3) {
        int m4072getimpl;
        int i6;
        int i7;
        int i8 = (i2 - i) - (i4 - i3);
        ...
        int i9 = -i5;
        for (int i10 = i9; i10 <= i5; i10 += 2) {
            if (i10 == i9 || (i10 != i5 && CenteredArray.m4072getimpl(iArr2, i10 + 1) < CenteredArray.m4072getimpl(iArr2, i10 - 1))) {
                m4072getimpl = CenteredArray.m4072getimpl(iArr2, i10 + 1);
                i6 = m4072getimpl;
            } else {
                m4072getimpl = CenteredArray.m4072getimpl(iArr2, i10 - 1);
                i6 = m4072getimpl - 1;
            ...
            CenteredArray.m4075setimpl(iArr2, i10, i6);
            if (z && (i7 = i8 - i10) >= i9 && i7 <= i5) {
                if (CenteredArray.m4072getimpl(iArr, i7) >= i6) {
                    fillSnake(i6, i11, m4072getimpl, i12, true, iArr3);
                    return true;
                }
            }
        }
