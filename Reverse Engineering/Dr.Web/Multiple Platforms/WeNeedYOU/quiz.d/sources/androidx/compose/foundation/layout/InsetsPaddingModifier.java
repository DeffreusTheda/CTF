...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(ConstraintsKt.m4977offsetNN6EwU(j, -right, -bottom));
        return MeasureScope.CC.layout$default(measure, ConstraintsKt.m4975constrainWidthK40F9xA(j, mo3967measureBRTryo0.getWidth() + right), ConstraintsKt.m4974constrainHeightK40F9xA(j, mo3967measureBRTryo0.getHeight() + bottom), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.InsetsPaddingModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
