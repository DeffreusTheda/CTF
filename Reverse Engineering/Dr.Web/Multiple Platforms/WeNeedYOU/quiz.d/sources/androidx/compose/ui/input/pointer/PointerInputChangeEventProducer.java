...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        long j;
        boolean down;
        long mo3930screenToLocalMKHz9U;
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(PointerId.m3828boximpl(pointerInputEventData.m3861getIdJ3iCeTQ()));
            if (pointerInputData == null) {
                j = pointerInputEventData.getUptime();
                mo3930screenToLocalMKHz9U = pointerInputEventData.m3862getPositionF1C5BW0();
                down = false;
            } else {
                long uptime = pointerInputData.getUptime();
                j = uptime;
                down = pointerInputData.getDown();
                mo3930screenToLocalMKHz9U = positionCalculator.mo3930screenToLocalMKHz9U(pointerInputData.getPositionOnScreen());
            }
            linkedHashMap.put(PointerId.m3828boximpl(pointerInputEventData.m3861getIdJ3iCeTQ()), new PointerInputChange(pointerInputEventData.m3861getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m3862getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j, mo3930screenToLocalMKHz9U, down, false, pointerInputEventData.m3865getTypeT8wyACA(), (List) pointerInputEventData.getHistorical(), pointerInputEventData.m3864getScrollDeltaF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(PointerId.m3828boximpl(pointerInputEventData.m3861getIdJ3iCeTQ()), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m3863getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m3865getTypeT8wyACA(), null));
            } else {
                this.previousPointerInputData.remove(PointerId.m3828boximpl(pointerInputEventData.m3861getIdJ3iCeTQ()));
            }
        }
