...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m4137setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m4024setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.getWidth(), measureResult.getHeight()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m4024setMeasuredSizeozmzZPI(IntSize.INSTANCE.m5182getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo3968placeAtf8xVGno(getPosition(), 0.0f, null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo3968placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        if (!IntOffset.m5134equalsimpl0(getPosition(), position)) {
            m4137setPositiongyyYBs(position);
    ...
    public final Placeable m4135performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m4136positionInBjo55l4$ui_release(LookaheadDelegate ancestor) {
        Intrinsics.checkNotNullParameter(ancestor, "ancestor");
        long m5145getZeronOccac = IntOffset.INSTANCE.m5145getZeronOccac();
        LookaheadDelegate lookaheadDelegate = this;
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            long position = lookaheadDelegate.getPosition();
            m5145getZeronOccac = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m5145getZeronOccac) + IntOffset.m5135getXimpl(position), IntOffset.m5136getYimpl(m5145getZeronOccac) + IntOffset.m5136getYimpl(position));
