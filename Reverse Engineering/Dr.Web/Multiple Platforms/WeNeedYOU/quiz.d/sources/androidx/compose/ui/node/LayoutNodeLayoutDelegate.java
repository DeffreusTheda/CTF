...
public final class LayoutNodeLayoutDelegate {
    ...
    public final Constraints m4125getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4131getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m4126getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.INSTANCE.m5145getZeronOccac();
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m4131getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m4949boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo3967measureBRTryo0(long constraints) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                lookaheadPassDelegate.mo3967measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4132remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4132remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m4954equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            this.measuredOnce = true;
            long mo3974getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3974getSizeYbymL2g();
            m4025setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m4124performMeasureBRTryo0(constraints);
            if (IntSize.m5175equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3974getSizeYbymL2g(), mo3974getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m4024setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo3968placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            if (!IntOffset.m5134equalsimpl0(position, this.lastPosition)) {
            ...
            if (layoutNodeLayoutDelegate.isOutMostLookaheadRoot(layoutNodeLayoutDelegate.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(companion, lookaheadPassDelegate, IntOffset.m5135getXimpl(position), IntOffset.m5136getYimpl(position), 0.0f, 4, null);
            }
            m4130placeOuterCoordinatorf8xVGno(position, zIndex, layerBlock);
        }

        /* renamed from: placeOuterCoordinator-f8xVGno, reason: not valid java name */
        private final void m4130placeOuterCoordinatorf8xVGno(final long position, final float zIndex, final Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LayingOut;
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m4174placeSelfApparentToRealOffsetf8xVGno(position, zIndex, layerBlock);
                ...
                snapshotObserver.observeLayoutModifierSnapshotReads$ui_release(layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinator$1
                    ...
                    public final void invoke2() {
                        ...
                        float f = zIndex;
                        if (function1 == null) {
                            companion.m4030place70tqf50(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f);
                        } else {
                            companion.m4035placeWithLayeraW9wM(layoutNodeLayoutDelegate2.getOuterCoordinator(), j, f, function1);
                        }
                    }
                });
            }
        ...
        public final void replace() {
            try {
                ...
                m4130placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
            } finally {
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4108remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                ...
                mo3967measureBRTryo0(lookaheadConstraints.getValue());
                ...
                mo3967measureBRTryo0(lookaheadConstraints2.getValue());
            }
        }
        ...
        public final void placeBasedOnLookahead() {
            ...
            mo3968placeAtf8xVGno(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release());
        }
    }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public Placeable mo3967measureBRTryo0(long constraints) {
            ...
            m4129remeasureBRTryo0(constraints);
            return this;
        }
        ...
        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m4129remeasureBRTryo0(long constraints) {
            Constraints constraints2;
            LayoutNode parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release();
            LayoutNodeLayoutDelegate.this.layoutNode.setCanMultiMeasure$ui_release(LayoutNodeLayoutDelegate.this.layoutNode.getCanMultiMeasure() || (parent$ui_release != null && parent$ui_release.getCanMultiMeasure()));
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release() && (constraints2 = this.lookaheadConstraints) != null && Constraints.m4954equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m4949boximpl(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m4123performLookaheadMeasureBRTryo0(constraints);
            m4024setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m5177getWidthimpl(IntSize) == lookaheadDelegate.getWidth() && IntSize.m5176getHeightimpl(IntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }

        /* JADX INFO: Access modifiers changed from: protected */
        @Override // androidx.compose.ui.layout.Placeable
        /* renamed from: placeAt-f8xVGno */
        public void mo3968placeAtf8xVGno(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            if (!IntOffset.m5134equalsimpl0(position, this.lastPosition)) {
                if (LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringModifierPlacement() || LayoutNodeLayoutDelegate.this.getCoordinatesAccessedDuringPlacement()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeAt$1
                    ...
                    public final void invoke2() {
                        ...
                        Intrinsics.checkNotNull(lookaheadDelegate);
                        Placeable.PlacementScope.m4026place70tqf50$default(companion2, lookaheadDelegate, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        Intrinsics.checkNotNull(lookaheadConstraints);
                        if (lookaheadPassDelegate.m4129remeasureBRTryo0(lookaheadConstraints.getValue())) {
        ...
        public final void replace() {
            try {
                ...
                mo3968placeAtf8xVGno(this.lastPosition, 0.0f, null);
            } finally {
                this.relayoutWithoutParentInProgress = false;
            }
        }
    ...
    public final void m4124performMeasureBRTryo0(final long constraints) {
        ...
        LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver().observeMeasureSnapshotReads$ui_release(this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasure$2
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3967measureBRTryo0(constraints);
            }
        });
    ...
    public final void m4123performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo3967measureBRTryo0(constraints);
            }
        }, 2, null);
