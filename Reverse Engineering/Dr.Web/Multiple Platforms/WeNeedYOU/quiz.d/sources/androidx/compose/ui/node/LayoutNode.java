...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo44measure3p2s80s(MeasureScope measureScope, List list, long j) {
            return (MeasureResult) m4114measure3p2s80s(measureScope, (List<? extends Measurable>) list, j);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4114measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4113getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.INSTANCE.m5125getZeroMYxV2XQ();
        }
    };
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (!this.nodes.m4147hasH91voCI$ui_release(NodeKind.m4184constructorimpl(8)) || this._collapsedSemantics != null) {
        ...
        LayoutNodeKt.requireOwner(this).getSnapshotObserver().observeSemanticsReads$ui_release(this, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNode$collapsedSemantics$1
            ...
            public final void invoke2() {
                ...
                int m4184constructorimpl = NodeKind.m4184constructorimpl(8);
                Ref.ObjectRef<SemanticsConfiguration> objectRef2 = objectRef;
                if ((nodes.getAggregateChildKindSet() & m4184constructorimpl) != 0) {
                    for (Modifier.Node tail = nodes.getTail(); tail != null; tail = tail.getParent()) {
                        if ((tail.getKindSet() & m4184constructorimpl) != 0) {
    ...
    public final void attach$ui_release(Owner owner) {
        ...
        if (this.nodes.m4147hasH91voCI$ui_release(NodeKind.m4184constructorimpl(8))) {
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long m4168getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4168getLastMeasurementConstraintsmsEJaDk$ui_release();
        return Constraints.m4959getHasFixedWidthimpl(m4168getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m4958getHasFixedHeightimpl(m4168getLastMeasurementConstraintsmsEJaDk$ui_release);
    }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4115maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4116maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4117minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i) {
            return ((Number) m4118minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i)).intValue();
        }

        /* renamed from: minIntrinsicWidth, reason: collision with other method in class */
        public Void m4118minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
        ...
        public Void m4117minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m4116maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
        ...
        public Void m4115maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i) {
            Intrinsics.checkNotNullParameter(intrinsicMeasureScope, "<this>");
            Intrinsics.checkNotNullParameter(measurables, "measurables");
            throw new IllegalStateException(this.error.toString());
        }
    ...
    public void setDensity(Density value) {
        ...
        if ((nodeChain.getAggregateChildKindSet() & m4184constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m4184constructorimpl) != 0) {
                ...
                if ((head.getAggregateChildKindSet() & m4184constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public void setCompositionLocalMap(CompositionLocalMap value) {
        ...
        NodeChain nodeChain = this.nodes;
        int m4184constructorimpl = NodeKind.m4184constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & m4184constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m4184constructorimpl) != 0) {
                    DelegatingNode delegatingNode = head;
    ...
    public void setModifier(Modifier value) {
        ...
        this.layoutDelegate.updateParentData();
        if (this.nodes.m4147hasH91voCI$ui_release(NodeKind.m4184constructorimpl(512)) && this.lookaheadRoot == null) {
            setLookaheadRoot(this);
        }
    }
    ...
    public final void m4109hitTestM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitTestResult, "hitTestResult");
        getOuterCoordinator$ui_release().m4171hitTestYqVAtuI(NodeCoordinator.INSTANCE.getPointerInputSource(), getOuterCoordinator$ui_release().m4167fromParentPositionMKHz9U(pointerPosition), hitTestResult, isTouchEvent, isInLayer);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release, reason: not valid java name */
    public final void m4110hitTestSemanticsM_7yMNQ$ui_release(long pointerPosition, HitTestResult hitSemanticsEntities, boolean isTouchEvent, boolean isInLayer) {
        Intrinsics.checkNotNullParameter(hitSemanticsEntities, "hitSemanticsEntities");
        getOuterCoordinator$ui_release().m4171hitTestYqVAtuI(NodeCoordinator.INSTANCE.getSemanticsSource(), getOuterCoordinator$ui_release().m4167fromParentPositionMKHz9U(pointerPosition), hitSemanticsEntities, true, isInLayer);
    }
    ...
    private final void invalidateFocusOnAttach() {
        if (this.nodes.has$ui_release(NodeKind.m4184constructorimpl(1024) | NodeKind.m4184constructorimpl(2048) | NodeKind.m4184constructorimpl(4096))) {
            for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
                if (((NodeKind.m4184constructorimpl(1024) & head.getKindSet()) != 0) | ((NodeKind.m4184constructorimpl(2048) & head.getKindSet()) != 0) | ((NodeKind.m4184constructorimpl(4096) & head.getKindSet()) != 0)) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int m4184constructorimpl = NodeKind.m4184constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & m4184constructorimpl) != 0) {
            for (Modifier.Node head = nodeChain.getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & m4184constructorimpl) != 0) {
                    DelegatingNode delegatingNode = head;
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4082requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4184constructorimpl(256)));
                        } else if ((delegatingNode.getKindSet() & m4184constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                            Modifier.Node delegate = delegatingNode.getDelegate();
                            int i = 0;
                            delegatingNode = delegatingNode;
    ...
    public static /* synthetic */ boolean m4107lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4126getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4111lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: lookaheadRemeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4111lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null || this.lookaheadRoot == null) {
            return false;
        }
        LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
        Intrinsics.checkNotNull(lookaheadPassDelegate$ui_release);
        return lookaheadPassDelegate$ui_release.m4129remeasureBRTryo0(constraints.getValue());
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release$default, reason: not valid java name */
    public static /* synthetic */ boolean m4108remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i, Object obj) {
        if ((i & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4125getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4112remeasure_Sx5XlM$ui_release(constraints);
    }

    /* renamed from: remeasure-_Sx5XlM$ui_release, reason: not valid java name */
    public final boolean m4112remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints == null) {
            return false;
        }
        if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
        ...
        return getMeasurePassDelegate$ui_release().m4132remeasureBRTryo0(constraints.getValue());
    }
                ...
                if ((head.getKindSet() & m4184constructorimpl) != 0) {
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m4082requireCoordinator64DMado((LayoutModifierNode) delegatingNode, NodeKind.m4184constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNode.getKindSet() & m4184constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
    ...
    public void forceRemeasure() {
        ...
        Constraints m4125getLastConstraintsDWUhwKw = this.layoutDelegate.m4125getLastConstraintsDWUhwKw();
        if (m4125getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4239measureAndLayout0kLqBqw(this, m4125getLastConstraintsDWUhwKw.getValue());
                return;
            }
            return;
        }
    ...
    public void onLayoutComplete() {
        ...
        for (Modifier.Node headNode = innerCoordinator$ui_release.headNode(m4193getIncludeSelfInTraversalH91voCI); headNode != null && (headNode.getAggregateChildKindSet() & m4184constructorimpl) != 0; headNode = headNode.getChild()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4147hasH91voCI$ui_release(NodeKind.m4184constructorimpl(4)) && !this.nodes.m4147hasH91voCI$ui_release(NodeKind.m4184constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head = this.nodes.getHead(); head != null; head = head.getChild()) {
            if ((NodeKind.m4184constructorimpl(2) & head.getKindSet()) != 0 && DelegatableNodeKt.m4082requireCoordinator64DMado(head, NodeKind.m4184constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m4184constructorimpl(4) & head.getKindSet()) != 0) {
                return true;
            }
        }
        return true;
