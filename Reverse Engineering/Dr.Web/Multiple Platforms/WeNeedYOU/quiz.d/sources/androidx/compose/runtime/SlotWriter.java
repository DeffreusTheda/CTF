...
public final class SlotWriter {
    ...
    public static final class Companion {
        ...
        public final List<Anchor> moveGroup(SlotWriter fromWriter, int fromIndex, SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            ArraysKt.copyInto(fromWriter.slots, objArr, i6, dataIndex, dataIndex2);
            ...
            while (true) {
                ...
                SlotTableKt.updateDataAnchor(iArr, i12, toWriter.dataIndexToDataAnchor(dataIndex4, i3, i10, length));
                if (i12 == i11) {
                    i11++;
                }
                i12++;
            ...
            locationOf2 = SlotTableKt.locationOf(fromWriter.anchors, i4, fromWriter.getSize$runtime_release());
