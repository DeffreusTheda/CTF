...
public interface Canvas {
    ...
    void mo2540clipPathmtrdDE(Path path, int clipOp);

    /* renamed from: clipRect-N_I0leg */
    void mo2541clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* renamed from: clipRect-mtrdD-E */
    void mo2542clipRectmtrdDE(Rect rect, int clipOp);

    /* renamed from: concat-58bKbWc */
    void mo2543concat58bKbWc(float[] matrix);
    ...
    void mo2544drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2545drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2546drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2547drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo2548drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2549drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo2550drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public final /* synthetic */ class CC {
        ...
        public static /* synthetic */ void m2685clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2542clipRectmtrdDE(rect, i);
        }

        /* renamed from: $default$clipRect-mtrdD-E, reason: not valid java name */
        public static void m2681$default$clipRectmtrdDE(Canvas _this, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            _this.mo2541clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), i);
        }

        /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
        public static /* synthetic */ void m2684clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2541clipRectN_I0leg(f, f2, f3, f4, i);
        }

        /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
        public static /* synthetic */ void m2683clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
            if (obj != null) {
            ...
            canvas.mo2540clipPathmtrdDE(path, i);
        }
        ...
        public static /* synthetic */ void m2686drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
            if (obj != null) {
                throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
            }
            long m5145getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m5145getZeronOccac() : j;
            long IntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
            canvas.mo2546drawImageRectHPBpro0(imageBitmap, m5145getZeronOccac, IntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m5145getZeronOccac() : j3, (i & 16) != 0 ? IntSize : j4, paint);
        }
    }
    ...
    public static final class DefaultImpls {
        ...
        public static void m2689clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            CC.m2681$default$clipRectmtrdDE(canvas, rect, i);
        }
