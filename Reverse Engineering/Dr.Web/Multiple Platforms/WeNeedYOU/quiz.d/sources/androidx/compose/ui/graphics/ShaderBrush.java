...
public abstract class ShaderBrush extends Brush {
    ...
    public abstract Shader mo2680createShaderuvyYCjk(long size);

    public ShaderBrush() {
        super(null);
        this.createdSize = Size.INSTANCE.m2523getUnspecifiedNHjbRc();
    }

    @Override // androidx.compose.ui.graphics.Brush
    /* renamed from: applyTo-Pq9zytI */
    public final void mo2658applyToPq9zytI(long size, Paint p, float alpha) {
        Intrinsics.checkNotNullParameter(p, "p");
        Shader shader = this.internalShader;
        if (shader == null || !Size.m2511equalsimpl0(this.createdSize, size)) {
            if (Size.m2517isEmptyimpl(size)) {
                shader = null;
                this.internalShader = null;
                this.createdSize = Size.INSTANCE.m2523getUnspecifiedNHjbRc();
            } else {
                shader = mo2680createShaderuvyYCjk(size);
                this.internalShader = shader;
                this.createdSize = size;
            }
        }
        if (!Color.m2712equalsimpl0(p.mo2561getColor0d7_KjU(), Color.INSTANCE.m2737getBlack0d7_KjU())) {
            p.mo2567setColor8_81llA(Color.INSTANCE.m2737getBlack0d7_KjU());
        }
