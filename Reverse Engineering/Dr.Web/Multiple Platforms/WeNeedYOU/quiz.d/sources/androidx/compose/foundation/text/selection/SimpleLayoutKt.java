...
public final class SimpleLayoutKt {
    public static final void SimpleLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            SimpleLayoutKt$SimpleLayout$1 simpleLayoutKt$SimpleLayout$1 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.selection.SimpleLayoutKt$SimpleLayout$1
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (int i6 = 0; i6 < size; i6++) {
                        arrayList.add(measurables.get(i6).mo3967measureBRTryo0(j));
                    }
                    ...
                    return MeasureScope.CC.layout$default(Layout, intValue, i5.intValue(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.selection.SimpleLayoutKt$SimpleLayout$1$measure$1
            ...
            Updater.m2325setimpl(m2318constructorimpl, simpleLayoutKt$SimpleLayout$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
