...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3967measureBRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            return new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, Constraints.m4960getMaxHeightimpl(constraints));
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(Constraints.m4961getMaxWidthimpl(constraints), minIntrinsicHeight);
    }
