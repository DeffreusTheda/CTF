...
public final class ClipScrollableContainerKt {
    private static final float MaxSupportedElevation = Dp.m5017constructorimpl(30);
    private static final Modifier HorizontalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$HorizontalScrollableClipModifier$1
        ...
        public Outline mo242createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
            Intrinsics.checkNotNullParameter(density, "density");
            float mo354roundToPx0680j_4 = density.mo354roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(0.0f, -mo354roundToPx0680j_4, Size.m2515getWidthimpl(size), Size.m2512getHeightimpl(size) + mo354roundToPx0680j_4));
        }
    });
    private static final Modifier VerticalScrollableClipModifier = ClipKt.clip(Modifier.INSTANCE, new Shape() { // from class: androidx.compose.foundation.ClipScrollableContainerKt$VerticalScrollableClipModifier$1
        ...
        public Outline mo242createOutlinePq9zytI(long size, LayoutDirection layoutDirection, Density density) {
            ...
            Intrinsics.checkNotNullParameter(density, "density");
            float mo354roundToPx0680j_4 = density.mo354roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
            return new Outline.Rectangle(new Rect(-mo354roundToPx0680j_4, 0.0f, Size.m2515getWidthimpl(size) + mo354roundToPx0680j_4, Size.m2512getHeightimpl(size)));
        }
    });
