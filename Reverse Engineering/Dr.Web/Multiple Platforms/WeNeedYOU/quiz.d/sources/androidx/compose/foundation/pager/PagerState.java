...
public abstract class PagerState implements ScrollableState {
    ...
    public PagerState(int i, float f) {
        ...
        double d = f;
        if (-0.5d <= d && d <= 0.5d) {
            this.upDownDifference = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2435boximpl(Offset.INSTANCE.m2462getZeroF1C5BW0()), null, 2, null);
    ...
    public final long m749getUpDownDifferenceF1C5BW0$foundation_release() {
    ...
    public final void m751setUpDownDifferencek4lQ0M$foundation_release(long j) {
        this.upDownDifference.setValue(Offset.m2435boximpl(j));
    }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.mo360toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    public final void m750setPremeasureConstraintsBRTryo0$foundation_release(long j) {
    ...
    private final void notifyPrefetch(float delta) {
        ...
        if (this.prefetchingEnabled) {
            ...
            if (!layoutInfo$foundation_release.getVisiblePagesInfo().isEmpty()) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m687schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
        }
    }
