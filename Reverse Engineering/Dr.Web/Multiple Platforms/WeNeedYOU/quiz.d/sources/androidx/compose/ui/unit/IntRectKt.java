...
public final class IntRectKt {
    ...
    public static final IntRect m5167IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(j), IntOffset.m5135getXimpl(j) + IntSize.m5177getWidthimpl(j2), IntOffset.m5136getYimpl(j) + IntSize.m5176getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY, reason: not valid java name */
    public static final IntRect m5166IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(j), IntOffset.m5135getXimpl(j2), IntOffset.m5136getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso, reason: not valid java name */
    public static final IntRect m5168IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m5135getXimpl(j) - i, IntOffset.m5136getYimpl(j) - i, IntOffset.m5135getXimpl(j) + i, IntOffset.m5136getYimpl(j) + i);
    }
