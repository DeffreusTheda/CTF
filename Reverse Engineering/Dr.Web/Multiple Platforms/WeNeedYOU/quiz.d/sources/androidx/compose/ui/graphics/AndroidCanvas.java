...
public final class AndroidCanvas implements Canvas {
    ...
    public /* synthetic */ void mo2542clipRectmtrdDE(androidx.compose.ui.geometry.Rect rect, int i) {
        Canvas.CC.m2681$default$clipRectmtrdDE(this, rect, i);
    }
    ...
    public void mo2543concat58bKbWc(float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        if (MatrixKt.m2968isIdentity58bKbWc(matrix)) {
            return;
        }
        android.graphics.Matrix matrix2 = new android.graphics.Matrix();
        AndroidMatrixConversions_androidKt.m2558setFromEL8BTi8(matrix2, matrix);
        this.internalCanvas.concat(matrix2);
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipRect-N_I0leg, reason: not valid java name */
    public void mo2541clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp) {
        this.internalCanvas.clipRect(left, top, right, bottom, m2551toRegionOp7u2Bmg(clipOp));
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: clipPath-mtrdD-E, reason: not valid java name */
    public void mo2540clipPathmtrdDE(Path path, int clipOp) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Canvas canvas = this.internalCanvas;
        if (path instanceof AndroidPath) {
            canvas.clipPath(((AndroidPath) path).getInternalPath(), m2551toRegionOp7u2Bmg(clipOp));
            return;
        }
    ...
    public final Region.Op m2551toRegionOp7u2Bmg(int i) {
        return ClipOp.m2695equalsimpl0(i, ClipOp.INSTANCE.m2699getDifferencertfAjoo()) ? Region.Op.DIFFERENCE : Region.Op.INTERSECT;
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawLine-Wko1d7g, reason: not valid java name */
    public void mo2547drawLineWko1d7g(long p1, long p2, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawLine(Offset.m2446getXimpl(p1), Offset.m2447getYimpl(p1), Offset.m2446getXimpl(p2), Offset.m2447getYimpl(p2), paint.getInternalPaint());
    }
    ...
    public void mo2544drawCircle9KIMszo(long center, float radius, Paint paint) {
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawCircle(Offset.m2446getXimpl(center), Offset.m2447getYimpl(center), radius, paint.getInternalPaint());
    }
    ...
    public void mo2545drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawBitmap(AndroidImageBitmap_androidKt.asAndroidBitmap(image), Offset.m2446getXimpl(topLeftOffset), Offset.m2447getYimpl(topLeftOffset), paint.getInternalPaint());
    }

    @Override // androidx.compose.ui.graphics.Canvas
    /* renamed from: drawImageRect-HPBpro0, reason: not valid java name */
    public void mo2546drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint) {
        Intrinsics.checkNotNullParameter(image, "image");
        Intrinsics.checkNotNullParameter(paint, "paint");
        android.graphics.Canvas canvas = this.internalCanvas;
        Bitmap asAndroidBitmap = AndroidImageBitmap_androidKt.asAndroidBitmap(image);
        Rect rect = this.srcRect;
        rect.left = IntOffset.m5135getXimpl(srcOffset);
        rect.top = IntOffset.m5136getYimpl(srcOffset);
        rect.right = IntOffset.m5135getXimpl(srcOffset) + IntSize.m5177getWidthimpl(srcSize);
        rect.bottom = IntOffset.m5136getYimpl(srcOffset) + IntSize.m5176getHeightimpl(srcSize);
        Unit unit = Unit.INSTANCE;
        Rect rect2 = this.dstRect;
        rect2.left = IntOffset.m5135getXimpl(dstOffset);
        rect2.top = IntOffset.m5136getYimpl(dstOffset);
        rect2.right = IntOffset.m5135getXimpl(dstOffset) + IntSize.m5177getWidthimpl(dstSize);
        rect2.bottom = IntOffset.m5136getYimpl(dstOffset) + IntSize.m5176getHeightimpl(dstSize);
    ...
    public void mo2548drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
        if (PointMode.m3014equalsimpl0(pointMode, PointMode.INSTANCE.m3018getLinesr_lszbg())) {
            drawLines(points, paint, 2);
        } else if (PointMode.m3014equalsimpl0(pointMode, PointMode.INSTANCE.m3020getPolygonr_lszbg())) {
            drawLines(points, paint, 1);
        } else if (PointMode.m3014equalsimpl0(pointMode, PointMode.INSTANCE.m3019getPointsr_lszbg())) {
    ...
    private final void drawLines(List<Offset> points, Paint paint, int stepBy) {
        if (points.size() >= 2) {
            ...
            while (i < points.size() - 1) {
                ...
                this.internalCanvas.drawLine(Offset.m2446getXimpl(packedValue), Offset.m2447getYimpl(packedValue), Offset.m2446getXimpl(packedValue2), Offset.m2447getYimpl(packedValue2), internalPaint);
                i += stepBy;
            }
        }
    }
    ...
    public void mo2549drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint) {
        Intrinsics.checkNotNullParameter(points, "points");
        Intrinsics.checkNotNullParameter(paint, "paint");
    ...
    public void mo2550drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint) {
        Intrinsics.checkNotNullParameter(vertices, "vertices");
        Intrinsics.checkNotNullParameter(paint, "paint");
        this.internalCanvas.drawVertices(AndroidVertexMode_androidKt.m2594toAndroidVertexModeJOOmi9M(vertices.getVertexMode()), vertices.getPositions().length, vertices.getPositions(), 0, vertices.getTextureCoordinates(), 0, vertices.getColors(), 0, vertices.getIndices(), 0, vertices.getIndices().length, paint.getInternalPaint());
    }
    ...
    private final void drawPoints(List<Offset> points, Paint paint) {
        ...
        for (int i = 0; i < size; i++) {
            long packedValue = points.get(i).getPackedValue();
            this.internalCanvas.drawPoint(Offset.m2446getXimpl(packedValue), Offset.m2447getYimpl(packedValue), paint.getInternalPaint());
        }
    }
}
