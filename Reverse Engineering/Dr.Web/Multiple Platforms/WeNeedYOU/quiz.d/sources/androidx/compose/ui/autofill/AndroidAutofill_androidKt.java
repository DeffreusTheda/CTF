...
public final class AndroidAutofill_androidKt {
        ...
        for (Map.Entry<Integer, AutofillNode> entry : androidAutofill.getAutofillTree().getChildren().entrySet()) {
            ...
            if (newChild != null) {
                ...
                if (boundingBox == null) {
                    ...
                    int roundToInt4 = MathKt.roundToInt(boundingBox.getBottom()) - roundToInt2;
                    AutofillApi23Helper.INSTANCE.setDimens(newChild, roundToInt, roundToInt2, 0, 0, roundToInt3 - roundToInt, roundToInt4);
                }
            }
            addChildCount++;
        }
    ...
    public static final void performAutofill(AndroidAutofill androidAutofill, SparseArray<AutofillValue> values) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            AutofillValue value = Api26Bitmap$$ExternalSyntheticApiModelOutline0.m2602m((Object) values.get(keyAt));
            AutofillApi26Helper autofillApi26Helper = AutofillApi26Helper.INSTANCE;
