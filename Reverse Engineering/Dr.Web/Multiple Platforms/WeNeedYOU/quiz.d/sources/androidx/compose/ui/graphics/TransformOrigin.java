...
public final class TransformOrigin {
    ...
    public static final /* synthetic */ TransformOrigin m3091boximpl(long j) {
        return new TransformOrigin(j);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static long m3094constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m3097equalsimpl(long j, Object obj) {
        return (obj instanceof TransformOrigin) && j == ((TransformOrigin) obj).getPackedValue();
    }

    /* renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3098equalsimpl0(long j, long j2) {
        return j == j2;
    }
    ...
    public static int m3101hashCodeimpl(long j) {
        return UByte$$ExternalSyntheticBackport0.m(j);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3102toStringimpl(long j) {
        return "TransformOrigin(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m3097equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m3101hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m3102toStringimpl(this.packedValue);
    }
    ...
    public static final float m3092component1impl(long j) {
        return m3099getPivotFractionXimpl(j);
    }

    /* renamed from: component2-impl, reason: not valid java name */
    public static final float m3093component2impl(long j) {
        return m3100getPivotFractionYimpl(j);
    }

    /* renamed from: copy-zey9I6w$default, reason: not valid java name */
    public static /* synthetic */ long m3096copyzey9I6w$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m3099getPivotFractionXimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m3100getPivotFractionYimpl(j);
        }
        return m3095copyzey9I6w(j, f, f2);
    }

    /* renamed from: copy-zey9I6w, reason: not valid java name */
    public static final long m3095copyzey9I6w(long j, float f, float f2) {
    ...
    public static final class Companion {
        ...
        public final long m3104getCenterSzJe1aQ() {
            return TransformOrigin.Center;
        }
    }

    /* renamed from: getPivotFractionX-impl, reason: not valid java name */
    public static final float m3099getPivotFractionXimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getPivotFractionY-impl, reason: not valid java name */
    public static final float m3100getPivotFractionYimpl(long j) {
        FloatCompanionObject floatCompanionObject = FloatCompanionObject.INSTANCE;
