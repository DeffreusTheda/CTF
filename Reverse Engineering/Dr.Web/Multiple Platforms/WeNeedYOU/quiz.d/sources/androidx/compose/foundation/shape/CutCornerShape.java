...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo764createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2515getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m2515getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m2515getWidthimpl(size), Size.m2512getHeightimpl(size) - f2);
        Path.lineTo(Size.m2515getWidthimpl(size) - f2, Size.m2512getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m2512getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2512getHeightimpl(size) - bottomEnd);
        Path.close();
