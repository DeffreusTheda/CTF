...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public static /* synthetic */ BorderModifierNodeElement m213copy8Feqmps$default(BorderModifierNodeElement borderModifierNodeElement, float f, Brush brush, Shape shape, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return borderModifierNodeElement.m215copy8Feqmps(f, brush, shape);
    }
    ...
    public final BorderModifierNodeElement m215copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m5022equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m5023hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m5028toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(BorderModifierNode node) {
        ...
        node.m212setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m5015boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set(TypedValues.Custom.S_COLOR, Color.m2701boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m2701boximpl(((SolidColor) this.brush).getValue()));
        } else {
