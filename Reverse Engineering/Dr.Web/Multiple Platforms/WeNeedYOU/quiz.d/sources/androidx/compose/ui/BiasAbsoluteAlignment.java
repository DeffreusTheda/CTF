...
public final /* data */ class BiasAbsoluteAlignment implements Alignment {
    ...
    public long mo2336alignKFBX0sM(long size, long space, LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        long IntSize = IntSizeKt.IntSize(IntSize.m5177getWidthimpl(space) - IntSize.m5177getWidthimpl(size), IntSize.m5176getHeightimpl(space) - IntSize.m5176getHeightimpl(size));
        float f = 1;
        return IntOffsetKt.IntOffset(MathKt.roundToInt((IntSize.m5177getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f)), MathKt.roundToInt((IntSize.m5176getHeightimpl(IntSize) / 2.0f) * (f + this.verticalBias)));
    }
