...
final class LazyStaggeredGridSlotCache implements Function2<Density, Constraints, LazyStaggeredGridSlots> {
    ...
    public /* bridge */ /* synthetic */ LazyStaggeredGridSlots invoke(Density density, Constraints constraints) {
        return m719invoke0kLqBqw(density, constraints.getValue());
    }

    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
    public LazyStaggeredGridSlots m719invoke0kLqBqw(Density density, long constraints) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (this.cachedSizes != null && Constraints.m4954equalsimpl0(this.cachedConstraints, constraints) && this.cachedDensity == density.getDensity()) {
        ...
        LazyStaggeredGridSlots invoke = this.calculation.invoke(density, Constraints.m4949boximpl(constraints));
