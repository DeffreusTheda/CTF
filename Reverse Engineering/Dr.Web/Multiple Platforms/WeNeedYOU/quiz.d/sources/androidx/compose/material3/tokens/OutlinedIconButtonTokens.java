...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5017constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m5017constructorimpl((float) 24.0d);
    ...
    public final float m2049getContainerSizeD9Ej5fM() {
    ...
    public final float m2050getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2051getUnselectedOutlineWidthD9Ej5fM() {
