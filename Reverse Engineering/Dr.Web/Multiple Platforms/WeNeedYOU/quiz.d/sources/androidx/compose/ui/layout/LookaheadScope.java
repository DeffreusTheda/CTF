...
public interface LookaheadScope {
    ...
    long mo3971localLookaheadPositionOfdBAh8RU(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2);
    ...
    public final /* synthetic */ class CC {
        ...
        public static long m3992$default$localLookaheadPositionOfdBAh8RU(LookaheadScope _this, LayoutCoordinates localLookaheadPositionOf, LayoutCoordinates coordinates) {
            Intrinsics.checkNotNullParameter(localLookaheadPositionOf, "$this$localLookaheadPositionOf");
            Intrinsics.checkNotNullParameter(coordinates, "coordinates");
            return _this.toLookaheadCoordinates(localLookaheadPositionOf).mo3975localPositionOfR5De75A(_this.toLookaheadCoordinates(coordinates), Offset.INSTANCE.m2462getZeroF1C5BW0());
        }

        @Deprecated(message = "", replaceWith = @ReplaceWith(expression = "intermediateLayout { measurable, constraints ->measure.invoke(this, measurable, constraints, lookaheadSize)}", imports = {}))
        public static Modifier $default$intermediateLayout(LookaheadScope _this, Modifier modifier, final Function4 measure) {
            ...
            return LookaheadScopeKt.intermediateLayout(modifier, new Function3<IntermediateMeasureScope, Measurable, Constraints, MeasureResult>() { // from class: androidx.compose.ui.layout.LookaheadScope$intermediateLayout$1
                ...
                public /* bridge */ /* synthetic */ MeasureResult invoke(IntermediateMeasureScope intermediateMeasureScope, Measurable measurable, Constraints constraints) {
                    return m3993invoke3p2s80s(intermediateMeasureScope, measurable, constraints.getValue());
                }

                /* renamed from: invoke-3p2s80s, reason: not valid java name */
                public final MeasureResult m3993invoke3p2s80s(IntermediateMeasureScope intermediateLayout, Measurable measurable, long j) {
                    Intrinsics.checkNotNullParameter(intermediateLayout, "$this$intermediateLayout");
                    Intrinsics.checkNotNullParameter(measurable, "measurable");
                    return measure.invoke(intermediateLayout, measurable, Constraints.m4949boximpl(j), IntSize.m5169boximpl(intermediateLayout.mo3970getLookaheadSizeYbymL2g()));
                }
            });
        }
    }
