...
final class InsetsPaddingValues implements PaddingValues {
    ...
    public float mo470calculateLeftPaddingu2uoSUM(LayoutDirection layoutDirection) {
        ...
        return density.mo357toDpu2uoSUM(this.insets.getLeft(density, layoutDirection));
    }
    ...
    public float getTop() {
        Density density = this.density;
        return density.mo357toDpu2uoSUM(this.insets.getTop(density));
    }
    ...
    public float mo471calculateRightPaddingu2uoSUM(LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Density density = this.density;
        return density.mo357toDpu2uoSUM(this.insets.getRight(density, layoutDirection));
    }
    ...
    public float getBottom() {
        Density density = this.density;
        return density.mo357toDpu2uoSUM(this.insets.getBottom(density));
    }
