...
public final class GridItemSpan {
    ...
    public static final /* synthetic */ GridItemSpan m635boximpl(long j) {
    ...
    public static final int m639getCurrentLineSpanimpl(long j) {
        return (int) j;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m640hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m640hashCodeimpl(this.packedValue);
    }
