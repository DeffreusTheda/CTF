    ...
    public static final Modifier transformable(Modifier modifier, final TransformableState state, final Function0<Boolean> canPan, final boolean z, final boolean z2) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.gestures.TransformableKt$transformable$$inlined$debugInspectorInfo$1
            ...
            static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    */
                    public final java.lang.Object invokeSuspend(java.lang.Object r7) {
                        ...
                        L3b:
                            ...
                            r3.mo286transformByd4ec7I(r1, r4, r7)
                        L4c:
                ...
                /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:18:0x0083 -> B:9:0x0038). Please report as a decompilation issue!!! */
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                /*
                    Code decompiled incorrectly, please refer to instructions dump.
                    To view partially-correct add '--show-bad-code' argument
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r10) {
                    ...
                    L5a:
                        ...
                        if (r10 == 0) goto L83
                        androidx.compose.foundation.gestures.TransformableState r10 = r9.$state     // Catch: java.util.concurrent.CancellationException -> L82
                        ...
                        androidx.compose.foundation.gestures.TransformableKt$transformable$3$1$1 r6 = new androidx.compose.foundation.gestures.TransformableKt$transformable$3$1$1     // Catch: java.util.concurrent.CancellationException -> L82
                        kotlinx.coroutines.channels.Channel<androidx.compose.foundation.gestures.TransformEvent> r7 = r9.$channel     // Catch: java.util.concurrent.CancellationException -> L82
                        r8 = 0
                        r6.<init>(r4, r7, r8)     // Catch: java.util.concurrent.CancellationException -> L82
                        kotlin.jvm.functions.Function2 r6 = (kotlin.jvm.functions.Function2) r6     // Catch: java.util.concurrent.CancellationException -> L82
                        r4 = r9
                        kotlin.coroutines.Continuation r4 = (kotlin.coroutines.Continuation) r4     // Catch: java.util.concurrent.CancellationException -> L82
                        r9.L$0 = r5     // Catch: java.util.concurrent.CancellationException -> L82
                        r9.L$1 = r8     // Catch: java.util.concurrent.CancellationException -> L82
                        r9.L$2 = r8     // Catch: java.util.concurrent.CancellationException -> L82
                        r9.label = r2     // Catch: java.util.concurrent.CancellationException -> L82
                        java.lang.Object r10 = r10.transform(r1, r6, r4)     // Catch: java.util.concurrent.CancellationException -> L82
                        if (r10 != r0) goto L83
                        return r0
                    L82:
                    L83:
