...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int i, boolean z, int i2, int i3) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m4969fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m4946getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final void m902setLayoutSizeozmzZPI$foundation_release(long j) {
        this.layoutSize = j;
    }

    /* renamed from: layoutWithConstraints-K40F9xA, reason: not valid java name */
    public final boolean m901layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        if (this.minLines > 1) {
            ...
            constraints = from.m890coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m899newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m4954equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m4972constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraph.getWidth()), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m4939equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4948getVisiblegIe3tQ8()) || (IntSize.m5177getWidthimpl(r9) >= paragraph.getWidth() && IntSize.m5176getHeightimpl(r9) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
            }
        ...
        Paragraph m898layoutTextK40F9xA = m898layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m4972constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(m898layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(m898layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m4939equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4948getVisiblegIe3tQ8()) && (IntSize.m5177getWidthimpl(r9) < m898layoutTextK40F9xA.getWidth() || IntSize.m5176getHeightimpl(r9) < m898layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
        this.paragraph = m898layoutTextK40F9xA;
        return true;
    }
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int ceilToIntPx = TextDelegateKt.ceilToIntPx(m898layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m903updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        this.text = text;
    ...
    private final Paragraph m898layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m4432Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m887finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m888finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m4939equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4947getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m899newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m4961getMaxWidthimpl(constraints) != Constraints.m4961getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m4960getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull() {
        ...
        long m4952copyZbe2FdA$default = Constraints.m4952copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, this.style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, m4952copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, this.style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), m4952copyZbe2FdA$default, this.maxLines, TextOverflow.m4939equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4947getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
