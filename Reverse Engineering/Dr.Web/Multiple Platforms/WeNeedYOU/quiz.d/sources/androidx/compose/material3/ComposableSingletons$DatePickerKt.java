...
public final class ComposableSingletons$DatePickerKt {
    ...
    public static Function2<Composer, Integer, Unit> f19lambda1 = ComposableLambdaKt.composableLambdaInstance(1244569435, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$DatePickerKt$lambda-1$1
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if ((i & 11) != 2 || !composer.getSkipping()) {
                ...
                IconKt.m1283Iconww6aTOc(EditKt.getEdit(Icons.Filled.INSTANCE), Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1472getDatePickerSwitchToInputModeadMyvUU(), composer, 6), (Modifier) null, 0L, composer, 0, 12);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static Function2<Composer, Integer, Unit> f20lambda2 = ComposableLambdaKt.composableLambdaInstance(668820324, false, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.ComposableSingletons$DatePickerKt$lambda-2$1
        ...
        public final void invoke(Composer composer, int i) {
            ...
            if ((i & 11) != 2 || !composer.getSkipping()) {
                ...
                IconKt.m1283Iconww6aTOc(DateRangeKt.getDateRange(Icons.Filled.INSTANCE), Strings_androidKt.m1512getStringNWtq28(Strings.INSTANCE.m1470getDatePickerSwitchToCalendarModeadMyvUU(), composer, 6), (Modifier) null, 0L, composer, 0, 12);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                    return;
                }
    ...
    public final Function2<Composer, Integer, Unit> m1161getLambda1$material3_release() {
        return f19lambda1;
    }

    /* renamed from: getLambda-2$material3_release, reason: not valid java name */
    public final Function2<Composer, Integer, Unit> m1162getLambda2$material3_release() {
        return f20lambda2;
    }
}
