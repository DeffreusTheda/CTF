...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3364rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        ...
        long m2747getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m2747getUnspecified0d7_KjU() : j;
        int m2653getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m2653getSrcIn0nO6VwU() : i;
        ...
        VectorPainter m3365rememberVectorPaintervIP8VLU = m3365rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, m2747getUnspecified0d7_KjU, m2653getSrcIn0nO6VwU, false, content, composer, (i2 & 14) | 12582912 | (i2 & 112) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3365rememberVectorPaintervIP8VLU;
    }

    /* renamed from: rememberVectorPainter-vIP8VLU, reason: not valid java name */
    public static final VectorPainter m3365rememberVectorPaintervIP8VLU(float f, float f2, float f3, float f4, String str, long j, int i, boolean z, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> content, Composer composer, int i2, int i3) {
        Intrinsics.checkNotNullParameter(content, "content");
        ...
        float mo360toPx0680j_4 = density.mo360toPx0680j_4(f);
        float mo360toPx0680j_42 = density.mo360toPx0680j_4(f2);
        if (Float.isNaN(f5)) {
            f5 = mo360toPx0680j_4;
        }
        if (Float.isNaN(f6)) {
            f6 = mo360toPx0680j_42;
        }
        Color m2701boximpl = Color.m2701boximpl(m2747getUnspecified0d7_KjU);
        BlendMode m2621boximpl = BlendMode.m2621boximpl(m2653getSrcIn0nO6VwU);
        int i4 = i2 >> 15;
        composer.startReplaceableGroup(511388516);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1,2):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2701boximpl) | composer.changed(m2621boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = !Color.m2712equalsimpl0(m2747getUnspecified0d7_KjU, Color.INSTANCE.m2747getUnspecified0d7_KjU()) ? ColorFilter.INSTANCE.m2755tintxETnrds(m2747getUnspecified0d7_KjU, m2653getSrcIn0nO6VwU) : null;
        ...
        vectorPainter.m3363setSizeuvyYCjk$ui_release(SizeKt.Size(mo360toPx0680j_4, mo360toPx0680j_42));
    ...
    private static final void mirror(DrawScope drawScope, Function1<? super DrawScope, Unit> function1) {
        long mo3183getCenterF1C5BW0 = drawScope.mo3183getCenterF1C5BW0();
