...
public final class DrawCache {
    ...
    private long size = IntSize.INSTANCE.m5182getZeroYbymL2g();
    ...
    public final void m3343drawCachedImageCJJARo(long size, Density density, LayoutDirection layoutDirection, Function1<? super DrawScope, Unit> block) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m5177getWidthimpl(size) > imageBitmap.getWidth() || IntSize.m5176getHeightimpl(size) > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m2941ImageBitmapx__hDU$default(IntSize.m5177getWidthimpl(size), IntSize.m5176getHeightimpl(size), 0, false, null, 28, null);
        ...
        long m5187toSizeozmzZPI = IntSizeKt.m5187toSizeozmzZPI(size);
        ...
        drawParams2.m3189setSizeuvyYCjk(m5187toSizeozmzZPI);
        canvas.save();
    ...
    public final void drawInto(DrawScope target, float alpha, ColorFilter colorFilter) {
        ...
        DrawScope.CC.m3253drawImageAZ2fEMs$default(target, imageBitmap, 0L, this.size, 0L, 0L, alpha, null, colorFilter, 0, 0, 858, null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.CC.m3264drawRectnJ9OG0$default(drawScope, Color.INSTANCE.m2737getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.INSTANCE.m2628getClear0nO6VwU(), 62, null);
    }
}
