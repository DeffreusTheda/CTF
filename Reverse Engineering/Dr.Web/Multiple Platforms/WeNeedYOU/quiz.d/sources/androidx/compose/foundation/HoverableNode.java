...
final class HoverableNode extends Modifier.Node implements PointerInputModifierNode {
    ...
    public void mo176onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        if (pass == PointerEventPass.Main) {
            ...
            if (PointerEventType.m3798equalsimpl0(type, PointerEventType.INSTANCE.m3802getEnter7fucELk())) {
            ...
            } else if (PointerEventType.m3798equalsimpl0(type, PointerEventType.INSTANCE.m3803getExit7fucELk())) {
