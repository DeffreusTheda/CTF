...
public final class PointerEventKt {
    ...
    public static final boolean positionChanged(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2443equalsimpl0(positionChangeInternal(pointerInputChange, false), Offset.INSTANCE.m2462getZeroF1C5BW0());
    }

    public static final boolean positionChangedIgnoreConsumed(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        return !Offset.m2443equalsimpl0(positionChangeInternal(pointerInputChange, true), Offset.INSTANCE.m2462getZeroF1C5BW0());
    }
    ...
    private static final long positionChangeInternal(PointerInputChange pointerInputChange, boolean z) {
        long m2450minusMKHz9U = Offset.m2450minusMKHz9U(pointerInputChange.getPosition(), pointerInputChange.getPreviousPosition());
        return (z || !pointerInputChange.isConsumed()) ? m2450minusMKHz9U : Offset.INSTANCE.m2462getZeroF1C5BW0();
    }
    ...
    public static final void consumePositionChange(PointerInputChange pointerInputChange) {
        Intrinsics.checkNotNullParameter(pointerInputChange, "<this>");
        if (Offset.m2443equalsimpl0(positionChange(pointerInputChange), Offset.INSTANCE.m2462getZeroF1C5BW0())) {
            return;
        }
        pointerInputChange.consume();
    }
    ...
    public static final boolean m3793isOutOfBoundsO0kMr_c(PointerInputChange isOutOfBounds, long j) {
        ...
        return m2446getXimpl < 0.0f || m2446getXimpl > ((float) IntSize.m5177getWidthimpl(j)) || m2447getYimpl < 0.0f || m2447getYimpl > ((float) IntSize.m5176getHeightimpl(j));
    }

    /* renamed from: isOutOfBounds-jwHxaWs, reason: not valid java name */
    public static final boolean m3794isOutOfBoundsjwHxaWs(PointerInputChange isOutOfBounds, long j, long j2) {
        Intrinsics.checkNotNullParameter(isOutOfBounds, "$this$isOutOfBounds");
        if (!PointerType.m3920equalsimpl0(isOutOfBounds.getType(), PointerType.INSTANCE.m3927getTouchT8wyACA())) {
            return m3793isOutOfBoundsO0kMr_c(isOutOfBounds, j);
        }
        long position = isOutOfBounds.getPosition();
        float m2446getXimpl = Offset.m2446getXimpl(position);
        float m2447getYimpl = Offset.m2447getYimpl(position);
        return m2446getXimpl < (-Size.m2515getWidthimpl(j2)) || m2446getXimpl > ((float) IntSize.m5177getWidthimpl(j)) + Size.m2515getWidthimpl(j2) || m2447getYimpl < (-Size.m2512getHeightimpl(j2)) || m2447getYimpl > ((float) IntSize.m5176getHeightimpl(j)) + Size.m2512getHeightimpl(j2);
    }
}
