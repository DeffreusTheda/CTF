        ...
        if (i == 0) {
            ...
            Flow snapshotFlow = SnapshotStateKt.snapshotFlow(new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.1
                ...
                public /* bridge */ /* synthetic */ Offset invoke() {
                    return Offset.m2435boximpl(m946invokeF1C5BW0());
                }

                /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                public final long m946invokeF1C5BW0() {
            ...
            if (snapshotFlow.collect(new FlowCollector<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1.2
                ...
                public /* bridge */ /* synthetic */ Object emit(Offset offset, Continuation continuation) {
                    return m947emit3MmeM6k(offset.getPackedValue(), continuation);
                }

                /* renamed from: emit-3MmeM6k, reason: not valid java name */
                public final Object m947emit3MmeM6k(long j, Continuation<? super Unit> continuation) {
                    if (OffsetKt.m2465isSpecifiedk4lQ0M(animatable.getValue().getPackedValue()) && OffsetKt.m2465isSpecifiedk4lQ0M(j) && Offset.m2447getYimpl(animatable.getValue().getPackedValue()) != Offset.m2447getYimpl(j)) {
                    ...
                    Object snapTo = animatable.snapTo(Offset.m2435boximpl(j), continuation);
