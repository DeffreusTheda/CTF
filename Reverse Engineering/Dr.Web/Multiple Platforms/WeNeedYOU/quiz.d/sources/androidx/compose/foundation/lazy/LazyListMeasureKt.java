...
public final class LazyListMeasureKt {
    ...
    public static final LazyListMeasureResult m627measureLazyListCD5nmq0(int i, LazyListMeasuredItemProvider measuredItemProvider, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, boolean z, List<Integer> headerIndexes, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z2, Density density, LazyListItemPlacementAnimator placementAnimator, int i8, List<Integer> pinnedItems, Function3<? super Integer, ? super Integer, ? super Function1<? super Placeable.PlacementScope, Unit>, ? extends MeasureResult> layout) {
        ...
        if (i <= 0) {
            return new LazyListMeasureResult(null, 0, false, 0.0f, layout.invoke(Integer.valueOf(Constraints.m4963getMinWidthimpl(j)), Integer.valueOf(Constraints.m4962getMinHeightimpl(j)), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$1
        ...
        int m4975constrainWidthK40F9xA = ConstraintsKt.m4975constrainWidthK40F9xA(j, z ? i49 : i11);
        if (z) {
            i49 = i11;
        }
        int m4974constrainHeightK40F9xA = ConstraintsKt.m4974constrainHeightK40F9xA(j, i49);
        float f3 = f2;
        int i52 = i10;
        final List<LazyListMeasuredItem> calculateItemsOffsets = calculateItemsOffsets(arrayDeque2, createItemsBeforeList, createItemsAfterList, m4975constrainWidthK40F9xA, m4974constrainHeightK40F9xA, i11, i2, i15, z, vertical, horizontal, z2, density);
        int i53 = i11;
        LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem;
        placementAnimator.onMeasured((int) f3, m4975constrainWidthK40F9xA, m4974constrainHeightK40F9xA, calculateItemsOffsets, measuredItemProvider, z);
        final LazyListMeasuredItem findOrComposeLazyListHeader = headerIndexes.isEmpty() ^ true ? LazyListHeadersKt.findOrComposeLazyListHeader(calculateItemsOffsets, measuredItemProvider, headerIndexes, i3, m4975constrainWidthK40F9xA, m4974constrainHeightK40F9xA) : null;
        boolean z4 = i52 < i || i53 > i2;
        MeasureResult invoke = layout.invoke(Integer.valueOf(m4975constrainWidthK40F9xA), Integer.valueOf(m4974constrainHeightK40F9xA), new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListMeasureKt$measureLazyList$5
