...
final class DerivedHeightModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(Constraints.m4952copyZbe2FdA$default(j, 0, 0, intValue, intValue, 3, null));
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), intValue, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedHeightModifier$measure$2
            {
                super(1);
            }
