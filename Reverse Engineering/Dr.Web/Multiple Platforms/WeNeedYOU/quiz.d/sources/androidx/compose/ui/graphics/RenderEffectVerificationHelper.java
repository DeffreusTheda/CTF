...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m3023createBlurEffect8A3gB4(RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        android.graphics.RenderEffect createBlurEffect;
        android.graphics.RenderEffect createBlurEffect2;
        if (inputRenderEffect == null) {
            createBlurEffect2 = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m2593toAndroidTileMode0vamqd0(edgeTreatment));
            Intrinsics.checkNotNullExpressionValue(createBlurEffect2, "{\n            android.gr…)\n            )\n        }");
            return createBlurEffect2;
        }
        createBlurEffect = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m2593toAndroidTileMode0vamqd0(edgeTreatment));
    ...
    public final android.graphics.RenderEffect m3024createOffsetEffectUv8p0NA(RenderEffect inputRenderEffect, long offset) {
        android.graphics.RenderEffect createOffsetEffect;
        android.graphics.RenderEffect createOffsetEffect2;
        if (inputRenderEffect == null) {
            createOffsetEffect2 = android.graphics.RenderEffect.createOffsetEffect(Offset.m2446getXimpl(offset), Offset.m2447getYimpl(offset));
            Intrinsics.checkNotNullExpressionValue(createOffsetEffect2, "{\n            android.gr…et.x, offset.y)\n        }");
            return createOffsetEffect2;
        }
        createOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(Offset.m2446getXimpl(offset), Offset.m2447getYimpl(offset), inputRenderEffect.asAndroidRenderEffect());
