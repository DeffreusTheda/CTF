...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5017constructorimpl(30);
    ...
    public static /* synthetic */ Modifier m199basicMarquee1Mj1MLw$default(Modifier modifier, int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f, int i5, Object obj) {
        if ((i5 & 1) != 0) {
            i = DefaultMarqueeIterations;
        }
        if ((i5 & 2) != 0) {
            i2 = MarqueeAnimationMode.INSTANCE.m265getImmediatelyZbEOnfQ();
        }
        int i6 = i2;
        if ((i5 & 4) != 0) {
        ...
        int i7 = i3;
        if ((i5 & 8) != 0) {
            i4 = MarqueeAnimationMode.m259equalsimpl0(i6, MarqueeAnimationMode.INSTANCE.m265getImmediatelyZbEOnfQ()) ? i7 : 0;
        }
        int i8 = i4;
        if ((i5 & 16) != 0) {
        ...
        return m198basicMarquee1Mj1MLw(modifier, i, i6, i7, i8, marqueeSpacing2, f);
    }

    /* renamed from: basicMarquee-1Mj1MLw, reason: not valid java name */
    public static final Modifier m198basicMarquee1Mj1MLw(Modifier basicMarquee, int i, int i2, int i3, int i4, MarqueeSpacing spacing, float f) {
    ...
    public static final AnimationSpec<Float> m200createMarqueeAnimationSpecZ4HSEVQ(int i, float f, int i2, int i3, float f2, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo360toPx0680j_4(f2)), f, i3);
        long m145constructorimpl$default = StartOffset.m145constructorimpl$default((-i3) + i2, 0, 2, null);
        if (i == Integer.MAX_VALUE) {
            return AnimationSpecKt.m124infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m145constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m126repeatable91I0pcU$default(i, velocityBasedTween, null, m145constructorimpl$default, 4, null);
    }
    ...
    public static final MarqueeSpacing m196MarqueeSpacing0680j_4(final float f) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i, int i2) {
                ...
                return MarqueeSpacing.mo354roundToPx0680j_4(f);
            }
        };
    }
}
