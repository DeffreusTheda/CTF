                ...
                while (true) {
                    ...
                    if (!it.hasNext()) {
                        ...
                        for (FocusEventModifierNode focusEventModifierNode : set3) {
                            if (focusEventModifierNode.getNode().getIsAttached()) {
                                ...
                                int m4184constructorimpl = NodeKind.m4184constructorimpl(i);
                                        ...
                                        while (node2 != null) {
                                            if ((node2.getKindSet() & m4184constructorimpl) != 0) {
                                                ...
                                                while (node2 != null) {
                                                    ...
                                                    } else if ((node2.getKindSet() & m4184constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                                        int i4 = 0;
                                                        for (Modifier.Node delegate2 = ((DelegatingNode) node2).getDelegate(); delegate2 != null; delegate2 = delegate2.getChild()) {
                                                            if ((delegate2.getKindSet() & m4184constructorimpl) != 0) {
                                                                i4++;
                                                                if (i4 == 1) {
                                                                    node2 = delegate2;
                                                                } else {
                    ...
                    if (focusPropertiesModifierNode.getNode().getIsAttached()) {
                        ...
                        while (mutableVector5.isNotEmpty()) {
                            ...
                            if ((node4.getAggregateChildKindSet() & m4184constructorimpl2) == 0) {
                                ...
                                while (true) {
                                    ...
                                    if ((node4.getKindSet() & m4184constructorimpl2) != 0) {
