...
public final class LazyLayoutItemContentFactoryKt {
    ...
    public static final void m675SkippableItemJVlU9Rs(final LazyLayoutItemProvider lazyLayoutItemProvider, final Object obj, final int i, final Object obj2, Composer composer, final int i2) {
        final int i3;
        ...
        endRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutItemContentFactoryKt$SkippableItem$2
            ...
            public final void invoke(Composer composer2, int i4) {
                LazyLayoutItemContentFactoryKt.m675SkippableItemJVlU9Rs(LazyLayoutItemProvider.this, obj, i, obj2, composer2, RecomposeScopeImplKt.updateChangedFlags(i2 | 1));
            }
        });
    }
}
