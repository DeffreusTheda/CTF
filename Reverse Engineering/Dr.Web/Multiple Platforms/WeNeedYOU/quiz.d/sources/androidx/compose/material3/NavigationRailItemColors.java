...
public final class NavigationRailItemColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2712equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2712equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2712equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2712equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m2712equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m2712equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }

    public int hashCode() {
        return (((((((((((Color.m2718hashCodeimpl(this.selectedIconColor) * 31) + Color.m2718hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2718hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2718hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2718hashCodeimpl(this.selectedIndicatorColor)) * 31) + Color.m2718hashCodeimpl(this.disabledIconColor)) * 31) + Color.m2718hashCodeimpl(this.disabledTextColor);
    }
}
