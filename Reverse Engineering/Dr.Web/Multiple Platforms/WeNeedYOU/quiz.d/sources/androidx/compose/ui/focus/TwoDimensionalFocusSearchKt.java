...
public final class TwoDimensionalFocusSearchKt {
    ...
    public static final Boolean m2411twoDimensionalFocusSearchOMvw8(FocusTargetNode twoDimensionalFocusSearch, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        Intrinsics.checkNotNullParameter(twoDimensionalFocusSearch, "$this$twoDimensionalFocusSearch");
        Intrinsics.checkNotNullParameter(onFound, "onFound");
        int i2 = WhenMappings.$EnumSwitchMapping$0[twoDimensionalFocusSearch.getFocusState().ordinal()];
        if (i2 != 1) {
            if (i2 == 2 || i2 == 3) {
                return Boolean.valueOf(m2407findChildCorrespondingToFocusEnterOMvw8(twoDimensionalFocusSearch, i, onFound));
            }
            if (i2 == 4) {
        ...
        if (i3 == 1) {
            Boolean m2411twoDimensionalFocusSearchOMvw8 = m2411twoDimensionalFocusSearchOMvw8(activeChild, i, onFound);
            return !Intrinsics.areEqual((Object) m2411twoDimensionalFocusSearchOMvw8, (Object) false) ? m2411twoDimensionalFocusSearchOMvw8 : Boolean.valueOf(m2408generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeNode(activeChild), i, onFound));
        }
        if (i3 == 2 || i3 == 3) {
            return Boolean.valueOf(m2408generateAndSearchChildren4C6V_qg(twoDimensionalFocusSearch, activeChild, i, onFound));
        }
        if (i3 == 4) {
            throw new IllegalStateException(NoActiveChild.toString());
        }
    ...
    private static final boolean m2408generateAndSearchChildren4C6V_qg(final FocusTargetNode focusTargetNode, final FocusTargetNode focusTargetNode2, final int i, final Function1<? super FocusTargetNode, Boolean> function1) {
        if (m2410searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2361searchBeyondBoundsOMvw8(focusTargetNode, i, new Function1<BeyondBoundsLayout.BeyondBoundsScope, Boolean>() { // from class: androidx.compose.ui.focus.TwoDimensionalFocusSearchKt$generateAndSearchChildren$1
            ...
            public final Boolean invoke(BeyondBoundsLayout.BeyondBoundsScope searchBeyondBounds) {
                boolean m2410searchChildren4C6V_qg;
                Intrinsics.checkNotNullParameter(searchBeyondBounds, "$this$searchBeyondBounds");
                m2410searchChildren4C6V_qg = TwoDimensionalFocusSearchKt.m2410searchChildren4C6V_qg(FocusTargetNode.this, focusTargetNode2, i, function1);
                Boolean valueOf = Boolean.valueOf(m2410searchChildren4C6V_qg);
                valueOf.getClass();
                if (m2410searchChildren4C6V_qg || !searchBeyondBounds.getHasMoreContent()) {
                    return valueOf;
                }
                return null;
            }
    ...
    private static final FocusTargetNode m2406findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i) {
        Rect translate;
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s())) {
            ...
            translate = rect.translate(-(rect.getWidth() + 1), 0.0f);
        } else if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2382getUpdhqQ8s())) {
            translate = rect.translate(0.0f, rect.getHeight() + 1);
        } else {
            if (!FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2373getDowndhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m2409isBetterCandidateI7lrPNg(focusRect, translate, rect, i)) {
    ...
    private static final float isBetterCandidate_I7lrPNg$majorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float f;
        if (!FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s())) {
            if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2381getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i, Rect rect2) {
        ...
        float top2;
        float height;
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2381getRightdhqQ8s())) {
            f = 2;
            top = rect2.getTop() + (rect2.getHeight() / f);
            top2 = rect.getTop();
            height = rect.getHeight();
        } else {
            if (!FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2382getUpdhqQ8s()) && !FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2373getDowndhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            f = 2;
    ...
    private static final boolean m2409isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i) {
        if (isBetterCandidate_I7lrPNg$isCandidate(rect, i, rect3)) {
            return !isBetterCandidate_I7lrPNg$isCandidate(rect2, i, rect3) || m2405beamBeatsI7lrPNg(rect3, rect, rect2, i) || (!m2405beamBeatsI7lrPNg(rect3, rect2, rect, i) && isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect) < isBetterCandidate_I7lrPNg$weightedDistance(i, rect3, rect2));
        }
        return false;
    }
    ...
    public static final boolean m2407findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode findChildCorrespondingToFocusEnter, int i, Function1<? super FocusTargetNode, Boolean> onFound) {
        Rect rect;
        ...
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2374getEnterdhqQ8s())) {
            i = FocusDirection.INSTANCE.m2381getRightdhqQ8s();
        }
        if (FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2381getRightdhqQ8s()) || FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2373getDowndhqQ8s())) {
            rect = topLeft(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        } else {
            if (!FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2377getLeftdhqQ8s()) && !FocusDirection.m2365equalsimpl0(i, FocusDirection.INSTANCE.m2382getUpdhqQ8s())) {
                throw new IllegalStateException(InvalidFocusDirection.toString());
            }
            rect = bottomRight(FocusTraversalKt.focusRect(findChildCorrespondingToFocusEnter));
        }
        FocusTargetNode m2406findBestCandidate4WY_MpI = m2406findBestCandidate4WY_MpI(mutableVector, rect, i);
        if (m2406findBestCandidate4WY_MpI != null) {
            return onFound.invoke(m2406findBestCandidate4WY_MpI).booleanValue();
        }
        return false;
    }
    ...
    public static final boolean m2410searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i, Function1<? super FocusTargetNode, Boolean> function1) {
        FocusTargetNode m2406findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        ...
        while (mutableVector2.isNotEmpty()) {
            ...
            if ((node.getAggregateChildKindSet() & m4184constructorimpl) == 0) {
                ...
                while (true) {
                    ...
                    if ((node.getKindSet() & m4184constructorimpl) != 0) {
        ...
        while (mutableVector.isNotEmpty() && (m2406findBestCandidate4WY_MpI = m2406findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i)) != null) {
            if (m2406findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                return function1.invoke(m2406findBestCandidate4WY_MpI).booleanValue();
            }
            if (m2408generateAndSearchChildren4C6V_qg(m2406findBestCandidate4WY_MpI, focusTargetNode2, i, function1)) {
                return true;
            }
            mutableVector.remove(m2406findBestCandidate4WY_MpI);
        }
        return false;
    }
