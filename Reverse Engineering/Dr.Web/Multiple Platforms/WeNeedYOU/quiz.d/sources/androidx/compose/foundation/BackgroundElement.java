...
final class BackgroundElement extends ModifierNodeElement<BackgroundNode> {
    ...
    public /* synthetic */ BackgroundElement(long j, Brush brush, float f, Shape shape, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Color.INSTANCE.m2747getUnspecified0d7_KjU() : j, (i & 2) != 0 ? null : brush, f, shape, function1, null);
    }
    ...
    public void update(BackgroundNode node) {
        ...
        node.m195setColor8_81llA(this.color);
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        int m2718hashCodeimpl = Color.m2718hashCodeimpl(this.color) * 31;
        Brush brush = this.brush;
        return ((((m2718hashCodeimpl + (brush != null ? brush.hashCode() : 0)) * 31) + Float.floatToIntBits(this.alpha)) * 31) + this.shape.hashCode();
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public boolean equals(Object other) {
        BackgroundElement backgroundElement = other instanceof BackgroundElement ? (BackgroundElement) other : null;
        return backgroundElement != null && Color.m2712equalsimpl0(this.color, backgroundElement.color) && Intrinsics.areEqual(this.brush, backgroundElement.brush) && this.alpha == backgroundElement.alpha && Intrinsics.areEqual(this.shape, backgroundElement.shape);
    }
}
