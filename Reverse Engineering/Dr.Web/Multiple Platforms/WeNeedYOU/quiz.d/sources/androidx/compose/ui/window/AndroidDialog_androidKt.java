    ...
    */
    ...
    public static final void DialogLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 91) != 18 || !startRestartGroup.getSkipping()) {
            ...
            AndroidDialog_androidKt$DialogLayout$1 androidDialog_androidKt$DialogLayout$1 = new MeasurePolicy() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    for (int i5 = 0; i5 < size; i5++) {
                        arrayList.add(measurables.get(i5).mo3967measureBRTryo0(j));
                    }
                    ...
                    int width3 = placeable2 != null ? placeable2.getWidth() : Constraints.m4963getMinWidthimpl(j);
                    if (!arrayList2.isEmpty()) {
                    ...
                    return MeasureScope.CC.layout$default(Layout, width3, placeable3 != null ? placeable3.getHeight() : Constraints.m4962getMinHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.window.AndroidDialog_androidKt$DialogLayout$1$measure$1
            ...
            Updater.m2325setimpl(m2318constructorimpl, androidDialog_androidKt$DialogLayout$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
