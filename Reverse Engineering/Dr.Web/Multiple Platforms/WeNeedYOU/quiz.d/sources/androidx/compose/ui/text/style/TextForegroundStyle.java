...
public interface TextForegroundStyle {
    ...
    public final /* synthetic */ class CC {
        public static TextForegroundStyle $default$merge(final TextForegroundStyle _this, TextForegroundStyle other) {
            ...
            if (!z || !(_this instanceof BrushStyle)) {
                return (!z || (_this instanceof BrushStyle)) ? (z || !(_this instanceof BrushStyle)) ? other.takeOrElse(new Function0<TextForegroundStyle>() { // from class: androidx.compose.ui.text.style.TextForegroundStyle$merge$2
                    {
                        super(0);
                    }
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        public long mo4806getColor0d7_KjU() {
            return Color.INSTANCE.m2747getUnspecified0d7_KjU();
        }
    }
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle from(Brush brush, float alpha) {
            ...
            if (brush instanceof SolidColor) {
                return m4918from8_81llA(TextDrawStyleKt.m4917modulateDxMtmZc(((SolidColor) brush).getValue(), alpha));
            }
        ...
        public final TextForegroundStyle m4918from8_81llA(long color) {
            return color != Color.INSTANCE.m2747getUnspecified0d7_KjU() ? new ColorStyle(color, null) : Unspecified.INSTANCE;
        }
    }
}
