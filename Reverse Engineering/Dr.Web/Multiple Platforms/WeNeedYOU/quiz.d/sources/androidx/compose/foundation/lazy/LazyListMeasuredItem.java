...
public final class LazyListMeasuredItem implements LazyListItemInfo {
    ...
    public final long m630getOffsetBjo55l4(int index) {
        int[] iArr = this.placeableOffsets;
        int i = index * 2;
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        for (int i = 0; i < placeablesCount; i++) {
            ...
            long m630getOffsetBjo55l4 = m630getOffsetBjo55l4(i);
            ...
            if (lazyLayoutAnimateItemModifierNode != null) {
                long m665getPlacementDeltanOccac = lazyLayoutAnimateItemModifierNode.m665getPlacementDeltanOccac();
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m630getOffsetBjo55l4) + IntOffset.m5135getXimpl(m665getPlacementDeltanOccac), IntOffset.m5136getYimpl(m630getOffsetBjo55l4) + IntOffset.m5136getYimpl(m665getPlacementDeltanOccac));
                if ((m629getMainAxisgyyYBs(m630getOffsetBjo55l4) <= mainAxisSize && m629getMainAxisgyyYBs(IntOffset) <= mainAxisSize) || (m629getMainAxisgyyYBs(m630getOffsetBjo55l4) >= i2 && m629getMainAxisgyyYBs(IntOffset) >= i2)) {
                    lazyLayoutAnimateItemModifierNode.cancelAnimation();
                }
                m630getOffsetBjo55l4 = IntOffset;
            }
            if (this.reverseLayout) {
                int m5135getXimpl = this.isVertical ? IntOffset.m5135getXimpl(m630getOffsetBjo55l4) : (this.mainAxisLayoutSize - IntOffset.m5135getXimpl(m630getOffsetBjo55l4)) - getMainAxisSize(placeable);
                if (this.isVertical) {
                    m5136getYimpl = (this.mainAxisLayoutSize - IntOffset.m5136getYimpl(m630getOffsetBjo55l4)) - getMainAxisSize(placeable);
                } else {
                    m5136getYimpl = IntOffset.m5136getYimpl(m630getOffsetBjo55l4);
                }
                m630getOffsetBjo55l4 = IntOffsetKt.IntOffset(m5135getXimpl, m5136getYimpl);
            }
            long j = this.visualOffset;
            long IntOffset2 = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m630getOffsetBjo55l4) + IntOffset.m5135getXimpl(j), IntOffset.m5136getYimpl(m630getOffsetBjo55l4) + IntOffset.m5136getYimpl(j));
            if (this.isVertical) {
                Placeable.PlacementScope.m4029placeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            } else {
                Placeable.PlacementScope.m4028placeRelativeWithLayeraW9wM$default(scope, placeable, IntOffset2, 0.0f, null, 6, null);
            }
        }
    }

    /* renamed from: getMainAxis--gyyYBs, reason: not valid java name */
    private final int m629getMainAxisgyyYBs(long j) {
        return this.isVertical ? IntOffset.m5136getYimpl(j) : IntOffset.m5135getXimpl(j);
    }
    ...
    private final long m628copy4Tuh3kE(long j, Function1<? super Integer, Integer> function1) {
        int m5135getXimpl = this.isVertical ? IntOffset.m5135getXimpl(j) : function1.invoke(Integer.valueOf(IntOffset.m5135getXimpl(j))).intValue();
        boolean z = this.isVertical;
        int m5136getYimpl = IntOffset.m5136getYimpl(j);
        if (z) {
            m5136getYimpl = function1.invoke(Integer.valueOf(m5136getYimpl)).intValue();
        }
        return IntOffsetKt.IntOffset(m5135getXimpl, m5136getYimpl);
    }
}
