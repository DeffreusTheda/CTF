...
public final class PointerEvent {
    ...
    public PointerEvent(List<PointerInputChange> changes, InternalPointerEvent internalPointerEvent) {
        ...
        this.buttons = PointerButtons.m3782constructorimpl(motionEvent$ui_release != null ? motionEvent$ui_release.getButtonState() : 0);
        MotionEvent motionEvent$ui_release2 = getMotionEvent$ui_release();
        this.keyboardModifiers = PointerKeyboardModifiers.m3911constructorimpl(motionEvent$ui_release2 != null ? motionEvent$ui_release2.getMetaState() : 0);
        this.type = m3788calculatePointerEventType7fucELk();
    }
    ...
    public final void m3792setTypeEhbLWgg$ui_release(int i) {
        this.type = i;
    }

    /* renamed from: calculatePointerEventType-7fucELk, reason: not valid java name */
    private final int m3788calculatePointerEventType7fucELk() {
        MotionEvent motionEvent$ui_release = getMotionEvent$ui_release();
            ...
            if (actionMasked != 0) {
                if (actionMasked != 1) {
                    if (actionMasked != 2) {
                        ...
                        return PointerEventType.INSTANCE.m3805getPress7fucELk();
                    }
                    return PointerEventType.INSTANCE.m3804getMove7fucELk();
                }
                return PointerEventType.INSTANCE.m3806getRelease7fucELk();
            }
            return PointerEventType.INSTANCE.m3805getPress7fucELk();
        }
    ...
    public final PointerEvent copy(List<PointerInputChange> changes, MotionEvent motionEvent) {
        ...
        while (i < size) {
            ...
            linkedHashMap.put(PointerId.m3828boximpl(pointerInputChange.getId()), pointerInputChange);
            ...
            if (internalPointerEvent != null) {
                z = true;
                if (internalPointerEvent.m3778issuesEnterExitEvent0FcD4WY(pointerInputChange.getId())) {
