...
public final class ParagraphStyleKt {
    private static final long DefaultLineHeight = TextUnit.INSTANCE.m5209getUnspecifiedXSAIIZE();
    ...
    public static final ParagraphStyle lerp(ParagraphStyle start, ParagraphStyle stop, float f) {
        ...
        long m4497lerpTextUnitInheritableC3pnCVY = SpanStyleKt.m4497lerpTextUnitInheritableC3pnCVY(start.getLineHeight(), stop.getLineHeight(), f);
    ...
    public static final ParagraphStyle resolveParagraphStyleDefaults(ParagraphStyle style, LayoutDirection direction) {
        ...
        TextAlign m4892boximpl = TextAlign.m4892boximpl(style.getTextAlignOrDefault());
        TextDirection m4905boximpl = TextDirection.m4905boximpl(TextStyleKt.m4564resolveTextDirectionYj3eThk(direction, style.getTextDirection()));
        long lineHeight = TextUnitKt.m5216isUnspecifiedR2X_6o(style.getLineHeight()) ? DefaultLineHeight : style.getLineHeight();
        ...
        LineBreak m4820boximpl = LineBreak.m4820boximpl(style.getLineBreakOrDefault());
        Hyphens m4811boximpl = Hyphens.m4811boximpl(style.getHyphensOrDefault());
        TextMotion textMotion = style.getTextMotion();
        if (textMotion == null) {
            textMotion = TextMotion.INSTANCE.getStatic();
        }
        return new ParagraphStyle(m4892boximpl, m4905boximpl, lineHeight, textIndent2, platformStyle, lineHeightStyle, m4820boximpl, m4811boximpl, textMotion, (DefaultConstructorMarker) null);
    }

    /* JADX WARN: Code restructure failed: missing block: B:38:0x003a, code lost:
    
        if (androidx.compose.ui.unit.TextUnit.m5195equalsimpl0(r11, r23.getLineHeight()) != false) goto L14;
     */
    ...
    */
    public static final androidx.compose.ui.text.ParagraphStyle m4450fastMergeHtYhynw(androidx.compose.ui.text.ParagraphStyle r23, androidx.compose.ui.text.style.TextAlign r24, androidx.compose.ui.text.style.TextDirection r25, long r26, androidx.compose.ui.text.style.TextIndent r28, androidx.compose.ui.text.PlatformParagraphStyle r29, androidx.compose.ui.text.style.LineHeightStyle r30, androidx.compose.ui.text.style.LineBreak r31, androidx.compose.ui.text.style.Hyphens r32, androidx.compose.ui.text.style.TextMotion r33) {
        /*
            r0 = r23
            r1 = r24
            r2 = r25
        ...
        L24:
            ...
            goto L93
        L28:
            boolean r9 = androidx.compose.ui.unit.TextUnitKt.m5216isUnspecifiedR2X_6o(r26)
            r9 = r9 ^ 1
            if (r9 == 0) goto L3d
            long r9 = r23.getLineHeight()
            r11 = r26
            boolean r9 = androidx.compose.ui.unit.TextUnit.m5195equalsimpl0(r11, r9)
            if (r9 == 0) goto L93
            goto L3f
        L3d:
            r11 = r26
