...
public final class TextFieldSelectionManager {
    ...
    public TextFieldSelectionManager(UndoManager undoManager) {
        ...
        this.dragBeginPosition = Offset.INSTANCE.m2462getZeroF1C5BW0();
        this.dragTotalDistance = Offset.INSTANCE.m2462getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo849onDownk4lQ0M(long point) {
            }
            ...
            public void mo851onStartk4lQ0M(long startPoint) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                TextFieldValue m987createTextFieldValueFDrldGo;
                long j;
                ...
                if ((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m884isPositionOnTextk4lQ0M(startPoint)) && (state = TextFieldSelectionManager.this.getState()) != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                    int transformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m2447getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo3373performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m3382getTextHandleMove5zf0vsI());
                    }
                    m987createTextFieldValueFDrldGo = textFieldSelectionManager.m987createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(m987createTextFieldValueFDrldGo);
                    return;
                }
                ...
                if (state3 != null && (layoutResult2 = state3.getLayoutResult()) != null) {
                    ...
                    int m881getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult2, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), m881getOffsetForPosition3MmeM6k$default, m881getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(m881getOffsetForPosition3MmeM6k$default);
                }
                ...
                textFieldSelectionManager3.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2462getZeroF1C5BW0();
            }

            @Override // androidx.compose.foundation.text.TextDragObserver
            /* renamed from: onDrag-k-4lQ0M */
            public void mo850onDragk4lQ0M(long delta) {
                long j;
                TextLayoutResultProxy layoutResult;
                long j2;
                long j3;
                ...
                textFieldSelectionManager.dragTotalDistance = Offset.m2451plusMKHz9U(j, delta);
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    textFieldSelectionManager2.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(Offset.m2451plusMKHz9U(j2, j3)));
                    num = textFieldSelectionManager2.dragBeginOffsetInText;
                    if (num != null) {
                        m883getOffsetForPosition3MmeM6k = num.intValue();
                    } else {
                        j4 = textFieldSelectionManager2.dragBeginPosition;
                        m883getOffsetForPosition3MmeM6k = layoutResult.m883getOffsetForPosition3MmeM6k(j4, false);
                    }
                    int i = m883getOffsetForPosition3MmeM6k;
                    Offset m992getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m992getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(m992getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, layoutResult.m883getOffsetForPosition3MmeM6k(m992getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = TextFieldSelectionManager.this.getState();
                if (state2 == null) {
                    return;
            ...
            public void onStop() {
                ...
                TextFieldSelectionManager.this.m989setCurrentDragPosition_kEHs6E(null);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null) {
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo911onExtendk4lQ0M(long downPosition) {
                TextLayoutResultProxy layoutResult;
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null || (layoutResult = state.getLayoutResult()) == null) {
                    return false;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4532getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onExtendDrag-k-4lQ0M */
            public boolean mo912onExtendDragk4lQ0M(long dragPosition) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), textFieldSelectionManager.getOffsetMapping().originalToTransformed(TextRange.m4532getStartimpl(textFieldSelectionManager.getValue$foundation_release().getSelection())), layoutResult.m883getOffsetForPosition3MmeM6k(dragPosition, false), false, SelectionAdjustment.INSTANCE.getNone());
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onStart-3MmeM6k */
            public boolean mo913onStart3MmeM6k(long downPosition, SelectionAdjustment adjustment) {
                TextLayoutResultProxy layoutResult;
                long j;
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                j = textFieldSelectionManager.dragBeginPosition;
                int m881getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult, j, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), m881getOffsetForPosition3MmeM6k$default, m881getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }

            @Override // androidx.compose.foundation.text.selection.MouseSelectionObserver
            /* renamed from: onDrag-3MmeM6k */
            public boolean mo910onDrag3MmeM6k(long dragPosition, SelectionAdjustment adjustment) {
                TextFieldState state;
                TextLayoutResultProxy layoutResult;
                Integer num;
                Intrinsics.checkNotNullParameter(adjustment, "adjustment");
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                int m883getOffsetForPosition3MmeM6k = layoutResult.m883getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), m883getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
        };
    }
    ...
    public final void m989setCurrentDragPosition_kEHs6E(Offset offset) {
        this.currentDragPosition.setValue(offset);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getCurrentDragPosition-_m7T9-E, reason: not valid java name */
    public final Offset m992getCurrentDragPosition_m7T9E() {
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo849onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m994getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo851onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m994getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2462getZeroF1C5BW0();
                TextFieldSelectionManager.this.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state == null) {
            ...
            public void mo850onDragk4lQ0M(long delta) {
                ...
                int m4504getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                j = textFieldSelectionManager.dragTotalDistance;
                textFieldSelectionManager.dragTotalDistance = Offset.m2451plusMKHz9U(j, delta);
                TextFieldState state = TextFieldSelectionManager.this.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z) {
                        Offset m992getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m992getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m992getCurrentDragPosition_m7T9E);
                        originalToTransformed = value.m4504getOffsetForPositionk4lQ0M(m992getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        originalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4532getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i = originalToTransformed;
                    if (z) {
                        m4504getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m4527getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset m992getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m992getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(m992getCurrentDragPosition_m7T9E2);
                        m4504getOffsetForPositionk4lQ0M = value.m4504getOffsetForPositionk4lQ0M(m992getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i, m4504getOffsetForPositionk4lQ0M, z, SelectionAdjustment.INSTANCE.getCharacter());
                }
                TextFieldState state2 = TextFieldSelectionManager.this.getState();
                if (state2 == null) {
                    return;
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo849onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m994getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo851onStartk4lQ0M(long startPoint) {
                long j;
                TextFieldSelectionManager textFieldSelectionManager = TextFieldSelectionManager.this;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m942getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m994getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = TextFieldSelectionManager.this;
                j = textFieldSelectionManager2.dragBeginPosition;
                textFieldSelectionManager2.m989setCurrentDragPosition_kEHs6E(Offset.m2435boximpl(j));
                TextFieldSelectionManager.this.dragTotalDistance = Offset.INSTANCE.m2462getZeroF1C5BW0();
            ...
            public void mo850onDragk4lQ0M(long delta) {
                ...
                Offset m992getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m992getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(m992getCurrentDragPosition_m7T9E);
                int transformedToOriginal = offsetMapping.transformedToOriginal(value.m4504getOffsetForPositionk4lQ0M(m992getCurrentDragPosition_m7T9E.getPackedValue()));
                long TextRange = TextRangeKt.TextRange(transformedToOriginal, transformedToOriginal);
                if (TextRange.m4525equalsimpl0(TextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                m987createTextFieldValueFDrldGo = textFieldSelectionManager2.m987createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getAnnotatedString(), TextRange);
                onValueChange$foundation_release.invoke(m987createTextFieldValueFDrldGo);
            }
    ...
    public static /* synthetic */ void m988deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i, Object obj) {
        if ((i & 1) != 0) {
            offset = null;
        }
        textFieldSelectionManager.m991deselect_kEHs6E$foundation_release(offset);
    }

    /* renamed from: deselect-_kEHs6E$foundation_release, reason: not valid java name */
    public final void m991deselect_kEHs6E$foundation_release(Offset position) {
        HandleState handleState;
        int m4529getMaximpl;
        if (!TextRange.m4526getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            ...
            if (position != null && layoutResult != null) {
                m4529getMaximpl = this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null));
            } else {
                m4529getMaximpl = TextRange.m4529getMaximpl(getValue$foundation_release().getSelection());
            }
            this.onValueChange.invoke(TextFieldValue.m4748copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange(m4529getMaximpl), (TextRange) null, 5, (Object) null));
        }
    ...
    public final void copy$foundation_release(boolean cancelSelection) {
        ...
        if (cancelSelection) {
            int m4529getMaximpl = TextRange.m4529getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m987createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(m4529getMaximpl, m4529getMaximpl)));
            setHandleState(HandleState.None);
        }
    }
    ...
    public final void paste$foundation_release() {
        ...
        int m4530getMinimpl = TextRange.m4530getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m987createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4530getMinimpl, m4530getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void cut$foundation_release() {
        ...
        int m4530getMinimpl = TextRange.m4530getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m987createTextFieldValueFDrldGo(plus, TextRangeKt.TextRange(m4530getMinimpl, m4530getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue m987createTextFieldValueFDrldGo = m987createTextFieldValueFDrldGo(getValue$foundation_release().getAnnotatedString(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(m987createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m4748copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, m987createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final long m994getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        long selection = getValue$foundation_release().getSelection();
        int m4532getStartimpl = isStartHandle ? TextRange.m4532getStartimpl(selection) : TextRange.m4527getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(m4532getStartimpl), isStartHandle, TextRange.m4531getReversedimpl(getValue$foundation_release().getSelection()));
    }

    /* renamed from: getCursorPosition-tuRUvjQ$foundation_release, reason: not valid java name */
    public final long m993getCursorPositiontuRUvjQ$foundation_release(Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4532getStartimpl(getValue$foundation_release().getSelection()));
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        ...
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo360toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }

    public final void showSelectionToolbar$foundation_release() {
        ClipboardManager clipboardManager;
        boolean z = this.visualTransformation instanceof PasswordVisualTransformation;
        Function0<Unit> function0 = (TextRange.m4526getCollapsedimpl(getValue$foundation_release().getSelection()) || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function02 = (TextRange.m4526getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function04 = TextRange.m4528getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public final void m990contextMenuOpenAdjustmentk4lQ0M(long position) {
        TextLayoutResultProxy layoutResult;
        TextFieldState textFieldState = this.state;
        if (textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) {
            return;
        }
        int m881getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m881getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m4523containsimpl(getValue$foundation_release().getSelection(), m881getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), m881getOffsetForPosition3MmeM6k$default, m881getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int originalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m4532getStartimpl(getValue$foundation_release().getSelection()));
                int originalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m4527getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long m2462getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2462getZeroF1C5BW0() : layoutCoordinates4.mo3976localToRootMKHz9U(m994getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long m2462getZeroF1C5BW02 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m2462getZeroF1C5BW0() : layoutCoordinates3.mo3976localToRootMKHz9U(m994getHandlePositiontuRUvjQ$foundation_release(false));
                ...
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    ...
                    f = Offset.m2447getYimpl(layoutCoordinates2.mo3976localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(originalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    f2 = Offset.m2447getYimpl(layoutCoordinates.mo3976localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(originalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m2446getXimpl(m2462getZeroF1C5BW0), Offset.m2446getXimpl(m2462getZeroF1C5BW02)), Math.min(f, f2), Math.max(Offset.m2446getXimpl(m2462getZeroF1C5BW0), Offset.m2446getXimpl(m2462getZeroF1C5BW02)), Math.max(Offset.m2447getYimpl(m2462getZeroF1C5BW0), Offset.m2447getYimpl(m2462getZeroF1C5BW02)) + (Dp.m5017constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        TextLayoutResultProxy layoutResult;
        long TextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m4532getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m4527getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long m984getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m984getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m4526getCollapsedimpl(TextRange) ? null : TextRange.m4520boximpl(TextRange), isStartHandle, adjustment);
        long TextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m4532getStartimpl(m984getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m4527getEndimpl(m984getTextFieldSelectionbb3KNj8)));
        if (TextRange.m4525equalsimpl0(TextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m987createTextFieldValueFDrldGo(value.getAnnotatedString(), TextRange2));
        TextFieldState textFieldState2 = this.state;
        if (textFieldState2 != null) {
    ...
    public final TextFieldValue m987createTextFieldValueFDrldGo(AnnotatedString annotatedString, long selection) {
