...
public final class NavigationBarKt {
    ...
    private static final float NavigationBarHeight = NavigationBarTokens.INSTANCE.m2013getContainerHeightD9Ej5fM();
    private static final float NavigationBarItemHorizontalPadding = Dp.m5017constructorimpl(8);
    private static final float NavigationBarItemVerticalPadding = Dp.m5017constructorimpl(16);
    private static final float IndicatorVerticalOffset = Dp.m5017constructorimpl(12);
    ...
    */
        ...
        if ((374491 & i2) != 74898 || !startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.NavigationBarKt$NavigationBarItemBaselineLayout$2
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j) {
                    ...
                    Object obj;
                    Placeable placeable;
                    MeasureResult m1342placeLabelAndIconzUg2_y0;
                    MeasureResult m1341placeIconX9ElhV4;
                    ...
                    for (Measurable measurable : list) {
                        if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), "icon")) {
                            ...
                            float f4 = 2;
                            int i3 = width + Layout.mo354roundToPx0680j_4(Dp.m5017constructorimpl(f2 * f4));
                            int roundToInt = MathKt.roundToInt(i3 * f);
                            int height = mo3967measureBRTryo0.getHeight();
                            f3 = NavigationBarKt.IndicatorVerticalPadding;
                            int i4 = height + Layout.mo354roundToPx0680j_4(Dp.m5017constructorimpl(f3 * f4));
                            for (Measurable measurable2 : list) {
                                if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), "indicatorRipple")) {
                                    Placeable mo3967measureBRTryo02 = measurable2.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(i3, i4));
                                    ...
                                    Placeable mo3967measureBRTryo03 = measurable3 != null ? measurable3.mo3967measureBRTryo0(Constraints.INSTANCE.m4969fixedJhjzzOo(roundToInt, i4)) : null;
                                    if (function24 != null) {
                                    ...
                                    placeable = null;
                                    if (function24 == null) {
                                        m1341placeIconX9ElhV4 = NavigationBarKt.m1341placeIconX9ElhV4(Layout, mo3967measureBRTryo0, mo3967measureBRTryo02, mo3967measureBRTryo03, j);
                                        return m1341placeIconX9ElhV4;
                                    }
                                    Intrinsics.checkNotNull(placeable);
                                    m1342placeLabelAndIconzUg2_y0 = NavigationBarKt.m1342placeLabelAndIconzUg2_y0(Layout, placeable, mo3967measureBRTryo0, mo3967measureBRTryo02, mo3967measureBRTryo03, j, z, f);
                                    return m1342placeLabelAndIconzUg2_y0;
                                }
                            }
                            throw new NoSuchElementException("Collection contains no element matching the predicate.");
                        }
            ...
            if (function24 != null) {
                Modifier m522paddingVpY3zN4$default = PaddingKt.m522paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(Modifier.INSTANCE, LabelLayoutIdTag), z ? 1.0f : f), Dp.m5017constructorimpl(NavigationBarItemHorizontalPadding / 2), 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ComposerKt.sourceInformation(startRestartGroup, "CC(Box)P(2,1,3)70@3267L67,71@3339L130:Box.kt#2w3rfo");
                ...
                Function3<SkippableUpdater<ComposeUiNode>, Composer, Integer, Unit> materializerOf3 = LayoutKt.materializerOf(m522paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
    ...
    public static final MeasureResult m1341placeIconX9ElhV4(MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, long j) {
        final int m4961getMaxWidthimpl = Constraints.m4961getMaxWidthimpl(j);
        final int m4960getMaxHeightimpl = Constraints.m4960getMaxHeightimpl(j);
        final int width = (m4961getMaxWidthimpl - placeable.getWidth()) / 2;
        final int height = (m4960getMaxHeightimpl - placeable.getHeight()) / 2;
        final int width2 = (m4961getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int height2 = (m4960getMaxHeightimpl - placeable2.getHeight()) / 2;
        return MeasureScope.CC.layout$default(measureScope, m4961getMaxWidthimpl, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (placeable4 != null) {
                    Placeable.PlacementScope.placeRelative$default(layout, placeable4, (m4961getMaxWidthimpl - placeable4.getWidth()) / 2, (m4960getMaxHeightimpl - placeable4.getHeight()) / 2, 0.0f, 4, null);
                }
    ...
    public static final MeasureResult m1342placeLabelAndIconzUg2_y0(final MeasureScope measureScope, final Placeable placeable, final Placeable placeable2, final Placeable placeable3, final Placeable placeable4, long j, final boolean z, final float f) {
        ...
        final int width = (m4961getMaxWidthimpl - placeable.getWidth()) / 2;
        final int width2 = (m4961getMaxWidthimpl - placeable2.getWidth()) / 2;
        final int width3 = (m4961getMaxWidthimpl - placeable3.getWidth()) / 2;
        final int i3 = i2 - measureScope.mo354roundToPx0680j_4(IndicatorVerticalPadding);
        return MeasureScope.CC.layout$default(measureScope, m4961getMaxWidthimpl, m4960getMaxHeightimpl, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.material3.NavigationBarKt$placeLabelAndIcon$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
    ...
    static {
        float f = 2;
        IndicatorHorizontalPadding = Dp.m5017constructorimpl(Dp.m5017constructorimpl(NavigationBarTokens.INSTANCE.m2011getActiveIndicatorWidthD9Ej5fM() - NavigationBarTokens.INSTANCE.m2014getIconSizeD9Ej5fM()) / f);
        IndicatorVerticalPadding = Dp.m5017constructorimpl(Dp.m5017constructorimpl(NavigationBarTokens.INSTANCE.m2010getActiveIndicatorHeightD9Ej5fM() - NavigationBarTokens.INSTANCE.m2014getIconSizeD9Ej5fM()) / f);
    }
