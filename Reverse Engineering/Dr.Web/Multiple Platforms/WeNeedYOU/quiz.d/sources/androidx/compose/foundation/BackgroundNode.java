...
final class BackgroundNode extends Modifier.Node implements DrawModifierNode {
    ...
    public final void m195setColor8_81llA(long j) {
        this.color = j;
    }
    ...
    private final void drawRect(ContentDrawScope contentDrawScope) {
        if (!Color.m2712equalsimpl0(this.color, Color.INSTANCE.m2747getUnspecified0d7_KjU())) {
            DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, this.color, 0L, 0L, 0.0f, null, null, 0, 126, null);
        }
        Brush brush = this.brush;
        if (brush != null) {
            DrawScope.CC.m3263drawRectAsUm42w$default(contentDrawScope, brush, 0L, 0L, this.alpha, null, null, 0, 118, null);
        }
    }

    private final void drawOutline(ContentDrawScope contentDrawScope) {
        Outline mo242createOutlinePq9zytI;
        if (Size.m2510equalsimpl(contentDrawScope.mo3184getSizeNHjbRc(), this.lastSize) && contentDrawScope.getLayoutDirection() == this.lastLayoutDirection && Intrinsics.areEqual(this.lastShape, this.shape)) {
            mo242createOutlinePq9zytI = this.lastOutline;
            Intrinsics.checkNotNull(mo242createOutlinePq9zytI);
        } else {
            mo242createOutlinePq9zytI = this.shape.mo242createOutlinePq9zytI(contentDrawScope.mo3184getSizeNHjbRc(), contentDrawScope.getLayoutDirection(), contentDrawScope);
        }
        if (!Color.m2712equalsimpl0(this.color, Color.INSTANCE.m2747getUnspecified0d7_KjU())) {
            OutlineKt.m2971drawOutlinewDX37Ww(contentDrawScope, mo242createOutlinePq9zytI, this.color, (r17 & 4) != 0 ? 1.0f : 0.0f, (r17 & 8) != 0 ? Fill.INSTANCE : null, (r17 & 16) != 0 ? null : null, (r17 & 32) != 0 ? DrawScope.INSTANCE.m3267getDefaultBlendMode0nO6VwU() : 0);
        }
        Brush brush = this.brush;
        if (brush != null) {
            OutlineKt.m2970drawOutlinehn5TExg$default(contentDrawScope, mo242createOutlinePq9zytI, brush, this.alpha, null, null, 0, 56, null);
        }
        this.lastOutline = mo242createOutlinePq9zytI;
        this.lastSize = Size.m2503boximpl(contentDrawScope.mo3184getSizeNHjbRc());
