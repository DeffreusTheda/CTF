...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        TextOverflow m4936boximpl = (textLayoutResult == null || (layoutInput = textLayoutResult.getLayoutInput()) == null) ? null : TextOverflow.m4936boximpl(layoutInput.getOverflow());
        int m4948getVisiblegIe3tQ8 = TextOverflow.INSTANCE.m4948getVisiblegIe3tQ8();
        if (m4936boximpl == null) {
            return false;
        }
        return TextOverflow.m4939equalsimpl0(m4936boximpl.getValue(), m4948getVisiblegIe3tQ8);
    }
