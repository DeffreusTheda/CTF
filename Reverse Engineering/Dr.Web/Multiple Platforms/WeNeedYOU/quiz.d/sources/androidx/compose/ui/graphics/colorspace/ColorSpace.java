...
public abstract class ColorSpace {
    ...
    public final int getComponentCount() {
        return ColorModel.m3121getComponentCountimpl(this.model);
    }
    ...
    public long mo3130xyzaToColorJlNiLsg$ui_graphics_release(float x, float y, float z, float a, ColorSpace colorSpace) {
    ...
    public final float[] fromXyz(float x, float y, float z) {
        float[] fArr = new float[ColorModel.m3121getComponentCountimpl(this.model)];
        fArr[0] = x;
        fArr[1] = y;
        fArr[2] = z;
        return fromXyz(fArr);
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3123toStringimpl(this.model)) + ')';
    }
    ...
    public boolean equals(Object other) {
        ...
        if (this.id == colorSpace.id && Intrinsics.areEqual(this.name, colorSpace.name)) {
            return ColorModel.m3120equalsimpl0(this.model, colorSpace.model);
        }
        return false;
    }

    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3122hashCodeimpl(this.model)) * 31) + this.id;
    }
}
