...
final class StateLayer {
    ...
    public final void m1016drawStateLayerH2RKhps(DrawScope drawStateLayer, float f, long j) {
        float f2;
        Intrinsics.checkNotNullParameter(drawStateLayer, "$this$drawStateLayer");
        if (Float.isNaN(f)) {
            f2 = RippleAnimationKt.m1007getRippleEndRadiuscSwnlzA(drawStateLayer, this.bounded, drawStateLayer.mo3184getSizeNHjbRc());
        } else {
            f2 = drawStateLayer.mo360toPx0680j_4(f);
        }
        float f3 = f2;
        float floatValue = this.animatedAlpha.getValue().floatValue();
        if (floatValue > 0.0f) {
            long m2710copywmQWz5c$default = Color.m2710copywmQWz5c$default(j, floatValue, 0.0f, 0.0f, 0.0f, 14, null);
            if (!this.bounded) {
                DrawScope.CC.m3251drawCircleVaOC9Bg$default(drawStateLayer, m2710copywmQWz5c$default, f3, 0L, 0.0f, null, null, 0, 124, null);
                return;
            }
            float m2515getWidthimpl = Size.m2515getWidthimpl(drawStateLayer.mo3184getSizeNHjbRc());
            float m2512getHeightimpl = Size.m2512getHeightimpl(drawStateLayer.mo3184getSizeNHjbRc());
