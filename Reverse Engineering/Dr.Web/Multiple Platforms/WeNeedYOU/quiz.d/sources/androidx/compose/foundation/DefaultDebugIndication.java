    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, Color.m2710copywmQWz5c$default(Color.INSTANCE.m2737getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3184getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                DrawScope.CC.m3264drawRectnJ9OG0$default(contentDrawScope, Color.m2710copywmQWz5c$default(Color.INSTANCE.m2737getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3184getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
