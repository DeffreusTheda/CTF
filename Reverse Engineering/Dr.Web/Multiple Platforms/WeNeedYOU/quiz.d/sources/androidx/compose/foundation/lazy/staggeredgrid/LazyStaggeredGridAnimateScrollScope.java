...
public final class LazyStaggeredGridAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public Integer getTargetItemOffset(int index) {
        ...
        return Integer.valueOf(this.state.getIsVertical() ? IntOffset.m5136getYimpl(offset) : IntOffset.m5135getXimpl(offset));
    }
    ...
    public float expectedDistanceTo(int index, int targetScrollOffset) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            i += this.state.getIsVertical() ? IntSize.m5176getHeightimpl(lazyStaggeredGridItemInfo.getSize()) : IntSize.m5177getWidthimpl(lazyStaggeredGridItemInfo.getSize());
        }
