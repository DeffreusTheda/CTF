...
final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public final long m109targetValueByStateoFUgxo0(EnterExitState targetState, long fullSize) {
        ...
        long m5145getZeronOccac = (value == null || (slideOffset2 = value.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5145getZeronOccac() : slideOffset2.invoke(IntSize.m5169boximpl(fullSize)).getPackedValue();
        Slide value2 = this.slideOut.getValue();
        long m5145getZeronOccac2 = (value2 == null || (slideOffset = value2.getSlideOffset()) == null) ? IntOffset.INSTANCE.m5145getZeronOccac() : slideOffset.invoke(IntSize.m5169boximpl(fullSize)).getPackedValue();
        int i = WhenMappings.$EnumSwitchMapping$0[targetState.ordinal()];
        if (i == 1) {
            return IntOffset.INSTANCE.m5145getZeronOccac();
        }
        if (i == 2) {
            return m5145getZeronOccac;
        }
        if (i == 3) {
            return m5145getZeronOccac2;
        }
    ...
    public MeasureResult mo70measure3p2s80s(MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.animation.SlideModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                Placeable.PlacementScope.m4029placeWithLayeraW9wM$default(layout, mo3967measureBRTryo0, lazyAnimation.animate(transitionSpec, new Function1<EnterExitState, IntOffset>() { // from class: androidx.compose.animation.SlideModifier$measure$1$slideOffset$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(1);
                    }
                    ...
                    public /* bridge */ /* synthetic */ IntOffset invoke(EnterExitState enterExitState) {
                        return IntOffset.m5126boximpl(m110invokeBjo55l4(enterExitState));
                    }

                    /* renamed from: invoke-Bjo55l4, reason: not valid java name */
                    public final long m110invokeBjo55l4(EnterExitState it) {
                        Intrinsics.checkNotNullParameter(it, "it");
                        return SlideModifier.this.m109targetValueByStateoFUgxo0(it, j2);
                    }
