...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4429toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2446getXimpl(j), Offset.m2447getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        Intrinsics.checkNotNullParameter(rect, "<this>");
        return rect.m2483translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    public final Path toGlobal(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        path.mo2583translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4428toGlobalGEjPoXI(long j) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4532getStartimpl(j)), toGlobalIndex(TextRange.m4527getEndimpl(j)));
    }
}
