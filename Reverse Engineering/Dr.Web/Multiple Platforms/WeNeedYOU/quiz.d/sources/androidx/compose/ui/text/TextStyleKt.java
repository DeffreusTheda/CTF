...
public final class TextStyleKt {
    ...
    public static final int m4564resolveTextDirectionYj3eThk(LayoutDirection layoutDirection, TextDirection textDirection) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        int m4912getContents_7Xco = TextDirection.INSTANCE.m4912getContents_7Xco();
        if (textDirection != null && TextDirection.m4908equalsimpl0(textDirection.getValue(), m4912getContents_7Xco)) {
            int i = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i == 1) {
                return TextDirection.INSTANCE.m4913getContentOrLtrs_7Xco();
            }
            if (i == 2) {
                return TextDirection.INSTANCE.m4914getContentOrRtls_7Xco();
            }
        ...
        if (textDirection == null) {
            ...
            if (i2 == 1) {
                return TextDirection.INSTANCE.m4915getLtrs_7Xco();
            }
            if (i2 == 2) {
                return TextDirection.INSTANCE.m4916getRtls_7Xco();
            }
            throw new NoWhenBranchMatchedException();
        }
