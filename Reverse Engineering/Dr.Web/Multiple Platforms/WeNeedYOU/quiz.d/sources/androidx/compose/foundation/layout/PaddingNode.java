...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m531setStart0680j_4(float f) {
        this.start = f;
    }
    ...
    public final void m532setTop0680j_4(float f) {
        this.top = f;
    }
    ...
    public final void m530setEnd0680j_4(float f) {
        this.end = f;
    }
    ...
    public final void m529setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    public MeasureResult mo272measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        int i = measure.mo354roundToPx0680j_4(this.start) + measure.mo354roundToPx0680j_4(this.end);
        int i2 = measure.mo354roundToPx0680j_4(this.top) + measure.mo354roundToPx0680j_4(this.bottom);
        final Placeable mo3967measureBRTryo0 = measurable.mo3967measureBRTryo0(ConstraintsKt.m4977offsetNN6EwU(j, -i, -i2));
        return MeasureScope.CC.layout$default(measure, ConstraintsKt.m4975constrainWidthK40F9xA(j, mo3967measureBRTryo0.getWidth() + i), ConstraintsKt.m4974constrainHeightK40F9xA(j, mo3967measureBRTryo0.getHeight() + i2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (PaddingNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo0, measure.mo354roundToPx0680j_4(PaddingNode.this.getStart()), measure.mo354roundToPx0680j_4(PaddingNode.this.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, mo3967measureBRTryo0, measure.mo354roundToPx0680j_4(PaddingNode.this.getStart()), measure.mo354roundToPx0680j_4(PaddingNode.this.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m5017constructorimpl(0) : f, (i & 2) != 0 ? Dp.m5017constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m5017constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m5017constructorimpl(0) : f4, z, null);
    }
}
