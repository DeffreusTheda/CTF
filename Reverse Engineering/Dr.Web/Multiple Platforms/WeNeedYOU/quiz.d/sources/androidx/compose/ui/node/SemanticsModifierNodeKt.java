...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4082requireCoordinator64DMado(node, NodeKind.m4184constructorimpl(8)));
        }
        return DelegatableNodeKt.m4082requireCoordinator64DMado(node, NodeKind.m4184constructorimpl(8)).touchBoundsInRoot();
    }
}
