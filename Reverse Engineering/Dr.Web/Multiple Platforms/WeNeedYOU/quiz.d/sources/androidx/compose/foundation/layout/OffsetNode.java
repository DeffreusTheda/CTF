...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m484setX0680j_4(float f) {
        this.x = f;
    }
    ...
    public final void m485setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult mo272measure3p2s80s(final MeasureScope measure, Measurable measurable, long j) {
        ...
        return MeasureScope.CC.layout$default(measure, mo3967measureBRTryo0.getWidth(), mo3967measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope layout) {
                ...
                if (OffsetNode.this.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(layout, mo3967measureBRTryo0, measure.mo354roundToPx0680j_4(OffsetNode.this.getX()), measure.mo354roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(layout, mo3967measureBRTryo0, measure.mo354roundToPx0680j_4(OffsetNode.this.getX()), measure.mo354roundToPx0680j_4(OffsetNode.this.getY()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
