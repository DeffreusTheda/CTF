...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1741getContainerElevationD9Ej5fM();
    ...
    static {
        ...
        ContentPadding = PaddingKt.m517PaddingValuesa9UjIt4$default(f, bottomAppBarVerticalPadding, f2, 0.0f, 8, null);
    }

    /* renamed from: getContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m1038getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets m593onlybOOhFvg = WindowInsetsKt.m593onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.INSTANCE, composer, 8), WindowInsetsSides.m603plusgK_yJZ4(WindowInsetsSides.INSTANCE.m613getHorizontalJoeWqyM(), WindowInsetsSides.INSTANCE.m611getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
