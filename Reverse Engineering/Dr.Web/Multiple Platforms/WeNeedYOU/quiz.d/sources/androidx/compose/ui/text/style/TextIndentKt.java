...
public final class TextIndentKt {
    public static final TextIndent lerp(TextIndent start, TextIndent stop, float f) {
        ...
        return new TextIndent(SpanStyleKt.m4497lerpTextUnitInheritableC3pnCVY(start.getFirstLine(), stop.getFirstLine(), f), SpanStyleKt.m4497lerpTextUnitInheritableC3pnCVY(start.getRestLine(), stop.getRestLine(), f), null);
    }
}
