...
public final class VectorComponent extends VNode {
    ...
    public VectorComponent() {
        ...
        this.previousDrawSize = Size.INSTANCE.m2523getUnspecifiedNHjbRc();
    ...
    public final void draw(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        if (this.isDirty || !Size.m2511equalsimpl0(this.previousDrawSize, drawScope.mo3184getSizeNHjbRc())) {
            this.root.setScaleX(Size.m2515getWidthimpl(drawScope.mo3184getSizeNHjbRc()) / this.viewportWidth);
            this.root.setScaleY(Size.m2512getHeightimpl(drawScope.mo3184getSizeNHjbRc()) / this.viewportHeight);
            this.cacheDrawScope.m3343drawCachedImageCJJARo(IntSizeKt.IntSize((int) Math.ceil(Size.m2515getWidthimpl(drawScope.mo3184getSizeNHjbRc())), (int) Math.ceil(Size.m2512getHeightimpl(drawScope.mo3184getSizeNHjbRc()))), drawScope, drawScope.getLayoutDirection(), this.drawVectorBlock);
            this.isDirty = false;
            this.previousDrawSize = drawScope.mo3184getSizeNHjbRc();
        }
