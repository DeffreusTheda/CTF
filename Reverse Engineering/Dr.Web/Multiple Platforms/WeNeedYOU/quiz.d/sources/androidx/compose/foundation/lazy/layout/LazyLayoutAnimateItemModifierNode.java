...
public final class LazyLayoutAnimateItemModifierNode extends Modifier.Node {
    ...
    public LazyLayoutAnimateItemModifierNode(FiniteAnimationSpec<IntOffset> placementAnimationSpec) {
        ...
        this.placementDeltaAnimation = new Animatable<>(IntOffset.m5126boximpl(IntOffset.INSTANCE.m5145getZeronOccac()), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, null, 12, null);
        this.placementDelta = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntOffset.m5126boximpl(IntOffset.INSTANCE.m5145getZeronOccac()), null, 2, null);
    }
    ...
    public final void m667setRawOffsetgyyYBs(long j) {
        this.rawOffset = j;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: setPlacementDelta--gyyYBs, reason: not valid java name */
    public final void m663setPlacementDeltagyyYBs(long j) {
        this.placementDelta.setValue(IntOffset.m5126boximpl(j));
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getPlacementDelta-nOcc-ac, reason: not valid java name */
    public final long m665getPlacementDeltanOccac() {
    ...
    public final void m664animatePlacementDeltagyyYBs(long delta) {
        long m665getPlacementDeltanOccac = m665getPlacementDeltanOccac();
        long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5135getXimpl(m665getPlacementDeltanOccac) - IntOffset.m5135getXimpl(delta), IntOffset.m5136getYimpl(m665getPlacementDeltanOccac) - IntOffset.m5136getYimpl(delta));
        m663setPlacementDeltagyyYBs(IntOffset);
    ...
    public void onDetach() {
        m663setPlacementDeltagyyYBs(IntOffset.INSTANCE.m5145getZeronOccac());
    ...
    public static final class Companion {
        ...
        public final long m668getNotInitializednOccac() {
