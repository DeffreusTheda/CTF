...
public final class ComposableSingletons$BasicTextFieldKt {
    ...
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m798getLambda1$foundation_release() {
        return f0lambda1;
    }

    /* renamed from: getLambda-2$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m799getLambda2$foundation_release() {
        return f1lambda2;
    }

    /* renamed from: getLambda-3$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m800getLambda3$foundation_release() {
        return f2lambda3;
    }

    /* renamed from: getLambda-4$foundation_release, reason: not valid java name */
    public final Function3<Function2<? super Composer, ? super Integer, Unit>, Composer, Integer, Unit> m801getLambda4$foundation_release() {
        return f3lambda4;
    }
}
