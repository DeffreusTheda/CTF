...
public final class SelectableChipColors {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2712equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m2712equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m2712equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m2712equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m2712equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m2712equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m2712equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m2712equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m2712equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m2712equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m2712equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m2712equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m2712equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor);
    }

    public int hashCode() {
        return (((((((((((((((((((((((Color.m2718hashCodeimpl(this.containerColor) * 31) + Color.m2718hashCodeimpl(this.labelColor)) * 31) + Color.m2718hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2718hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2718hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2718hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2718hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2718hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2718hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2718hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m2718hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m2718hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m2718hashCodeimpl(this.selectedTrailingIconColor);
    }
}
