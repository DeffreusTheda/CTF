...
public final class ExposedDropdownMenuPopupKt {
    ...
    public static final void ExposedDropdownMenuPopup(Function0<Unit> function0, final PopupPositionProvider popupPositionProvider, final Function2<? super Composer, ? super Integer, Unit> content, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 731) != 146 || !startRestartGroup.getSkipping()) {
            ...
            UUID popupId = (UUID) RememberSaveableKt.m2332rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<UUID>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupId$1
                @Override // kotlin.jvm.functions.Function0
                        ...
                        if ((i7 & 11) != 2 || !composer5.getSkipping()) {
                            ...
                            Modifier alpha = AlphaKt.alpha(OnRemeasuredModifierKt.onSizeChanged(semantics$default, new Function1<IntSize, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1.2
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(IntSize intSize) {
                                    m1725invokeozmzZPI(intSize.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* renamed from: invoke-ozmzZPI, reason: not valid java name */
                                public final void m1725invokeozmzZPI(long j) {
                                    PopupLayout.this.m1727setPopupContentSizefhxjrPA(IntSize.m5169boximpl(j));
                            ...
                            Composer m2318constructorimpl = Updater.m2318constructorimpl(composer5);
                            Updater.m2325setimpl(m2318constructorimpl, exposedDropdownMenuPopupKt$SimpleStack$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
                            Updater.m2325setimpl(m2318constructorimpl, density2, ComposeUiNode.INSTANCE.getSetDensity());
                            Updater.m2325setimpl(m2318constructorimpl, layoutDirection3, ComposeUiNode.INSTANCE.getSetLayoutDirection());
                            Updater.m2325setimpl(m2318constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
                            materializerOf.invoke(SkippableUpdater.m2309boximpl(SkippableUpdater.m2310constructorimpl(composer5)), composer5, 0);
            ...
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.INSTANCE, new Function1<LayoutCoordinates, Unit>() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$5
                ...
                public final void invoke2(LayoutCoordinates childCoordinates) {
                    ...
                    long mo3974getSizeYbymL2g = parentLayoutCoordinates.mo3974getSizeYbymL2g();
                    long positionInWindow = LayoutCoordinatesKt.positionInWindow(parentLayoutCoordinates);
                    PopupLayout.this.setParentBounds(IntRectKt.m5167IntRectVbeCjmY(IntOffsetKt.IntOffset(MathKt.roundToInt(Offset.m2446getXimpl(positionInWindow)), MathKt.roundToInt(Offset.m2447getYimpl(positionInWindow))), mo3974getSizeYbymL2g));
                    PopupLayout.this.updatePosition();
                }
            });
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.internal.ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$6
                ...
                public final MeasureResult mo44measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j) {
    ...
    private static final void SimpleStack(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        Updater.m2325setimpl(m2318constructorimpl, viewConfiguration, ComposeUiNode.INSTANCE.getSetViewConfiguration());
        materializerOf.invoke(SkippableUpdater.m2309boximpl(SkippableUpdater.m2310constructorimpl(composer)), composer, 0);
