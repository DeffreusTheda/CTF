...
public final class MaterialThemeKt {
    ...
    */
    public static final void MaterialTheme(androidx.compose.material3.ColorScheme r77, androidx.compose.material3.Shapes r78, androidx.compose.material3.Typography r79, final kotlin.jvm.functions.Function2<? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r80, androidx.compose.runtime.Composer r81, final int r82, final int r83) {
        /*
    ...
    public static final TextSelectionColors rememberTextSelectionColors(ColorScheme colorScheme, Composer composer, int i) {
        ...
        long m1100getPrimary0d7_KjU = colorScheme.m1100getPrimary0d7_KjU();
        Color m2701boximpl = Color.m2701boximpl(m1100getPrimary0d7_KjU);
        composer.startReplaceableGroup(1157296644);
        ComposerKt.sourceInformation(composer, "CC(remember)P(1):Composables.kt#9igjgp");
        boolean changed = composer.changed(m2701boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.INSTANCE.getEmpty()) {
            rememberedValue = new TextSelectionColors(m1100getPrimary0d7_KjU, Color.m2710copywmQWz5c$default(m1100getPrimary0d7_KjU, 0.4f, 0.0f, 0.0f, 0.0f, 14, null), null);
