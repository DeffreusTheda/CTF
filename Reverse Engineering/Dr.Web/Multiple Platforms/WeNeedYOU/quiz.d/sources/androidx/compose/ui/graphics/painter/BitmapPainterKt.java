...
public final class BitmapPainterKt {
    ...
    public static /* synthetic */ BitmapPainter m3339BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j, long j2, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            j = IntOffset.INSTANCE.m5145getZeronOccac();
        }
        long j3 = j;
        if ((i2 & 4) != 0) {
        ...
        long j4 = j2;
        if ((i2 & 8) != 0) {
            i = FilterQuality.INSTANCE.m2808getLowfv9h1I();
        }
        return m3338BitmapPainterQZhYCtY(imageBitmap, j3, j4, i);
    }

    /* renamed from: BitmapPainter-QZhYCtY, reason: not valid java name */
    public static final BitmapPainter m3338BitmapPainterQZhYCtY(ImageBitmap image, long j, long j2, int i) {
        Intrinsics.checkNotNullParameter(image, "image");
        BitmapPainter bitmapPainter = new BitmapPainter(image, j, j2, null);
        bitmapPainter.m3337setFilterQualityvDHp3xo$ui_graphics_release(i);
