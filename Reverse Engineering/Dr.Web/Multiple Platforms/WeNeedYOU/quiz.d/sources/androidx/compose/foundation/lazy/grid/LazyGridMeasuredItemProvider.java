...
public abstract class LazyGridMeasuredItemProvider {
    ...
    public static /* synthetic */ LazyGridMeasuredItem m658getAndMeasure3p2s80s$default(LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, int i, int i2, long j, int i3, Object obj) {
        if (obj != null) {
        ...
        return lazyGridMeasuredItemProvider.m659getAndMeasure3p2s80s(i, i2, j);
    }

    /* renamed from: getAndMeasure-3p2s80s, reason: not valid java name */
    public final LazyGridMeasuredItem m659getAndMeasure3p2s80s(int index, int mainAxisSpacing, long constraints) {
        ...
        List<Placeable> mo678measure0kLqBqw = this.measureScope.mo678measure0kLqBqw(index, constraints);
        if (Constraints.m4959getHasFixedWidthimpl(constraints)) {
            m4962getMinHeightimpl = Constraints.m4963getMinWidthimpl(constraints);
        } else {
            if (!Constraints.m4958getHasFixedHeightimpl(constraints)) {
                throw new IllegalArgumentException("Failed requirement.".toString());
            }
            m4962getMinHeightimpl = Constraints.m4962getMinHeightimpl(constraints);
        }
        return createItem(index, key, contentType, m4962getMinHeightimpl, mainAxisSpacing, mo678measure0kLqBqw);
    }
