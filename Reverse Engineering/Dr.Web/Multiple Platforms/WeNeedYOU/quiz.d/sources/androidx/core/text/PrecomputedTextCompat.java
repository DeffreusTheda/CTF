...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        Params(TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, int i, int i2) {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                breakStrategy = HalfKt$$ExternalSyntheticApiModelOutline0.m5356m(textPaint).setBreakStrategy(i);
    ...
    public PrecomputedText getPrecomputedText() {
        if (HalfKt$$ExternalSyntheticApiModelOutline0.m5375m((Object) this.mText)) {
            return HalfKt$$ExternalSyntheticApiModelOutline0.m5357m((Object) this.mText);
        }
        return null;
    }
