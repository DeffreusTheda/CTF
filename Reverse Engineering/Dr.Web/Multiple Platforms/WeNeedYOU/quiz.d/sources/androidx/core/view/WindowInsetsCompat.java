...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m5364m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m5364m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m5364m = HalfKt$$ExternalSyntheticApiModelOutline0.m5365m(windowInsets);
            } else {
                m5364m = HalfKt$$ExternalSyntheticApiModelOutline0.m5364m();
            }
            this.mPlatBuilder = m5364m;
        }
