...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                ...
                if (!collection.contains(Api26Impl.getId(m5267m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(m5267m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(m5267m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup m5268m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m5268m((Object) it.next());
                if (Api26Impl.getId(m5268m).equals(str)) {
                    return m5268m;
                }
            }
        }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(NotificationCompat$$ExternalSyntheticApiModelOutline0.m5267m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup m5268m = NotificationCompat$$ExternalSyntheticApiModelOutline0.m5268m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m5268m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m5268m, notificationChannels));
                    }
                }
                return arrayList;
            }
