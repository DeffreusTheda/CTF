...
public interface SendChannel<E> {
    ...
    Object mo7090trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo7090trySendJP2dKIU = sendChannel.mo7090trySendJP2dKIU(e);
            if (ChannelResult.m7110isSuccessimpl(mo7090trySendJP2dKIU)) {
                return true;
            }
            Throwable m7104exceptionOrNullimpl = ChannelResult.m7104exceptionOrNullimpl(mo7090trySendJP2dKIU);
