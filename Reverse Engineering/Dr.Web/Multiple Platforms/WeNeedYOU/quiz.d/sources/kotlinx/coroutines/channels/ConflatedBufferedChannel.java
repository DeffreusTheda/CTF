...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m7118trySendImplMj0NB7M = conflatedBufferedChannel.m7118trySendImplMj0NB7M(e, true);
        if (m7118trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m7104exceptionOrNullimpl(m7118trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m7118trySendImplMj0NB7M = conflatedBufferedChannel.m7118trySendImplMj0NB7M(e, true);
        if (!(m7118trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo7090trySendJP2dKIU(E element) {
        return m7118trySendImplMj0NB7M(element, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m7118trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m7116trySendDropLatestMj0NB7M(element, isSendOp) : m7117trySendDropOldestJP2dKIU(element);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m7116trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo7090trySendJP2dKIU = super.mo7090trySendJP2dKIU(element);
        if (ChannelResult.m7110isSuccessimpl(mo7090trySendJP2dKIU) || ChannelResult.m7108isClosedimpl(mo7090trySendJP2dKIU)) {
            return mo7090trySendJP2dKIU;
        }
        ...
        return ChannelResult.INSTANCE.m7115successJP2dKIU(Unit.INSTANCE);
    }

    /* renamed from: trySendDropOldest-JP2dKIU, reason: not valid java name */
    private final Object m7117trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (findSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m7113closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object mo7090trySendJP2dKIU = mo7090trySendJP2dKIU(element);
        if (!(mo7090trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(mo7090trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m7104exceptionOrNullimpl(mo7090trySendJP2dKIU);
