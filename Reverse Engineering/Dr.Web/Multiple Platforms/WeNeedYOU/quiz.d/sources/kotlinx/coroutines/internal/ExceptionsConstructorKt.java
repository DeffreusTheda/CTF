...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m5528constructorimpl = Result.m5528constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    m5528constructorimpl = Result.m5528constructorimpl(invoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m5528constructorimpl = Result.m5528constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m5534isFailureimpl(m5528constructorimpl) ? null : m5528constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m5528constructorimpl = Result.m5528constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5528constructorimpl = Result.m5528constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m5534isFailureimpl(m5528constructorimpl)) {
            m5528constructorimpl = valueOf;
        }
        return ((Number) m5528constructorimpl).intValue();
    }
