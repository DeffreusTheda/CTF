...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m5528constructorimpl = Result.m5528constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5528constructorimpl = Result.m5528constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m5534isFailureimpl(m5528constructorimpl) ? null : m5528constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo7146dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
