...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo7094receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo7094receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo7095tryReceivePtdJZtk() {
        return this._channel.mo7095tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo7090trySendJP2dKIU(E element) {
        return this._channel.mo7090trySendJP2dKIU(element);
    }
