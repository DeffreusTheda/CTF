...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> continuation) {
        ...
        try {
            ...
            m5528constructorimpl = Result.m5528constructorimpl(continuation + '@' + getHexAddress(continuation));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m5528constructorimpl = Result.m5528constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5531exceptionOrNullimpl(m5528constructorimpl) != null) {
            m5528constructorimpl = continuation.getClass().getName() + '@' + getHexAddress(continuation);
        }
        return (String) m5528constructorimpl;
    }
