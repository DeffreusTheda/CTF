...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> m6863m = StreamsKt$$ExternalSyntheticApiModelOutline0.m6863m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(newCoroutineContext, m6863m);
        m6863m.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m6865m((Object) completableFutureCoroutine));
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> m6863m = StreamsKt$$ExternalSyntheticApiModelOutline0.m6863m();
        setupCancellation(deferred, m6863m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$1
            ...
            public final void invoke2(Throwable th) {
                try {
                    m6863m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    m6863m.completeExceptionally(th2);
                }
            }
        });
        return m6863m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> m6863m = StreamsKt$$ExternalSyntheticApiModelOutline0.m6863m();
        setupCancellation(job, m6863m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    m6863m.complete(Unit.INSTANCE);
                } else {
                    m6863m.completeExceptionally(th);
                }
            }
        });
        return m6863m;
            ...
            */
            public final java.lang.Object invoke2(T r2, java.lang.Throwable r3) {
                ...
                L9:
                    ...
                    if (r0 == 0) goto L16
                    java.util.concurrent.CompletionException r0 = kotlin.streams.jdk8.StreamsKt$$ExternalSyntheticApiModelOutline0.m6864m(r3)     // Catch: java.lang.Throwable -> L2a
                    goto L17
                L16:
                    r0 = 0
                L17:
    ...
    public static final <T> Object await(CompletionStage<T> completionStage, Continuation<? super T> continuation) {
        ...
        completionStage.handle(StreamsKt$$ExternalSyntheticApiModelOutline0.m6865m((Object) continuationHandler));
