...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo7147scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m7078delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m7079toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7079toDelayMillisLRDsOJo(long j) {
        if (Duration.m6913compareToLRDsOJo(j, Duration.INSTANCE.m7017getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m6932getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
