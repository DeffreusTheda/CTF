    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                systemService = getContext().getSystemService((Class<Object>) Api26Bitmap$$ExternalSyntheticApiModelOutline0.m2603m());
                AutofillManager m2601m = Api26Bitmap$$ExternalSyntheticApiModelOutline0.m2601m(systemService);
                if (m2601m != null) {
                    m2601m.notifyValueChanged(this);
                }
            }
