...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m7054boximpl(m7048markNowz9LOYto());
    }
    ...
    public long m7048markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m7057constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m7047elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m7046differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m7045adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m7057constructorimpl(LongSaturatedMathKt.m7043saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
