...
final class ExceptionsCollector {
    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                PathTreeWalk$$ExternalSyntheticApiModelOutline0.m6764m$1();
                initCause = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m6744m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(initCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m6743m((Object) initCause);
            }
