...
class PathsKt__PathUtilsKt extends PathsKt__PathRecursiveFunctionsKt {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream it = StreamsKt$$ExternalSyntheticApiModelOutline0.m((Object) directoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        if (fileAttributeView != null) {
            return (V) StreamsKt$$ExternalSyntheticApiModelOutline0.m6856m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        readAttributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m6740m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(readAttributes, "readAttributes(this, A::class.java, *options)");
        return (A) StreamsKt$$ExternalSyntheticApiModelOutline0.m6855m((Object) readAttributes);
    }
