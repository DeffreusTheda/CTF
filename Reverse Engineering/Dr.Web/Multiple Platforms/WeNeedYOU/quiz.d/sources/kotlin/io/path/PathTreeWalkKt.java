...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        ...
        try {
            ...
            readAttributes = Files.readAttributes(path, (Class<BasicFileAttributes>) PathTreeWalk$$ExternalSyntheticApiModelOutline0.m6740m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
