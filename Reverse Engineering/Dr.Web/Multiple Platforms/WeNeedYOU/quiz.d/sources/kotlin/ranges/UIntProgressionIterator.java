...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r6 = kotlin.UInt.m5624constructorimpl(r6)
            r3.step = r6
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m5618boximpl(m6781nextpVg5ArA());
    }
    ...
    public int m6781nextpVg5ArA() {
        ...
        if (i == this.finalElement) {
            ...
            this.next = UInt.m5624constructorimpl(this.step + i);
        }
        return i;
    }
}
