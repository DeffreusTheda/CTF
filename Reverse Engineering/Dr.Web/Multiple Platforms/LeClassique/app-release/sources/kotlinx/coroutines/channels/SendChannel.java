...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1630trySendJP2dKIU = sendChannel.mo1630trySendJP2dKIU(e);
            if (ChannelResult.m1645isSuccessimpl(mo1630trySendJP2dKIU)) {
                return true;
            }
            Throwable m1639exceptionOrNullimpl = ChannelResult.m1639exceptionOrNullimpl(mo1630trySendJP2dKIU);
