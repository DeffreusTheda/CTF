...
public final class ConcurrentLinkedListKt {
    ...
    private static final <S extends Segment<S>> Object findSegmentInternal(S s2, long j, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s2.getId() >= j && !s2.getRemoved()) {
                return SegmentOrClosed.m1679constructorimpl(s2);
            }
            Object obj = s2.get_next();
            if (obj == CLOSED) {
                return SegmentOrClosed.m1679constructorimpl(CLOSED);
            }
