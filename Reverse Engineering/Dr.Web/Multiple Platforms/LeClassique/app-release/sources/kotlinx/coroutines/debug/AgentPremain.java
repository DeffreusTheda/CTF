...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m125constructorimpl = Result.m125constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m125constructorimpl = Result.m125constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m131isFailureimpl(m125constructorimpl) ? null : m125constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1653installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1653installSignalHandler$lambda1(Signal signal) {
