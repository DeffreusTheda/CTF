...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1677scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1614delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1615toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1615toDelayMillisLRDsOJo(long j) {
        if (Duration.m1450compareToLRDsOJo(j, Duration.INSTANCE.m1553getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1469getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
