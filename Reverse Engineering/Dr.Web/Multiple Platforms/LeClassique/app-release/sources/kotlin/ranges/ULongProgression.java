...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1344getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m299constructorimpl = ((int) ULong.m299constructorimpl(j ^ ULong.m299constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m299constructorimpl2 = (m299constructorimpl + ((int) ULong.m299constructorimpl(j2 ^ ULong.m299constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m299constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m345toStringimpl(this.first)).append("..").append((Object) ULong.m345toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m345toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m345toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
