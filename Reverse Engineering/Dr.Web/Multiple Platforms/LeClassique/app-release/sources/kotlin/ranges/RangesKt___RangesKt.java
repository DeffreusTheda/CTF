...
public class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final IntProgression downTo(short s2, int i) {
        return IntProgression.INSTANCE.fromClosedRange(s2, i, -1);
    }
    ...
    public static final LongProgression downTo(short s2, long j) {
        return LongProgression.INSTANCE.fromClosedRange(s2, j, -1L);
    }

    public static final IntProgression downTo(int i, short s2) {
        return IntProgression.INSTANCE.fromClosedRange(i, s2, -1);
    }

    public static final LongProgression downTo(long j, short s2) {
        return LongProgression.INSTANCE.fromClosedRange(j, s2, -1L);
    }
    ...
    public static final Byte toByteExactOrNull(short s2) {
        if (RangesKt.intRangeContains((ClosedRange<Integer>) new IntRange(-128, WorkQueueKt.MASK), s2)) {
    ...
    public static final IntRange until(short s2, int i) {
        if (i <= Integer.MIN_VALUE) {
            return IntRange.INSTANCE.getEMPTY();
        }
        return new IntRange(s2, i - 1);
    }
    ...
    public static final LongRange until(short s2, long j) {
        if (j <= Long.MIN_VALUE) {
            return LongRange.INSTANCE.getEMPTY();
        }
        return new LongRange(s2, j - 1);
    }

    public static final IntRange until(int i, short s2) {
        return new IntRange(i, s2 - 1);
    }

    public static final LongRange until(long j, short s2) {
        return new LongRange(j, s2 - 1);
    }
