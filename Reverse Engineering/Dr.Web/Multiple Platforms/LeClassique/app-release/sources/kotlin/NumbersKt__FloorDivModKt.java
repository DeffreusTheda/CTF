...
class NumbersKt__FloorDivModKt extends NumbersKt__BigIntegersKt {
    ...
    private static final int floorDiv(short s2, short s3) {
        int i = s2 / s3;
        return ((s2 ^ s3) >= 0 || s3 * i == s2) ? i : i - 1;
    }

    private static final short mod(short s2, short s3) {
        int i = s2 % s3;
        return (short) (i + (s3 & (((i ^ s3) & ((-i) | i)) >> 31)));
    }

    private static final int floorDiv(short s2, int i) {
        int i2 = s2 / i;
        return ((s2 ^ i) >= 0 || i * i2 == s2) ? i2 : i2 - 1;
    }

    private static final int mod(short s2, int i) {
        int i2 = s2 % i;
        return i2 + (i & (((i2 ^ i) & ((-i2) | i2)) >> 31));
    }

    private static final long floorDiv(short s2, long j) {
        long j2 = s2;
        long j3 = j2 / j;
        return ((j2 ^ j) >= 0 || j * j3 == j2) ? j3 : j3 - 1;
    }

    private static final long mod(short s2, long j) {
        long j2 = s2 % j;
        return j2 + (j & (((j2 ^ j) & ((-j2) | j2)) >> 63));
    }
    ...
    private static final int floorDiv(int i, short s2) {
        int i2 = i / s2;
        return ((i ^ s2) >= 0 || s2 * i2 == i) ? i2 : i2 - 1;
    }

    private static final short mod(int i, short s2) {
        int i2 = i % s2;
    ...
    private static final long floorDiv(long j, short s2) {
        long j2 = s2;
        long j3 = j / j2;
        return ((j ^ j2) >= 0 || j2 * j3 == j) ? j3 : j3 - 1;
    }

    private static final short mod(long j, short s2) {
        long j2 = j % s2;
