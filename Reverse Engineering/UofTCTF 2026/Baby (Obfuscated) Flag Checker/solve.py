                    ...
                    while True:
                        if G0g0SQu1D == 172:
                            if len(g0go) == 74:
                                                ...
                                                if g0gOSqu1D == 853:
                                                    while True:
                                                        if gogOSqUID == 263:
                                                            break
                                                        if gogOSqUID == 208:
                                                            return G0Gosqu1D * 1103515245 + 12345 & 2147483647
                                                    g0gOSqu1D = 997
                                                    continue
                                                if g0gOSqu1D == 418:
                                                    gogOSqUID = 208
                                ...
                                Ggs_833848 = Ggs(9)
                                GgS = (90 ^ 60) + 23 & 255
                                G0gosQu1D = [[13, 73, 41, 30, 53, 34], [8, 18, 27, 9, 30, 9, 27, 6, 25, 76, 25, 34], [37, 57, 66, 66, 66, 0], [25, 78, 63, 8, 58, 34], [77, 19, 78, 34, 14, 21, 77, 74, 34], [73, 19, 34, 76, 49, 48, 34], [15, 78, 11, 34, 77, 15, 34], [9, 21, 76, 72, 34, 10, 76, 74, 21, 34], [4, 77, 8, 34, 16, 77, 19, 22, 78, 36, 34]]
                                sQU1D = [6, 12, 6, 6, 9, 7, 7, 10, 11]
                                SqUId = [1, 8, 0, 3, 6, 4, 7, 5, 2]
                                        ...
                                        if GOgosqu1d == 430:
                                            while True:
                                                ...
                                                if g0GOSquID == 141:
                                                    while True:
                                                        if gogOsQU1d == 378:
                                                            return ''.join((chr(g0goSQu1D ^ GgS) for g0goSQu1D in G0gosQu1D[GgS_595457]))
                                                        if gogOsQU1d == 637:
                                                            break
                                                    g0GOSquID = 367
                                                    continue
                                                ...
                                                if g0g0sqUId == 347:
                                                    while True:
                                                        ...
                                                        if g0G0Squ1D == 564:
                                                            while True:
                                                                if g0gOSqU1D == 5843:
                                                                    g0gOSqU1D = 6814 if goG0sqU1d < len(g0Gosqu1D) else 1671
                                                                    continue
                                                                if g0gOSqU1D == 6814:
                                        ...
                                        if gOg0SQUId == 44:
                                            while True:
                                                ...
                                                if GogOSQuId == 996:
                                                    while True:
                                                        if gOG0Squ1D == 864:
                                                            GgS_178462 = sQUId * 73244475 & 4294967295
                                                            gOG0Squ1D = 966
                                                            continue
                                                        if gOG0Squ1D == 444:
                                                            break
                        ...
                        if G0g0SQu1D == 630:
                            break
                        if G0g0SQu1D == 194:
                            g0go = input('Enter the flag: ')
                            G0g0SQu1D = 172
                            continue
                        if G0g0SQu1D == 257:
                            print("\n  ____          ______     __  ______ _               _____    _____ _    _ ______ _____ _  ________ _____  \n |  _ \\   /\\   |  _ \\ \\   / / |  ____| |        /\\   / ____|  / ____| |  | |  ____/ ____| |/ /  ____|  __ \\ \n | |_) | /  \\  | |_) \\ \\_/ /  | |__  | |       /  \\ | |  __  | |    | |__| | |__ | |    | ' /| |__  | |__) |\n |  _ < / /\\ \\ |  _ < \\   /   |  __| | |      / /\\ \\| | |_ | | |    |  __  |  __|| |    |  < |  __| |  _  / \n | |_) / ____ \\| |_) | | |    | |    | |____ / ____ \\ |__| | | |____| |  | | |___| |____| . \\| |____| | \\ \\ \n |____/_/    \\_\\____/  |_|    |_|    |______/_/    \\_\\_____|  \\_____|_|  |_|______\\_____|_|\\_\\______|_|  \\_\\\n")
                            G0g0SQu1D = 194
                            continue
                    G0GosQu1D = 964
                    continue
