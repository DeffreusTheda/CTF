...
public final class DurationKt {
    ...
    private static final double m1006timesmvk6XK0(int i, double d) {
        return Duration.m988timesimpl(d, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final double m1005timeskIfJnKk(double d, double d2) {
        return Duration.m987timesimpl(d2, d);
    }

    public static final double toDuration(double d, TimeUnit unit) {
        Intrinsics.checkParameterIsNotNull(unit, "unit");
        return Duration.m961constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
}
