...
public abstract class TimeMark {
    ...
    public TimeMark m1009minusLRDsOJo(double duration) {
        return mo958plusLRDsOJo(Duration.m1002unaryMinusimpl(duration));
    }

    public final boolean hasPassedNow() {
        return !Duration.m982isNegativeimpl(elapsedNow());
    }
