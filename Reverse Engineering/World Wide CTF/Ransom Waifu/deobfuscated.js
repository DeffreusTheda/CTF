...
// await aes(new Uint8Array(await fetch('./waifu').then(r => r.arrayBuffer())), new Uint8Array(await crypto.subtle.digest('SHA-256', new TextEncoder().encode(password))));
// await aes(new Uint8Array(await fetch('./waifu').then(r => r.arrayBuffer())), new Uint8Array(await crypto.subtle.digest('SHA-256', new TextEncoder().encode(password))));
