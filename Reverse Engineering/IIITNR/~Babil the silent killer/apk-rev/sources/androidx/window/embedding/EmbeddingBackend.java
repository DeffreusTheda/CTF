...
public interface EmbeddingBackend {
    ...
    void registerSplitListenerForActivity(Activity activity, Executor executor, e.a<List<SplitInfo>> aVar);

    void setSplitRules(Set<? extends EmbeddingRule> set);

    void unregisterRule(EmbeddingRule embeddingRule);

    void unregisterSplitListenerForActivity(e.a<List<SplitInfo>> aVar);
}
