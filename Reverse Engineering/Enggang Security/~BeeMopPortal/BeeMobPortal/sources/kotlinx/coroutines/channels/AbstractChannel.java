    ...
    */
    public final java.lang.Object mo1632receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        ...
        L32:
            ...
            java.lang.Object r5 = r0.m1652closedJP2dKIU(r5)
            goto L52
        L4c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.INSTANCE
            java.lang.Object r5 = r0.m1654successJP2dKIU(r5)
        L52:
            return r5
        L53:
            r0.label = r3
    ...
    public final Object mo1633tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1653failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1652closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1654successJP2dKIU(pollInternal);
    }
    ...
    protected void onCancelIdempotent(boolean wasClosed) {
        ...
        Object m1671constructorimpl$default = InlineList.m1671constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1679remove()) {
                    prevNode.helpRemove();
                } else {
                    m1671constructorimpl$default = InlineList.m1676plusFjFbRPM(m1671constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1631onCancelIdempotentListww6eGU(m1671constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1639boximpl(z ? companion.m1652closedJP2dKIU(((Closed) obj).closeCause) : companion.m1654successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1639boximpl(ChannelResult.INSTANCE.m1652closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                ChannelResult m1639boximpl = ChannelResult.m1639boximpl(ChannelResult.INSTANCE.m1652closedJP2dKIU(closed.closeCause));
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m129constructorimpl(m1639boximpl));
            }
        }
