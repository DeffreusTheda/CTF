...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1634trySendJP2dKIU = sendChannel.mo1634trySendJP2dKIU(e);
            if (ChannelResult.m1649isSuccessimpl(mo1634trySendJP2dKIU)) {
                return true;
            }
            Throwable m1643exceptionOrNullimpl = ChannelResult.m1643exceptionOrNullimpl(mo1634trySendJP2dKIU);
