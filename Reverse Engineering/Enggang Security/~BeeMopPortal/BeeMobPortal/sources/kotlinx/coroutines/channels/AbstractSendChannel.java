    ...
    */
    ...
    public final Object mo1634trySendJP2dKIU(E element) {
        ...
        if (offerInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m1652closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo1679remove()) {
                receive.helpRemove();
            } else {
                m1671constructorimpl$default = InlineList.m1676plusFjFbRPM(m1671constructorimpl$default, receive);
            }
        }
        if (m1671constructorimpl$default != null) {
            if (!(m1671constructorimpl$default instanceof ArrayList)) {
                ((Receive) m1671constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m1671constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m1671constructorimpl$default;
