...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1592plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1591minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1447plusLRDsOJo(Duration.m1507unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1488isNegativeimpl(timeMark.mo1444elapsedNowUwyO8pc());
        }
