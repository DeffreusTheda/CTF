...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1450minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.mo1447plusLRDsOJo(Duration.m1507unaryMinusUwyO8pc(j));
        }

        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1454compareToLRDsOJo(comparableTimeMark.mo1446minusUwyO8pc(other), Duration.INSTANCE.m1557getZEROUwyO8pc());
        }
    }
}
