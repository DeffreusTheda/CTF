...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1616toJavaDurationLRDsOJo(long j) {
        Duration ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1476getInWholeSecondsimpl(j), kotlin.time.Duration.m1478getNanosecondsComponentimpl(j));
