...
public interface ReceiveChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1633tryReceivePtdJZtk = receiveChannel.mo1633tryReceivePtdJZtk();
            if (ChannelResult.m1649isSuccessimpl(mo1633tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1645getOrThrowimpl(mo1633tryReceivePtdJZtk);
            }
            Throwable m1643exceptionOrNullimpl = ChannelResult.m1643exceptionOrNullimpl(mo1633tryReceivePtdJZtk);
            if (m1643exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1643exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1632receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m1644getOrNullimpl(r4)
                return r4
            */
