...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            Throwable m1643exceptionOrNullimpl = ChannelResult.m1643exceptionOrNullimpl(holder);
            if (m1643exceptionOrNullimpl != null) {
                throw m1643exceptionOrNullimpl;
            }
            Function2<E, Continuation<? super R>, Object> function2 = this.$block;
            Object m1644getOrNullimpl = ChannelResult.m1644getOrNullimpl(holder);
            this.label = 1;
            obj = function2.invoke(m1644getOrNullimpl, this);
