...
public final class DurationKt {
    ...
    private static final long m1581timesmvk6XK0(int i, long j) {
        return Duration.m1493timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m1580timeskIfJnKk(double d, long j) {
        return Duration.m1492timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1557getZEROUwyO8pc = Duration.INSTANCE.m1557getZEROUwyO8pc();
        ...
        if (str2.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str2.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z7;
                        long m1491plusLRDsOJo = Duration.m1491plusLRDsOJo(m1557getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1557getZEROUwyO8pc = Duration.m1491plusLRDsOJo(m1491plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z7;
                        m1557getZEROUwyO8pc = Duration.m1491plusLRDsOJo(m1557getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z7 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, "Infinity".length()), true)) {
                m1557getZEROUwyO8pc = Duration.INSTANCE.m1555getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1491plusLRDsOJo2 = Duration.m1491plusLRDsOJo(m1557getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1557getZEROUwyO8pc = Duration.m1491plusLRDsOJo(m1491plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i3 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1557getZEROUwyO8pc = Duration.m1491plusLRDsOJo(m1557getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m1507unaryMinusUwyO8pc(m1557getZEROUwyO8pc) : m1557getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1455constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m1455constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m1455constructorimpl((j << 1) + i);
    }
