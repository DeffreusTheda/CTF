...
class UArraysKt___UArraysJvmKt {
    ...
    private static final int m610elementAtqFRl0hI(int[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UIntArray.m284getpVg5ArA(elementAt, i);
    }

    /* renamed from: elementAt-r7IrZao, reason: not valid java name */
    private static final long m611elementAtr7IrZao(long[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return ULongArray.m363getsVKNKU(elementAt, i);
    }

    /* renamed from: elementAt-PpDY95g, reason: not valid java name */
    private static final byte m608elementAtPpDY95g(byte[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UByteArray.m205getw2LRezQ(elementAt, i);
    }

    /* renamed from: elementAt-nggk6HY, reason: not valid java name */
    private static final short m609elementAtnggk6HY(short[] elementAt, int i) {
        Intrinsics.checkNotNullParameter(elementAt, "$this$elementAt");
        return UShortArray.m468getMh2AYeg(elementAt, i);
    }
    ...
    public static final int m600binarySearch2fe2U9s(int[] binarySearch, int i, int i2, int i3) {
    ...
    public static final int m604binarySearchK6DWlUc(long[] binarySearch, long j, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, ULongArray.m364getSizeimpl(binarySearch));
        int i3 = i2 - 1;
        while (i <= i3) {
            int i4 = (i + i3) >>> 1;
    ...
    public static final int m606binarySearchWpHrYlw(byte[] binarySearch, byte b, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UByteArray.m206getSizeimpl(binarySearch));
    ...
    public static final int m602binarySearchEtDCXyQ(short[] binarySearch, short s, int i, int i2) {
        Intrinsics.checkNotNullParameter(binarySearch, "$this$binarySearch");
        AbstractList.INSTANCE.checkRangeIndexes$kotlin_stdlib(i, i2, UShortArray.m469getSizeimpl(binarySearch));
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m618maxByjgv0xPQ(int[] maxBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int m284getpVg5ArA = UIntArray.m284getpVg5ArA(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UInt.m218boximpl(m284getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int m284getpVg5ArA2 = UIntArray.m284getpVg5ArA(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UInt.m218boximpl(m284getpVg5ArA2));
                if (invoke.compareTo(invoke2) < 0) {
                    m284getpVg5ArA = m284getpVg5ArA2;
                    invoke = invoke2;
                }
            }
        }
        return UInt.m218boximpl(m284getpVg5ArA);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> ULong m617maxByMShoTSo(long[] maxBy, Function1<? super ULong, ? extends R> selector) {
        ...
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(ULong.m297boximpl(m363getsVKNKU));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                long m363getsVKNKU2 = ULongArray.m363getsVKNKU(maxBy, it.nextInt());
                R invoke2 = selector.invoke(ULong.m297boximpl(m363getsVKNKU2));
                if (invoke.compareTo(invoke2) < 0) {
        ...
        return ULong.m297boximpl(m363getsVKNKU);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m616maxByJOV_ifY(byte[] maxBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte m205getw2LRezQ = UByteArray.m205getw2LRezQ(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UByte.m141boximpl(m205getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte m205getw2LRezQ2 = UByteArray.m205getw2LRezQ(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UByte.m141boximpl(m205getw2LRezQ2));
                if (invoke.compareTo(invoke2) < 0) {
                    m205getw2LRezQ = m205getw2LRezQ2;
                    invoke = invoke2;
                }
            }
        }
        return UByte.m141boximpl(m205getw2LRezQ);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m619maxByxTcfx_M(short[] maxBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short m468getMh2AYeg = UShortArray.m468getMh2AYeg(maxBy, 0);
        int lastIndex = ArraysKt.getLastIndex(maxBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UShort.m404boximpl(m468getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short m468getMh2AYeg2 = UShortArray.m468getMh2AYeg(maxBy, it.nextInt());
                R invoke2 = selector.invoke(UShort.m404boximpl(m468getMh2AYeg2));
                if (invoke.compareTo(invoke2) < 0) {
                    m468getMh2AYeg = m468getMh2AYeg2;
                    invoke = invoke2;
                }
            }
        }
        return UShort.m404boximpl(m468getMh2AYeg);
    }
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UInt m630minByjgv0xPQ(int[] minBy, Function1<? super UInt, ? extends R> selector) {
        ...
        int m284getpVg5ArA = UIntArray.m284getpVg5ArA(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UInt.m218boximpl(m284getpVg5ArA));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                int m284getpVg5ArA2 = UIntArray.m284getpVg5ArA(minBy, it.nextInt());
                R invoke2 = selector.invoke(UInt.m218boximpl(m284getpVg5ArA2));
                if (invoke.compareTo(invoke2) > 0) {
                    m284getpVg5ArA = m284getpVg5ArA2;
                    invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UByte m628minByJOV_ifY(byte[] minBy, Function1<? super UByte, ? extends R> selector) {
        ...
        byte m205getw2LRezQ = UByteArray.m205getw2LRezQ(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UByte.m141boximpl(m205getw2LRezQ));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                byte m205getw2LRezQ2 = UByteArray.m205getw2LRezQ(minBy, it.nextInt());
                R invoke2 = selector.invoke(UByte.m141boximpl(m205getw2LRezQ2));
                if (invoke.compareTo(invoke2) > 0) {
                    m205getw2LRezQ = m205getw2LRezQ2;
                    invoke = invoke2;
    ...
    private static final /* synthetic */ <R extends Comparable<? super R>> UShort m631minByxTcfx_M(short[] minBy, Function1<? super UShort, ? extends R> selector) {
        ...
        short m468getMh2AYeg = UShortArray.m468getMh2AYeg(minBy, 0);
        int lastIndex = ArraysKt.getLastIndex(minBy);
        if (lastIndex != 0) {
            R invoke = selector.invoke(UShort.m404boximpl(m468getMh2AYeg));
            ?? it = new IntRange(1, lastIndex).iterator();
            while (it.hasNext()) {
                short m468getMh2AYeg2 = UShortArray.m468getMh2AYeg(minBy, it.nextInt());
                R invoke2 = selector.invoke(UShort.m404boximpl(m468getMh2AYeg2));
                if (invoke.compareTo(invoke2) > 0) {
                    m468getMh2AYeg = m468getMh2AYeg2;
                    invoke = invoke2;
    ...
    private static final BigDecimal sumOfBigDecimal(int[] sumOf, Function1<? super UInt, ? extends BigDecimal> selector) {
        ...
        int m285getSizeimpl = UIntArray.m285getSizeimpl(sumOf);
        for (int i = 0; i < m285getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UInt.m218boximpl(UIntArray.m284getpVg5ArA(sumOf, i))));
    ...
    private static final BigDecimal sumOfBigDecimal(long[] sumOf, Function1<? super ULong, ? extends BigDecimal> selector) {
        ...
        for (int i = 0; i < m364getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(ULong.m297boximpl(ULongArray.m363getsVKNKU(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(byte[] sumOf, Function1<? super UByte, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m206getSizeimpl = UByteArray.m206getSizeimpl(sumOf);
        for (int i = 0; i < m206getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UByte.m141boximpl(UByteArray.m205getw2LRezQ(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
    ...
    private static final BigDecimal sumOfBigDecimal(short[] sumOf, Function1<? super UShort, ? extends BigDecimal> selector) {
        ...
        BigDecimal valueOf = BigDecimal.valueOf(0L);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(this.toLong())");
        int m469getSizeimpl = UShortArray.m469getSizeimpl(sumOf);
        for (int i = 0; i < m469getSizeimpl; i++) {
            valueOf = valueOf.add(selector.invoke(UShort.m404boximpl(UShortArray.m468getMh2AYeg(sumOf, i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "this.add(other)");
        }
        return valueOf;
    }
