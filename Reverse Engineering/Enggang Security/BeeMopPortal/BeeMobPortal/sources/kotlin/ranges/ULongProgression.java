...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1348getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m303constructorimpl = ((int) ULong.m303constructorimpl(j ^ ULong.m303constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m303constructorimpl2 = (m303constructorimpl + ((int) ULong.m303constructorimpl(j2 ^ ULong.m303constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m303constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m349toStringimpl(this.first)).append("..").append((Object) ULong.m349toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m349toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m349toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
