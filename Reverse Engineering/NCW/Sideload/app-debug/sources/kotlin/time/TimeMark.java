...
public interface TimeMark {
    ...
    TimeMark mo1479minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1481plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1626plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1625minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1481plusLRDsOJo(Duration.m1541unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1522isNegativeimpl($this.mo1478elapsedNowUwyO8pc());
        }
