...
public interface SendChannel<E> {
    ...
    Object mo1670trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object result = sendChannel.mo1670trySendJP2dKIU(e);
            if (ChannelResult.m1685isSuccessimpl(result)) {
                return true;
            }
            Throwable m1679exceptionOrNullimpl = ChannelResult.m1679exceptionOrNullimpl(result);
