            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m163constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        result = Result.m163constructorimpl(Unit.INSTANCE);
                    } catch (Throwable th3) {
                        th = th3;
                        Result.Companion companion5 = Result.INSTANCE;
                        result = Result.m163constructorimpl(ResultKt.createFailure(th));
                        handleFatalException(fatalException, Result.m166exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
