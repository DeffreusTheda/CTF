...
public final class UnsignedKt {
    ...
    public static final long m516ulongDivideeb3DHEI(long v1, long v2) {
        ...
        if (v2 < 0) {
            ...
            return ULong.m337constructorimpl(compare2 >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
        ...
        compare = Long.compare(ULong.m337constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m337constructorimpl(v2) ^ Long.MIN_VALUE);
        return ULong.m337constructorimpl((compare < 0 ? 0 : 1) + quotient);
    }
