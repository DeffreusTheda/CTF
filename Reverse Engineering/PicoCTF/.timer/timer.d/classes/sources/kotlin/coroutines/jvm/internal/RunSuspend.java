...
final class RunSuspend implements Continuation<Unit> {
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m33boximpl(result);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result result = m1221getResultxLWZpok();
                if (result == null) {
                    wait();
                } else {
