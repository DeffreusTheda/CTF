...
An EP titled "The Enigma of Heaven and Other Daily Delusions" """)
            ...
            reg.set('r4', [1611216, 946813, 716893, 716989, 488303, 939977, 1175675, 1391467, 1391323])
            reg.set('r2', 0)
            while reg.get('r2') < 9:
                reg.set('r6', (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+0] | (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+0] << 16)) & 0x030000FF)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 8))  & 0x0300F00F)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 4))  & 0x030C30C3)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 2))  & 0x09249249)
                reg.set('r5', reg.get('r6'))
                reg.set('r6', (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+1] | (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+1] << 16)) & 0x030000FF)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 8))  & 0x0300F00F)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 4))  & 0x030C30C3)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 2))  & 0x09249249)
                reg.set('r5', reg.get('r5') | (reg.get('r6') << 1))
                reg.set('r6', (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+2] | (reg.get('r1')[reg.get('r0')][reg.get('r2')*3+2] << 16)) & 0x030000FF)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 8))  & 0x0300F00F)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 4))  & 0x030C30C3)
                reg.set('r6', (reg.get('r6') | (reg.get('r6') << 2))  & 0x09249249)
                reg.set('r5', reg.get('r5') | (reg.get('r6') << 2))
                # print(f'{reg.get('r5')} {reg.get('r4')[reg.get('r2')]}')
                if reg.get('r5') != reg.get('r4')[reg.get('r2')]:
                    destruction(reg)
                reg.set('r2', reg.get('r2') + 1)
            reg.set('r0', reg.get('r0') + 1)
