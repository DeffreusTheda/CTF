...
`pdfcrack` with `rockyou.txt`, and you'll get `makanapel` as the password.
`qpdf --password=makanapel --decrypt flag_protected.pdf decrypted.pdf`
use `flatedecode.py` on `decrypted.pdf`
Deob: [jsfuck](https://enkhee-osiris.github.io/Decoder-JSFuck/) then [Obfuscator.io](https://obf-io.deobfuscate.io/).
